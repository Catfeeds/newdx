...
SCRIPT;
	...
	if(!submitcheck('deletesubmit')) {
		$a_count = DB::result_first('SELECT COUNT(*) FROM '.DB::table('home_album')." WHERE catid = '$_GET[catid]' " . getSlaveID());
		...
		if($delids) {
			...
			$num = DB::result_first('SELECT COUNT(*) FROM '.DB::table('home_album')." WHERE catid = '$_POST[tocatid]' " . getSlaveID());
