...
var rowtypedata = [
	[
		...
		[1,'<input type="text" class="txt" name="newdescription[]" size="20">', 'td26'],
		[1,'<input type="text" class="txt" name="newlogo[]" size="20">'],
		[1,'<input type="text" class="txt" name="newfids[]" size="25">'],
		[1,'<input class="checkbox" type="checkbox" value="1" name="newportal[]">'],
		[1,'<input class="checkbox" type="checkbox" value="1" name="newforum[]">'],
		[1,'<input class="checkbox" type="checkbox" value="1" name="newgroup[]">'],
		[1,'<input class="checkbox" type="checkbox" value="1" name="newhome[]">']
	]
]
</script>
<?
		...
		showtableheader();
		showsubtitle(array('', 'display_order', 'misc_link_edit_name', 'misc_link_edit_url', 'misc_link_edit_description', 'misc_link_edit_logo', 'fid ex:189,124', 'misc_link_group1', 'misc_link_group2', 'misc_link_group3','misc_link_group4'));
		...
		while($forumlink = DB::fetch($query)) {
			...
			showtablerow('', array('class="td25"', 'class="td28"', '', '', 'class="td26"', ''), array(
				...
				'<input type="text" class="txt" name="description['.$forumlink[id].']" value="'.$forumlink['description'].'" size="20" />',
				'<input type="text" class="txt" name="logo['.$forumlink[id].']" value="'.$forumlink['logo'].'" size="20" />',
				'<input type="text" class="txt" name="fids['.$forumlink[id].']" value="'.$forumlink['fids'].'" size="25" />',
		...
		if(is_array($_G['gp_newname'])) {
			foreach($_G['gp_newname'] as $key => $value) {
				if($value) {
					$type_str = $_G['gp_newportal'][$key].$_G['gp_newforum'][$key].$_G['gp_newgroup'][$key].$_G['gp_newhome'][$key];
					$type_str = intval($type_str, '2');
