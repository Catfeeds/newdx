		...
		if(submitcheck('sortdetailsubmit')) {
			...
			if(is_array($addoption) && !empty($addoption)) {
				...
				if(DB::num_rows($query) != 1) {
					...
					$create_table_sql .= ($create_tableoption_sql ? $create_tableoption_sql.',' : '')."tid int(10) UNSIGNED NOT NULL DEFAULT '0',fid smallint(6) UNSIGNED NOT NULL DEFAULT '0',dateline int(10) UNSIGNED NOT NULL DEFAULT '0',expiration int(10) UNSIGNED NOT NULL DEFAULT '0',";
