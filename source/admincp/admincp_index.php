...
$blogsmod = DB::result_first("SELECT COUNT(*) FROM ".DB::table('home_blog')." WHERE status='1' " . getSlaveID());
$doingsmod = DB::result_first("SELECT COUNT(*) FROM ".DB::table('home_doing')." WHERE status='1' " . getSlaveID());
$picturesmod = DB::result_first("SELECT COUNT(*) FROM ".DB::table('home_pic')." WHERE status='1' " . getSlaveID());
$sharesmod = DB::result_first("SELECT COUNT(*) FROM ".DB::table('home_share')." WHERE status='1' " . getSlaveID());
//$commentsmod = DB::result_first("SELECT COUNT(*) FROM ".DB::table('home_comment')." WHERE status='1'");
$articlesmod = DB::result_first("SELECT COUNT(*) FROM ".DB::table('portal_article_title')." WHERE status='1' " . getSlaveID());
$articlecommentsmod = DB::result("SELECT COUNT(*) FROM ".DB::table('portal_comment')." WHERE status='1' " . getSlaveID());
$verify = '';
