 ...
 *
 *      $Id: cloud_connect.php 23125 2011-06-20 10:35:23Z yangli $
 */
...
if($_G['gp_anchor'] == 'service') {
	...
	$staturl = $setting['connectsiteid'] ? 'http://connect.manyou.com/site/stats/index?'.cloud_http_build_query($params) : '';
