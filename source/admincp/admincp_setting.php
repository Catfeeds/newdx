 ...
 *
 *      $Id: admincp_setting.php 22962 2011-06-09 06:28:30Z monkey $
 */
...
if(!submitcheck('settingsubmit')) {
	...
	if($operation == 'basic') {
		...
		showsetting('setting_serveropti_jspath', '', '', '<ul class="nofloat" onmouseover="altStyle(this);">
			...
			// '<li'.($tjspath['custom'] ? ' class="checked"' : '').'><input class="radio" type="radio" name="settingnew[jspath]" value="" '.$tjspath['custom'].'> '.$lang['setting_serveropti_jspath_custom'].' <input type="text" class="txt" style="width: 100px" name="settingnew[jspathcustom]" value="'.$setting['jspath'].'" size="6"></li>'.
			'</ul>'
		);
		...
		showsetting('setting_mail_setting_send', array('settingnew[mail][mailsend]', array(
			...
			array(4, $lang['setting_mail_setting_send_4'], array('hidden1' => 'none', 'hidden2' => 'none'))
...
EOT;
		...
		showsetting('setting_sec_secqaa_status', array('settingnew[secqaa][status]', array(
			...
			cplang('setting_sec_seccode_status_post'),
			cplang('setting_sec_seccode_status_password'),
			cplang('setting_sec_seccode_status_m8264')
