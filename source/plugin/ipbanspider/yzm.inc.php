...
$w=180;
$h=60;
$fontface=dirname(__file__)."/simhei.ttf"; //字体文件
//$fontface=DISCUZ_ROOT."./static/image/seccode/font/en/FetteSteinschrift.ttf";
...
//$str="sfsaghdshg3oippwamklnbzx254joagnsmaskmpi890890jkspgagkngmasj020hygnasnag";
$code="";
for($i=0;$i<4;$i++){
