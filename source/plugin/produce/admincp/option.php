...
<tr><td class="td27" colspan="2">板块页是否宽屏显示:</td></tr>
<tr class="noborder">
	<td class="vtop rowform">
		<ul onmouseover="altStyle(this);">
			<li <?php if ($option_fields['isFullScreen']==1) {?> class="checked"<?php } ?>><input type="radio" value="1" name="isFullScreen" class="radio" <?php if ($option_fields['isFullScreen']==1) {?> checked="checked"<?php } ?>>&nbsp;是</li>
			<li <?php if ($option_fields['isFullScreen']==0) {?> class="checked"<?php } ?>><input type="radio" value="0" name="isFullScreen" class="radio" <?php if ($option_fields['isFullScreen']==0) {?> checked="checked"<?php } ?>>&nbsp;否</li>
		</ul>
	</td>
	<td class="vtop tips2">
...
<tr class="noborder">
	<td class="vtop rowform">
		<ul onmouseover="altStyle(this);">
			<li <?php if ($option_fields['isFullScreen_viewthread']==1) {?> class="checked"<?php } ?>><input type="radio" value="1" name="isFullScreen_viewthread" class="radio" <?php if ($option_fields['isFullScreen_viewthread']==1) {?> checked="checked"<?php } ?>>&nbsp;是</li>
			<li <?php if ($option_fields['isFullScreen_viewthread']==0) {?> class="checked"<?php } ?>><input type="radio" value="0" name="isFullScreen_viewthread" class="radio" <?php if ($option_fields['isFullScreen_viewthread']==0) {?> checked="checked"<?php } ?>>&nbsp;否</li>
		</ul>
	</td>
	<td class="vtop tips2">
