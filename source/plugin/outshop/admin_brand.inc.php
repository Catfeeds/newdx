...
showtableheader();
?>
<tr class="header"><th>编号</th><th>品牌名称</th><th>专卖品牌下店铺个数</th><th>操作</th></tr>
...
<tr>
	...
	<td>
		...
		&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" id="submit_<?php echo $value['id'];?>" name="submit_<?php echo $value['id'];?>" value="修改" style="visibility:hidden" onClick="checkvalue('brand_<?php echo $value['id']; ?>');"/><input type="hidden" name="id" id="id" value="<?php echo $value['id']; ?>" />&nbsp;&nbsp;&nbsp;<span id="tip<?php echo $value['id']; ?>"></span>
	</td>
	<td>
	...
	<td>
	<a onclick="return confirm('您确认删除？');" href="<?php echo ADMINSCRIPT;?>?action=plugins&operation=config&do=<?php echo $pluginid;?>&identifier=outshop&pmod=admin_brand&id=<?php echo $value['id']; ?>">删除</a>
	</td>
</tr>
<?php }
showtablefooter();
