...
$ppp = 12;
$count = $forumoption_mudidi->getCountSubScapeareaByTid($tid);
$scapeareaData = $forumoption_mudidi->getSubScapeareaByTid($tid, (($page - 1) * $ppp).", $ppp");
...
$pageTitle = "{$mudidi_data['subject']}旅游景区介绍 - {$mudidi_data['subject']}旅游景区大全 - 户外资料网";

include template('whither:scapearealist');
