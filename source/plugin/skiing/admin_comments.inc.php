...
$where = " WHERE p.first=0 AND p.fid=".$_G['config']['fids']['skiing'];
$ppp = 50;
...
<div style="overflow:hidden;width:99%;clear:both;padding:5px;border-top:1px solid #deeffb;">
	...
	<div style="float:right;">
		<?php echo multi($count, $ppp, $page, ADMINSCRIPT."?action=plugins&operation=config&do=$pluginid&identifier=skiing&pmod=admin_comments");?>
	</div>
</div>
</form>
