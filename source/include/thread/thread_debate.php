...
$query = DB::query("SELECT author, authorid FROM ".DB::table($posttable)." p, ".DB::table('forum_debatepost')." dp
	WHERE p.tid='$_G[tid]' AND p.anonymous='0' AND p.invisible='0' AND dp.stand='1' AND p.pid=dp.pid ORDER BY p.dateline DESC LIMIT 32");
...
$query = DB::query("SELECT author, authorid FROM ".DB::table($posttable)." p, ".DB::table('forum_debatepost')." dp
	WHERE p.tid='$_G[tid]' AND p.anonymous='0' AND p.invisible='0' AND dp.stand='2' AND p.pid=dp.pid ORDER BY p.dateline DESC LIMIT 32");
