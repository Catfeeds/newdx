...
if(!empty($searchid)) {
	...
	while($info = DB::fetch($query)) {
		$threadlist[$info['tid']]['icon'] = isset($_G['cache']['icons'][$info['iconid']]) ? '<img src="http://static.8264.com/static/image/forum/icon/'.$_G['cache']['icons'][$info['iconid']].'" alt="Icon'.$info['iconid'].'" class="icon" />' : '&nbsp;';
