...
function accessimg($access) {
	return $access == -1 ? '<img src="http://static.8264.com/static/image/common/access_disallow.gif" />' :
		($access == 1 ? '<img src="http://static.8264.com/static/image/common/access_allow.gif" />' : '<img src="http://static.8264.com/static/image/common/access_normal.gif" />');
}
