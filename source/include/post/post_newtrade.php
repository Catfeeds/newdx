 ...
 *
 *      $Id: post_newtrade.php 22550 2011-05-12 05:21:39Z monkey $
 */
...
if($displayorder == -2) {
	...
	$has_moderated_arr = explode('|', $has_moderated_arr);
...
if($modnewthreads) {
	...
	if($displayorder != -4) {
		...
		if($_G['forum']['type'] == 'sub') {
			DB::query("UPDATE ".DB::table('forum_forum')." SET lastpost='$lastpost', threads=threads+1, posts=posts+2, todayposts=todayposts+1 WHERE fid='".$_G['forum']['fup']."'", 'UNBUFFERED');
		}
	}
