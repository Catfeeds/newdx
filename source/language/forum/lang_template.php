...
$lang = array (
  ...
  'activiy_nature_1' => 'AA',
  'activiy_nature_2' => '商业',
  'activiy_nature_3' => 'AA：表示全体人员包括领队组织者均摊费用，多退少补。<br />商业：组织者以盈利为目的或组织者不参与AA。',
  'consumption_credit' => '消耗积分',
  'input_invalid' => '填写无效',
  'optional_data' => '您希望报名人员填写哪些信息',
  'other_data' => '其它资料项',
  'post_activity_message' => '每行代表一个项目，最多',
  'post_click_message_1' => '点击更新来更换你的图片',
  'post_click_message_2' => '添加一张活动的真实图片，报名率提高30%',
  'post_closing' => '报名截止',
  'post_error_message_1' => '对不起，请输入活动时间',
  'post_error_message_2' => '对不起，请输入活动地点',
  'post_error_message_3' => '对不起，请输入活动玩法',
  'post_error_message_4' => '对不起，请输入活动地区',
  ...
  'stats_main_child_threadname' => '子版块名称',
  ...
  'topicadmin_delet_comment_commentreply' => '删除点评，其回复也会被删除，确定？',
  ...
  'activity_no_member' => '你还不是本{$_G[setting][navs][3][navname]}群的成员不能参与此活动。',
  ...
  'post_newreply' => '发表回复',
  'post_tip' => '希望您的评论，能为大家提供一个全面并客观的参考意见。所以请不要发任何无实际意义的评论内容。',
  ...
  'xiangguanxinxi' => '相关信息',
  'qitafenxiang' =>'的其它分享',
  'kenengganxingqudezhuangbei' =>'可能感兴趣的装备',
  'kenengganxingquderen' =>'可能感兴趣的人',
  ...
  'attach_nopermission_login' => '你需要<a href="member.php?mod=logging&action=login" onclick="showWindow(\'login\', this.href);return false;">登录</a>才可以下载或查看附件。没有账号？<a href="member.php?mod={$_G[setting][regname]}" onclick="hideWindow(\'login\');showWindow(\'register\', this.href);return false;" title="注册账号">{$_G[setting][reglinkname]}</a>',
  'has_expired' => '该信息已经过期',
  'have' => '已有',
