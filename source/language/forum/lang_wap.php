...
(
	...
	'register_ctrl' => '对不起，你的 IP 地址在 {$_G[setting][regctrl]} 小时内只能注册一个账号，请返回。',
	...
	'register_activation_message' => '对不起，你输入的用户名 \"$username\" 已经存在，请登录论坛激活此账号<br /><a href=\"forum.php?mod=index&action=login\">登录论坛</a>',
	...
	'profile_email_verify' => '确认 Email 已经发送，请用邮件中提供的方法激活你的账号。如果你没有收到我们发送的系统邮件，请点击控制面板首页中的“重新验证 Email 有效性”，或尝试更换另外一个地址。注意：在完成激活之前，根据管理员设置，你将只能以等验证会员的身份访问论坛，你可能不能进行发帖等操作。激活成功后，上述限制将自动取消。',
