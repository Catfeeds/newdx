...
<p class="summary">订单号：<span>{orderid}</span></p><p class="summary">支出：<span>人民币 {price} 元</span></p><p class="summary">收入：<span>{value}</span></p>',
        ...
        'rate_reasons' => '你在主题 <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank">{subject}</a> 的帖子被 {actor} 评分 {ratescore} <div class="quote"><blockquote>{reason}</blockquote>&nbsp;&nbsp;&nbsp;8264币可以兑换礼品，请点击进入<a href="http://bbs.8264.com/forum-483-1.html" target="_blank">礼品兑换中心</a></div>',
	...
	'repquote_noticeauthor' => '{actor} 回复了你的帖子 <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank">{subject}</a> &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="lit">查看</a>',
	...
	'task_reward_checked_ok' => '恭喜你的任务：<a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>，已经通过管理员的审核',
	
	'task_reward_checked_error' => '很遗憾你完成任务：<a href="home.php?mod=task&do=view&id={taskid}" target="_blank">{name}</a>，未能通过管理员的审核',
    ...
    'thread_invitefx' => '{actor} 邀请你{invitename} <a href="http://www.8264.com/zb-{tid}" target="_blank">{subject}</a> &nbsp; <a href="http://www.8264.com/zb-{tid}" target="_blank" class="lit">查看 &rsaquo;</a>',
...
<p class="mbn"><a href="home.php?mod=magic" target="_blank">回赠道具</a><span class="pipe">|</span><a href="home.php?mod=magic&action=mybox" target="_blank">查看我的道具箱</a></p>',
	'at_message' => '<a href="home.php?mod=space&uid={src_uid}" target="_blank">{src_username}</a> 在 <a href="forum.php?mod=redirect&goto=findpost&ptid={tid}&pid={pid}" target="_blank">{subject}</a> 中提到了您，<a href="forum.php?mod=redirect&goto=findpost&ptid={tid}&pid={pid}" target="_blank">现在去看看</a>。',
	'following_notify' => '{actor} 关注了您',
