 ...
 *
 *      $Id: lang_template.php 23325 2011-07-06 03:20:34Z zhengqingpeng $
 *
...
$lang = array (
  ...
  'ignore_member_pm_message_2014' => '<li><i>1</i><span>添加到该列表中的用户给你发送短消息时将不予接收</span></li>
								<li><i>2</i><span>添加多个忽略人员名单时用逗号 "," 隔开，如“张三,李四,王五”</span></li>
								<li><i>3</i><span>如需禁止所有用户发来的短消息，请设置为 "&#123;ALL&#125;"</span></li>',
  'last_day_1' => '最近一天',
  'last_day_2' => '最近两天',
  'last_day_3' => '最近三天',
  ...
  'task_complete' => '已完成',
  'task_complete_waitting' => '<font color="green">已完成</font>,<font color="red">等待审核</font>',
  ...
  'random' => '任意',
  'reside_city' => '居住地',
  'search_member_list_message' => '以下是查找到的用户列表(最多显示100个)',
  ...
  'upload_pic_tips' => '<p>从电脑中选择你要上传的图片。<br />提示：选择一张图片后，你可以继续选择下一张图片，这样就可以一次上传多张图片了。<br />照片尺寸边长请不要大于2500像素，否则无法上传。</p>',
