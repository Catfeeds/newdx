...
$ac = in_array($_GET['ac'], array('comment', 'article', 'related', 'block', 'portalblock', 'blockdata', 'topic', 'topic_block', 'topic_block_item', 'diy', 'upload', 'category', 'plugin', 'api_geturl', 'logout'))?$_GET['ac']:'index';
