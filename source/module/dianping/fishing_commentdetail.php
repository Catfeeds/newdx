...
$detail = $detail_obj->getdetail('fishing', 'i.lon, i.lat, i.dir,i.serverid,i.addr,i.provinceid,i.cityid,i.type,i.isfree');
...
include template('dianping/fishing_commentdetail');
?>
