...
$detail = $detail_obj->getdetail('brand', 'i.id,i.url,i.letter,i.nation,i.showimg,i.dir,i.serverid,i.cname,i.ename,i.nation,i.company,i.addr,i.ranklist,i.city,i.tel,i.url');
...
include template('dianping/brand_commentdetail');
?>
