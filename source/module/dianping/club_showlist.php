...
$where = 'ispublish = 1';
if ($gongsitype) {
    $condition .= " and  gongsitype = {$gongsitype}";
...
$modlistcount = $list_obj->getlist($mod, 'cityid,provinceid,addr,cnum,tel,chenglishijian,lingduinum,gongsitype', $condition_if, $start, $perpage, $orderby, '', 1);
$listcount = count($modlistcount);

$modlistall = $list_obj->getlist($mod, 'cityid,provinceid,addr,cnum,chenglishijian,lingduinum,gongsitype', 'ispublish=1', $start, '', $orderby, '', 0);
...
include template('dianping/club_showlist');