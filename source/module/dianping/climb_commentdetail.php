...
$detail = $detail_obj->getdetail('climb', 'i.lon, i.lat, i.addr,i.tel,i.provinceid,i.placetype,i.type,i.cityid,i.dir,i.serverid');
...
include template('dianping/climb_commentdetail');
?>
