...
$detail = $detail_obj->getdetail('equipment', 'i.cid, cname, i.pcid, i.dir,i.serverid,i.pcname, i.price, i.relatedtid, i.brandid, i.brandname, i.brandtid');
...
include template('dianping/equipment_commentdetail');
?>
