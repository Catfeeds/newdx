...
$detail = $detail_obj->getdetail('shop', 'i.lon, i.lat, i.addr, i.provinceid, p.pid,i.dir,i.serverid');
...
$modlistall = $list_obj->getlist('shop', 'addr,cnum', 'ispublish=1', $start, '', $orderby, '', 0);
$allcodeList = array();
...
include template('dianping/shop_commentdetail');
?>
