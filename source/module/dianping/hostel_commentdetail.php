...
$detail = $detail_obj->getdetail('hostel', 'i.lon, i.lat, i.addr,i.tel,i.provinceid,i.placetype,i.type,i.cityid,i.dir,i.serverid');
...
include template('dianping/hostel_commentdetail');
?>
