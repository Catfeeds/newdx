...
$detail = $detail_obj->getdetail('mountain', 'i.type,i.dir,i.serverid, i.height, i.region, i.altitude, i.lon, i.lat, i.season');
...
include template('dianping/mountain_commentdetail');
?>
