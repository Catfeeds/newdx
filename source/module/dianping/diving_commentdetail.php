...
$detail = $detail_obj->getdetail('diving', 'i.lon, i.lat, i.addr,i.dir,i.serverid, i.provinceid, p.pid,i.type,i.cityid');
...
include template('dianping/diving_commentdetail');
?>
