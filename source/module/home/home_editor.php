...
<tr><td>
<table cellpadding="0" cellspacing="0" id="tmpdd" style=" background-color:#999999;height:100%;width:100%;overflow:hidden">
<tr>
<td>
<SCRIPT LANGUAGE="JavaScript">
	function blank_load() {
	...
	if(document.all){
		document.write('<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" id="divEditor"><tr><td style="background-color:#ffffff"><IFRAME class="HtmlEditor" ID="HtmlEditor" name="HtmlEditor" style="height:100%;width:100%" frameBorder="0" marginHeight=0 marginWidth=0 src="home.php?mod=editor&op=blank&charset=<?=$_GET['charset']?>" onload="blank_load();"></IFRAME></td></tr></table>');
	}else{
...
<script>
function timelimit(){
	if(parseInt(BROWSER.ie) == 9){
	var bbt = document.getElementById('tmpdd');
	bbt.style.height = bbt.parentNode.offsetHeight + 'px';
	document.getElementById('HtmlEditor').style.height =  bbt.parentNode.offsetHeight + 'px';
	document.getElementById('divEditor').style.height =  bbt.parentNode.offsetHeight + 'px';
	}
}
setTimeout(timelimit, 500);
</script>
</body>
</html>
<?php
