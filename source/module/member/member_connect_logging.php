 ...
 *
 *      $Id: member_connect_logging.php 22725 2011-05-18 06:45:29Z monkey $
 */
...
if(!empty($_POST)) {
	...
	if ((count($auth_code) == 1 && $conopenid) || ($conuin && $conuinsecret && $conopenid)) {
