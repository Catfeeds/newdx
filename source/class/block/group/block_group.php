 ...
 *
 *      $Id: block_group.php 22550 2011-05-12 05:21:39Z monkey $
 */
	...
	function getdata($style, $parameter) {
		...
		while($data = DB::fetch($query)) {
			$list[] = array(
				...
				'fields' => array(
					'fulltitle' => $data['name'],
					'icon' => !empty($data['icon']) ? $_G['setting']['attachurl'].'group/'.$data['icon'] : 'http://static.8264.com/static/image/common/nophoto.gif',
