 ...
 *
 *      $Id: block_article.php 22550 2011-05-12 05:21:39Z monkey $
 */
...
class block_article {
	...
	function fields() {
		return array(
				...
				//'caturls' => array('name' => lang('blockclass', 'blockclass_article_field_caturl'), 'formtype' => 'text', 'datatype' => 'string'),
	...
	function getdata($style, $parameter) {
		...
		while($data = DB::fetch($query)) {
			if(empty($data['pic'])) {
				$data['pic'] = 'http://static.8264.com/static/image/common/nophoto.gif';
				$data['picflag'] = '0';
			} else {
