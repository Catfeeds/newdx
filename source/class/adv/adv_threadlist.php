...
class adv_threadlist {
	...
	function evalcode() {
		...
		return array(
			'check' => '
			if($GLOBALS[\'page\'] != 1 || (!empty($_GET[\'filter\']) && $_GET[\'filter\'] != \'typeid\' )|| !empty($_GET[\'orderby\'])
			...
			if($_G[\'newtpl\']){
				...
				: \'<tr><td class="tb_"><a href="forum.php?mod=viewthread&tid=\'.$vt[$vttid][\'tid\'].\'" target="_blank"><img src="http://static.8264.com/static/image/common/folder_new.gif" /></a></td>\'.
					($_G[\'forum\'][\'ismoderator\'] && !$_G[\'gp_archiveid\'] ? \'<td class="glfx"></td>\' : \'\').
					\'<td class="w660"><a href="\'.($parameters[$adid][\'threadurl\'] ? $parameters[$adid][\'threadurl\'] : \'forum.php?mod=viewthread&tid=\'.$vt[$vttid][\'tid\']).\'" class="xst">\'.$codes[$adid].\'</a></td>\'.
					\'<td class="w105"><span class="d_block"><a href="home.php?mod=space&uid=\'.$vt[$vttid][\'authorid\'].\'">\'.$vt[$vttid][\'author\'].\'</a></span><em class="d_block">\'.dgmdate($vt[$vttid][\'dateline\'], \'d\').\'</em></td>\'.
					\'<td class="w70"><span class="d_block"><a href="forum.php?mod=viewthread&tid=\'.$vt[$vttid][\'tid\'].\'" class="xi2">\'.$vt[$vttid][\'replies\'].\'</a></span><em class="d_block">\'.$vt[$vttid][\'views\'].\'</em></td>\'.
					($_G[\'forum\'][\'allowside\'] && $_G[\'basescript\'] != \'group\' ? \'\' : \'<td class="w105"><span class="d_block"><a href="forum.php?mod=viewthread&tid=\'.$vt[$vttid][\'tid\'].\'">\'.$vt[$vttid][\'lastposter\'].\'</a></span>\'.
					\'<span class="d_block"><a href="forum.php?mod=redirect&tid=\'.$vt[$vttid][\'tid\'].\'&goto=lastpost#lastpost">\'.dgmdate($vt[$vttid][\'lastpost\'], \'u\').\'</a></span></td>\').
					\'</tr>\') : \'\';
			} else {
				$adcode = $adid ? (!$parameters[$adid][\'mode\'] ? \'<tbody><tr><td colspan=\'.($_G[\'forum\'][\'ismoderator\'] && !$_G[\'gp_archiveid\'] ? 6 : 5).\'>\'.$codes[$adid].\'</td></tr></tbody>\'
				: \'<tr><td class="icn"><a href="forum.php?mod=viewthread&tid=\'.$vt[$vttid][\'tid\'].\'" target="_blank"><img src="http://static.8264.com/static/image/common/folder_new.gif" /></a></td>\'.
