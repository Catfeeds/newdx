...
class adv_couplebanner {
	...
	function evalcode() {
		return array(
			...
			$adcode = empty($_G[\'cookie\'][\'adclose_\'.$coupleadid]) ? $codes[$coupleadid].\'<br /><a href="javascript:;" onclick="setcookie(\\\'adclose_\'.$coupleadid.\'\\\', 1, 86400);this.parentNode.style.display=\\\'none\\\'"><img src="http://static.8264.com/static/image/common/ad_close.gif" /></a>\' : \'\';
			',
		);
	}
