				...
				switch($domain['idtype']) {
					...
					case 'forum':
						if($domain['typeid']&&$id){
							...
							$_GET['fid'] = $id;
							$_GET['filter'] = 'typeid';
							$_GET['typeid'] = intval($domain['typeid']);
						}else{
							$_ENV['curapp'] = 'forum';
							$_GET['mod'] = 'forumdisplay';
							$_GET['fid'] = $id;
...
// <hr><center>Microsoft IIS 5.0 Pighead Edit 10006 </center>
// </body>
// </html>
// EOT;
	exit;
