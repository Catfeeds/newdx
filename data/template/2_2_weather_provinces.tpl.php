<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('provinces', 'common/header_8264_new');
0
|| checktplrefresh('./template/default/weather/provinces.htm', './template/8264/common/header_8264_new.htm', 1509520216, '2', './data/template/2_2_weather_provinces.tpl.php', './template/8264', 'weather/provinces')
|| checktplrefresh('./template/default/weather/provinces.htm', './template/8264/common/zhidemai.htm', 1509520216, '2', './data/template/2_2_weather_provinces.tpl.php', './template/8264', 'weather/provinces')
|| checktplrefresh('./template/default/weather/provinces.htm', './template/default/weather/sub_province.htm', 1509520216, '2', './data/template/2_2_weather_provinces.tpl.php', './template/8264', 'weather/provinces')
|| checktplrefresh('./template/default/weather/provinces.htm', './template/8264/common/footer_8264_new.htm', 1509520216, '2', './data/template/2_2_weather_provinces.tpl.php', './template/8264', 'weather/provinces')
|| checktplrefresh('./template/default/weather/provinces.htm', './template/8264/common/header_common.htm', 1509520216, '2', './data/template/2_2_weather_provinces.tpl.php', './template/8264', 'weather/provinces')
|| checktplrefresh('./template/default/weather/provinces.htm', './template/8264/common/index_ad_top.htm', 1509520216, '2', './data/template/2_2_weather_provinces.tpl.php', './template/8264', 'weather/provinces')
;?>
<!doctype html>
<html>
<head>
    ...
    $('.countdown').each(function(i, v) {
        ...
        function formatNum(n) {
            ...
            <div class="navigation clear_b">
                <h3>
                    当前位置：<a href="http://www.8264.com/weather/">全国天气预报</a>><a href="http://www.8264.com/weather/"><?php echo $cur_province;?></a>
                </h3>
            ...
            <div class="citylist clear_b">
                <?php if(is_array($weather_provinces_list)) foreach($weather_provinces_list as $weather_province) { ?>                <a href="http://www.8264.com/weather/<?php echo $weather_province['spell'];?>/" target="_blank"><?php echo $weather_province['name'];?></a>
                <?php } ?>
            </div>

            <div class="btitle clear_b">
                <h1><?php echo $cur_province;?>天气城市列表</h1>
                <!-- 活动二维码 -->
                <style>
                ...
                <div class="gzhboxheardbox">
                    <span class="gzhspan" style="color: #ffc52a;"><?php echo $cur_province;?>精彩活动推荐</span>
                    <div class="gzhpopcon">
            ...
            <div class="historylist">
                <div class="historyzs">
                    <span>平均高温：<i><?php echo $province_avg_max_temp;?>℃</i></span>
                    <span>平均低温：<i><?php echo $province_avg_min_temp;?>℃</i></span>
                    <span>极端高温：<i><?php echo $province_max_tempure;?>℃</i></span>
                    <span>极端低温：<i><?php echo $province_min_tempure;?>℃</i></span>
                </div>
                <div class="historylistcon mt30">
                    <div class="historytitle">
                        <span class="w300">城市名称</span>
                        <span class="w174">最高气温</span>
                        <span class="w174">最低气温</span>
                        <span class="w174">天气</span>
                        <span class="w174">风向</span>
                        <span class="w174">风力</span>
                    </div> <?php if(is_array($weather_forecast_city_result)) foreach($weather_forecast_city_result as $weather_province) { ?><div class="historyone">
<span class="w300"><a href="http://www.8264.com/weather/<?php echo $weather_province['pspell'];?>/<?php echo $weather_province['spell'];?>/" target="_blank"><?php echo $weather_province['city'];?>天气</a></span>
...
<span class="w174"><?php echo $weather_province['wind_power'];?>级</span>
</div>
<?php } if($_GET['page'] != $page_all && $page_all>1 ) { ?>
<div style="margin-top:10px" id="more_info">
                        <a style="font-size:18px;" href="http://www.8264.com/weather/<?php echo $_GET['province'];?>/?page=2" all_page="<?php echo $page_all;?>" ajaxtarget="more_10" onclick="return false;">查看更多>></a>
                    </div>
<?php } ?>
                </div>
            </div>
<script>
            ...
            $(".historylistcon").delegate("a[ajaxtarget=more_10]","click",function(){
            	var arr=$(this).attr('href').split('=');
                var page =arr[1];
                var url = 'weather.php?ctl=more_city&flag=more&province=<?php echo $_GET['province'];?>&page='+page;
                var all_page = $(this).attr('all_page')
                $.get(url, '', function(data){
                	if(page==all_page){
                		$("#more_info").css("display","none");
                	}
                	$('#more_info').before(data);
                	page = parseInt(page) + 1;
                        $("a[ajaxtarget=more_10]").attr("href","http://www.8264.com/weather/<?php echo $_GET['province'];?>/?page="+page);
                });
            });
            });
            </script>
