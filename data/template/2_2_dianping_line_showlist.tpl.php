<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('line_showlist', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/line_showlist.htm', './template/8264/dianping/header.htm', 1509517866, '2', './data/template/2_2_dianping_line_showlist.tpl.php', './template/8264', 'dianping/line_showlist')
|| checktplrefresh('./template/8264/dianping/line_showlist.htm', './template/8264/dianping/nav.htm', 1509517866, '2', './data/template/2_2_dianping_line_showlist.tpl.php', './template/8264', 'dianping/line_showlist')
|| checktplrefresh('./template/8264/dianping/line_showlist.htm', './template/8264/common/zhidemai.htm', 1509517866, '2', './data/template/2_2_dianping_line_showlist.tpl.php', './template/8264', 'dianping/line_showlist')
|| checktplrefresh('./template/8264/dianping/line_showlist.htm', './template/8264/dianping/sidebar_comment_rate.htm', 1509517866, '2', './data/template/2_2_dianping_line_showlist.tpl.php', './template/8264', 'dianping/line_showlist')
|| checktplrefresh('./template/8264/dianping/line_showlist.htm', './template/8264/dianping/sidebar_contactus.htm', 1509517866, '2', './data/template/2_2_dianping_line_showlist.tpl.php', './template/8264', 'dianping/line_showlist')
|| checktplrefresh('./template/8264/dianping/line_showlist.htm', './template/8264/dianping/footer.htm', 1509517866, '2', './data/template/2_2_dianping_line_showlist.tpl.php', './template/8264', 'dianping/line_showlist')
|| checktplrefresh('./template/8264/dianping/line_showlist.htm', './template/8264/common/header_8264_new.htm', 1509517866, '2', './data/template/2_2_dianping_line_showlist.tpl.php', './template/8264', 'dianping/line_showlist')
|| checktplrefresh('./template/8264/dianping/line_showlist.htm', './template/8264/common/ewm_r.htm', 1509517866, '2', './data/template/2_2_dianping_line_showlist.tpl.php', './template/8264', 'dianping/line_showlist')
|| checktplrefresh('./template/8264/dianping/line_showlist.htm', './template/8264/common/weixin_share.htm', 1509517866, '2', './data/template/2_2_dianping_line_showlist.tpl.php', './template/8264', 'dianping/line_showlist')
|| checktplrefresh('./template/8264/dianping/line_showlist.htm', './template/8264/common/footer_8264_new.htm', 1509517866, '2', './data/template/2_2_dianping_line_showlist.tpl.php', './template/8264', 'dianping/line_showlist')
|| checktplrefresh('./template/8264/dianping/line_showlist.htm', './template/8264/common/header_common.htm', 1509517866, '2', './data/template/2_2_dianping_line_showlist.tpl.php', './template/8264', 'dianping/line_showlist')
|| checktplrefresh('./template/8264/dianping/line_showlist.htm', './template/8264/common/index_ad_top.htm', 1509517866, '2', './data/template/2_2_dianping_line_showlist.tpl.php', './template/8264', 'dianping/line_showlist')
;
block_get('6905');?>
<!doctype html>
<html>
...
jQuery(function($){
    $('.countdown').each(function(i, v) {
        ...
        <!-- //值得买 -->
            ...
            <div class="ui-grid-12 ui-grid-full">
                <div class="nav-sift-class">
                    ...
                    <div class="nav-sift-one">
                        <div class="nav-name blue">线路类型</div>
                        <div class="nav-list-wartpen">
                            <div class="nav-list-box">
                                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=0&amp;timetype=<?php echo $timetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"
                                <?php if($type == 0) { ?> class="blue"<?php } ?>>全部</a>
                                <?php if(is_array($cate_type)) foreach($cate_type as $k => $v) { ?>                                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $k;?>&amp;timetype=<?php echo $timetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"<?php if($type == $k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
                                <?php } ?>
                            </div>
                    ...
                    <!--单个导航开始-->
                    <div class="nav-sift-one">
                        <div class="nav-name orange">线路时长</div>
                        <div class="nav-list-wartpen">
                            <div class="nav-list-box">
                                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;timetype=0&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"
                                <?php if($timetype == 0) { ?> class="blue"<?php } ?>>全部</a>
                                <?php if(is_array($cate_timetype)) foreach($cate_timetype as $k => $v) { ?>                                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;timetype=<?php echo $k;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"<?php if($timetype == $k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
                                <?php } ?>
                            </div>
                            <div class="nav-list-more"></div>
                        </div>
                    ...
                    <!--单个导航结束-->
                    <!--start----省和城市级联菜单导航--老版本-->
                    <div class="nav-sift-one">
                        <div class="nav-name darkblue">所在地域</div>
                        <div class="nav-list-wartpen">
                            <div class="nav-list-box nav-line-list">
                            <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;timetype=<?php echo $timetype;?>&amp;provinceid=0&amp;cityid=0&amp;page=1" <?php if($provinceid == 0) { ?> class = "blue"<?php } ?>>全部</a>
                            <?php if(is_array($proList)) foreach($proList as $k => $v) { ?>                            <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;timetype=<?php echo $timetype;?>&amp;provinceid=<?php echo $k;?>&amp;cityid=0&amp;page=1" value="<?php echo $k;?>" class="province_line <?php if($provinceid == $k) { ?> blue<?php } ?>" rel="nofollow"><?php echo $regionList[$k]['cityname'];?></a>
                            <?php } ?>
                            </div>
                        </div>
                        <div class="nav-list-more-box">
                        <?php if($citylist) { ?>
                            <?php if(is_array($citylist)) foreach($citylist as $key => $value) { ?>                            <?php $num= 0; ?>                            <div class="nav-list-wrap" id="province_<?php echo $key;?>">
                                <ul>
                                    <?php if(is_array($value)) foreach($value as $k => $v) { ?>                                    <?php $num++; ?>                                    <li style="display:none;">
                                        <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;timetype=<?php echo $timetype;?>&amp;provinceid=<?php echo $key;?>&amp;cityid=<?php echo $k;?>&amp;page=1" class="city <?php if($cityid == $k) { ?> blue<?php } ?>" rel="nofollow"><?php echo $onlycity[$k]['name'];?></a>
                                    </li>
                                    <?php } ?>
                                </ul>
                                <?php if($num > 20 ) { ?>
                                <span class="link-add-more">全部<?php echo $regionList[$key]['cityname'];?>分类</span>
                                <?php } ?>
                            </div>
                            <?php } ?>
                        <?php } else { ?>
                            <?php if(is_array($onlypro)) foreach($onlypro as $key => $value) { ?>                            <?php $num= 0; ?>                            <div class="nav-list-wrap" id="province_<?php echo $key;?>">
                                <ul>
                                    <?php if(is_array($value)) foreach($value as $k => $v) { ?>                                    <?php $num++; ?>                                    <li style="display:none;">
                                        <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;timetype=<?php echo $timetype;?>&amp;provinceid=<?php echo $key;?>&amp;cityid=<?php echo $k;?>&amp;page=1" class="city <?php if($cityid == $k) { ?> blue<?php } ?>" rel="nofollow"><?php echo $v['name'];?></a>
                                    </li>
                                    <?php } ?>
                                </ul>
                                <?php if($num > 20 ) { ?>
            ...
            <!-- main left -->
            <div class="col-main">
            	<div style="margin-bottom:35px; display:none;"><?php echo adshow("custom_342"); ?></div>
                <div class="main-wrap">
                    <div class="ui-grid-6 ui-grid-left">
                        <div class="left-title-box">
                            <div class="title-right">
                                <?php if($type==0 && $timetype==0 && $provinceid==0  ) { ?> <h3><span>所有线路</span> </h3><?php } ?>
                            </div>
                            <div class="sift-left">
                                <div class="condition-box">
                                   <h1>
                                   	<?php if($type) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=0&amp;timetype=<?php echo $timetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1" class="condition"><?php echo $cate_type[$type];?><i></i></a><?php } ?>
                                    <?php if($timetype) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;timetype=0&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1" class="condition"><?php echo $cate_timetype[$timetype];?><i></i></a><?php } ?>
                                    <?php if($provinceid) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;timetype=<?php echo $timetype;?>&amp;provinceid=0&amp;cityid=<?php echo $cityid;?>&amp;page=1" class="condition"><?php echo $regionList[$provinceid]['cityname'];?><i></i></a><?php } ?>
                                    <?php if($provinceid && $cityid) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;timetype=<?php echo $timetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=0&amp;page=1" class="condition"><?php echo $onlycity[$cityid]['name'];?><i></i></a><?php } ?>
                                   </h1>
                                </div>
                            </div>
                            <!-- 排序筛选 -->
                            <div class="sift-right">
                                <div class="sift-box">
                                    <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;timetype=<?php echo $timetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"<?php if($order=='lastpost') { ?> class="hover"<?php } ?>><i></i>默认</a>
                                    <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;type=<?php echo $type;?>&amp;timetype=<?php echo $timetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"<?php if($order=='heats') { ?> class="hover"<?php } ?>><i></i>热度</a>
                                    <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=score&amp;type=<?php echo $type;?>&amp;timetype=<?php echo $timetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"<?php if($order=='score') { ?> class="hover"<?php } ?>><i></i>评分</a>
                                    <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=dateline&amp;type=<?php echo $type;?>&amp;timetype=<?php echo $timetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"<?php if($order=='dateline') { ?> class="hover"<?php } ?>><i></i>最新</a>
                                </div>
                            </div>
                            <!-- //排序筛选 -->
                        </div>
                        ...
                        <div class="left-list-box">
                            <div class="left-list-warpten">
                                <ul>
                                    <?php if(is_array($modlist)) foreach($modlist as $item) { ?>                                    <li>
                                        <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=dateline&amp;type=<?php echo $item['type'];?>&amp;timetype=<?php echo $timetype;?>&amp;provinceid=<?php echo $item['province'];?>&amp;cityid=0&amp;page=1" class="tag-link">
                                            <span class="city"><?php echo $item['provincename'];?></span>
                                            <span class="assort"><?php echo $cate_type[$item['type']];?></span>
                                        </a>
                                        <div class="list-info">
                                            <h2><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="<?php echo $item['subject'];?>" class="title-big" target="_blank"><?php echo $item['subject'];?></a></h2>
                                            <p>经过地域：
                                                <?php if($item['cityids']) { ?>
                                                <?php $tempcross = array(); ?>                                                    <?php if(is_array($item['cityids'])) foreach($item['cityids'] as $k => $v) { ?>                                                       <?php $tempcross[] = "<a href=\"http://www.8264.com/dianping.php?mod=$mod&amp;act=showlist&amp;order=lastpost&amp;type=$type&amp;timetype=$timetype&amp;provinceid=$v&amp;cityid=$k&amp;page=1\">".$onlycity[$k]['name']."</a>" ?>                                                    <?php } ?>
                                                <?php echo implode(" -- ",$tempcross);; ?>                                                <?php } ?>
                                            </p>
                                            <div class="star">
                                                <div class="rating-level small-rating line-rating" style="width: 105px;">
<span class="score-value score-value-<?php echo floor($item['score']); ?>" title="<?php echo $item['score'];?>分">
<em></em>
</span>
                                                    <strong><?php if($item['score']) { ?><?php echo $item['score'];?><?php } else { ?>0.0<?php } ?></strong>
                                                </div>
                                                <em>（<?php if($item['cnum']) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>#comment"><?php echo $item['cnum'];?>人点评</a><?php } else { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>#write">0人点评</a><?php } ?> )</em>
                                            </div>
                                        </div>
                                    </li>
                                    <?php } ?>
            ...
            <div class="col-sider">
                <div class="ui-grid-2 ui-grid-right">
                    <div class="right-publish-button-wapten">
                        <a href="http://www.8264.com/dianping.php?mod=line&amp;act=dopost&amp;do=new" target="_blank" class="line-button">
                            <i class="line-icon"></i>
                            <span>发布线路</span>
                        </a>
                    </div>
               	...
               	<div class="ui-grid-2 ui-grid-right">
                	<!--编号333--><?php echo adshow("custom_333"); ?></div>
                <!-- 精彩点评 -->
                <div class="ui-grid-2 ui-grid-right">
...
<?php } ?>
                ...
                <!-- //精彩点评 -->
<div style="margin-top:15px;"><?php echo adshow("custom_329"); ?></div>
                <!-- 联系我们 -->
                <div class="ui-grid-2 ui-grid-right">
