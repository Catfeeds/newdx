<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('climbpost', 'forum/dianping/header');
0
|| checktplrefresh('./template/8264/forum/dianping/climbpost.htm', './template/8264/forum/dianping/header.htm', 1507004904, '2', './data/template/2_2_forum_dianping_climbpost.tpl.php', './template/8264', 'forum/dianping/climbpost')
|| checktplrefresh('./template/8264/forum/dianping/climbpost.htm', './template/8264/forum/dianping/editor_2014_second.htm', 1507004904, '2', './data/template/2_2_forum_dianping_climbpost.tpl.php', './template/8264', 'forum/dianping/climbpost')
|| checktplrefresh('./template/8264/forum/dianping/climbpost.htm', './template/8264/forum/dianping/editor_2014_first.htm', 1507004904, '2', './data/template/2_2_forum_dianping_climbpost.tpl.php', './template/8264', 'forum/dianping/climbpost')
|| checktplrefresh('./template/8264/forum/dianping/climbpost.htm', './template/8264/forum/dianping/footer.htm', 1507004904, '2', './data/template/2_2_forum_dianping_climbpost.tpl.php', './template/8264', 'forum/dianping/climbpost')
|| checktplrefresh('./template/8264/forum/dianping/climbpost.htm', './template/8264/common/header_8264_new.htm', 1507004904, '2', './data/template/2_2_forum_dianping_climbpost.tpl.php', './template/8264', 'forum/dianping/climbpost')
|| checktplrefresh('./template/8264/forum/dianping/climbpost.htm', './template/8264/common/editor_2014.htm', 1507004904, '2', './data/template/2_2_forum_dianping_climbpost.tpl.php', './template/8264', 'forum/dianping/climbpost')
|| checktplrefresh('./template/8264/forum/dianping/climbpost.htm', './template/8264/forum/editor_menu_forum_newimage_2014.htm', 1507004904, '2', './data/template/2_2_forum_dianping_climbpost.tpl.php', './template/8264', 'forum/dianping/climbpost')
|| checktplrefresh('./template/8264/forum/dianping/climbpost.htm', './template/8264/common/ewm_r.htm', 1507004904, '2', './data/template/2_2_forum_dianping_climbpost.tpl.php', './template/8264', 'forum/dianping/climbpost')
|| checktplrefresh('./template/8264/forum/dianping/climbpost.htm', './template/8264/common/footer_8264_new.htm', 1507004904, '2', './data/template/2_2_forum_dianping_climbpost.tpl.php', './template/8264', 'forum/dianping/climbpost')
|| checktplrefresh('./template/8264/forum/dianping/climbpost.htm', './template/8264/common/header_common.htm', 1507004904, '2', './data/template/2_2_forum_dianping_climbpost.tpl.php', './template/8264', 'forum/dianping/climbpost')
|| checktplrefresh('./template/8264/forum/dianping/climbpost.htm', './template/8264/common/index_ad_top.htm', 1507004904, '2', './data/template/2_2_forum_dianping_climbpost.tpl.php', './template/8264', 'forum/dianping/climbpost')
|| checktplrefresh('./template/8264/forum/dianping/climbpost.htm', './template/8264/common/taobao_ad_alert.htm', 1507004904, '2', './data/template/2_2_forum_dianping_climbpost.tpl.php', './template/8264', 'forum/dianping/climbpost')
;?>
<!doctype html>
<html>
<head>
...
<span class="inputTipsText2">
                    <?php if(is_array($climbTypeList)) foreach($climbTypeList as $k => $v) { ?>                        <span style="padding-right: 20px;"><input type="checkbox" name="type[]" value="<?php echo $k;?>" rel="<?php echo $v['name'];?>" class="check" <?php if($typelists[$k]) { ?>checked<?php } ?>><span style="padding-left: 8px;"><?php echo $v['name'];?></span></span>
                    <?php } ?>
</span>
                <span class="icoRedStar">*</span>
            </dd>
...
<dl class="pubDt50" <?php if($climbTypeList[$editdata['type']]['name'] == '攀冰') { ?>style="display:none;"<?php } ?> id="climb_place_list">
<dt><span class="icoCity48x43"></span></dt>
<dd>
<span class="inputTipsText2">
<div class="sc selectdown">
<input type="hidden" name="placetype" id="placetype" value="<?php echo $editdata['placetype'];?>" />
<input type="text" value="<?php if($editdata['placetype']) { ?>已选择场地：<?php echo $placeTypelist[$editdata['placetype']]['name'];?> <?php } else { ?>请选择<?php echo $modname;?><?php } ?>" class="diqu js"
 readonly="readonly"/>
<div class="sc_down"><?php if(is_array($placeTypelist)) foreach($placeTypelist as $k => $v) { ?><a href="javascript:void(0);" rel="<?php echo $k;?>" ><?php echo $v['name'];?></a>
<?php } ?>
</div>
</div>
</span>
...
<input type="hidden" value="<?php echo $editdata['latitude'];?>" id="latitude" name="latitude">
        ...
        <dl class="pubDt50">
            ...
            <dd>
<span class="inputTipsText">
<label class="fs16"<?php if($editdata['tel']) { ?> style="display:none;"<?php } ?>>如：022-27308264</label>
                    <input type="text" class="inputText w270" name="tel" id="link" value="<?php echo $editdata['tel'];?>" />
</span>
                <span class="icoRedStar">*</span>
            </dd>
        </dl>
    ...
    $("input:checkbox").change(function(){
       ...
       // alert(str);
        ...
        if($(this).attr('rel') == '攀冰' && $(this).is(":checked") && !$(this).parent().next().find('input').is(":checked") && !$(this).parent().prev().find('input').is(":checked")){
              ...
              $("#placetype").val('').next(':text').val("请选择<?php echo $modname;?>场地");
...
'type' : {'pnumber': "请选择<?php echo $modname;?>类型"},
'placetype' : {'pnumber': "请选择<?php echo $modname;?>"},
'uploadfile': {'pnumber': "请上传<?php echo $modname;?>图片，并至少选择一张"},
'provinceid' : {'pnumber': "请选择<?php echo $modname;?>经过省份"},
'city' : {'pnumber': "请选择或填写<?php echo $modname;?>所在城市"},
'longitude' : {'pnumber': "请在地图上标注<?php echo $modname;?>所在地址"},
'latitude' : {'pnumber': "请在地图上标注<?php echo $modname;?>所在地址"},
