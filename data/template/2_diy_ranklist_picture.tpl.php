<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('picture', 'common/header');
0
|| checktplrefresh('./template/default/ranklist/picture.htm', './template/8264/common/header.htm', 1509432616, 'diy', './data/template/2_diy_ranklist_picture.tpl.php', './template/8264', 'ranklist/picture')
|| checktplrefresh('./template/default/ranklist/picture.htm', './template/default/common/simplesearchform.htm', 1509432616, 'diy', './data/template/2_diy_ranklist_picture.tpl.php', './template/8264', 'ranklist/picture')
|| checktplrefresh('./template/default/ranklist/picture.htm', './template/default/ranklist/side_left.htm', 1509432616, 'diy', './data/template/2_diy_ranklist_picture.tpl.php', './template/8264', 'ranklist/picture')
|| checktplrefresh('./template/default/ranklist/picture.htm', './template/8264/common/footer.htm', 1509432616, 'diy', './data/template/2_diy_ranklist_picture.tpl.php', './template/8264', 'ranklist/picture')
|| checktplrefresh('./template/default/ranklist/picture.htm', './template/8264/common/header_common.htm', 1509432616, 'diy', './data/template/2_diy_ranklist_picture.tpl.php', './template/8264', 'ranklist/picture')
;?>
<!doctype html>
<html>
<head>
...
<h1 class="mt">图片排行</h1>
<ul class="tb cl">
<li<?php if($_G['gp_orderby'] == 'heats') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=picture&amp;orderby=heats&amp;before=<?php echo $_G['gp_before'];?>">热图排行</a></li>
<?php if($clicks) { if(is_array($clicks)) foreach($clicks as $key => $value) { ?><li<?php if($_G['gp_orderby'] == $key) { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=picture&amp;orderby=<?php echo $key;?>&amp;before=<?php echo $_G['gp_before'];?>"><?php echo $value['name'];?>排行</a></li>
<?php } } ?>
<li<?php if($_G['gp_orderby'] == 'sharetimes') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=picture&amp;orderby=sharetimes&amp;before=<?php echo $_G['gp_before'];?>">分享排行</a></li>
</ul>
<p id="before" class="tbmu">
<a href="misc.php?mod=ranklist&amp;type=picture&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=thismonth" id="2592000" <?php if($_G['gp_before'] == 'thismonth') { ?>class="a"<?php } ?> />本月</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=picture&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=thisweek" id="604800" <?php if($_G['gp_before'] == 'thisweek') { ?>class="a"<?php } ?> />本周</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=picture&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=today" id="86400" <?php if($_G['gp_before'] == 'today') { ?>class="a"<?php } ?> />今日</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=picture&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=all" id="all" <?php if($_G['gp_before'] == 'all') { ?>class="a"<?php } ?> />全部</a>
</p>
<?php if($picturelist) { ?>
...
<?php if($_G['gp_orderby'] == 'heats') { ?><p class="ptm">人气: <?php echo $picture['hot'];?></p>
<?php } elseif($_G['gp_orderby'] == 'sharetimes') { ?><p class="ptm">分享 <?php echo $picture['sharetimes'];?></p>
<?php } else { ?><p class="ptm"><?php echo $clicks[$_G['gp_orderby']]['name'];?> <?php echo $picture['click'.$_G['gp_orderby']];?></p><?php } ?>
