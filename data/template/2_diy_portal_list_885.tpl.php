<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_885', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/portal/list_885.htm', './template/8264/common/header_8264_new.htm', 1509519200, 'diy', './data/template/2_diy_portal_list_885.tpl.php', 'data/diy', 'portal/list_885')
|| checktplrefresh('./template/8264/portal/list_885.htm', './template/8264/common/footer_8264_new.htm', 1509519200, 'diy', './data/template/2_diy_portal_list_885.tpl.php', 'data/diy', 'portal/list_885')
|| checktplrefresh('./template/8264/portal/list_885.htm', './template/8264/common/header_common.htm', 1509519200, 'diy', './data/template/2_diy_portal_list_885.tpl.php', 'data/diy', 'portal/list_885')
|| checktplrefresh('./template/8264/portal/list_885.htm', './template/8264/common/index_ad_top.htm', 1509519200, 'diy', './data/template/2_diy_portal_list_885.tpl.php', 'data/diy', 'portal/list_885')
;
block_get('6886');?>
<!doctype html>
<html>
...
<?php } ?>
<!-- //手机绑定提示 -->
<style id="diy_style" type="text/css">#frame6HRSqu {  margin:0px !important;border:#000000 none !important;background-color:transparent !important;background-image:none !important;}#portal_block_6886 {  margin:0px !important;border:#000000 none !important;background-color:transparent !important;background-image:none !important;}#portal_block_6886 .content {  margin:0px !important;}</style>
<style>
/*清除浮动开始*/
.linktitle:after { content: ""; display: block; clear: both; visibility: hidden; }
.linktitle { zoom: 1; }
/*清除浮动结束*/
.linkwarpten{ width:980px; margin:auto; font-family:"Microsoft YaHei",Tahoma,Helvetica,SimSun,sans-serif; color:#555; padding-bottom:20px;}
.linktitle{ padding:20px 0px 10px 0px;}
.linktitle span{ float:left;}
.sm { border-bottom: #fff solid 1px; border-top: #D9E0D5 solid 1px; }
.sm_n { border-top: #fff solid 1px; border-bottom: #D9E0D5 solid 1px; line-height: 1.5; font-size: 13px; padding: 10px 0px 10px 10px;}
.sm_n b{ display:block; padding:10px 0px 0px 0px;}
.bigtitle{ font-size:16px; padding:8px 0px; border-bottom:#CCC solid 1px; border-radius:3px; font-weight:bold; text-indent:12px; color:#6E8FB5; margin:10px 0px; }
.linklist b{ display:block; margin:0px 10px 10px 0px; font-size:14px; text-indent:12px;}
.linklist a{ display: inline-block; margin:0px 10px 10px 0px; font-size:14px; color:#555; text-decoration:none; text-indent:12px;}
.linklist a:hover{  font-size:14px; color:#6E8FB5;  }
</style>
<div class="header">
<div class="layout">
<div class="icoHill">&nbsp;</div>
<div class="headerL">
<h1><span class="country">户外网址大全</span></h1>
<div class="site">
<a href="<?php echo $_G['config']['web']['portal'];?>">首页</a>
> <a href="http://www.8264.com/list/885">户外网址大全</a>	
</div>			
</div>		
<div class="headerR">
...
<div class="warpten clearfix" id="pic_list">
<div class="linkwarpten">
<div class="linktitle">
<span>
<!-- Baidu Button BEGIN -->
...
<!--[diy=linkdiy]--><div id="linkdiy" class="area"><div id="frame6HRSqu" class=" frame move-span cl frame-1"><div id="frame6HRSqu_left" class="column frame-1-c"><div id="frame6HRSqu_left_temp" class="move-span temp"></div><?php block_display('6886'); ?></div></div></div><!--[/diy]-->
</div>
</div>
