<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('guidelist', 'common/header_8264_new');
0
|| checktplrefresh('./source/plugin/whither/template/guidelist.htm', './template/8264/common/header_8264_new.htm', 1508242705, 'whither', './data/template/2_whither_guidelist.tpl.php', './source/plugin/whither/template', 'guidelist')
|| checktplrefresh('./source/plugin/whither/template/guidelist.htm', './template/8264/common/footer_8264_new.htm', 1508242705, 'whither', './data/template/2_whither_guidelist.tpl.php', './source/plugin/whither/template', 'guidelist')
|| checktplrefresh('./source/plugin/whither/template/guidelist.htm', './template/8264/common/header_common.htm', 1508242705, 'whither', './data/template/2_whither_guidelist.tpl.php', './source/plugin/whither/template', 'guidelist')
|| checktplrefresh('./source/plugin/whither/template/guidelist.htm', './template/8264/common/index_ad_top.htm', 1508242705, 'whither', './data/template/2_whither_guidelist.tpl.php', './source/plugin/whither/template', 'guidelist')
;?>
<!doctype html>
<html>
<head>
...
<div class="z" style="line-height:30px;"><?php echo $forumoption_mudidi->getBreadcrumbNavByTid($tid); ?> <em>&rsaquo;</em> 游记攻略
</div>
</div>
...
<div class="bm_h cl">
<h2><?php echo $mudidi_data['subject'];?>攻略大全
<span style="font-weight:normal;">(共<?php echo $count;?>篇)</span>
...
<?php if($guideData) { ?>
<div class="bm_c"><?php if(is_array($guideData)) foreach($guideData as $guideid => $guide) { if($guide['type'] == 1) { ?><?php $link = "/forum.php?mod=viewthread&amp;tid=".$guide['typeid']; } elseif($guide['type'] == 2) { ?><?php $link = "/home.php?mod=space&amp;uid=".$guide['uid']."&do=blog&id=".$guide['typeid']; } ?>
<div class="row">
<div class="detail">
<h5>
<span class="status">
...
<div class="author">
<a href="/home.php?mod=space&amp;uid=<?php echo $guide['authorid'];?>&amp;do=profile"><?php echo avatar($guide['authorid'], 'small'); ?></a>
作者: <a href="/home.php?mod=space&amp;uid=<?php echo $guide['authorid'];?>&amp;do=profile"><?php echo $guide['author'];?></a>
</div>
<div class="lastposter">
<a href="/home.php?mod=space&amp;uid=<?php echo $guide['lastposterid'];?>&amp;do=profile"><?php echo avatar($guide['lastposterid'], 'small'); ?></a>
回复: <a href="/home.php?mod=space&amp;uid=<?php echo $guide['lastposterid'];?>&amp;do=profile"><?php echo $guide['lastposter'];?></a>
</div>
</div>
<div class="content">
...
<?php } ?>
<div class="pagebar"><?php $pageMulti = multi($count, $ppp, $page, "/whither-guidelist-".$tid."-1.html"); ?><?php $pageMulti = preg_replace('/1\.html\?page=(\d+)/', '$1.html', $pageMulti); ?><?php echo $pageMulti;?>
</div>
</div>
<?php } else { ?>
<div class="bm_c">
