<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('warn_view', 'common/header');
0
|| checktplrefresh('./template/default/forum/warn_view.htm', './template/default/common/simplesearchform.htm', 1501554680, '2', './data/template/2_2_forum_warn_view.tpl.php', './template/8264', 'forum/warn_view')
...
<div class="f_c">
<h3 class="flb">
<em id="return_<?php echo $_G['gp_handlekey'];?>"><?php echo $warnuser;?> 警告记录</em>
<span>
