<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('skiing_showlist', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/skiing_showlist.htm', './template/8264/dianping/header.htm', 1509517920, '2', './data/template/2_2_dianping_skiing_showlist.tpl.php', './template/8264', 'dianping/skiing_showlist')
|| checktplrefresh('./template/8264/dianping/skiing_showlist.htm', './template/8264/dianping/nav.htm', 1509517920, '2', './data/template/2_2_dianping_skiing_showlist.tpl.php', './template/8264', 'dianping/skiing_showlist')
|| checktplrefresh('./template/8264/dianping/skiing_showlist.htm', './template/8264/common/zhidemai.htm', 1509517920, '2', './data/template/2_2_dianping_skiing_showlist.tpl.php', './template/8264', 'dianping/skiing_showlist')
|| checktplrefresh('./template/8264/dianping/skiing_showlist.htm', './template/8264/dianping/skiing_comment.htm', 1509517920, '2', './data/template/2_2_dianping_skiing_showlist.tpl.php', './template/8264', 'dianping/skiing_showlist')
|| checktplrefresh('./template/8264/dianping/skiing_showlist.htm', './template/8264/dianping/sidebar_contactus.htm', 1509517920, '2', './data/template/2_2_dianping_skiing_showlist.tpl.php', './template/8264', 'dianping/skiing_showlist')
|| checktplrefresh('./template/8264/dianping/skiing_showlist.htm', './template/8264/dianping/footer.htm', 1509517920, '2', './data/template/2_2_dianping_skiing_showlist.tpl.php', './template/8264', 'dianping/skiing_showlist')
|| checktplrefresh('./template/8264/dianping/skiing_showlist.htm', './template/8264/common/header_8264_new.htm', 1509517920, '2', './data/template/2_2_dianping_skiing_showlist.tpl.php', './template/8264', 'dianping/skiing_showlist')
|| checktplrefresh('./template/8264/dianping/skiing_showlist.htm', './template/8264/common/ewm_r.htm', 1509517920, '2', './data/template/2_2_dianping_skiing_showlist.tpl.php', './template/8264', 'dianping/skiing_showlist')
|| checktplrefresh('./template/8264/dianping/skiing_showlist.htm', './template/8264/common/weixin_share.htm', 1509517920, '2', './data/template/2_2_dianping_skiing_showlist.tpl.php', './template/8264', 'dianping/skiing_showlist')
|| checktplrefresh('./template/8264/dianping/skiing_showlist.htm', './template/8264/common/footer_8264_new.htm', 1509517920, '2', './data/template/2_2_dianping_skiing_showlist.tpl.php', './template/8264', 'dianping/skiing_showlist')
|| checktplrefresh('./template/8264/dianping/skiing_showlist.htm', './template/8264/common/header_common.htm', 1509517920, '2', './data/template/2_2_dianping_skiing_showlist.tpl.php', './template/8264', 'dianping/skiing_showlist')
|| checktplrefresh('./template/8264/dianping/skiing_showlist.htm', './template/8264/common/index_ad_top.htm', 1509517920, '2', './data/template/2_2_dianping_skiing_showlist.tpl.php', './template/8264', 'dianping/skiing_showlist')
;
block_get('7032');?>
<!doctype html>
<html>
...
<div class="col-main">
<div class="main-wrap">
                    <?php echo adshow("custom_448"); ?><!-- 排序筛选 -->
<div class="ui-grid-6 ui-grid-left" style="margin-top:0px;">
<div class="left-title-box">
<div class="title-right">
<span>排行榜 - </span>
<h1><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;pro=<?php echo $pro;?>&amp;page=1" title="<?php echo $region[$pro]['name'];?>滑雪场"><?php echo $region[$pro]['name'];?>滑雪场</a></h1>
</div>
<div class="sift-right">
<div class="sift-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;pro=<?php echo $pro;?>&amp;page=1"<?php if($order=='lastpost') { ?> class="hover"<?php } ?>><i></i>默认</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;pro=<?php echo $pro;?>&amp;page=1"<?php if($order=='heats') { ?> class="hover"<?php } ?>><i></i>热度</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=score&amp;pro=<?php echo $pro;?>&amp;page=1"<?php if($order=='score') { ?> class="hover"<?php } ?>><i></i>评分</a>
</div>
</div>
</div>
</div>
...
<div class="left-skiing-park-box">
<div class="left-skiing-park-warpten">
<ul><?php if(is_array($modlist)) foreach($modlist as $item) { ?><li>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="<?php echo $item['subject'];?>" target="_blank"><img src="<?php echo getimagethumb(60,60,2, $item['dir'].'/'.$item['showimg'], '', $item['serverid']); ?>" alt="<?php echo $item['subject'];?>"></a>
<div class="list-info">
<h2><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="<?php echo $item['subject'];?>" class="title-ski" target="_blank"><?php echo $item['subject'];?></a></h2>
<b><?php echo $item['score'];?></b>
<div class="rating-level small-rating snow-rating">
...
<div class="ui-block ui-block-content"><div class="comment-main"><?php if(is_array($commentlist)) foreach($commentlist as $comment) { ?><div id="post_<?php echo $comment['pid'];?>" class="comment-list-box">
...
<a href="http://www.8264.com/dianping.php?mod=skiing&amp;act=dopost&amp;do=new" target="_blank" class="line-button">
<i class="line-icon"></i>
<span>发布滑雪场</span>
</a>
</div>
</div>
                    <div style="margin:15px 0px 0px 0px;"><?php echo adshow("custom_427"); ?></div>
<div class="ui-grid-2 ui-grid-right">
<!-- 分类 -->
...
<div class="area-list-box" id="arealist">
<ul><?php $i = 0; if(is_array($region)) foreach($region as $k => $v) { ?><li>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;pro=<?php echo $k;?>&amp;page=1">
<span<?php if($pro==$k) { ?> class="blue"<?php } ?>><?php echo $v['name'];?></span>
<em<?php if($i<6) { ?> class="blue"<?php } elseif($i==6 || $i==7) { ?> class="orange"<?php } ?>><?php echo $v['num'];?></em>
</a>
</li><?php $i++; } ?>
</ul>
<div class="add-more" id="addmore">加载更多</div>
</div>
</div>
</div>
<!-- //分类 -->
...
<ul class="right-same-area"><?php if(is_array($sidebar_new)) foreach($sidebar_new as $k => $item) { ?><li>
...
<span class=""><?php echo dgmdate($item['dateline'], "Y-m-d"); ?></span>
</div>
</li>
<?php } ?>
</ul>
...
</script><?php echo adshow("custom_445"); if($act=='showview') { ?>
