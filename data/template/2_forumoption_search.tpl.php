<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('search', 'common/header');
0
|| checktplrefresh('./source/plugin/forumoption/template/search.htm', './template/8264/common/header.htm', 1501860399, 'forumoption', './data/template/2_forumoption_search.tpl.php', './source/plugin/forumoption/template', 'search')
|| checktplrefresh('./source/plugin/forumoption/template/search.htm', './template/8264/common/footer.htm', 1501860399, 'forumoption', './data/template/2_forumoption_search.tpl.php', './source/plugin/forumoption/template', 'search')
|| checktplrefresh('./source/plugin/forumoption/template/search.htm', './template/8264/common/header_common.htm', 1501860399, 'forumoption', './data/template/2_forumoption_search.tpl.php', './source/plugin/forumoption/template', 'search')
;?>
<!doctype html>
<html>
<head>
...
<style>
.ininput{ width:530px; height:22px; background:none; font-size:14px;}
.ininbuttom{ width:50px; height:30px;}
</style>
...
<div class="cse-branding-right" style="background-color:#FFFFFF;color:#000000">
  <div class="cse-branding-form">
    <form action="http://www.8264.com/so" id="cse-search-box">
      <div>
        <input type="hidden" name="cx" value="partner-pub-1295541823364623:5330094889" />
...
<script src="http://www.google.com/cse/query_renderer.js" type="text/javascript"></script>
<div id="queries"></div>
<script src="http://www.google.com/cse/api/partner-pub-1295541823364623/cse/5330094889/queries/js?oe=GB2312&callback=(new+PopularQueryRenderer(document.getElementById(%22queries%22))).render" type="text/javascript"></script></div>
