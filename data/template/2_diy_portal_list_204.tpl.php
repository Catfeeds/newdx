<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_204', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/portal/list_204.htm', './template/8264/common/header_8264_new.htm', 1509517865, 'diy', './data/template/2_diy_portal_list_204.tpl.php', 'data/diy', 'portal/list_204')
|| checktplrefresh('./template/8264/portal/list_204.htm', './template/8264/common/zhidemai.htm', 1509517865, 'diy', './data/template/2_diy_portal_list_204.tpl.php', 'data/diy', 'portal/list_204')
|| checktplrefresh('./template/8264/portal/list_204.htm', './template/8264/common/weixin_share_bottom.htm', 1509517865, 'diy', './data/template/2_diy_portal_list_204.tpl.php', 'data/diy', 'portal/list_204')
|| checktplrefresh('./template/8264/portal/list_204.htm', './template/8264/common/float_guide.htm', 1509517865, 'diy', './data/template/2_diy_portal_list_204.tpl.php', 'data/diy', 'portal/list_204')
|| checktplrefresh('./template/8264/portal/list_204.htm', './template/8264/common/footer_8264_new.htm', 1509517865, 'diy', './data/template/2_diy_portal_list_204.tpl.php', 'data/diy', 'portal/list_204')
|| checktplrefresh('./template/8264/portal/list_204.htm', './template/8264/common/header_common.htm', 1509517865, 'diy', './data/template/2_diy_portal_list_204.tpl.php', 'data/diy', 'portal/list_204')
|| checktplrefresh('./template/8264/portal/list_204.htm', './template/8264/common/index_ad_top.htm', 1509517865, 'diy', './data/template/2_diy_portal_list_204.tpl.php', 'data/diy', 'portal/list_204')
;?>
<!doctype html>
<html>
<head>
...
<link href=" http://static.8264.com/static/css/portal/channel_204.css" rel="stylesheet" type="text/css" />
<div class="header">
<div class="layout">
...
> <a href="http://www.8264.com/list/204"><?php echo $cat['catname'];?></a>
</div>
</div>
<div class="headerR">
<div class="colNameList">
<a target="_blank" href="http://bbs.8264.com/forum-378-1.html">体验</a>
<a target="_blank" href="http://www.8264.com/zhuangbei">装备库</a>
<a target="_blank" href="http://bbs.8264.com/forum-7-1.html">装备论坛</a>
<a target="_blank" href="http://bbs.8264.com/forum-53-1.html">装备交易</a>
</div>
</div>
</div>
</div>
<div class="warpten">
<div class="mt5 adborder">
<!-- 广告位：装备频道doite 391-->
<script type='text/javascript'><!--//<![CDATA[
           var m3_u = (location.protocol=='https:'?'https://ads.8264.com/www/delivery/ajs.php':'http://ads.8264.com/www/delivery/ajs.php');
           var m3_r = Math.floor(Math.random()*99999999999);
...
<div class="bignewsbox">
            	...
            	<div class="bignews">
                	<!--单条循环开始-->
                <?php if(is_array($lunboList)) foreach($lunboList as $v) { ?>                    <div class="bignewsone">
                        <div class="bignewsimg"><img src="<?php echo $v['pic'];?>"/></div>
                        <div class="bignewssummary">
                            <a href="portal.php?mod=view&amp;aid=<?php echo $v['aid'];?>" target="_blank"><?php echo $v['title'];?></a>
                            <p><?php echo cutstr($v['summary'],160,'...'); ?></p>
                            <div class="bignewsinfo zbiconbg">
                                <a href="/list/<?php echo $v['catid'];?>" class="zbicon<?php echo $v['catid'];?>">装备</a>
                                <span>来源：<i><?php echo $v['from'];?></i></span>
                                <span>作者：<i><?php echo $v['author'];?></i></span>
...
// 轮播开始
jQuery(function(){
 var shuliang = jQuery(".bignews>div").size();
 var lunbotime;
 var index = 0;
jQuery(".bignewsbox").append("<div class='shuzi'></div>");
for ( i=0 ; i< shuliang ;i){
i++
jQuery(".shuzi").append("<span></span>");
};
jQuery(".shuzi span").eq(0).addClass("tsshuzi");
jQuery(".shuzi span").mouseenter(function(){
var index = jQuery(this).index();
jQuery(this).addClass("tsshuzi").siblings().removeClass("tsshuzi");
jQuery(".bignews>div").eq(index).fadeIn(1).siblings().hide(1);
});
jQuery(".bignewsbox").hover(
function(){
clearInterval(lunbotime);
},function(){
lunbotime = setInterval(function(){
jQuery(".shuzi span").eq(index).addClass("tsshuzi").siblings().removeClass("tsshuzi");
jQuery(".bignews>div").eq(index).fadeIn(1).siblings().hide(1);
index++;
if(index == shuliang ){
index=0;
...
<!--list条大模块开始-->
<div class="">
<!--list单条开始--><?php $templist = array_slice($list, 0, 2); if(is_array($templist)) foreach($templist as $v) { ?><div class="newslistone clear_b">
<a href="<?php echo $v['url'];?>" target="_blank"><img src="<?php echo $v['pic'];?>" alt="<?php echo $v['title'];?>"/></a>
<div class="newslist_r">
<a href="<?php echo $v['url'];?>" target="_blank"><?php echo $v['title'];?></a>
<p><?php echo $v['summary'];?></p>
<div class="newslist_info zbiconbg clear_b">
<a href="/list/<?php echo $v['catid'];?>" class="zbicon<?php echo $v['catid'];?>" target="_blank"><?php echo $v['catname'];?></a>
<span>来源：<i><?php echo $v['from'];?></i></span>
<span>作者：<i><?php echo $v['author'];?></i></span>
</div>
</div>
...
<div  class="rlinkbox clear_b">
            ...
            <div class=""><?php echo adshow("custom_324"); ?></div>
<div class="rtitle mt20">装备品牌点评榜</div>
<div class="brand">
...
<!--list条大模块开始-->
<div class="">
<!--list单条开始--><?php $templist = array_slice($list, 3, 3); if(is_array($templist)) foreach($templist as $v) { ?><div class="newslistone clear_b">
<a href="<?php echo $v['url'];?>" target="_blank"><img src="<?php echo $v['pic'];?>" alt="<?php echo $v['title'];?>"/></a>
<div class="newslist_r">
<a href="<?php echo $v['url'];?>" target="_blank"><?php echo $v['title'];?></a>
<p><?php echo $v['summary'];?></p>
...
<div class="r260zb">
<div class="mt20"><?php echo adshow("custom_39"); ?></div>
            <div class="mt10"><?php echo adshow("custom_343"); ?></div>
</div>
</div>
<div class="clear_b">
<div class="l660zb">
<!--list条大模块开始-->
<div class="">
<!--list单条开始--><?php $templist = array_slice($list, 6, 4); if(is_array($templist)) foreach($templist as $v) { ?><div class="newslistone clear_b">
<a href="<?php echo $v['url'];?>" target="_blank"><img src="<?php echo $v['pic'];?>" alt="<?php echo $v['title'];?>"/></a>
<div class="newslist_r">
<a href="<?php echo $v['url'];?>" target="_blank"><?php echo $v['title'];?></a>
<p><?php echo $v['summary'];?></p>
...
<div class="r260zb">
        	<div class="mt20">
        <?php echo adshow("custom_430"); ?>            </div>
<div class="rtitle mt20">装备论坛</div>
<div class="bbsbox">
<ul><?php if(is_array($zbList)) foreach($zbList as $v) { ?><li>
<a href="home.php?mod=space&amp;uid=<?php echo $v['authorid'];?>" target="_blank"><?php echo $v['avatar'];?></a>
<div class="bbsbox_r">
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $v['tid'];?>" target="_blank"><?php echo $v['subject'];?></a>
</div>
</li>
<?php } ?>
</ul>
...
<div style="margin:20px auto 0px auto; width:980px;margin-bottom:40px;">
...
<script src="http://static.8264.com/static/js/common/common.js" type="text/javascript" type="text/javascript"></script><?php echo adshow("custom_484"); ?><style type="text/css">
    .side-float{
        position: fixed;
        width: 161px;
        height: 149px;
