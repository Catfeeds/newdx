<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('mountain_showlist', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/mountain_showlist.htm', './template/8264/dianping/header.htm', 1509517960, '2', './data/template/2_2_dianping_mountain_showlist.tpl.php', './template/8264', 'dianping/mountain_showlist')
|| checktplrefresh('./template/8264/dianping/mountain_showlist.htm', './template/8264/dianping/nav.htm', 1509517960, '2', './data/template/2_2_dianping_mountain_showlist.tpl.php', './template/8264', 'dianping/mountain_showlist')
|| checktplrefresh('./template/8264/dianping/mountain_showlist.htm', './template/8264/common/zhidemai.htm', 1509517960, '2', './data/template/2_2_dianping_mountain_showlist.tpl.php', './template/8264', 'dianping/mountain_showlist')
|| checktplrefresh('./template/8264/dianping/mountain_showlist.htm', './template/8264/dianping/sidebar_comment_rate.htm', 1509517960, '2', './data/template/2_2_dianping_mountain_showlist.tpl.php', './template/8264', 'dianping/mountain_showlist')
|| checktplrefresh('./template/8264/dianping/mountain_showlist.htm', './template/8264/dianping/sidebar_contactus.htm', 1509517960, '2', './data/template/2_2_dianping_mountain_showlist.tpl.php', './template/8264', 'dianping/mountain_showlist')
|| checktplrefresh('./template/8264/dianping/mountain_showlist.htm', './template/8264/dianping/footer.htm', 1509517960, '2', './data/template/2_2_dianping_mountain_showlist.tpl.php', './template/8264', 'dianping/mountain_showlist')
|| checktplrefresh('./template/8264/dianping/mountain_showlist.htm', './template/8264/common/header_8264_new.htm', 1509517960, '2', './data/template/2_2_dianping_mountain_showlist.tpl.php', './template/8264', 'dianping/mountain_showlist')
|| checktplrefresh('./template/8264/dianping/mountain_showlist.htm', './template/8264/common/ewm_r.htm', 1509517960, '2', './data/template/2_2_dianping_mountain_showlist.tpl.php', './template/8264', 'dianping/mountain_showlist')
|| checktplrefresh('./template/8264/dianping/mountain_showlist.htm', './template/8264/common/weixin_share.htm', 1509517960, '2', './data/template/2_2_dianping_mountain_showlist.tpl.php', './template/8264', 'dianping/mountain_showlist')
|| checktplrefresh('./template/8264/dianping/mountain_showlist.htm', './template/8264/common/footer_8264_new.htm', 1509517960, '2', './data/template/2_2_dianping_mountain_showlist.tpl.php', './template/8264', 'dianping/mountain_showlist')
|| checktplrefresh('./template/8264/dianping/mountain_showlist.htm', './template/8264/common/header_common.htm', 1509517960, '2', './data/template/2_2_dianping_mountain_showlist.tpl.php', './template/8264', 'dianping/mountain_showlist')
|| checktplrefresh('./template/8264/dianping/mountain_showlist.htm', './template/8264/common/index_ad_top.htm', 1509517960, '2', './data/template/2_2_dianping_mountain_showlist.tpl.php', './template/8264', 'dianping/mountain_showlist')
;
block_get('7029');?>
<!doctype html>
<html>
...
<div class="nav-name blue">属地</div>
<div class="nav-list-wartpen">
<div class="nav-list-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;dq=0&amp;gd=<?php echo $gdnum;?>&amp;page=1"<?php if($_GET['dq']==0) { ?> class="blue"<?php } ?>>全部</a><?php if(is_array($cate_dq)) foreach($cate_dq as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;dq=<?php echo $k;?>&amp;gd=<?php echo $gdnum;?>&amp;page=1"<?php if($_GET['dq']==$k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
<?php } ?>
</div>
</div>
</div>
<div class="nav-sift-one">
<div class="nav-name orange">海拔</div>
<div class="nav-list-wartpen">
<div class="nav-list-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;dq=<?php echo $dqnum;?>&amp;gd=0&amp;page=1"<?php if($_GET['gd']==0) { ?> class="blue"<?php } ?>>全部</a><?php if(is_array($cate_gd)) foreach($cate_gd as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;dq=<?php echo $dqnum;?>&amp;gd=<?php echo $k;?>&amp;page=1"<?php if($_GET['gd']==$k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
<?php } ?>
</div>
</div>
</div>
...
<!-- main left -->
<div class="col-main">
                	<div style=" margin-bottom:35px; display:none;"><?php echo adshow("custom_334"); ?></div>
<div class="main-wrap">
<div class="ui-grid-6 ui-grid-left">
<div class="left-title-box">
<div class="title-right">
<?php if($_GET['dq']==0 && $_GET['gd']==0) { ?>
<h3>
<span>所有山峰</span>
</h3>
<?php } ?>
</div>
<?php if($_GET['dq'] || $_GET['gd']) { ?>
<div class="sift-left">
<div class="condition-box">
<h1>
<?php if($_GET['dq']) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;dq=0&amp;gd=<?php echo $gdnum;?>&amp;page=1" class="condition"><?php echo $cate_dq[$dqnum];?><i></i></a><?php } if($_GET['gd']) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;dq=<?php echo $dqnum;?>&amp;gd=0&amp;page=1" class="condition"><?php echo $cate_gd[$gdnum];?><i></i></a><?php } ?>
</h1>
</div>
</div>
<?php } ?>
...
<div class="sift-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;dq=<?php echo $dqnum;?>&amp;gd=<?php echo $gdnum;?>&amp;page=1"<?php if($order=='lastpost') { ?> class="hover"<?php } ?>><i></i>默认</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;dq=<?php echo $dqnum;?>&amp;gd=<?php echo $gdnum;?>&amp;page=1"<?php if($order=='heats') { ?> class="hover"<?php } ?>><i></i>热度</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=score&amp;dq=<?php echo $dqnum;?>&amp;gd=<?php echo $gdnum;?>&amp;page=1"<?php if($order=='score') { ?> class="hover"<?php } ?>><i></i>难度</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=dateline&amp;dq=<?php echo $dqnum;?>&amp;gd=<?php echo $gdnum;?>&amp;page=1"<?php if($order=='dateline') { ?> class="hover"<?php } ?>><i></i>最新</a>
</div>
</div>
<!-- //排序筛选 -->
</div>
...
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="<?php echo $item['subject'];?>" target="_blank"><img src="<?php echo getimagethumb(120,90,2, $item['dir'].'/'.$item['showimg'], '', $item['serverid']); ?>" alt="<?php echo $item['subject'];?>"></a>
<div class="list-info">
...
<span><?php echo $dp_category['mountain']['dq'][$item['type']];?>，<?php echo $item['height'];?>米，攀登季节<?php echo $item['season'];?></span>
<span>地址：<?php echo $item['region'];?></span>
</div>
...
<a href="http://www.8264.com/dianping.php?mod=mountain&amp;act=dopost&amp;do=new" target="_blank" class="line-button">
<i class="line-icon"></i>
<span>发布山峰</span>
</a>
</div>
