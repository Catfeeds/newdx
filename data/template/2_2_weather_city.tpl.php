...
0
|| checktplrefresh('./template/default/weather/city.htm', './template/8264/common/header_8264_new.htm', 1509518631, '2', './data/template/2_2_weather_city.tpl.php', './template/8264', 'weather/city')
|| checktplrefresh('./template/default/weather/city.htm', './template/8264/common/zhidemai.htm', 1509518631, '2', './data/template/2_2_weather_city.tpl.php', './template/8264', 'weather/city')
|| checktplrefresh('./template/default/weather/city.htm', './template/8264/common/footer_8264_new.htm', 1509518631, '2', './data/template/2_2_weather_city.tpl.php', './template/8264', 'weather/city')
|| checktplrefresh('./template/default/weather/city.htm', './template/8264/common/header_common.htm', 1509518631, '2', './data/template/2_2_weather_city.tpl.php', './template/8264', 'weather/city')
|| checktplrefresh('./template/default/weather/city.htm', './template/8264/common/index_ad_top.htm', 1509518631, '2', './data/template/2_2_weather_city.tpl.php', './template/8264', 'weather/city')
;?>
<!doctype html>
<html>
<head>
...
jQuery(function($){
    ...
    <div class="citylist clear_b">
        <a href="http://www.8264.com/weather/guangxi/yangshuo/" target="_blank">阳朔</a>
        <a href="http://www.8264.com/weather/heilongjiang/haerbin/" target="_blank">哈尔滨</a>
        <a href="http://www.8264.com/weather/yunnan/lijiang/" target="_blank">丽江</a>
        <a href="http://www.8264.com/weather/neimenggu/hulunbeier/" target="_blank">呼伦贝尔</a>
        <a href="http://www.8264.com/weather/beijing/" target="_blank">北京</a>
        <a href="http://www.8264.com/weather/aomen/aomen/" target="_blank">澳门</a>
        <a href="http://www.8264.com/weather/guangdong/guangzhou/" target="_blank">广州</a>
        <a href="http://www.8264.com/weather/jilin/changchun/" target="_blank">长春</a>
        <a href="http://www.8264.com/weather/jiangsu/suzhou/" target="_blank">苏州</a>
        <a href="http://www.8264.com/weather/yunnan/dali/" target="_blank">大理</a>
        <a href="http://www.8264.com/weather/jiangxi/wuyuan/" target="_blank">婺源</a>
        <a href="http://www.8264.com/weather/shanghai/shanghai/" target="_blank">上海</a>
        <a href="http://www.8264.com/weather/anhui/huangshan/" target="_blank">黄山</a>
        <a href="http://www.8264.com/weather/zhejiang/hangzhou/" target="_blank">杭州</a>
        <a href="http://www.8264.com/weather/hebei/qinhuangdao/" target="_blank">秦皇岛</a>
        <a href="http://www.8264.com/weather/shandong/jinan/" target="_blank">济南</a>
        <a href="http://www.8264.com/weather/jiangsu/wuxi/" target="_blank">无锡</a>
        <a href="http://www.8264.com/weather/guangxi/guilin/" target="_blank">桂林</a>
        <a href="http://www.8264.com/weather/jiangsu/nanjing/" target="_blank">南京</a>
        <a href="http://www.8264.com/weather/tianjin/tianjin/" target="_blank">天津</a>
        <a href="http://www.8264.com/weather/taiwan/taibei/" target="_blank">台北</a>
        <a href="http://www.8264.com/weather/fujian/xiamen/" target="_blank">厦门</a>
        <a href="http://www.8264.com/weather/hainan/sanya/" target="_blank">三亚</a>
        <a href="http://www.8264.com/weather/hubei/wuhan/" target="_blank">武汉</a>
        <a href="http://www.8264.com/weather/xianggang/xianggang/" target="_blank">香港</a>
        <a href="http://www.8264.com/weather/guangdong/zhuhai/" target="_blank">珠海</a>
        <a href="http://www.8264.com/weather/shanxi/xian/" target="_blank">西安</a>
        <a href="http://www.8264.com/weather/sichuan/chengdu/" target="_blank">成都</a>
        <a href="http://www.8264.com/weather/jiangsu/yangzhou/" target="_blank">扬州</a>
    </div>

    <div class="citylistpagy clear_b">

        <?php if(is_array($weather_area_list)) foreach($weather_area_list as $weather_area) { ?>        <dl class="clear_b">
            <dt><a href="http://www.8264.com/weather/<?php echo $weather_area['spell'];?>/" target="_blank"><?php echo $weather_area['name'];?></a><a href="http://www.8264.com/weather/<?php echo $weather_area['spell'];?>/" target="_blank" class="morecity">更多城市</a></dt>
            <dd>
                <?php if(is_array($weather_area['areas'])) foreach($weather_area['areas'] as $weather_city) { ?>                <a href="http://www.8264.com/weather/<?php echo $weather_city['pspell'];?>/<?php echo $weather_city['spell'];?>/" target="_blank"><?php echo $weather_city['name'];?></a>
                <?php } ?>
            </dd>
        </dl>
        <?php } ?>
...
<!-- <div style="background:url(images/bottom.jpg) top center no-repeat; height:70px;"></div> -->
<script>
    $(document).ready(function () {
        $("body").addClass("citylistbody");
    });
</script>
<!--嵌入公用底部开始--></div>
<!-- 友情链接 -->
