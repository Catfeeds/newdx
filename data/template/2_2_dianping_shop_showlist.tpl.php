<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('shop_showlist', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/shop_showlist.htm', './template/8264/dianping/header.htm', 1509517868, '2', './data/template/2_2_dianping_shop_showlist.tpl.php', './template/8264', 'dianping/shop_showlist')
|| checktplrefresh('./template/8264/dianping/shop_showlist.htm', './template/8264/dianping/nav.htm', 1509517868, '2', './data/template/2_2_dianping_shop_showlist.tpl.php', './template/8264', 'dianping/shop_showlist')
|| checktplrefresh('./template/8264/dianping/shop_showlist.htm', './template/8264/common/zhidemai.htm', 1509517868, '2', './data/template/2_2_dianping_shop_showlist.tpl.php', './template/8264', 'dianping/shop_showlist')
|| checktplrefresh('./template/8264/dianping/shop_showlist.htm', './template/8264/dianping/footer.htm', 1509517868, '2', './data/template/2_2_dianping_shop_showlist.tpl.php', './template/8264', 'dianping/shop_showlist')
|| checktplrefresh('./template/8264/dianping/shop_showlist.htm', './template/8264/common/header_8264_new.htm', 1509517868, '2', './data/template/2_2_dianping_shop_showlist.tpl.php', './template/8264', 'dianping/shop_showlist')
|| checktplrefresh('./template/8264/dianping/shop_showlist.htm', './template/8264/common/ewm_r.htm', 1509517868, '2', './data/template/2_2_dianping_shop_showlist.tpl.php', './template/8264', 'dianping/shop_showlist')
|| checktplrefresh('./template/8264/dianping/shop_showlist.htm', './template/8264/common/weixin_share.htm', 1509517868, '2', './data/template/2_2_dianping_shop_showlist.tpl.php', './template/8264', 'dianping/shop_showlist')
|| checktplrefresh('./template/8264/dianping/shop_showlist.htm', './template/8264/common/footer_8264_new.htm', 1509517868, '2', './data/template/2_2_dianping_shop_showlist.tpl.php', './template/8264', 'dianping/shop_showlist')
|| checktplrefresh('./template/8264/dianping/shop_showlist.htm', './template/8264/common/header_common.htm', 1509517868, '2', './data/template/2_2_dianping_shop_showlist.tpl.php', './template/8264', 'dianping/shop_showlist')
|| checktplrefresh('./template/8264/dianping/shop_showlist.htm', './template/8264/common/index_ad_top.htm', 1509517868, '2', './data/template/2_2_dianping_shop_showlist.tpl.php', './template/8264', 'dianping/shop_showlist')
;
block_get('6905');?>
<!doctype html>
<html>
...
<div class="nav-name blue">所在地域</div>
 <div class="line_con_gray clboth p_r div_region">
<span class="arrow_d"></span>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=0&amp;rid=0&amp;sid=0&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;order=<?php echo $order;?>&amp;page=1" <?php if($_GET['pid']==0) { ?> class="blue" <?php } ?>>全部</a><?php if(is_array($arr_region)) foreach($arr_region as $k => $v) { if($k!=1430) { ?>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $k;?>&amp;rid=0&amp;sid=0&amp;cid=<?php echo $cid;?>&amp;bid=0&amp;order=<?php echo $order;?>&amp;page=1" value="<?php echo $k;?>" class="province <?php if($pid == $k) { ?> blue<?php } ?>"><?php echo $v['name'];?></a>
<?php } } ?>
</div>
<span class="tc_dq clboth" style="z-index:10000;width:450px;"><?php if(is_array($arr_region)) foreach($arr_region as $key => $value) { if($key!=1430 && $key!=1426 && $key!=1428) { ?>
<span id='province_<?php echo $key;?>' class='div_city'><?php if(is_array($value['city'])) foreach($value['city'] as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $key;?>&amp;rid=<?php echo $k;?>&amp;sid=0&amp;cid=0&amp;bid=0&amp;order=<?php echo $order;?>&amp;page=1"<?php if($rid==$k) { ?> class="blue"<?php } ?>><?php echo $v['cityname'];?></a>
<?php } ?>
</span>
<?php } } ?>
</span>
...
<div class="nav-name orange">分类</div>
<div class="nav-list-wartpen">
<div class="nav-list-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=0&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;order=<?php echo $order;?>&amp;page=1" <?php if($_GET['sid']==0) { ?>class="blue"<?php } ?>>不限</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=1&amp;cid=0&amp;bid=0&amp;order=<?php echo $order;?>&amp;page=1"<?php if($_GET['sid']==1) { ?> class="blue"<?php } ?>>街边店</a>
<a id="cbtn_2" href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=2&amp;cid=0&amp;bid=0&amp;order=<?php echo $order;?>&amp;page=1"<?php if($_GET['sid']>=2) { ?>  class="blue"<?php } ?>>商场店</a>
<div id="sub_list_2" class="nav-list-more-box" style="display:none;">
<ul>
<li>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=0&amp;sid=<?php echo $sid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;order=<?php echo $order;?>&amp;page=1"<?php if($_GET['sid']==0) { ?> class="blue"<?php } ?>>全部</a>
</li><?php if(is_array($brand_market['market_array'])) foreach($brand_market['market_array'] as $k => $v) { ?><li>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=<?php echo $k;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;order=<?php echo $order;?>&amp;page=1"<?php if($_GET['sid']==$k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
</li>
<?php } ?>
</ul>
</div>
...
<?php } if($brand_market['brand_array']) { ?>
<div class="line_l_t_d">
<div class="nav-name darkblue">品牌</div>
<div class="line_con_gray clboth p_r div_region">
<span class="arrow_d"></span>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=<?php echo $sid;?>&amp;cid=<?php echo $cid;?>&amp;bid=0&amp;order=<?php echo $order;?>&amp;page=1" <?php if($bid==0) { ?> class="blue" <?php } ?>>全部</a><?php if(is_array($brand_market['brand_array'])) foreach($brand_market['brand_array'] as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=<?php echo $sid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $k;?>&amp;order=<?php echo $order;?>&amp;page=1" class="<?php if($_GET['bid']==$k) { ?> blue <?php } ?>"><?php echo $v;?></a>
<?php } ?>
</div>
</div>
<?php } ?>
...
<h1>	<?php if($pid) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=0&amp;rid=0&amp;sid=0&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;order=<?php echo $order;?>&amp;page=1" class="condition" style="margin-bottom:10px;"><?php echo $arr_region[$pid]['name'];?><i></i></a><?php } if($rid) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=0&amp;rid=<?php echo $rid;?>&amp;sid=0&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;order=<?php echo $order;?>&amp;page=1" class="condition" style="margin-bottom:10px;"><?php echo $arr_region[$pid]['city'][$rid]['cityname'];?><i></i></a><?php } if($sid==1) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=0cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;order=<?php echo $order;?>&amp;page=1" class="condition" style="margin-bottom:10px;">街边店<i></i></a>
<?php } elseif($sid>=2) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=0cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;order=<?php echo $order;?>&amp;page=1" class="condition" style="margin-bottom:10px;">商场店<i></i></a><?php } if($sid>2) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=2cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;order=<?php echo $order;?>&amp;page=1" class="condition" style="margin-bottom:10px;"><?php echo $brand_market['market_array'][$sid];?><i></i></a><?php } if($bid) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=<?php echo $sid;?>&amp;cid=<?php echo $cid;?>&amp;bid=0&amp;order=<?php echo $order;?>&amp;page=1" class="condition" style="margin-bottom:10px;"><?php echo $brand_market['brand_array'][$bid];?><i></i></a><?php } ?>
</h1>
</div>
</div>
<!-- //取消分类筛选 -->
...
<div class="sift-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=<?php echo $sid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;order=lastpost&amp;page=1" <?php if($_GET['order']=='lastpost' || $_GET['order']=='') { ?> class="hover" <?php } ?> ><i></i>默认</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=<?php echo $sid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;order=heats&amp;page=1" <?php if($_GET['order']=='heats') { ?> class="hover" <?php } ?> ><i></i>热度</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=<?php echo $sid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;order=score&amp;page=1" <?php if($_GET['order']=='score') { ?> class="hover" <?php } ?>><i></i>评分</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $pid;?>&amp;rid=<?php echo $rid;?>&amp;sid=<?php echo $sid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;order=dateline&amp;page=1" <?php if($_GET['order']=='dateline') { ?> class="hover" <?php } ?>><i></i>最新</a>
</div>
</div>
...
<ul>
<?php if($modlist) { if(is_array($modlist)) foreach($modlist as $item) { ?><li>
<a href="http://www.8264.com/dianping.php?mod=shop&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" target="_blank" title="<?php echo $item['subject'];?>"><img src="<?php echo getimagethumb(120,90,2, $item['dir'].'/'.$item['showimg'], '', $item['serverid']); ?>" alt="<?php echo $item['subject'];?>"></a>
<div class="list-info">
<h2><a href="http://www.8264.com/dianping.php?mod=shop&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" class="title-big" target="_blank"  title="<?php echo $item['subject'];?>"><?php echo $item['subject'];?></a></h2>
<span><?php $bat=array(); if($item['provinceid']) { ?><?php $bat[0]=$arr_region[$item['provinceid']]['name']; } if($item['regionid']) { ?><?php $bat[1]=$arr_region[$item['provinceid']]['city'][$item['regionid']]['cityname']; } if($item['marketid']) { ?><?php $bat[3]='商场店'; } else { ?><?php $bat[3]='街边店'; } if($item['sbrandid']) { ?><?php $bat[4]='品牌专卖'; } else { ?><?php $bat[4]='综合品牌'; } if($item['cbrandid']) { ?><?php $bat[5]='连锁'; } ?><?php echo  implode('，',$bat) ?></span>
<span>地址：<?php echo $item['addr'];?></span>
</div>
...
<?php if($item['cnum']) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>#comment" target="_blank"><?php echo $item['cnum'];?>人点评</a><?php } else { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>#write" class="gift" target="_blank"><i></i>我要点评</a><?php } ?>
</div>
</li>
<?php } } else { ?>
<li>没有找到您要查看的内容</li>
...
<a href="http://www.8264.com/dianping.php?mod=shop&amp;act=dopost&amp;do=new" target="_blank"
   class="line-button">
<i class="line-icon"></i>
<span>发布店铺</span>
</a>
...
<ul><?php if(is_array($shop_new)) foreach($shop_new as $k => $value) { ?><li>
<div class="imgbox"><a href="http://www.8264.com/dianping.php?mod=shop&amp;act=showview&amp;tid=<?php echo $value['tid'];?>" title="<?php echo $value['subject'];?>" target="_blank"><img src="<?php echo getimagethumb(120,90,2, $value['dir'].'/'.$value['showimg'], '', $value['serverid']); ?>" alt="<?php echo $value['subject'];?>"></a></div>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="http://www.8264.com/dianping.php?mod=shop&amp;act=showview&amp;tid=<?php echo $value['tid'];?>" class="<?php if($k<1) { ?>orange<?php } elseif($k<3) { ?>blue<?php } ?>" title="<?php echo $value['subject'];?>" target="_blank"><?php echo $value['subject'];?></a></h3>
<div class="date"><?php echo dgmdate($value['dateline']); ?></div>
</div>
</li>
<?php } ?>
</ul>
...
<ul class="right-same-area"><?php if(is_array($arrDzcx)) foreach($arrDzcx as $k => $value) { ?><li>
<h3 class="wlist-bd-title"><a href="http://bbs.8264.com/thread-<?php echo $value['tid'];?>-1-1.html"  title="<?php echo $value['subject'];?>" target="_blank"><?php echo $value['subject'];?></a></h3>
</li>
<?php } ?>
</ul>
</div>
