...
$_G['home_tpl_spacemenus'][] = "<a href=\"home.php?mod=space&amp;uid=$space[uid]&amp;do=$do&amp;view=me\">TA的所有日志</a>";
$_G['home_tpl_spacemenus'][] = "<a href=\"home.php?mod=space&amp;uid=$space[uid]&amp;do=blog&amp;id=$blog[blogid]\">查看日志</a>";
$friendsname = array(1 => '仅自己可见',2 => '仅自己可见',3 => '仅自己可见',4 => '仅自己可见'); ?><!doctype html>
<html>
<head>
...
<div class="ui-title">
<h3><?php if($space['self']) { ?>我<?php } else { ?><?php echo $space['username'];?><?php } ?>的日志</h3>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=blog&amp;view=me&amp;from=space" class="ui-list-link">返回日志列表 ></a>
</div>
</div>
...
<?php if($blog['friend']) { ?><span class="view-num"><?php echo $friendsname[$blog['friend']];?></span><?php } if($classarr['classname']) { ?><span class="view-num">个人分类：<a href="home.php?mod=space&amp;uid=<?php echo $blog['uid'];?>&amp;do=blog&amp;classid=<?php echo $blog['classid'];?>&amp;view=me"><?php echo $classarr['classname'];?></a></span><?php } if($blog['hot']) { ?><span class="view-num">热度：<?php echo $blog['hot'];?></span><?php } ?>
</div>
<!--文章信息 end-->
<!--文章操作-->
...
<?php } ?>
赞(<span id="clicknum" class="clicknum"><?php echo $blog['click3']+$blog['click4'];; ?></span>)</a>
<span id="return_click_blogid_<?php echo $blog['blogid'];?>_3"></span>
</li>
<li class="op-list-item">
<a class="btncomment" href="javascript:void(0);">评论(<span id="comment_replynum" class="comment_replynum"><?php echo $blog['replynum'];?></span>)</a>
</li>
...
<?php if($_G['uid'] == $blog['uid'] || checkperm('manageblog')) { ?>
<li>
<a href="home.php?mod=spacecp&amp;ac=blog&amp;blogid=<?php echo $blog['blogid'];?>&amp;op=edit" class="drop-list">编辑</a>
</li>
<li>
<a href="home.php?mod=spacecp&amp;ac=blog&amp;blogid=<?php echo $blog['blogid'];?>&amp;op=delete&amp;handlekey=delbloghk_<?php echo $blog['blogid'];?>" onclick="showWindow(this.id, this.href, 'get', 0);" id="blog_delete_<?php echo $blog['blogid'];?>">删除</a>
</li>	
...
<li class="op-list-item">
<a href="home.php?mod=spacecp&amp;ac=blog&amp;blogid=<?php echo $blog['blogid'];?>&amp;op=edithot&amp;handlekey=bloghothk_<?php echo $blog['blogid'];?>" id="blog_hot_<?php echo $blog['blogid'];?>" onclick="showWindow(this.id, this.href, 'get', 0);">热度</a>
</li>
<?php } ?>	
<?php if(!$blog['friend'] && !$blog['pushedaid'] && ($_G['group']['allowauthorizedarticle'] || $_G['group']['allowmanagearticle'])) { ?>
<li>
<a href="portal.php?mod=portalcp&amp;ac=index&amp;op=push&amp;idtype=blogid&amp;id=<?php echo $blog['blogid'];?>" onclick="showWindow('push', this.href, 'get', 0)">生成文章</a>
</li>
<?php } ?>
</ul>
</div>
...
<a href="home.php?mod=space&amp;uid=<?php echo $blog['uid'];?>&amp;do=blog&amp;id=<?php echo $prevBlog['blogid'];?>" class="">上一篇</a>
</span>
<?php } if($nextBlog) { ?>
<span class="next-blog">
<a href="home.php?mod=space&amp;uid=<?php echo $blog['uid'];?>&amp;do=blog&amp;id=<?php echo $nextBlog['blogid'];?>" class="">下一篇：<?php echo $nextBlog['subject'];?></a>
</span>
<?php } ?>
</div>
<!--文章操作-->
...
<li class="op-list-item">
<a class="btncomment" href="javascript:void(0);">评论(<span class="comment_replynum"><?php echo $blog['replynum'];?></span>)</a>
</li>
<li class="op-list-item shareBtn">
<a href="javascript:;" class="share">分享(<span class="shareCount"></span>)</a>
<div class="bdsharebuttonbox share-wrap-cust" data-tag="share_1">
...
<?php if($_G['uid'] == $blog['uid'] || checkperm('manageblog')) { ?>
<li>
<a class="drop-list" href="home.php?mod=spacecp&amp;ac=blog&amp;blogid=<?php echo $blog['blogid'];?>&amp;op=edit">编辑</a>
</li>
<li>
<a href="home.php?mod=spacecp&amp;ac=blog&amp;blogid=<?php echo $blog['blogid'];?>&amp;op=delete&amp;handlekey=delbloghk_<?php echo $blog['blogid'];?>" onclick="showWindow(this.id, this.href, 'get', 0);" id="blog_delete_<?php echo $blog['blogid'];?>">删除</a>
</li>	
