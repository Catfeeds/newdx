<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('blog', 'common/header');
0
|| checktplrefresh('./template/default/ranklist/blog.htm', './template/8264/common/header.htm', 1509519671, 'diy', './data/template/2_diy_ranklist_blog.tpl.php', './template/8264', 'ranklist/blog')
|| checktplrefresh('./template/default/ranklist/blog.htm', './template/default/common/simplesearchform.htm', 1509519671, 'diy', './data/template/2_diy_ranklist_blog.tpl.php', './template/8264', 'ranklist/blog')
|| checktplrefresh('./template/default/ranklist/blog.htm', './template/default/ranklist/side_left.htm', 1509519671, 'diy', './data/template/2_diy_ranklist_blog.tpl.php', './template/8264', 'ranklist/blog')
|| checktplrefresh('./template/default/ranklist/blog.htm', './template/8264/common/footer.htm', 1509519671, 'diy', './data/template/2_diy_ranklist_blog.tpl.php', './template/8264', 'ranklist/blog')
|| checktplrefresh('./template/default/ranklist/blog.htm', './template/8264/common/header_common.htm', 1509519671, 'diy', './data/template/2_diy_ranklist_blog.tpl.php', './template/8264', 'ranklist/blog')
;?>
<!doctype html>
<html>
<head>
...
<h1 class="mt">日志排行</h1>
<ul class="tb cl">
<li<?php if($_G['gp_orderby'] == 'heats') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=blog&amp;orderby=heats&amp;before=<?php echo $_G['gp_before'];?>">人气排行</a></li>
<li<?php if($_G['gp_orderby'] == 'replies') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=blog&amp;orderby=replies&amp;before=<?php echo $_G['gp_before'];?>">评论排行</a></li>
<li<?php if($_G['gp_orderby'] == 'views') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=blog&amp;orderby=views&amp;before=<?php echo $_G['gp_before'];?>">查看排行</a></li>
<li<?php if($_G['gp_orderby'] == 'sharetimes') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=blog&amp;orderby=sharetimes&amp;before=<?php echo $_G['gp_before'];?>">分享排行</a></li>
<li<?php if($_G['gp_orderby'] == 'favtimes') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=blog&amp;orderby=favtimes&amp;before=<?php echo $_G['gp_before'];?>">收藏排行</a></li>
<?php if($clicks) { if(is_array($clicks)) foreach($clicks as $key => $value) { ?><li<?php if($_G['gp_orderby'] == $key) { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=blog&amp;orderby=<?php echo $key;?>&amp;before=<?php echo $_G['gp_before'];?>"><?php echo $value['name'];?>排行</a></li>
<?php } } ?>
</ul>
<p id="before" class="tbmu">
<a href="misc.php?mod=ranklist&amp;type=blog&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=thisweek" id="604800" <?php if($_G['gp_before'] == 'thisweek') { ?>class="a"<?php } ?> />本周</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=blog&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=thismonth" id="2592000" <?php if($_G['gp_before'] == 'thismonth') { ?>class="a"<?php } ?> />本月</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=blog&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=today" id="86400" <?php if($_G['gp_before'] == 'today') { ?>class="a"<?php } ?> />今日</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=blog&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=all" id="all" <?php if($_G['gp_before'] == 'all') { ?>class="a"<?php } ?> />全部</a>
</p>
<?php if($bloglist) { ?>
...
<dd class="xg1">
<?php if($_G['gp_orderby'] == 'heats') { ?>人气: <?php echo $blog['hot'];?>
<?php } elseif($_G['gp_orderby'] == 'replies') { ?><a href="home.php?mod=space&amp;uid=<?php echo $blog['uid'];?>&amp;do=blog&amp;id=<?php echo $blog['blogid'];?>#comment" target="_blank">评论 <?php echo $blog['replynum'];?></a>
<?php } elseif($_G['gp_orderby'] == 'views') { ?>查看 <?php echo $blog['viewnum'];?>
<?php } elseif($_G['gp_orderby'] == 'sharetimes') { ?>分享 <?php echo $blog['sharetimes'];?>
<?php } elseif($_G['gp_orderby'] == 'favtimes') { ?>收藏 <?php echo $blog['favtimes'];?>
<?php } else { ?><?php echo $clicks[$_G['gp_orderby']]['name'];?> <?php echo $blog['click'.$_G['gp_orderby']];?><?php } ?>
</dd>
</dl>
<?php } ?>
</div>
