<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('mountain_commentdetail', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/mountain_commentdetail.htm', './template/8264/dianping/header.htm', 1509518292, '2', './data/template/2_2_dianping_mountain_commentdetail.tpl.php', './template/8264', 'dianping/mountain_commentdetail')
|| checktplrefresh('./template/8264/dianping/mountain_commentdetail.htm', './template/8264/dianping/nav_comment.htm', 1509518292, '2', './data/template/2_2_dianping_mountain_commentdetail.tpl.php', './template/8264', 'dianping/mountain_commentdetail')
|| checktplrefresh('./template/8264/dianping/mountain_commentdetail.htm', './template/8264/dianping/footer.htm', 1509518292, '2', './data/template/2_2_dianping_mountain_commentdetail.tpl.php', './template/8264', 'dianping/mountain_commentdetail')
|| checktplrefresh('./template/8264/dianping/mountain_commentdetail.htm', './template/8264/common/header_8264_new.htm', 1509518292, '2', './data/template/2_2_dianping_mountain_commentdetail.tpl.php', './template/8264', 'dianping/mountain_commentdetail')
|| checktplrefresh('./template/8264/dianping/mountain_commentdetail.htm', './template/8264/common/ewm_r.htm', 1509518292, '2', './data/template/2_2_dianping_mountain_commentdetail.tpl.php', './template/8264', 'dianping/mountain_commentdetail')
|| checktplrefresh('./template/8264/dianping/mountain_commentdetail.htm', './template/8264/common/weixin_share.htm', 1509518292, '2', './data/template/2_2_dianping_mountain_commentdetail.tpl.php', './template/8264', 'dianping/mountain_commentdetail')
|| checktplrefresh('./template/8264/dianping/mountain_commentdetail.htm', './template/8264/common/footer_8264_new.htm', 1509518292, '2', './data/template/2_2_dianping_mountain_commentdetail.tpl.php', './template/8264', 'dianping/mountain_commentdetail')
|| checktplrefresh('./template/8264/dianping/mountain_commentdetail.htm', './template/8264/common/header_common.htm', 1509518292, '2', './data/template/2_2_dianping_mountain_commentdetail.tpl.php', './template/8264', 'dianping/mountain_commentdetail')
|| checktplrefresh('./template/8264/dianping/mountain_commentdetail.htm', './template/8264/common/index_ad_top.htm', 1509518292, '2', './data/template/2_2_dianping_mountain_commentdetail.tpl.php', './template/8264', 'dianping/mountain_commentdetail')
;?>
<!doctype html>
<html>
<head>
...
<!--                                    <div class="avatar-box">
                                            ...
                                            <div class="rows-content row-color-1">
                                                ...
                                                <div class="attrValues">
                                                    <div class="rating-level big-rating">
                                                        ...
                                                        <span>(<?php if($commentlist['starnum']==1) { ?>非常简单<?php } elseif($commentlist['starnum']==2) { ?>简单<?php } elseif($commentlist['starnum']==3) { ?>难<?php } elseif($commentlist['starnum']==4) { ?>困难<?php } elseif($commentlist['starnum']==5) { ?>非常困难<?php } ?>)</span>
                                                    </div>
                                                </div>
                                            </div>
                                        <?php } ?>
                                            ...
                                            <div class="rows-content row-color-3">
                                                ...
                                                <div class="attrValues">
                                                <p><?php echo dgmdate($commentlist['ext1'], 'Y-m-d'); ?> 至 <?php echo dgmdate($commentlist['ext2'], 'Y-m-d'); ?> 
                                                共
                                                <?php if(date($comment['ext1'], 'Y-m-d')==date($comment['ext2'], 'Y-m-d')) { ?>
                                                        <?php echo floor($commentlist['ext2']-$commentlist['ext1'])/3600;; ?>小时
                                                <?php } else { ?>
                                                        <?php echo floor(($commentlist['ext2']-$commentlist['ext1'])/86400); ?>天
                                                <?php } ?>
                                                </p>
                                                </div>
                                            </div>
                                        
                                        <?php if($commentlist['ext3']) { ?>
                                            <div class="rows-content row-color-4">
                                            <div class="commAttr">
                                            <i class="attrs-icon price"></i>费用协作
                                            </div>
                                            <div class="attrValues">
                                            <p><?php echo $commentlist['ext3'];?></p>
                                            </div>
                                            </div>
                                        <?php } ?>
                                        <div class="rows-content row-color-4">
                                    ...
                                    <div class="comment-word">
                                        ...
                                        <div class="attrValues">
                                            <div class="rating-level big-rating">
                                                ...
                                                <span>(<?php if($pre['starnum']==1) { ?>非常简单<?php } elseif($pre['starnum']==2) { ?>简单<?php } elseif($pre['starnum']==3) { ?>难<?php } elseif($pre['starnum']==4) { ?>困难<?php } elseif($pre['starnum']==5) { ?>非常困难<?php } ?>)</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="comment-word">
                                        ...
                                        <div class="attrValues">
                                            <div class="rating-level big-rating">
                                                ...
                                                <span>(<?php if($next['starnum']==1) { ?>非常简单<?php } elseif($next['starnum']==2) { ?>简单<?php } elseif($next['starnum']==3) { ?>难<?php } elseif($next['starnum']==4) { ?>困难<?php } elseif($next['starnum']==5) { ?>非常困难<?php } ?>)</span>
                                            </div>
                                        </div>
                                        <div class="attrValues pt15">
        ...
        <div class="col-sider">
        	<div class="morecommenttitle clear_b">点评对象</div>
                <div class="porductimg">
                    <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $detail['tid'];?>" target="_blank" class="morelink">
                        <img src="<?php echo getimagethumb(120,90,2, $detail['dir'].'/'.$detail['showimg'], '', $detail['serverid']); ?>" alt="<?php echo $detail['subject'];?>" style="width:200px;height:200px;">
                    </a>
                </div>
            ...
            <div class="taglist clear_b">
                ...
                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;dq=<?php echo $detail['type'];?>&amp;gd=0&amp;page=1" target="_blank">
                    
                    <?php echo $cate_dq[$detail['type']];?>
                </a>
                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;dq=0&amp;gd=<?php echo $detail['altitude'];?>&amp;page=1" target="_blank">
                    
                    <?php echo $detail['height'];?>
                </a>
