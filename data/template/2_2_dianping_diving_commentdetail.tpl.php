<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('diving_commentdetail', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/diving_commentdetail.htm', './template/8264/dianping/header.htm', 1509519942, '2', './data/template/2_2_dianping_diving_commentdetail.tpl.php', './template/8264', 'dianping/diving_commentdetail')
|| checktplrefresh('./template/8264/dianping/diving_commentdetail.htm', './template/8264/dianping/nav_comment.htm', 1509519942, '2', './data/template/2_2_dianping_diving_commentdetail.tpl.php', './template/8264', 'dianping/diving_commentdetail')
|| checktplrefresh('./template/8264/dianping/diving_commentdetail.htm', './template/8264/dianping/footer.htm', 1509519942, '2', './data/template/2_2_dianping_diving_commentdetail.tpl.php', './template/8264', 'dianping/diving_commentdetail')
|| checktplrefresh('./template/8264/dianping/diving_commentdetail.htm', './template/8264/common/header_8264_new.htm', 1509519942, '2', './data/template/2_2_dianping_diving_commentdetail.tpl.php', './template/8264', 'dianping/diving_commentdetail')
|| checktplrefresh('./template/8264/dianping/diving_commentdetail.htm', './template/8264/common/ewm_r.htm', 1509519942, '2', './data/template/2_2_dianping_diving_commentdetail.tpl.php', './template/8264', 'dianping/diving_commentdetail')
|| checktplrefresh('./template/8264/dianping/diving_commentdetail.htm', './template/8264/common/weixin_share.htm', 1509519942, '2', './data/template/2_2_dianping_diving_commentdetail.tpl.php', './template/8264', 'dianping/diving_commentdetail')
|| checktplrefresh('./template/8264/dianping/diving_commentdetail.htm', './template/8264/common/footer_8264_new.htm', 1509519942, '2', './data/template/2_2_dianping_diving_commentdetail.tpl.php', './template/8264', 'dianping/diving_commentdetail')
|| checktplrefresh('./template/8264/dianping/diving_commentdetail.htm', './template/8264/common/header_common.htm', 1509519942, '2', './data/template/2_2_dianping_diving_commentdetail.tpl.php', './template/8264', 'dianping/diving_commentdetail')
|| checktplrefresh('./template/8264/dianping/diving_commentdetail.htm', './template/8264/common/index_ad_top.htm', 1509519942, '2', './data/template/2_2_dianping_diving_commentdetail.tpl.php', './template/8264', 'dianping/diving_commentdetail')
;?>
<!doctype html>
<html>
<head>
...
<!--                                    <div class="avatar-box">
        ...
        <div class="col-sider">
            ...
            <div class="taglist clear_b">
            	<a href="http://www.8264.com/qianshui" target="_blank">潜水点</a>
                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $detail['type'];?>&amp;provinceid=0&amp;cityid=0&amp;page=1" target="_blank">
                    <?php list($type1,$type2) = explode(',', $detail['type']); ?>                    <?php if($type1 || $type2 ) { ?><?php echo $cate_type[$type1];?> <?php echo $cate_type[$type2];?><?php } ?>
                </a>
                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=0&amp;provinceid=<?php echo $detail['provinceid'];?>&amp;cityid=0&amp;page=1" target="_blank">
