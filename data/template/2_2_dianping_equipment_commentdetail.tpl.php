<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('equipment_commentdetail', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/equipment_commentdetail.htm', './template/8264/dianping/header.htm', 1509517926, '2', './data/template/2_2_dianping_equipment_commentdetail.tpl.php', './template/8264', 'dianping/equipment_commentdetail')
|| checktplrefresh('./template/8264/dianping/equipment_commentdetail.htm', './template/8264/dianping/nav_comment.htm', 1509517926, '2', './data/template/2_2_dianping_equipment_commentdetail.tpl.php', './template/8264', 'dianping/equipment_commentdetail')
|| checktplrefresh('./template/8264/dianping/equipment_commentdetail.htm', './template/8264/dianping/footer.htm', 1509517926, '2', './data/template/2_2_dianping_equipment_commentdetail.tpl.php', './template/8264', 'dianping/equipment_commentdetail')
|| checktplrefresh('./template/8264/dianping/equipment_commentdetail.htm', './template/8264/common/header_8264_new.htm', 1509517926, '2', './data/template/2_2_dianping_equipment_commentdetail.tpl.php', './template/8264', 'dianping/equipment_commentdetail')
|| checktplrefresh('./template/8264/dianping/equipment_commentdetail.htm', './template/8264/common/ewm_r.htm', 1509517926, '2', './data/template/2_2_dianping_equipment_commentdetail.tpl.php', './template/8264', 'dianping/equipment_commentdetail')
|| checktplrefresh('./template/8264/dianping/equipment_commentdetail.htm', './template/8264/common/weixin_share.htm', 1509517926, '2', './data/template/2_2_dianping_equipment_commentdetail.tpl.php', './template/8264', 'dianping/equipment_commentdetail')
|| checktplrefresh('./template/8264/dianping/equipment_commentdetail.htm', './template/8264/common/footer_8264_new.htm', 1509517926, '2', './data/template/2_2_dianping_equipment_commentdetail.tpl.php', './template/8264', 'dianping/equipment_commentdetail')
|| checktplrefresh('./template/8264/dianping/equipment_commentdetail.htm', './template/8264/common/header_common.htm', 1509517926, '2', './data/template/2_2_dianping_equipment_commentdetail.tpl.php', './template/8264', 'dianping/equipment_commentdetail')
|| checktplrefresh('./template/8264/dianping/equipment_commentdetail.htm', './template/8264/common/index_ad_top.htm', 1509517926, '2', './data/template/2_2_dianping_equipment_commentdetail.tpl.php', './template/8264', 'dianping/equipment_commentdetail')
;?>
<!doctype html>
<html>
<head>
...
<!--                                    <div class="avatar-box">
                                    ...
                                    <div>
                                        ...
                                        <?php } ?>
                                        <?php if($commentlist['extdata']) { ?>
                                            <div class="rows-content row-color-2">
                                                
                                                <div style="padding:3px 4px" class="commAttr">价格来源</div>
                                                
                                                <div class="attrValues">
                                                <p><?php $extdata = unserialize($commentlist['extdata']); echo $extdata['price'] ?></p>
                                                </div>
                                            </div>
                                        <?php } ?>
        ...
        <div class="col-sider">
        	<div class="morecommenttitle clear_b">点评对象</div>
                <div class="porductimg">
                    <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $detail['tid'];?>" target="_blank" class="morelink">
                        <img src="<?php echo getimagethumb(200,200,2, $detail['dir'].'/'.$detail['showimg'], $detail['kaid'], $detail['serverid']); ?>" alt="<?php echo $detail['subject'];?>" style="width:200px;height:200px;">
                    </a>
                </div>
            ...
            <div class="taglist clear_b">
            	<a href="http://www.8264.com/zhuangbei" target="_blank">户外用品</a>

                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;pcid=0&amp;cid=0&amp;bid=<?php echo $detail['brandid'];?>&amp;page=1" target="_blank">
                    <?php echo $detail['brandname'];?>
                </a>
              
                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;pcid=<?php echo $detail['pcid'];?>&amp;cid=0&amp;bid=0&amp;page=1" target="_blank">
                    <?php echo $category[$detail['pcid']]['name'];?>
                </a>
