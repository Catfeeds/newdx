<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('mountainpost', 'forum/dianping/header');
0
|| checktplrefresh('./template/8264/forum/dianping/mountainpost.htm', './template/8264/forum/dianping/header.htm', 1503209128, '2', './data/template/2_2_forum_dianping_mountainpost.tpl.php', './template/8264', 'forum/dianping/mountainpost')
|| checktplrefresh('./template/8264/forum/dianping/mountainpost.htm', './template/8264/forum/dianping/editor_2014_second.htm', 1503209128, '2', './data/template/2_2_forum_dianping_mountainpost.tpl.php', './template/8264', 'forum/dianping/mountainpost')
|| checktplrefresh('./template/8264/forum/dianping/mountainpost.htm', './template/8264/forum/dianping/editor_2014_first.htm', 1503209128, '2', './data/template/2_2_forum_dianping_mountainpost.tpl.php', './template/8264', 'forum/dianping/mountainpost')
|| checktplrefresh('./template/8264/forum/dianping/mountainpost.htm', './template/8264/forum/dianping/footer.htm', 1503209128, '2', './data/template/2_2_forum_dianping_mountainpost.tpl.php', './template/8264', 'forum/dianping/mountainpost')
|| checktplrefresh('./template/8264/forum/dianping/mountainpost.htm', './template/8264/common/header_8264_new.htm', 1503209128, '2', './data/template/2_2_forum_dianping_mountainpost.tpl.php', './template/8264', 'forum/dianping/mountainpost')
|| checktplrefresh('./template/8264/forum/dianping/mountainpost.htm', './template/8264/common/editor_2014.htm', 1503209128, '2', './data/template/2_2_forum_dianping_mountainpost.tpl.php', './template/8264', 'forum/dianping/mountainpost')
|| checktplrefresh('./template/8264/forum/dianping/mountainpost.htm', './template/8264/forum/editor_menu_forum_newimage_2014.htm', 1503209128, '2', './data/template/2_2_forum_dianping_mountainpost.tpl.php', './template/8264', 'forum/dianping/mountainpost')
|| checktplrefresh('./template/8264/forum/dianping/mountainpost.htm', './template/8264/common/ewm_r.htm', 1503209128, '2', './data/template/2_2_forum_dianping_mountainpost.tpl.php', './template/8264', 'forum/dianping/mountainpost')
|| checktplrefresh('./template/8264/forum/dianping/mountainpost.htm', './template/8264/common/footer_8264_new.htm', 1503209128, '2', './data/template/2_2_forum_dianping_mountainpost.tpl.php', './template/8264', 'forum/dianping/mountainpost')
|| checktplrefresh('./template/8264/forum/dianping/mountainpost.htm', './template/8264/common/header_common.htm', 1503209128, '2', './data/template/2_2_forum_dianping_mountainpost.tpl.php', './template/8264', 'forum/dianping/mountainpost')
|| checktplrefresh('./template/8264/forum/dianping/mountainpost.htm', './template/8264/common/index_ad_top.htm', 1503209128, '2', './data/template/2_2_forum_dianping_mountainpost.tpl.php', './template/8264', 'forum/dianping/mountainpost')
|| checktplrefresh('./template/8264/forum/dianping/mountainpost.htm', './template/8264/common/taobao_ad_alert.htm', 1503209128, '2', './data/template/2_2_forum_dianping_mountainpost.tpl.php', './template/8264', 'forum/dianping/mountainpost')
;?>
<!doctype html>
<html>
<head>
...
_showmsg('请填写<?php echo $modname;?>高度');
return false;
}
if (theform.lon.value == '') {
_showmsg('请填写<?php echo $modname;?>经度');
return false;
}
if (theform.lat.value == '') {
_showmsg('请填写<?php echo $modname;?>纬度');
return false;
}
if (theform.type.value == '') {
_showmsg('请填写<?php echo $modname;?>所在地址');
return false;
}
if (theform.season.value == '') {
_showmsg('请填写<?php echo $modname;?>攀登季节');
return false;
}
...
EOF;
?><?php $adveditor = $isfirstpost && $special || $special == 2 && ($_G['gp_action'] == 'newthread' || $_G['gp_action'] == 'reply' && !empty($_G['gp_addtrade']) || $_G['gp_action'] == 'edit' && $thread['special'] == 2); ?><?php $advmore = !$showthreadsorts && !$special || $_G['gp_action'] == 'reply' && empty($_G['gp_addtrade']) || $_G['gp_action'] == 'edit' && !$isfirstpost && ($thread['special'] == 2 && !$special || $thread['special'] != 2); ?><div id="wps">
<div class="layout mt50">
<div class="pubWeb">
<h1 class="tit20 mb45"><?php if(($action=='new')) { ?>发布<?php echo $modname;?><?php } else { ?>编辑<?php echo $modname;?><?php } ?></h1>
<div class="bd">
<form action="<?php if($action=='new') { ?>
...
<?php } ?>" onsubmit="return modform_validate(this);return false;" method="post" id="postform" autocomplete="off">
...
<label class="fs16"><?php if($editdata['subject']) { } else { ?>山峰名称<?php } ?></label><input type="text" class="inputText w270" name="subject" id="subject" value="<?php echo $editdata['subject'];?>"/>
</span>
...
<dd>
<span class="inputTipsText">
<label class="fs16"><?php if($editdata['height']) { } else { ?>高度<?php } ?></label><input type="text" class="inputText w270" value="<?php if($editdata['height']) { ?><?php echo $editdata['height'];?><?php } else { } ?>" name="height" id="height" />
</span>
<span class="icoRedStar">*</span>
</dd>
</dl>
...
<input type="hidden" name="gdqj" id="gdqj" value="" /><span class="js"><?php if(!$editdata['gdqj']) { ?>请选择<?php echo $modname;?>高度区间<?php } else { ?>已选择高度区间：<?php echo $gdqjlist[$editdata['gdqj']];?><?php } ?></span>
<div class="qy_down"><?php if(is_array($gdqjlist)) foreach($gdqjlist as $k => $v) { ?><a hid="<?php echo $k;?>" href="javascript:void(0);" class="province"><?php echo $v;?></a>
<?php } ?>
</div>
</div>
</span>
...
<dd>
<span class="inputTipsText">
<label class="fs16"><?php if($editdata['lon']) { } else { ?>经度,位数最好保留一到两位小数（例如：64.11）<?php } ?></label><input type="text" class="inputText w270" value="<?php if($editdata['lon']) { ?><?php echo $editdata['lon'];?><?php } else { } ?>"  name="lon" id="lon" />
</span>
<span class="icoRedStar">*</span>
</dd>
</dl>
...
<dd>
<span class="inputTipsText">
<label class="fs16"><?php if($editdata['lat']) { } else { ?>纬度,位数最好保留一到两位小数（例如：36.11）<?php } ?></label><input type="text" class="inputText w270" value="<?php if($editdata['lat']) { ?><?php echo $editdata['lat'];?><?php } else { } ?>"  name="lat" id="lat"/>
</span>
<span class="icoRedStar">*</span>
</dd>
</dl>
...
<input type="hidden" name="type" id="type" value="<?php echo $editdata['type'];?>" /><span class="js"><?php if(!$editdata['type']) { ?>所在地区<?php } else { ?>已选择所在地区：<?php echo $dqlist[$editdata['type']];?><?php } ?></span>
<div class="sc_down"><?php if(is_array($dqlist)) foreach($dqlist as $k => $v) { ?><a hid="<?php echo $k;?>" href="javascript:void(0);"><?php echo $v;?></a>
<?php } ?>
</div>
</div>
</span>
...
<dd>
<span class="inputTipsText">
<label class="fs16"><?php if($editdata['region']) { } else { ?>所在地址<?php } ?></label><input type="text" class="inputText w270" value="<?php echo $editdata['region'];?>" name="region" id="region"/>
</span>
<span class="icoRedStar">*</span>
</dd>
</dl>
...
<dd>
<span class="inputTipsText">
<label class="fs16"><?php if($editdata['season']) { } else { ?>攀登季节<?php } ?></label><input type="text" class="inputText w270" value="<?php echo $editdata['season'];?>" name="season" id="season"/>
</span>
<span class="icoRedStar">*</span>
</dd>
</dl>
...
<div class="inputTipsText"><?php $editor['value'] = $editdata['message']; ?><script src="<?php echo $_G['setting']['jspath'];?>forum_post.js?<?php echo VERHASH;?>" type="text/javascript"></script>
...
<script src="static/js/newswfobject.js" type="text/javascript"></script>
<script type="text/javascript">
var params = {site:"<?php echo $_G['siteroot'];?>misc.php%3fmod=swfupload%26type=image%26fid=392%26mtype=plugin%26twidth=60%26theight=60%26back=uploadpic%26random=<?php echo random(4); ?>",buttonimg:"<?php echo $_G['siteroot'];?>static/image/common/uploadnew.png"};
