<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_index', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/home/space_index.htm', './template/8264/common/header_8264_new.htm', 1509517868, '2', './data/template/2_2_home_space_index.tpl.php', './template/8264', 'home/space_index')
|| checktplrefresh('./template/8264/home/space_index.htm', './template/8264/home/space_header_uc.htm', 1509517868, '2', './data/template/2_2_home_space_index.tpl.php', './template/8264', 'home/space_index')
|| checktplrefresh('./template/8264/home/space_index.htm', './template/8264/home/space_footer_uc.htm', 1509517868, '2', './data/template/2_2_home_space_index.tpl.php', './template/8264', 'home/space_index')
|| checktplrefresh('./template/8264/home/space_index.htm', './template/8264/common/footer_8264_new.htm', 1509517868, '2', './data/template/2_2_home_space_index.tpl.php', './template/8264', 'home/space_index')
|| checktplrefresh('./template/8264/home/space_index.htm', './template/8264/common/header_common.htm', 1509517868, '2', './data/template/2_2_home_space_index.tpl.php', './template/8264', 'home/space_index')
|| checktplrefresh('./template/8264/home/space_index.htm', './template/8264/common/index_ad_top.htm', 1509517868, '2', './data/template/2_2_home_space_index.tpl.php', './template/8264', 'home/space_index')
|| checktplrefresh('./template/8264/home/space_index.htm', './template/8264/common/ewm_r.htm', 1509517868, '2', './data/template/2_2_home_space_index.tpl.php', './template/8264', 'home/space_index')
;
block_get('6905');?>
<!doctype html>
<html>
...
<div class="serc-wrap">
<a href="javascript:void(0);" class="atten-link"><?php if($groups[$gid]) { ?><?php echo $groups[$gid];?><?php } else { ?>全部关注<?php } ?><i class="icon-t icon-trai-f"></i></a>
</div>
<div class="atten-list-wrap">
<ul class="atten-list">
<li <?php if($gid == -1) { ?>class="active"<?php } ?>>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?><?php if($_G['adminid'] == 1) { ?>&amp;view=admin<?php } ?>">全部关注</a>
</li><?php if(is_array($groups)) foreach($groups as $k => $v) { ?><li <?php if($gid == $k) { ?>class="active"<?php } ?>>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=home&amp;ismy=1&amp;gid=<?php echo $k;?>"><?php echo $v;?></a>
</li>
<?php } ?>
</ul>
</div>
...
<!--动态头部 end-->
<div class="page-container-dync" <?php if(empty($list)) { ?>style="padding:0;"<?php } ?>>
<div class="list-area">
<!--列表-->
<?php if($list) { ?>
<ul><?php if(is_array($list)) foreach($list as $v) { ?><li class="dync-list-row">
<div class="dync-avatar">
<a href="home.php?mod=space&amp;uid=<?php echo $v['uid'];?>" target="_blank" class="avatar"><?php echo avatar($v[uid],small); ?></a>
<?php if($v['dateline']==0) { ?>
<span class="page-container-reded"><span class="reded-content"><a href="javascript:void(0);" class="focus-btn ajax_follow_me" uid="<?php echo $v['uid'];?>">关注</a></span></span>
<?php } ?>
</div>
<div class="dync-content">
<div class="hd">
<div class="dync-head">
<a href="home.php?mod=space&amp;uid=<?php echo $v['uid'];?>" class="c-tx5" title="<?php echo $v['username'];?>"><?php echo $v['username'];?></a>
<span><?php echo $v['subject'];?></span>
<span class="puplh-time"><?php if($v['dateline'] > 0) { echo date('Y-m-d', $v['dateline']); } else { ?>来自推荐关注<?php } ?></span>
</div>
</div>
<div class="bd">
<div class="dync-info">
<?php if($v['type'] == 4) { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $v['uid'];?>&amp;do=blog&amp;id=<?php echo $v['id'];?>" target="_blank"><?php echo $v['message']['title'];?></a>
<?php if($v['message']['content'] ) { ?><p><?php echo $v['message']['content'];?></p><?php } } elseif($v['type'] == 5) { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $v['uid'];?>&amp;do=album&amp;id=<?php echo $v['id'];?>" target="_blank"><?php echo $v['message']['albumname'];?></a>
<div class="dync-album-list"><?php if(is_array($v['message']['picture'])) foreach($v['message']['picture'] as $picid => $img_src) { ?><img src="<?php echo $img_src;?>" alt="" style="width:auto;height:auto;display:none;" class="realimg"/>
<a href="home.php?mod=space&amp;uid=<?php echo $v['uid'];?>&amp;do=album&amp;picid=<?php echo $picid;?>" target="_blank" class="hassrc" style="display:none;"><img src="<?php echo $img_src;?>" alt="" /></a>												
<a href="javascript:void(0);" class="img-src-null" style="display:none;"></a>
<?php } ?>
<span class="photo-stat">共<em><?php echo $v['message']['pic_count'];?></em>张</span>
</div>
<?php } elseif($v['type'] == 3) { ?>
<a href="dianping.php?mod=<?php echo $dpModList[$v['fid']]['mname'];?>&amp;act=showview&amp;tid=<?php echo $v['id'];?>" target="_blank"><?php echo $v['message']['subject'];?></a>
<div class="rating-level big-rating dync-rating">
<span class="score-value score-value-<?php echo intval($v['message']['starnum'])*2;; ?>">
<em></em>
</span>
<strong>(<?php echo $dp_star[$dpModList[$v['fid']]['mname']][$v['message']['starnum']];?>)</strong>
</div>
<?php } elseif($v['type'] == 1) { ?>	
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $v['id'];?>" target="_blank"><?php echo $v['message']['subject'];?></a>
<?php if($v['message']['message']) { ?><p><?php echo $v['message']['message'];?></p><?php } } elseif($v['type'] == 6 || $v['type'] == 7) { ?>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $v['id'];?>" target="_blank" class="dync-tit"><?php echo $v['message']['subject'];?></a><?php $v[message]['expiration'] = max($v[message]['expiration'], 0); ?><?php $activityclose = $v[message]['expiration'] ? ($v[message]['expiration'] > $_G[timestamp] ? 0 : 1) : 0; if(!$activityclose) { ?>
<p><a href="forum.php?mod=viewthread&amp;tid=<?php echo $v['id'];?>" target="_blank" class="part-in">我也要参加 >></a></p>
<?php } ?>											
<?php } ?>
</div>
</div>
...
<?php if($recommend_pages > 1) { ?>
<div class="scroll-dot-lists"><?php for($i=1; $i<=$recommend_pages; $i++) : ?><span <?php if($i==1) { ?>class="curr"<?php } ?> title="第<?php echo $i;?>页" id="recommend_page_<?php echo $i;?>"></span><?php endfor; ?></div>
<?php } ?>
</div>
<div class="reded-bd">
<ul class="reded-friend-list"><?php $recommend_user_seq = 1; if(is_array($recommend_list)) foreach($recommend_list as $user) { ?><li <?php if($recommend_user_seq>3) { ?>style="display:none;"<?php } ?>>
<div class="reded-avatar">
<a class="avatar" href="home.php?mod=space&amp;uid=<?php echo $user['uid'];?>" target="_blank"><?php echo avatar($user[uid],small); ?></a>
</div>
<div class="reded-content">
<a title="<?php echo $user['username'];?>" class="usr-name" href="home.php?mod=space&amp;uid=<?php echo $user['uid'];?>"><?php echo $user['username'];?></a>
<span class="t"><?php echo $groups_statistic[$user['uid']];?></span>
<span class="post-num">发帖：<?php echo $threads_statistic[$user['uid']];?></span>
<a href="javascript:void(0);" class="focus-btn ajax_follow_me" uid="<?php echo $user['uid'];?>">关注</a>
</div>
</li><?php $recommend_user_seq++; } ?>
</ul>
</div>
</div>
<?php } ?>
...
<!--分页-->
<?php if($multi) { ?><div class="cust-page-list"><?php echo $multi;?></div><?php } ?>					
<!--分页 end-->	
</div>
<?php } else { ?>
<div class="col-main">
...
<?php if(!empty($list)) { ?>	
<div class="dync-tit-bar">
<span class="static-tit"><?php echo $space['username'];?>的动态</span>
</div>
<div class="page-container-dynci">
<!--列表-->			
<div class="list-area">
<ul><?php if(is_array($list)) foreach($list as $k => $v) { ?><?php $v[message][subject] 	= $v[message][subject] ? cutstr($v[message][subject], 64, '...') : '';
$v[message][title]   	= $v[message][title] ? cutstr($v[message][title], 64, '...') : '';
$v[message][albumname]  = $v[message][albumname] ? cutstr($v[message][albumname], 64, '...') : ''; if($v['typeen'] == 'post') { ?>				
<li class="dync-list-row">
<div class="dynci-content">
<div class="hd">
<div class="dync-head">
<span class="c-label c-bx2">帖子</span>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $v['tid'];?>" class="c-tx" title="<?php echo $v['subject'];?>" target="_blank"><?php echo $v['message']['subject'];?></a>
<span class="post-cate" title="<?php echo $forums[$v['fid']]['name'];?>"><?php echo $forums[$v['fid']]['name'];?></span>
<?php if($v['stamp'] == 0 && $v['rate'] > 0) { ?><span class="icon-m icon-coin-m" title="加币"></span><?php } ?>
</div>
</div>
<div class="bd">
<div class="dync-info" <?php if($v['message']['message']) { ?>style="margin-top:10px;"<?php } ?>>
<?php if($v['message']['message']) { ?>
<p <?php if($v['message']['imgList']) { ?>style="line-height:1.8;margin-bottom:5px;"<?php } ?>><?php echo $v['message']['message'];?></p>
<?php } ?>				
<?php if($v['message']['imgList']) { if(is_array($v['message']['imgList'])) foreach($v['message']['imgList'] as $src) { ?><img src="<?php echo $src;?>" alt="" style="width:auto;height:auto;display:none;">
<?php } } ?>
</div>
</div>
<div class="ft dyi-ft">
<span class="puplh-time"><?php echo date('Y-m-d', $v['dateline']); ?></span>
</div>
</div>
</li>
<?php } elseif($v['typeen'] == 'dianping') { ?>
<li class="dync-list-row">
<div class="dynci-content">
<div class="hd">
<div class="dync-head">
<span class="c-label c-bx3">点评</span>								
<a href="<?php echo $_G['config']['web']['portal'];?><?php echo $dpModList[$v['fid']]['uname'];?><?php if($dpModList[$v['fid']]['mname'] == 'climb' || $dpModList[$v['fid']]['mname'] == 'diving' || $dpModList[$v['fid']]['mname'] == 'fishing') { ?>/<?php echo $v['tid'];?>.html<?php } elseif($dpModList[$v['fid']]['mname'] == 'equipment') { ?>-<?php echo $v['tid'];?>-1.html<?php } else { ?>-<?php echo $v['tid'];?><?php } ?>" class="c-tx7 f-sz" title="<?php echo $v['message']['subject'];?>" target="_blank">
<span class="c-tx8 s-mr8">点评</span><?php echo $v['message']['subject'];?>
</a>
<div class="rating-level small-rating dync-rating" style="width:140px;display:block;float:left;margin-left:10px;margin-top:0;">
<span class="score-value score-value-<?php echo intval($v['message']['starnum'])*2;; ?>">
<em></em>
</span>
<strong>(<?php echo $dpModList[$v['fid']]['star'][$v['message']['starnum']];?>)</strong>
</div>
<?php if($v['rate']) { ?><span class="icon-m icon-coin-m" title="8264币"></span><?php } ?>
</div>
</div><?php unset($v[message][starnum], $v[message][imagelist], $v[message][subject], $v[message][albumname], $v[message][title], $v[message][message]); ?><div class="bd">
<div class="dync-info">
<div class="details-review-info showheight" style="height:90px;overflow:hidden;"><?php if(is_array($v['message'])) foreach($v['message'] as $key => $val) { ?><p><b><?php echo $key;?>：</b><?php echo $val;?></p>
<?php } ?>
...
<!--计算高度所用-->
<div class="txt-details-info realheight" style="display:none;"><?php if(is_array($v['message'])) foreach($v['message'] as $key => $val) { ?><p><b><?php echo $key;?>：</b><?php echo $val;?></p>
<?php } ?>
</div>
<!--计算高度所用 end-->
</div>
...
<?php } elseif($v['typeen'] == 'blog') { ?>
<li class="dync-list-row">
<div class="dynci-content">
<div class="hd">
<div class="dync-head">
<span class="c-label c-bx5">日志</span>
<a href="home.php?mod=space&amp;uid=<?php echo $v['uid'];?>&amp;do=blog&amp;id=<?php echo $v['id'];?>" class="c-tx" title="<?php echo $v['message']['title'];?>" target="_blank"><?php echo $v['message']['title'];?></a>
<?php if($v['message']['pic']) { ?><span class="icon-m icon-img-m" title="日志中包含图片"></span><?php } ?>								
</div>
</div>
<div class="bd">
<div class="dync-info">
<?php if($v['message']['content'] ) { ?><p><?php echo $v['message']['content'];?></p><?php } ?>
</div>
</div>
<div class="ft dyi-ft">
<span class="puplh-time"><?php echo date('Y-m-d', $v['dateline']); ?></span>
...
<?php } elseif($v['typeen'] == 'album') { ?>
<li class="dync-list-row">
<div class="dynci-content">
<div class="hd">
<div class="dync-head">
<span class="c-label c-bx1">相册</span>
<a href="home.php?mod=space&amp;uid=<?php echo $v['uid'];?>&amp;do=album&amp;id=<?php echo $v['id'];?>" class="c-tx" title="<?php echo $v['message']['albumname'];?>" target="_blank"><?php echo $v['message']['albumname'];?></a>
</div>
</div>
<div class="bd">
<div class="dync-info">
...
<?php } elseif($v['typeen'] == 'activity') { ?>							
<li class="dync-list-row">
<div class="dynci-content">
<div class="hd">
<div class="dync-head">
<span class="c-label c-bx4">活动</span>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $v['id'];?>" class="c-tx" title="<?php echo $v['message']['subject'];?>" target="_blank"><span class="c-tx8 s-mr8"><?php if($v['type'] == 6) { ?>发布<?php } else { ?>参与<?php } ?></span><?php echo $v['message']['subject'];?></a><?php $v[message]['expiration'] = max($v[message]['expiration'], 0); ?><?php $activityclose = $v[message]['expiration'] ? ($v[message]['expiration'] > $_G[timestamp] ? 0 : 1) : 0; if(!$activityclose) { ?>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $v['id'];?>" class="part-in" target="_blank">我也要参加 >></a>
<?php } ?>
</div>
</div>
<div class="bd">
<div class="dync-info"><?php $starttimefrom = date('Y-m-d', $v[message][starttimefrom]); if($v['message']['place']) { ?><p>活动地点：<?php echo $v['message']['place'];?></p><?php } if($v['message']['starttimefrom']) { ?><p>活动时间：<?php if($v['message']['starttimeto']) { ?><?php echo $starttimefrom;?> 至 <?php echo date('Y-m-d', $v[message][starttimeto]) ?> 商定<?php } else { ?><?php echo $starttimefrom;?><?php } ?></p><?php } ?>
</div>
</div>
<div class="ft dyi-ft">
<span class="puplh-time"><?php echo date('Y-m-d', $v['dateline']); ?></span>
...
<ul>
<li class="name-box">
<span><?php echo $space['username'];?></span>
<span class="n-id">ID <?php echo $space['uid'];?></span>
</li>
<li class="other-box">
...
<span class="t"><?php echo $space['views'];?></span>
</div>
</li>
<li class="other-box">
<div class="ic-info-left">
...
<div class="ic-info-main">
<a href="forum.php?mod=viewthread&amp;tid=669908" class="t a" target="_blank"><?php echo $space['group']['grouptitle'];?></a>
</div>
</li>
<li class="other-box">
<div class="ic-info-left">
...
<div class="ic-info-main">
<a href="home.php?mod=spacecp&amp;ac=credit&amp;uid=<?php echo $space['uid'];?>&amp;op=base" class="t a"><?php echo $space['credits'];?></a>
</div>
</li>
<li class="other-box">
<div class="ic-info-left">
...
<div class="ic-info-main">
<a href="home.php?mod=spacecp&amp;ac=credit&amp;uid=<?php echo $space['uid'];?>&amp;op=base" class="t a"><?php echo $space['extcredits2'];?></a>
</div>
</li>
<li class="other-box">
<div class="ic-info-left">
...
<div class="ic-info-main">
<a href="home.php?mod=spacecp&amp;ac=credit&amp;uid=<?php echo $space['uid'];?>&amp;op=base" class="t a" target="_blank"><?php echo $space['extcredits5'];?></a>
</div>
</li>
<!--<li class="other-box">
<div class="ic-info-left">
...
<div class="ic-info-main">
<span class="t"><?php if($profiles['residecity']['value']) { ?><?php echo $profiles['residecity']['value'];?><?php } else { ?>未填写<?php } ?></span>
</div>
</li>
<li class="other-box">
<div class="ic-info-left">
...
<div class="ic-info-main">
<span class="t"><?php if($space['medals']['0']) { ?><?php echo $space['medals']['0']['name'];?><?php } else { ?>目前没有<?php } ?></span>								
</div>
</li>-->
</ul>
<?php if($space['self']) { ?>
<a href="<?php echo $_G['config']['web']['home'];?>home-setting.html" class="read-more">完善资料</a>
<?php } ?>
</div>
</div>
<!--个人资料 end-->
<div style=" margin-top:15px;"><?php echo adshow("custom_436"); ?> 
</div>
<style type="text/css">
.qr-code{
...
<?php } ?>
<script src="http://static.8264.com/static/js/home_dianping.js?<?php echo VERHASH;?>" type="text/javascript"></script>	
</div>	
<!--content end-->
</div>
