<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('mountain_showview', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/dianping/header.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/dianping/nav.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/common/zhidemai.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/dianping/showview_content.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/dianping/showview_credit.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/dianping/mountain_mycomment.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/dianping/mountain_comment.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/dianping/replyedit_pic_upload.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/dianping/reply_pic_upload.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/common/hd_ad.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/dianping/footer.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/common/header_8264_new.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/common/ewm_r.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/common/weixin_share.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/common/footer_8264_new.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/common/header_common.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
|| checktplrefresh('./template/8264/dianping/mountain_showview.htm', './template/8264/common/index_ad_top.htm', 1509517953, '2', './data/template/2_2_dianping_mountain_showview.tpl.php', './template/8264', 'dianping/mountain_showview')
;
block_get('7029,6991');?>
<!doctype html>
<html>
...
<style>
.rows-content{padding-left: 92px;}
.timeText {
...
<ul class="review-pic-box"><?php if(is_array($piclist)) foreach($piclist as $k => $pic) { ?><li>
...
<ul class="review-booth-tbumb"><?php if(is_array($piclist)) foreach($piclist as $k => $pic) { ?><li class="<?php if($k==0) { ?>pic-selected<?php } else { ?>pic-item<?php } ?>">
<div class="pic-item">
...
<div title="非常困难" class="rm-rechart-line">
...
<div class="rm-rechart-val"><?php echo $detail['percent5'];?>% (非常困难)</div>
</div>
<div title="困难" class="rm-rechart-line">
<div class="rating-level small-rating rm-rating">
...
<div class="rm-rechart-val"><?php echo $detail['percent4'];?>% (困难)</div>
</div>
<div title="难" class="rm-rechart-line">
<div class="rating-level small-rating rm-rating">
...
<div class="rm-rechart-val"><?php echo $detail['percent3'];?>% (难)</div>
</div>
<div title="简单" class="rm-rechart-line">
<div class="rating-level small-rating rm-rating">
...
<div class="rm-rechart-val"><?php echo $detail['percent2'];?>% (简单)</div>
</div>
<div title="非常简单" class="rm-rechart-line">
<div class="rating-level small-rating rm-rating">
...
<div class="rm-rechart-val"><?php echo $detail['percent1'];?>% (非常简单)</div>
</div>
</div>
<div class="review-item-detail">
<span class="detail-item longitude">
<i class="ui-icon"></i>经度：<?php echo $detail['lon'];?>
</span>
<span class="detail-item latitude">
<i class="ui-icon"></i>纬度：<?php echo $detail['lat'];?>
</span>
<span class="detail-item altitude">
<i class="ui-icon"></i>高度：<?php echo $detail['height'];?>
</span>
<span class="detail-item season">
<i class="ui-icon"></i>攀登季节：<?php echo $detail['season'];?></span>
<span class="detail-item address">
<i class="ui-icon"></i>所在地址：<?php echo $detail['region'];?>
</span>
</div>
</div>
</div>
...
<!-- comment list -->
<?php if(!$commentlist) { ?>
<div style="margin:16px 0px 30px 0px; display:none"><img src="http://static.8264.com/dianping/images/demo/pdyb.jpg"></div>
<?php } if($commentlist) { ?>
...
<!-- comment edit --><a id="write"></a>
<div class="write-comment-box">
<div class="ui-block ui-block-title">
<div class="ui-title ui-title-line">
<h3>修改点评</h3><span class="note">注：转山线路不在山峰点评范围之内，山峰点评仅针对攀登进行点评</span>
...
<li><a class="one-star" id="star_1_e" value='1' href="javascript:void(0);" title="非常简单">100</a></li>
<li><a class="two-stars" id="star_2_e" value='2' href="javascript:void(0);" title="简单">200</a></li>
<li><a class="three-stars" id="star_3_e" value='3'  href="javascript:void(0);" title="难">300</a></li>
<li><a class="four-stars" id="star_4_e" value='4' href="javascript:void(0);" title="困难">400</a></li>
<li><a class="five-stars" id="star_5_e" value='5' href="javascript:void(0);" title="非常困难">500</a></li>
</ul>
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="ext4" id="ext4_e" cols="30" rows="2" placeholder="提醒他人需要注意的关键事项，如露营点、水源点、岔路口等"></textarea>
<div id="ext4_eTip" class="valid-tips-container"></div>
</div>
</div>
</div>
<div class="rows-content row-color-5">
...
<div class="ui-block ui-block-title">
<div class="ui-title ui-title-line">
<h3>写点评</h3><span class="note">注：转山线路不在山峰点评范围之内，山峰点评仅针对攀登进行点评</span>
</div>
</div>
...
<div class="star-rating-box">
<ul class="star-rating-level stars1">
<li><a class="one-star" id="star_1" value='1' href="javascript:void(0);" title="非常简单">100</a></li>
<li><a class="two-stars" id="star_2" value='2' href="javascript:void(0);" title="简单">200</a></li>
<li><a class="three-stars" id="star_3" value='3'  href="javascript:void(0);" title="难">300</a></li>
<li><a class="four-stars" id="star_4" value='4' href="javascript:void(0);" title="困难">400</a></li>
<li><a class="five-stars" id="star_5" value='5' href="javascript:void(0);" title="非常困难">500</a></li>
</ul>
<span class="result stars1-tips"  style=""></span>
<div class="clearfix"></div>
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="ext4" id="ext4" cols="30" rows="2" placeholder="提醒他人需要注意的关键事项，如露营点、水源点、岔路口等"></textarea>
<div id="ext4Tip" class="valid-tips-container"></div>
</div>
</div>
</div>
<div class="rows-content row-color-5">
...
<div class="ui-title ui-title-line">
<h3>热门</h3>
<div class="ui-title-link"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;dq=0&amp;gd=0&amp;page=1" target="_brank">more</a></div>
</div>
</div>
<div class="ui-block ui-block-content">
<div class="common-list-box hot-list-box">
<ul class="hot-list"><?php if(is_array($sidebar_hot)) foreach($sidebar_hot as $k => $item) { ?><li>
...
<span class="comm-num"><i class="ui-icon icon-comm"></i><?php echo $item['cnum'];?>人参加评论</span>
<span class="fire <?php if($k==0) { ?>orange<?php } elseif($k==1 || $k==2) { ?>blue<?php } ?>"></span>
</div>
</li>
<?php } ?>
</ul>
...
<div class="ui-title ui-title-line">
<h3>周边山峰</h3>
<div class="ui-title-link"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;dq=<?php echo $detail['type'];?>&amp;gd=0&amp;page=1" target="_brank">more</a></div>
</div>
</div>
<div class="ui-block ui-block-content">
<div class="common-list-box hot-list-box">
<ul class="hot-list"><?php if(is_array($sidebar_type)) foreach($sidebar_type as $k => $item) { ?><li>
<div class="imgbox"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" target="_blank"><img src="<?php echo getimagethumb(60,60,2, $item['dir'].'/'.$item['showimg'], 0, $item['serverid']); ?>" alt=""></a></div>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="<?php echo $item['subject'];?>" target="_blank"<?php if($k==0) { ?> class="orange"<?php } elseif($k==1 || $k==2) { ?> class="blue"<?php } ?>><?php echo $item['subject'];?></a></h3>
<div class="rating-level small-rating hot-rating">
...
<div class="choiceness">
        <?php block_display('7029'); ?></div>
</div>
<div class="friendLink"><?php block_display('6991'); ?></div>
<script>
(function($){
$(function(){
//添加点评
...
var begindate = getNumberTime($("#postform input[name='datapicker[]']").eq(0).val());
var enddate = getNumberTime($("#postform input[name='datapicker[]']").eq(1).val());
var startHour = $("#postform input[name='datapicker[]']").eq(2).val();
var endHour   = $("#postform input[name='datapicker[]']").eq(3).val();
var ext3 = $.trim($("#postform #ext3").val());
var ext4 = $.trim($("#postform #ext4").val());
...
if(ext3.length<10 || ext4.length <10 || message.length <50 || starnum == 0){
return false;
}
<?php if(checkperm('seccode') && ($secqaacheck || $seccodecheck)) { ?>
...
var postUrll='http://www.8264.com/dianping.php?mod=misc&act=dopost&model=mountain&do=newsave&tid=<?php echo $detail['tid'];?>';
var stararray=['非常简单','简单','难','困难','非常困难'];
$.post(postUrll,{starnum:starnum,ext1:begindate,ext2:enddate,startHour:startHour,endHour:endHour,ext3:ext3,ext4:ext4,message:message,formhash:'<?php echo FORMHASH;?>',replypostsubmit:'yes',imgselect:imgselect},
function(data){
if(data == '-1'){
alert('你需要登陆后才能评价');
...
var begindate = getNumberTime($("#editform input[name='datapicker[]']").eq(0).val());
var enddate = getNumberTime($("#editform input[name='datapicker[]']").eq(1).val());
var startHour = $("#editform input[name='datapicker[]']").eq(2).val();
var endHour   = $("#editform input[name='datapicker[]']").eq(3).val();
var ext3 = $.trim($("#editform #ext3_e").val());
var ext4 = $.trim($("#editform #ext4_e").val());
...
$("#postform #starnumTip").show();
    			 ...
    			 if(!checkText(begindate, enddate, startHour, endHour, '', '', '', 'show_errors')){
         			return false;
         		}
if(ext3.length<10 || ext4.length <10 || message.length <50 || starnum == 0){
return false;
...
var postUrll='http://www.8264.com/dianping.php?mod=misc&act=dopost&model=mountain&do=editsave&tid=<?php echo $detail['tid'];?>';
var stararray=['非常简单','简单','难','困难','非常困难'];
$.post(postUrll,{pid:pid,starnum:starnum,ext1:begindate,ext2:enddate,startHour:startHour,endHour:endHour,ext3:ext3,ext4:ext4,message:message,formhash:'<?php echo FORMHASH;?>',replypostsubmit:'yes',imgselect:imgselect},
function(data){
if(data == '-2'){
alert('修改失败');
$('#overlay').remove();
...
$("#editform .timeHour").show();
$("#editform input[name='datapicker[]']").eq(2).val(data['startHour']);
$("#editform input[name='datapicker[]']").eq(3).val(data['endHour']);
}else{
...
onShow: '',
onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写综合总结。</span></div>',
onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
defaultValue: ""
}).inputValidator({
empty: false,
min: 50,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写综合总结，不少于50字</span></div>'
});
//我的建议
$('#ext4').formValidator({
onShow: '',
onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写您对未来攀登此山峰的攀登者的建议和经验</span></div>',
onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
defaultValue: ""
}).inputValidator({
empty: false,
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写您对未来攀登此山峰的攀登者的建议和经验，不能少于10个字符</span></div>'
});
//费用协作
$('#ext3').formValidator({
onShow: '',
onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请准确填写此次攀登所用费及商业队情况</span></div>',
onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
defaultValue: ""
}).inputValidator({
empty: false,
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请准确填写此次攀登所用费及商业队情况，不能少于10个字符</span></div>'
});
