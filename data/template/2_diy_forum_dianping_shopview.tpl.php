...
eval(fun+'("请认真填写对<?php echo $modname;?>的综合评价，不能少于10个字符，多余400字符")');
return false;
}
return true;
}
...
<div class="lunbo">
<div class="lunbobig">
<ul id="lunbobig"><?php $_ii = 0; if(is_array($piclist)) foreach($piclist as $pic) { ?><li <?php if($_ii > 0) { ?>style="display:none;"<?php } ?>><a title="点击查看原图" target="_blank" href="<?php echo $pic['url'];?><?php echo $pic['attachment'];?>"><img src="<?php echo getimagethumb(406,244,2,'plugin/'.$pic['attachment'], $pic['aid'], $pic['serverid']); ?>" /></a></li><?php $_ii++; } ?>
</ul>
</div>
...
<p><b>电话：</b><?php echo $region['areacode'];?> - <?php echo $viewdata['link'];?></p>
<?php } if($sbrand['brand']) { ?>
                	<p><b>专营品牌：</b><?php echo $sbrand['brand'];?></p>
<?php } ?>
                <p>
                	<b>分类：</b>
...
<!--		                		<?php echo $cbrand['chainbrand'];?>连锁-->
                	<?php } else { ?>
                	<?php } ?>
</p>
                <!--<a class="liul">浏览&nbsp;<?php echo $viewdata['views'];?>人</a>--><a class="dianp">点评&nbsp;<?php echo $viewdata['replies'];?>人</a>
</div>
<div class="clear"></div>
</div>
...
<span class="text"></span>
                        ...
                        <div class="peoples">
                            (<span class="num"><?php echo $star_data['count'];?></span>人评分)
                        </div>
                     <div class="star_list">
...
<h2 class="h2Tit">我的点评&nbsp;&nbsp;&nbsp;<span style="color: #43A6E1; font-size: small;">假如您的点评没有奖励8264币，请联系工作人员QQ1919501975询问原因</span></h2>
<dl class="cmtDl">
...
<span class="ans" id="editBtn_<?php echo $my_comment['pid'];?>"><a href="javascript:;" style="color: #666;">修改</a></span>
...
<?php if($replylist) { ?>
                            <h2 class="h2Tit"><?php echo $viewdata['subject'];?>的点评</h2><?php if(is_array($replylist)) foreach($replylist as $comment) { ?><dl class="cmtDl">
...
<span class="usrName"><a href="home.php?mod=space&amp;uid=<?php echo $comment['authorid'];?>" target="_blank" rel="nofollow" class="usrName"><?php echo $comment['author'];?></a></span>
                                            <span style="color:#A8A8A8;float: left">点评了<a href="forum.php?ctl=shop&amp;act=showview&amp;tid=<?php echo $viewdata['tid'];?>" style="color:#A8A8A8;" title="<?php echo $viewdata['subject'];?>"><?php echo $viewdata['subject'];?></a>，</span>
...
<span class="ans" id="editBtn_<?php echo $comment['pid'];?>"><a href="javascript:;" style="color: #666;">修改</a></span>
...
'pro' => $province['name']
            ...
            <div class="mian_rightbox yuanjiao">
            	<div class="mian_tit">
                        <p><?php echo $viewdata['subject'];?>附近的店铺</p>
             	</div>
...
<?php } ?>
                                ...
                                <div style=" float:right"><span><?php echo $fj['replies'];?></span>人点评</div>
                            <div class="clear"></div>
                        </div>
                    </div>
                    <?php } ?>
...
<?php } } if($qt) { ?>
            <div class="mian_rightbox yuanjiao">
            	<div class="mian_tit">
<?php if($market) { ?>
            		<p><?php echo $market['market'];?>其他户外店</p>
<?php } ?>
             	</div>
...
<?php if($province&&$cbrand) { ?>
            		<p><?php echo $province['name'];?>其他<span><?php echo $cbrand['chainbrand'];?></span></p>
<?php } ?>
             	</div>
...
<li><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $_G['fid'];?>" class="bbsli" title="返回店铺首页"></a></li>
