<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('activepass', 'common/header');
0
|| checktplrefresh('./template/default/forum/activepass.htm', './template/default/common/simplesearchform.htm', 1509345515, '2', './data/template/2_2_forum_activepass.tpl.php', './template/8264', 'forum/activepass')
...
<div class="f_c">
<h3 class="flb">
<em id="return_<?php echo $_G['gp_handlekey'];?>"><?php if(($_GET['action']=='activenopass')) { ?>暂未<?php } elseif(($_GET['action']=='activepass')) { ?>已<?php } ?>通过人员列表</em>
<span>
...
<?php if(!empty($log['appusername']) && $log['uid'] == 40269021) { ?>
<td><a href="javascript:void(0);"><?php echo $log['appusername'];?></a></td>
<?php } elseif((!empty($log['wechatusername'])) && $log['uid'] == 40269021 ) { ?>
<td><a href="javascript:void(0);"><?php echo $log['wechatusername'];?></a></td>
<?php } else { ?>
