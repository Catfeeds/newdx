<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_wall', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/home/space_wall.htm', './template/8264/common/header_8264_new.htm', 1509432306, '2', './data/template/2_2_home_space_wall.tpl.php', './template/8264', 'home/space_wall')
|| checktplrefresh('./template/8264/home/space_wall.htm', './template/8264/home/space_header_uc.htm', 1509432306, '2', './data/template/2_2_home_space_wall.tpl.php', './template/8264', 'home/space_wall')
|| checktplrefresh('./template/8264/home/space_wall.htm', './template/8264/home/space_footer_uc.htm', 1509432306, '2', './data/template/2_2_home_space_wall.tpl.php', './template/8264', 'home/space_wall')
|| checktplrefresh('./template/8264/home/space_wall.htm', './template/8264/common/footer_8264_new.htm', 1509432306, '2', './data/template/2_2_home_space_wall.tpl.php', './template/8264', 'home/space_wall')
|| checktplrefresh('./template/8264/home/space_wall.htm', './template/8264/common/header_common.htm', 1509432306, '2', './data/template/2_2_home_space_wall.tpl.php', './template/8264', 'home/space_wall')
|| checktplrefresh('./template/8264/home/space_wall.htm', './template/8264/common/index_ad_top.htm', 1509432306, '2', './data/template/2_2_home_space_wall.tpl.php', './template/8264', 'home/space_wall')
|| checktplrefresh('./template/8264/home/space_wall.htm', './template/8264/common/ewm_r.htm', 1509432306, '2', './data/template/2_2_home_space_wall.tpl.php', './template/8264', 'home/space_wall')
;
block_get('6905');?>
<?php $_G['home_tpl_titles'] = array('留言板'); ?><!doctype html>
<html>
<head>
...
<p>
<span id="comment_face" title="插入表情" onclick="showFace(this.id, 'comment_message');return false;" style="cursor: pointer;"><img src="<?php echo IMGDIR;?>/facelist.gif" alt="facelist" class="vm" /></span>
...
<a id="a_magic_doodle" href="home.php?mod=magic&amp;mid=doodle&amp;showid=comment_doodle&amp;target=comment_message" onclick="showWindow(this.id, this.href, 'get', '0')"><img src="http://static.8264.com/static/image/magic/doodle.small.gif" alt="doodle" class="vm" /><?php echo $_G['setting']['magics']['doodle'];?></a>
<?php } ?>
</p>
...
<?php } else { ?>
<div class="pt hm">你需要登录后才可以留言 <a href="member.php?mod=logging&amp;action=login" onclick="showWindow('login', this.href)" class="xi2">登录</a> | <a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" onclick="showWindow('register', this.href)" class="xi2"><?php echo $_G['setting']['reglinkname'];?></a></div>
<?php } ?>
</div>
</div>
<p>
...
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
                ...
                <hr class="da mtm m0" />
                <div class="comment-list-container" id="comment">
<div class="blog-comment">			
<span id="comment_wall" style="display:none;"></span>
<ul id="comment_ul">
