<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('climb_showlist', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/climb_showlist.htm', './template/8264/dianping/header.htm', 1509517977, '2', './data/template/2_2_dianping_climb_showlist.tpl.php', './template/8264', 'dianping/climb_showlist')
|| checktplrefresh('./template/8264/dianping/climb_showlist.htm', './template/8264/dianping/nav.htm', 1509517977, '2', './data/template/2_2_dianping_climb_showlist.tpl.php', './template/8264', 'dianping/climb_showlist')
|| checktplrefresh('./template/8264/dianping/climb_showlist.htm', './template/8264/common/zhidemai.htm', 1509517977, '2', './data/template/2_2_dianping_climb_showlist.tpl.php', './template/8264', 'dianping/climb_showlist')
|| checktplrefresh('./template/8264/dianping/climb_showlist.htm', './template/8264/dianping/sidebar_comment_rate.htm', 1509517977, '2', './data/template/2_2_dianping_climb_showlist.tpl.php', './template/8264', 'dianping/climb_showlist')
|| checktplrefresh('./template/8264/dianping/climb_showlist.htm', './template/8264/dianping/sidebar_contactus.htm', 1509517977, '2', './data/template/2_2_dianping_climb_showlist.tpl.php', './template/8264', 'dianping/climb_showlist')
|| checktplrefresh('./template/8264/dianping/climb_showlist.htm', './template/8264/dianping/footer.htm', 1509517977, '2', './data/template/2_2_dianping_climb_showlist.tpl.php', './template/8264', 'dianping/climb_showlist')
|| checktplrefresh('./template/8264/dianping/climb_showlist.htm', './template/8264/common/header_8264_new.htm', 1509517977, '2', './data/template/2_2_dianping_climb_showlist.tpl.php', './template/8264', 'dianping/climb_showlist')
|| checktplrefresh('./template/8264/dianping/climb_showlist.htm', './template/8264/common/ewm_r.htm', 1509517977, '2', './data/template/2_2_dianping_climb_showlist.tpl.php', './template/8264', 'dianping/climb_showlist')
|| checktplrefresh('./template/8264/dianping/climb_showlist.htm', './template/8264/common/weixin_share.htm', 1509517977, '2', './data/template/2_2_dianping_climb_showlist.tpl.php', './template/8264', 'dianping/climb_showlist')
|| checktplrefresh('./template/8264/dianping/climb_showlist.htm', './template/8264/common/footer_8264_new.htm', 1509517977, '2', './data/template/2_2_dianping_climb_showlist.tpl.php', './template/8264', 'dianping/climb_showlist')
|| checktplrefresh('./template/8264/dianping/climb_showlist.htm', './template/8264/common/header_common.htm', 1509517977, '2', './data/template/2_2_dianping_climb_showlist.tpl.php', './template/8264', 'dianping/climb_showlist')
|| checktplrefresh('./template/8264/dianping/climb_showlist.htm', './template/8264/common/index_ad_top.htm', 1509517977, '2', './data/template/2_2_dianping_climb_showlist.tpl.php', './template/8264', 'dianping/climb_showlist')
;
block_get('7030');?>
<!doctype html>
<html>
...
jQuery(function($){
    $('.countdown').each(function(i, v) {
      ...
      <?php } ?>
      <!-- //值得买 -->
      <div class="ui-grid-12 ui-grid-full" style="margin-top:20px;display: none;"><?php $bottom_ads = array('416', '409', '417'); $bottom_ad = rand(0, 2); $bottom_ad_id = $bottom_ads[$bottom_ad]; ?><?php echo adshow("custom_$bottom_ad_id"); ?></div>
...
<div class="nav-name blue">攀爬类型</div>
<div class="nav-list-wartpen">
<div class="nav-list-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=0&amp;placetype=<?php echo $placetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"
<?php if($type == 0) { ?> class="blue"<?php } ?>>全部</a><?php if(is_array($cate_type)) foreach($cate_type as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $k;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"<?php if($type == $k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
<?php } ?>
</div>
...
<div class="nav-sift-one">
<div class="nav-name orange">场地类型</div>
<div class="nav-list-wartpen">
<div class="nav-list-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;placetype=0&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"
<?php if($placetype == 0) { ?> class="blue"<?php } ?>>全部</a><?php if(is_array($cate_placetype)) foreach($cate_placetype as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $k;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"<?php if($placetype == $k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
<?php } ?>
</div>
<div class="nav-list-more"></div>
</div>
...
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=0&amp;cityid=0&amp;page=1"
<?php if($provinceid == 0) { ?> class = "blue"<?php } ?>>全部</a><?php if(is_array($proList)) foreach($proList as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=<?php echo $k;?>&amp;cityid=0&amp;page=1"
   value="<?php echo $k;?>"
   class="province <?php if($provinceid == $k) { ?> blue<?php } ?>"><?php echo $v['cityname'];?></a>
<?php } ?>
</div>
<span class="tc_dq clboth" style="z-index:10000;width:450px;"><?php if(is_array($cityList)) foreach($cityList as $key => $value) { ?><span id='province_<?php echo $key;?>' class='div_city'><?php if(is_array($value)) foreach($value as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=<?php echo $key;?>&amp;cityid=<?php echo $k;?>&amp;page=1"
...
<div class="nav-list-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=0&amp;cityid=0&amp;page=1"
<?php if($provinceid == 0) { ?> class = "blue"<?php } ?>>全部</a><?php if(is_array($proList)) foreach($proList as $k => $val) { ?><a id="cbtn_<?php echo $k;?>" href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=<?php echo $k;?>&amp;cityid=0&amp;page=1"
   value="<?php echo $k;?>"
...
<ul><?php if(is_array($cityList)) foreach($cityList as $key => $value) { if($key ==  $k) { if(is_array($value)) foreach($value as $kc => $v) { ?><li>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=<?php echo $key;?>&amp;cityid=<?php echo $kc;?>&amp;page=1"
   class="city <?php if($cityid == $kc) { ?> blue<?php } ?>"><?php echo $v['cityname'];?></a>
</li>
<?php } ?><?php continue; } } ?>
</ul>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=<?php echo $k;?>&amp;cityid=0&amp;page=1" class="link-add-more">全部<?php echo $val['cityname'];?>分类</a>
</div>
<?php } ?>
</div>
</div>
...
<?php if($type==0 && $placetype==0 && $provinceid==0 ) { ?> <h3><span>所有攀爬</span></h3><?php } ?>
</div>
<div class="sift-left">
<div class="condition-box">
<h1>
<?php if($type) { ?><a
href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=0&amp;placetype=<?php echo $placetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"
class="condition"><?php echo $cate_type[$type];?><i></i></a><?php } if($placetype) { ?><a
href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;placetype=0&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"
class="condition"><?php echo $cate_placetype[$placetype];?><i></i></a><?php } if($provinceid) { ?><a
href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=0&amp;cityid=0&amp;page=1"
class="condition"><?php echo $proList[$provinceid]['cityname'];?><i></i></a><?php } if($provinceid && $cityid) { ?><a
href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=0&amp;page=1"
...
<div class="sift-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"<?php if($order=='lastpost') { ?> class="hover"<?php } ?>><i></i>默认</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"<?php if($order=='heats') { ?> class="hover"<?php } ?>><i></i>热度</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=score&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"<?php if($order=='score') { ?> class="hover"<?php } ?>><i></i>评分</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=dateline&amp;type=<?php echo $type;?>&amp;placetype=<?php echo $placetype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"<?php if($order=='dateline') { ?> class="hover"<?php } ?>><i></i>最新</a>
</div>
</div>
<!-- //排序筛选 -->
</div>
...
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>"
 ...
 <?php if($item['placetype']) { ?><?php echo $cate_placetype[$item['placetype']];?>，<?php } ?>
 <?php list($type1,$type2,$type3) = explode(',', $item['type']); ?> <?php if($type1 || $type2 || $type3) { ?><?php echo $cate_type[$type1];?> <?php echo $cate_type[$type2];?> <?php echo $cate_type[$type3];?><?php } ?>
 </span>
...
<a href="http://www.8264.com/dianping.php?mod=climb&amp;act=dopost&amp;do=new" target="_blank"
   class="line-button">
<i class="line-icon"></i>
<span>发布场地</span>
</a>
