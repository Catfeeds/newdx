<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('club_commentdetail', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/club_commentdetail.htm', './template/8264/dianping/header.htm', 1509520731, '2', './data/template/2_2_dianping_club_commentdetail.tpl.php', './template/8264', 'dianping/club_commentdetail')
|| checktplrefresh('./template/8264/dianping/club_commentdetail.htm', './template/8264/dianping/nav_comment.htm', 1509520731, '2', './data/template/2_2_dianping_club_commentdetail.tpl.php', './template/8264', 'dianping/club_commentdetail')
|| checktplrefresh('./template/8264/dianping/club_commentdetail.htm', './template/8264/dianping/footer.htm', 1509520731, '2', './data/template/2_2_dianping_club_commentdetail.tpl.php', './template/8264', 'dianping/club_commentdetail')
|| checktplrefresh('./template/8264/dianping/club_commentdetail.htm', './template/8264/common/header_8264_new.htm', 1509520731, '2', './data/template/2_2_dianping_club_commentdetail.tpl.php', './template/8264', 'dianping/club_commentdetail')
|| checktplrefresh('./template/8264/dianping/club_commentdetail.htm', './template/8264/common/ewm_r.htm', 1509520731, '2', './data/template/2_2_dianping_club_commentdetail.tpl.php', './template/8264', 'dianping/club_commentdetail')
|| checktplrefresh('./template/8264/dianping/club_commentdetail.htm', './template/8264/common/weixin_share.htm', 1509520731, '2', './data/template/2_2_dianping_club_commentdetail.tpl.php', './template/8264', 'dianping/club_commentdetail')
|| checktplrefresh('./template/8264/dianping/club_commentdetail.htm', './template/8264/common/footer_8264_new.htm', 1509520731, '2', './data/template/2_2_dianping_club_commentdetail.tpl.php', './template/8264', 'dianping/club_commentdetail')
|| checktplrefresh('./template/8264/dianping/club_commentdetail.htm', './template/8264/common/header_common.htm', 1509520731, '2', './data/template/2_2_dianping_club_commentdetail.tpl.php', './template/8264', 'dianping/club_commentdetail')
|| checktplrefresh('./template/8264/dianping/club_commentdetail.htm', './template/8264/common/index_ad_top.htm', 1509520731, '2', './data/template/2_2_dianping_club_commentdetail.tpl.php', './template/8264', 'dianping/club_commentdetail')
;?>
<!doctype html>
<html>
<head>
    ...
    <div class="module">
        ...
        <div class="col-sider">
            ...
            <div class="taglist clear_b">
                ...
                <a href="" target="_blank">
                    <?php list($type1,$type2,$type3) = explode(',', $detail['gongsitype']); ?>                    <?php if($type1 || $type2 || $type3) { ?><?php echo $cate_type[$type1];?> <?php echo $cate_type[$type2];?> <?php echo $cate_type[$type3];?><?php } ?>
                </a>
