<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('post_line', 'forum/dianping/header');
0
|| checktplrefresh('./template/8264/forum/dianping/post_line.htm', './template/8264/forum/dianping/header.htm', 1508226016, '2', './data/template/2_2_forum_dianping_post_line.tpl.php', './template/8264', 'forum/dianping/post_line')
|| checktplrefresh('./template/8264/forum/dianping/post_line.htm', './template/8264/forum/dianping/editor_2014_second.htm', 1508226016, '2', './data/template/2_2_forum_dianping_post_line.tpl.php', './template/8264', 'forum/dianping/post_line')
|| checktplrefresh('./template/8264/forum/dianping/post_line.htm', './template/8264/forum/dianping/editor_2014_first.htm', 1508226016, '2', './data/template/2_2_forum_dianping_post_line.tpl.php', './template/8264', 'forum/dianping/post_line')
|| checktplrefresh('./template/8264/forum/dianping/post_line.htm', './template/8264/forum/dianping/footer.htm', 1508226016, '2', './data/template/2_2_forum_dianping_post_line.tpl.php', './template/8264', 'forum/dianping/post_line')
|| checktplrefresh('./template/8264/forum/dianping/post_line.htm', './template/8264/common/header_8264_new.htm', 1508226016, '2', './data/template/2_2_forum_dianping_post_line.tpl.php', './template/8264', 'forum/dianping/post_line')
|| checktplrefresh('./template/8264/forum/dianping/post_line.htm', './template/8264/common/editor_2014.htm', 1508226016, '2', './data/template/2_2_forum_dianping_post_line.tpl.php', './template/8264', 'forum/dianping/post_line')
|| checktplrefresh('./template/8264/forum/dianping/post_line.htm', './template/8264/forum/editor_menu_forum_newimage_2014.htm', 1508226016, '2', './data/template/2_2_forum_dianping_post_line.tpl.php', './template/8264', 'forum/dianping/post_line')
|| checktplrefresh('./template/8264/forum/dianping/post_line.htm', './template/8264/common/ewm_r.htm', 1508226016, '2', './data/template/2_2_forum_dianping_post_line.tpl.php', './template/8264', 'forum/dianping/post_line')
|| checktplrefresh('./template/8264/forum/dianping/post_line.htm', './template/8264/common/footer_8264_new.htm', 1508226016, '2', './data/template/2_2_forum_dianping_post_line.tpl.php', './template/8264', 'forum/dianping/post_line')
|| checktplrefresh('./template/8264/forum/dianping/post_line.htm', './template/8264/common/header_common.htm', 1508226016, '2', './data/template/2_2_forum_dianping_post_line.tpl.php', './template/8264', 'forum/dianping/post_line')
|| checktplrefresh('./template/8264/forum/dianping/post_line.htm', './template/8264/common/index_ad_top.htm', 1508226016, '2', './data/template/2_2_forum_dianping_post_line.tpl.php', './template/8264', 'forum/dianping/post_line')
;?>
<!doctype html>
<html>
<head>
...
<input type="hidden" name="lType" id="lType" value="<?php echo $editdata['lType'];?>" />
<input type="text" value="<?php if(!$editdata['lType']) { ?>请选择<?php echo $modname;?>类型<?php } else { ?>已选择类型：<?php echo $typelist[$editdata['lType']]['name'];?><?php } ?>" class="diqu js" readonly="readonly"/>
...
<input type="hidden" name="lTime" id="lTime" value="<?php echo $timelist[$editdata['lTime']]['cid'];?>" />
<input type="text" value="<?php if(!$editdata['lTime']) { ?>请选择<?php echo $modname;?>时长<?php } else { ?>已选择时长：<?php echo $timelist[$editdata['lTime']]['name'];?><?php } ?>" class="diqu js" readonly="readonly"/>
<div class="sc_down"><?php if(is_array($timelist)) foreach($timelist as $k => $v) { ?><a href="javascript:void(0);" rel="<?php echo $k;?>" ><?php echo $v['name'];?></a>
<?php } ?>
</div>
</div>
</span>
...
<?php if($editdata['lcross']) { ?><?php $i = 0; ?><?php $zIndex = 500; if(is_array($editdata['lcross'])) foreach($editdata['lcross'] as $key => $val) { ?><dl class="pubDt50 getRegion">
<dt><?php if($i == 0) { ?><span class="icoWeb48x43"></span><?php } else { ?>&nbsp;<?php } ?></dt>
<dd>
<span class="inputTipsText2">
<div class="qy selectdown " style="z-index:<?php echo $zIndex;?>;">
<input type="hidden" name="province[]" value="<?php echo $val['province'];?>" />
<input type="text" value="<?php echo $regionsList[$val['province']]['cityname'];?>" class="diqu js" readonly="readonly"/>
<div class="qy_down"><?php if(is_array($regionSort)) foreach($regionSort as $k => $v) { ?><a rel="<?php echo $k;?>" href="javascript:void(0);" class="province"><?php echo $regionsList[$k]["cityname"];?></a>
<?php } if(is_array($regionsList)) foreach($regionsList as $k => $v) { if(!isset($regionSort[$k])) { ?>
<a rel="<?php echo $k;?>" href="javascript:void(0);" class="province"><?php echo $v["cityname"];?></a>
<?php } } ?>
</div>
</div>
</span>
<span class="inputTipsText2">
<div class="qy selectdown noselected" style="z-index:<?php echo $zIndex;?>;" >
<input type="hidden" name="city[]" value="<?php echo $val['city'];?>" editvalue="<?php echo $val['city'];?>" class="fromedit" />
...
<input id="lMap" name="lMap" type="hidden" value="<?php if($gpsShow['aid']) { ?><?php echo $gpsShow['aid'];?><?php } else { ?>0<?php } ?>"/>
<div id="div_kml" <?php if($gpsShow['aid']) { ?>style="display:none;"<?php } ?>>
...
<input type="button" name="button2" id="btn_kml_show" value="" class="flup" <?php if(!$gpsShow['aid']) { ?>style="display:none;"<?php } ?>>
<div class="wzjs">手绘地图或轨迹文件都可（支持*.gpx、*.kml）</div>
</div>
<div id="kmllist">
<?php if($gpsShow['aid']) { ?>
<span><?php echo $gpsShow["filename"];?><a class="delkml" href="javascript:void(0);">删除</a></span>
<?php } ?>
</div>
</dd>
</dl>
...
type: 'post',
dataType: 'json',
url: '/forum.php?ctl=<?php echo $modstr;?>&act=ajaxDelGps',
data: postData,
success: function(data){
if (data.isOk == "yes") {
$("#kmllist").hide();
...
_showmsg('请选择<?php echo $modname;?>类型');
return false;
}
if (trim(theform.lTime.value)=="") {
_showmsg('请选择<?php echo $modname;?>时长');
return false;
}
...
if(!hasRegion) {
_showmsg('请选择<?php echo $modname;?>经过地域');
return false;
}
if(!isFull) {
_showmsg('请经过<?php echo $modname;?>地域选择完整');
return false;
}
...
<script type="text/javascript">
//上传kml
var params = {site:"<?php echo $_G['siteroot'];?>misc.php%3fmod=swfupload%26type=gps%26fid=<?php echo $fid;?>%26mtype=plugin%26back=uploadkml%26random=<?php echo random(4); ?>",buttonimg:"<?php echo $_G['siteroot'];?>static/images/dianping/line/uploaddoc.jpg"};
