<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_ownactivity', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/home/space_ownactivity.htm', './template/8264/common/header_8264_new.htm', 1509517963, '2', './data/template/2_2_home_space_ownactivity.tpl.php', './template/8264', 'home/space_ownactivity')
|| checktplrefresh('./template/8264/home/space_ownactivity.htm', './template/8264/home/space_header_uc.htm', 1509517963, '2', './data/template/2_2_home_space_ownactivity.tpl.php', './template/8264', 'home/space_ownactivity')
|| checktplrefresh('./template/8264/home/space_ownactivity.htm', './template/8264/home/space_footer_uc.htm', 1509517963, '2', './data/template/2_2_home_space_ownactivity.tpl.php', './template/8264', 'home/space_ownactivity')
|| checktplrefresh('./template/8264/home/space_ownactivity.htm', './template/8264/common/footer_8264_new.htm', 1509517963, '2', './data/template/2_2_home_space_ownactivity.tpl.php', './template/8264', 'home/space_ownactivity')
|| checktplrefresh('./template/8264/home/space_ownactivity.htm', './template/8264/common/header_common.htm', 1509517963, '2', './data/template/2_2_home_space_ownactivity.tpl.php', './template/8264', 'home/space_ownactivity')
|| checktplrefresh('./template/8264/home/space_ownactivity.htm', './template/8264/common/index_ad_top.htm', 1509517963, '2', './data/template/2_2_home_space_ownactivity.tpl.php', './template/8264', 'home/space_ownactivity')
|| checktplrefresh('./template/8264/home/space_ownactivity.htm', './template/8264/common/ewm_r.htm', 1509517963, '2', './data/template/2_2_home_space_ownactivity.tpl.php', './template/8264', 'home/space_ownactivity')
;
block_get('6905');?>
<!doctype html>
<html>
...
<!--module end--><link href="data/cache/style_2_forum_viewthread.css?<?php echo VERHASH;?>" rel="stylesheet" type="text/css">
<!--main-content-->			
...
<div class="list-area">
<?php if($list) { ?>
<ul class="act-list mod-op-current manageContainer"><?php if(is_array($list)) foreach($list as $v) { ?> 
<?php if($viewtype == 'apply') { ?>								
<li class="list-row" id="acitivity_<?php echo $v['tid'];?>" style="height:auto;">
<div class="activity-content">
<div class="hd">					
<div class="activity-img-wrap">
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $v['tid'];?>" title="<?php echo $v['subject'];?>" target="_blank">
<?php if($v['thumb']) { ?>
<img src="<?php echo $v['thumb'];?>" alt="<?php echo $v['subject'];?>">
<?php } ?>
</a>	
</div>			
<?php if($v['activityStatus'] == '已结束') { ?>		
...
<li>
<?php if($v['activityStatus'] == '已结束') { ?>	
<a href="home.php?mod=spacecp&amp;ac=activity&amp;tid=<?php echo $v['tid'];?>&amp;op=delete&amp;handlekey=activity_noshow_<?php echo $v['tid'];?>" class="pl-activityitem-op-delete" onclick="showWindow(this.id, this.href, 'get', 0);" id="activity_noshow_<?php echo $v['tid'];?>">
<i class="icon-m icon-delete-m"></i>删除
</a>
<?php } else { ?>
<a href="javascript:void(0);" onclick="activityCancle('<?php echo $v['tid'];?>')">
...
<h3>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $v['tid'];?>" class="" title="<?php echo $v['subject'];?>" target="_blank"><?php echo $v['subject'];?></a>
</h3>
<span class="sign-time">活动地点：<?php echo $v['place'];?></span>
<span class="rele-time"><?php $starttimefrom = date('Y-m-d', $v[starttimefrom]); ?>活动时间：<?php if(!$v['displayorder']) { if($v['starttimeto']) { ?><?php echo $starttimefrom;?> 至 <?php echo date('Y-m-d', $v[starttimeto]) ?> 商定<?php } else { ?><?php echo $starttimefrom;?><?php } } ?>
</span>
</div>
</div>
</div>
                <?php if($v['displayorder'] == -1) { ?>
                <div class="isDelete-mask"></div>
                <div class="isDelete-panel">
                    <p>此活动已删除</p>
                    <form name="activitycancleform_<?php echo $v['tid'];?>" id="activitycancleform_<?php echo $v['tid'];?>" method="post" autocomplete="off" action="forum.php?mod=misc&amp;action=activityapplies&amp;is_uc=1&amp;page=<?php echo $page;?>" onsubmit="ajaxpost(this.id, 'return_activitycancle_<?php echo $v['tid'];?>');">		
                        ...
                        <input type="hidden" name="query_string" value="<?php echo str_replace('?', '' , $_SERVER['QUERY_STRING']); ?>" />
                        ...
                        <div id="return_activitycancle_<?php echo $v['tid'];?>" style="display:none;"></div>
                    </form>
                </div>
                <?php } ?>
</li>
<?php } else { ?>
<li class="list-row" id="acitivity_<?php echo $v['tid'];?>">
<div class="activity-content">
<div class="hd">
<div class="activity-img-wrap">
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $v['tid'];?>" title="<?php echo $v['subject'];?>" target="_blank">
...
<?php if($v['activityStatus'] == '已满员') { ?>
<span class="icon-status icon-full-a"></span>
<?php } elseif($v['activityStatus'] == '已结束') { ?>
<span class="icon-status icon-end-a"></span>
<?php } ?>	
<?php if($v['activityStatus'] != '已结束' && $space['self']) { ?>				
<div class="mod-activity-op pl-popup-wrap pl-activityitem-op mod-op" style="display:none;">
<a href="javascript:void(0)" class="pl-popup-btn pl-activityitem-op-btn">
<span class="activity-op-tip">
<i class="icon-m icon-expansion-m"></i>
...
<ul>
<li>
<a href="<?php echo $v['manageurl'];?>" target="_blank" class="pl-activityitem-op-manage">
<i class="icon-m icon-manage-m"></i>管理
</a>
</li>
<li>
<a href="misc.php?mod=invite&amp;action=thread&amp;id=<?php echo $v['tid'];?>&amp;is_uc=1" onclick="showWindow('invite', this.href, 'get', 0);" class="pl-activityitem-op-invit">
<i class="icon-m icon-invit-m"></i>邀请
</a>
</li>
<li>
<a href="<?php echo $v['manageurl'];?>" target="_blank" class="pl-activityitem-op-export">
...
<span class="sign-time">活动地点：<?php echo $v['place'];?></span>
<span class="rele-time"><?php $starttimefrom = date('Y-m-d', $v[starttimefrom]); ?>活动时间：<?php if($v['starttimeto']) { ?><?php echo $starttimefrom;?> 至 <?php echo date('Y-m-d', $v[starttimeto]) ?> 商定<?php } else { ?><?php echo $starttimefrom;?><?php } ?>
</span>
</div>
</div>
<div class="ft">
...
<em><?php echo $v['allapplynum'];?>人</em>已报名
</span>
<span class="list-stat-item list-stat-no">
<em><?php echo $v['noverifiednum'];?>人</em>未审核
</span>
</div>
</div>
</div>
...
<div class="empty-tips"><?php $tempval = $viewtype == 'apply' ? '报名' : '发起'; ?><p><i class="icon-warn"></i><?php if($space['self']) { ?>您还没有<?php echo $tempval;?>活动<?php } else { ?>没有可浏览的活动<?php } ?></p>
</div>
</div>	
<?php } ?>
...
<li class="menu-nav <?php if($viewtype == 'apply') { ?>menu-nav-current<?php } ?>">
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=ownactivity&amp;type=apply">
<i class="menu-nav-icon icon-sign"></i>
<em>已报名的</em>
<span class="number"><?php echo $applyCnt;?></span>
</a>
</li>
<li class="menu-nav <?php if($viewtype == 'orig') { ?>menu-nav-current<?php } ?>">
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=ownactivity&amp;type=orig">
<i class="menu-nav-icon icon-initiate"></i>
<em>已发起的</em>
<span class="number"><?php echo $origCnt;?></span>
</a>
</li>					
</ul>
</div>
...
<form name="activitycancleform" id="activitycancleform" method="post" autocomplete="off" action="forum.php?mod=misc&amp;action=activityapplies&amp;is_uc=1&amp;page=<?php echo $page;?>" onsubmit="ajaxpost(this.id, 'return_activitycancle');">		
...
<button type="submit" name="activitycancel" value="true" class="button_confirm" id="activitycancel">确定</button>
</li>
</ul>
</div>
</div>
