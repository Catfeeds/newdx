<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('club_showlist', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/club_showlist.htm', './template/8264/dianping/header.htm', 1509518024, '2', './data/template/2_2_dianping_club_showlist.tpl.php', './template/8264', 'dianping/club_showlist')
|| checktplrefresh('./template/8264/dianping/club_showlist.htm', './template/8264/dianping/nav.htm', 1509518024, '2', './data/template/2_2_dianping_club_showlist.tpl.php', './template/8264', 'dianping/club_showlist')
|| checktplrefresh('./template/8264/dianping/club_showlist.htm', './template/8264/common/zhidemai.htm', 1509518024, '2', './data/template/2_2_dianping_club_showlist.tpl.php', './template/8264', 'dianping/club_showlist')
|| checktplrefresh('./template/8264/dianping/club_showlist.htm', './template/8264/dianping/sidebar_comment_rate.htm', 1509518024, '2', './data/template/2_2_dianping_club_showlist.tpl.php', './template/8264', 'dianping/club_showlist')
|| checktplrefresh('./template/8264/dianping/club_showlist.htm', './template/8264/dianping/sidebar_contactus.htm', 1509518024, '2', './data/template/2_2_dianping_club_showlist.tpl.php', './template/8264', 'dianping/club_showlist')
|| checktplrefresh('./template/8264/dianping/club_showlist.htm', './template/8264/dianping/footer.htm', 1509518024, '2', './data/template/2_2_dianping_club_showlist.tpl.php', './template/8264', 'dianping/club_showlist')
|| checktplrefresh('./template/8264/dianping/club_showlist.htm', './template/8264/common/header_8264_new.htm', 1509518024, '2', './data/template/2_2_dianping_club_showlist.tpl.php', './template/8264', 'dianping/club_showlist')
|| checktplrefresh('./template/8264/dianping/club_showlist.htm', './template/8264/common/ewm_r.htm', 1509518024, '2', './data/template/2_2_dianping_club_showlist.tpl.php', './template/8264', 'dianping/club_showlist')
|| checktplrefresh('./template/8264/dianping/club_showlist.htm', './template/8264/common/weixin_share.htm', 1509518024, '2', './data/template/2_2_dianping_club_showlist.tpl.php', './template/8264', 'dianping/club_showlist')
|| checktplrefresh('./template/8264/dianping/club_showlist.htm', './template/8264/common/footer_8264_new.htm', 1509518024, '2', './data/template/2_2_dianping_club_showlist.tpl.php', './template/8264', 'dianping/club_showlist')
|| checktplrefresh('./template/8264/dianping/club_showlist.htm', './template/8264/common/header_common.htm', 1509518024, '2', './data/template/2_2_dianping_club_showlist.tpl.php', './template/8264', 'dianping/club_showlist')
|| checktplrefresh('./template/8264/dianping/club_showlist.htm', './template/8264/common/index_ad_top.htm', 1509518024, '2', './data/template/2_2_dianping_club_showlist.tpl.php', './template/8264', 'dianping/club_showlist')
;
block_get('6905');?>
<!doctype html>
<html>
...
<div class="nav-name blue">俱乐部类型</div>
<div class="nav-list-wartpen">
<div class="nav-list-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;gongsitype=0&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"
<?php if($gongsitype == 0) { ?> class="blue"<?php } ?>>全部</a><?php if(is_array($cate_type)) foreach($cate_type as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;gongsitype=<?php echo $k;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"
                                                                           <?php if($gongsitype == $k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
<?php } ?>
</div>
...
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;gongsitype=<?php echo $gongsitype;?>&amp;provinceid=0&amp;cityid=0&amp;page=1"
<?php if($provinceid == 0) { ?> class = "blue"<?php } ?>>全部</a><?php if(is_array($proList)) foreach($proList as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;gongsitype=<?php echo $gongsitype;?>&amp;provinceid=<?php echo $k;?>&amp;cityid=0&amp;page=1"
   value="<?php echo $k;?>"
   class="province <?php if($provinceid == $k) { ?> blue<?php } ?>"><?php echo $v['cityname'];?></a>
<?php } ?>
</div>
<span class="tc_dq clboth" style="z-index:10000;width:450px;"><?php if(is_array($cityList)) foreach($cityList as $key => $value) { ?><span id='province_<?php echo $key;?>' class='div_city'><?php if(is_array($value)) foreach($value as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;gongsitype=<?php echo $gongsitype;?>&amp;provinceid=<?php echo $key;?>&amp;cityid=<?php echo $k;?>&amp;page=1"
...
<?php if($gongsitype==0 && $placetype==0 && $provinceid==0 ) { ?>
...
<div class="sift-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;gongsitype=<?php echo $gongsitype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1" <?php if($order=='lastpost') { ?> class="hover"<?php } ?>><i></i>默认</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;gongsitype=<?php echo $gongsitype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1" <?php if($order=='heats') { ?> class="hover"<?php } ?>><i></i>热度</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=score&amp;gongsitype=<?php echo $gongsitype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1" <?php if($order=='score') { ?> class="hover"<?php } ?>><i></i>评分</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=dateline&amp;gongsitype=<?php echo $gongsitype;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1" <?php if($order=='dateline') { ?> class="hover"<?php } ?>><i></i>最新</a>
</div>
</div>
...
src="<?php echo getimagethumb(400,300,2, $item['dir'].'/'.$item['showimg'], '', $item['serverid']); ?>"
alt=""></a>
