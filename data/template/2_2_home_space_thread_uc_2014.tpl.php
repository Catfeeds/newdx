<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_thread_uc_2014', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/home/space_thread_uc_2014.htm', './template/8264/common/header_8264_new.htm', 1509517867, '2', './data/template/2_2_home_space_thread_uc_2014.tpl.php', './template/8264', 'home/space_thread_uc_2014')
|| checktplrefresh('./template/8264/home/space_thread_uc_2014.htm', './template/8264/home/space_header_uc.htm', 1509517867, '2', './data/template/2_2_home_space_thread_uc_2014.tpl.php', './template/8264', 'home/space_thread_uc_2014')
|| checktplrefresh('./template/8264/home/space_thread_uc_2014.htm', './template/8264/home/space_thread_post.htm', 1509517867, '2', './data/template/2_2_home_space_thread_uc_2014.tpl.php', './template/8264', 'home/space_thread_uc_2014')
|| checktplrefresh('./template/8264/home/space_thread_uc_2014.htm', './template/8264/home/space_thread_reply.htm', 1509517867, '2', './data/template/2_2_home_space_thread_uc_2014.tpl.php', './template/8264', 'home/space_thread_uc_2014')
|| checktplrefresh('./template/8264/home/space_thread_uc_2014.htm', './template/8264/home/space_page_uc.htm', 1509517867, '2', './data/template/2_2_home_space_thread_uc_2014.tpl.php', './template/8264', 'home/space_thread_uc_2014')
|| checktplrefresh('./template/8264/home/space_thread_uc_2014.htm', './template/8264/home/space_footer_uc.htm', 1509517867, '2', './data/template/2_2_home_space_thread_uc_2014.tpl.php', './template/8264', 'home/space_thread_uc_2014')
|| checktplrefresh('./template/8264/home/space_thread_uc_2014.htm', './template/8264/common/footer_8264_new.htm', 1509517867, '2', './data/template/2_2_home_space_thread_uc_2014.tpl.php', './template/8264', 'home/space_thread_uc_2014')
|| checktplrefresh('./template/8264/home/space_thread_uc_2014.htm', './template/8264/common/header_common.htm', 1509517867, '2', './data/template/2_2_home_space_thread_uc_2014.tpl.php', './template/8264', 'home/space_thread_uc_2014')
|| checktplrefresh('./template/8264/home/space_thread_uc_2014.htm', './template/8264/common/index_ad_top.htm', 1509517867, '2', './data/template/2_2_home_space_thread_uc_2014.tpl.php', './template/8264', 'home/space_thread_uc_2014')
|| checktplrefresh('./template/8264/home/space_thread_uc_2014.htm', './template/8264/common/ewm_r.htm', 1509517867, '2', './data/template/2_2_home_space_thread_uc_2014.tpl.php', './template/8264', 'home/space_thread_uc_2014')
;
block_get('6905');?>
<?php $_G[home_tpl_spacemenus][] = "<a href=\"home.php?mod=space&amp;uid=$space[uid]&amp;do=thread&amp;view=me\">TA的所有帖子</a>"; ?><!doctype html>
<html>
<head>
...
<div class="col-main">
<div class="main-wrap">
<?php if($viewtype == 'thread' && $list) { ?>
<div class="ui-block ui-block-title mod-wrap">
<div class="ui-title">
<h3>
<?php if($space['self']) { ?>我<?php } else { ?><?php echo $space['username'];?><?php } ?>的发帖
<span class="number"><?php echo $threadCount;?></span>
</h3>
<?php if($space['self']) { ?>
<a href="forum.php?mod=misc&amp;action=nav" onclick="showWindow('nav', this.href, 'get', 0)" class="ui-add-link"><i class="ui-icon ui-add-icon"></i>发表帖子</a>
<?php } ?>
</div>
</div>				
<?php } ?>
...
<div class="<?php if($viewtype == 'thread') { ?>page-container-post<?php } else { ?>page-container-reply<?php } ?>">
<div class="list-area">
<?php if($list) { ?><?php $listcnt = 0; ?><ul><?php if(is_array($list)) foreach($list as $v) { if($viewtype == 'thread') { ?>
<li class="list-row"><div class="post-content article-info">
<div class="hd">
<div class="list-tit rate_<?php echo $v['tid'];?>">
<span class="icon-c post-icon">帖子</span>
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $v['tid'];?>" class="c-tx" title="<?php echo $v['subject'];?>" target="_blank"><?php echo cutstr($v['subject'], 64, '...'); ?></a>
...
<div class="bd">
<div class="txt-details-info" <?php if($v['message']['message']) { ?>style="margin-top:10px;"<?php } ?>>
...
<?php } if($v['message']['imgList']) { ?>
<p style="height:90px;" class="realimgContainer"><?php if(is_array($v['message']['imgList'])) foreach($v['message']['imgList'] as $src) { ?><img src="<?php echo $src;?>" alt="" style="width:auto;height:auto;display:none;" class="realimg">
<?php } ?>
</p>
<?php } ?>
</div>
...
<div class="ft">
<div class="list-op-bar">
<span class="list-op-item">
<i class="icon-m icon-view-m"></i>
<em class="views_<?php echo $v['tid'];?>"><?php echo $v['views'];?></em>
</span>
<span class="list-op-item">
<i class="icon-m icon-comment-m"></i>
<em class="replies_<?php echo $v['tid'];?>"><?php echo $v['replies'];?></em>
</span>
<span class="list-op-item list-op-item-time">
<em><?php echo date('Y-m-d', $v[dateline]) ?></em>
</span>
</div>
</div>
</div></li>
<?php } else { ?>
<li class="list-row"><div class="reply-content article-info">
<div class="bd">
<span class="icon-c reply-icon">回复</span>
<div class="reply-list"><?php if(is_array($v)) foreach($v as $val) { ?><div id="postmessage_<?php echo $val['pid'];?>">
<?php if($val['imgList']) { ?>
<p class="rlist-has-img">
<!--有图--><?php if(is_array($val['imgList'])) foreach($val['imgList'] as $src) { ?><a href="forum.php?mod=redirect&amp;goto=findpost&amp;ptid=<?php echo $val['tid'];?>&amp;pid=<?php echo $val['pid'];?>" target="_blank"><img src="<?php echo $src;?>" alt=""></a>
<?php } ?>
</p>
<?php } else { ?>				
<p>
<!--无图-->
<?php if($postList[$forpids[$val['pid']]]) { ?>
<b class="reply-inner">回复<a href="home.php?mod=space&amp;uid=<?php echo $postList[$forpids[$val['pid']]]['authorid'];?>" class="c-tx"><?php echo $postList[$forpids[$val['pid']]]['author'];?>：</a></b>
<?php } if($val['touid']) { ?>
<b class="reply-inner">回复<a href="home.php?mod=space&amp;uid=<?php echo $val['touid'];?>" class="c-tx"><?php echo $val['tousername'];?>：</a></b>
<?php } ?>
<a href="forum.php?mod=redirect&amp;goto=findpost&amp;ptid=<?php echo $val['tid'];?>&amp;pid=<?php echo $val['pid'];?>" target="_blank"><?php echo cutstr($val['message'], 120, '...'); ?></a>
</p>
<?php } ?>						
<span class="reply-time"><?php echo date('Y-m-d H:i:s', $val['dateU']); ?></span>
</div><?php $listcnt++; } ?>
</div>	
</div>
<div class="ft">
...
<span class="list-op-item">
<i class="icon-m icon-view-m"></i>
<em class="views_<?php echo $val['tid'];?>"><?php echo $val['views'];?></em>
</span>
<span class="list-op-item">
<i class="icon-m icon-comment-m"></i>
<em class="replies_<?php echo $val['tid'];?>"><?php echo $val['replies'];?></em>
</span>
<span class="list-op-item list-op-item-tit">
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $val['tid'];?>" class="c-tx3" title="<?php echo $val['subject'];?>" target="_blank"><?php echo cutstr($val['subject'], 72, '...'); ?></a>
<b><?php echo $forums[$val['fid']]['name'];?></b>
</span>										
</div>
</div>
</div></li>
...
<!--分页--><?php $listcnt = $listcnt ? $listcnt : count($list); if(!($page == 1 && $listcnt < $perpage)) { ?>
<div class="cust-page-list">
<div class="pg">
<?php if($page > 1) { ?>
<a href="<?php echo $theurl;?>" class="prev simple">首页</a>
<?php } if($prevpage > 0) { ?>
<a href="<?php echo $theurl;?>&page=<?php echo $prevpage;?>" class="prev simple">上一页</a>
<?php } else { ?>
<a href="javascript:void(0);" class="prev simple" style="cursor:auto;">上一页</a>
<?php } ?>
<!-- <strong><?php echo $page;?></strong> -->
<?php if($listcnt >= $perpage) { ?>
<a href="<?php echo $theurl;?>&page=<?php echo $nextpage;?>" class="nxt">下一页</a>
<?php } else { ?>
<a href="javascript:void(0);" class="nxt" style="cursor:auto;">下一页</a>
<?php } ?>
</div>
</div>
<?php } ?>
...
<div class="empty-tips"><?php $tempval = $viewtype == 'thread' ? '帖子' : '回复'; ?><p><i class="icon-warn"></i><?php if($space['self']) { ?>您还没有发表<?php echo $tempval;?><?php } else { ?>没有可浏览的<?php echo $tempval;?><?php } ?></p>
<?php if($space['self']) { ?><p><a class="post-btn" href="forum.php?mod=misc&amp;action=nav" onclick="showWindow('nav', this.href, 'get', 0)"><i>+</i>发表帖子</a></p><?php } ?>
</div>
</div>
<?php } ?>
</div>
...
<li class="menu-nav <?php if($viewtype == 'thread') { ?>menu-nav-current<?php } ?>">
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=thread&amp;view=me&amp;type=thread&amp;from=space">
<i class="menu-nav-icon icon-post"></i>
<em>全部发帖</em>
<span class="number"><?php if($threadCount > 999) { ?>999+<?php } else { ?><?php echo $threadCount;?><?php } ?></span>
</a>
</li>
<li class="menu-nav <?php if($viewtype == 'reply') { ?>menu-nav-current<?php } ?>">
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=thread&amp;view=me&amp;type=reply&amp;from=space">
<i class="menu-nav-icon icon-reply"></i>
<em>全部回复</em>
<span class="number"><?php if($replyCount > 999) { ?>999+<?php } else { ?><?php echo $replyCount;?><?php } ?></span>
</a>
</li>
</ul>
</div>
</div>
            <div style="padding:20px 0px 0px 0px;;"><?php echo adshow("custom_465"); ?></div>
</div>
</div>
</div>
<script type="text/javascript">
...
jQuery('.realimgContainer').each(function(){
if (jQuery(this).find('.realimg').length == 0) {
jQuery(this).remove();
}
});
});
