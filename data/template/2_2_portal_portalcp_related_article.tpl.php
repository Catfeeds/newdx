...
<div class="cl">
<div class="z">
<p class="mtm mbn">待选(<span id="articlenum">0</span>/<span id="articlenumall"><?php echo $count;?></span> 最多显示50条)</p>
...
<button type="reset" name="dsf" class="pn" onclick="hideWindow('<?php echo $_G['gp_handlekey'];?>');"><em>取消</em></button>
</p>
