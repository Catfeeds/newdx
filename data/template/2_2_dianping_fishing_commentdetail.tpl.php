<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('fishing_commentdetail', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/fishing_commentdetail.htm', './template/8264/dianping/header.htm', 1509518107, '2', './data/template/2_2_dianping_fishing_commentdetail.tpl.php', './template/8264', 'dianping/fishing_commentdetail')
|| checktplrefresh('./template/8264/dianping/fishing_commentdetail.htm', './template/8264/dianping/nav_comment.htm', 1509518107, '2', './data/template/2_2_dianping_fishing_commentdetail.tpl.php', './template/8264', 'dianping/fishing_commentdetail')
|| checktplrefresh('./template/8264/dianping/fishing_commentdetail.htm', './template/8264/dianping/footer.htm', 1509518107, '2', './data/template/2_2_dianping_fishing_commentdetail.tpl.php', './template/8264', 'dianping/fishing_commentdetail')
|| checktplrefresh('./template/8264/dianping/fishing_commentdetail.htm', './template/8264/common/header_8264_new.htm', 1509518107, '2', './data/template/2_2_dianping_fishing_commentdetail.tpl.php', './template/8264', 'dianping/fishing_commentdetail')
|| checktplrefresh('./template/8264/dianping/fishing_commentdetail.htm', './template/8264/common/ewm_r.htm', 1509518107, '2', './data/template/2_2_dianping_fishing_commentdetail.tpl.php', './template/8264', 'dianping/fishing_commentdetail')
|| checktplrefresh('./template/8264/dianping/fishing_commentdetail.htm', './template/8264/common/weixin_share.htm', 1509518107, '2', './data/template/2_2_dianping_fishing_commentdetail.tpl.php', './template/8264', 'dianping/fishing_commentdetail')
|| checktplrefresh('./template/8264/dianping/fishing_commentdetail.htm', './template/8264/common/footer_8264_new.htm', 1509518107, '2', './data/template/2_2_dianping_fishing_commentdetail.tpl.php', './template/8264', 'dianping/fishing_commentdetail')
|| checktplrefresh('./template/8264/dianping/fishing_commentdetail.htm', './template/8264/common/header_common.htm', 1509518107, '2', './data/template/2_2_dianping_fishing_commentdetail.tpl.php', './template/8264', 'dianping/fishing_commentdetail')
|| checktplrefresh('./template/8264/dianping/fishing_commentdetail.htm', './template/8264/common/index_ad_top.htm', 1509518107, '2', './data/template/2_2_dianping_fishing_commentdetail.tpl.php', './template/8264', 'dianping/fishing_commentdetail')
;?>
<!doctype html>
<html>
<head>
        ...
        <div class="col-sider">
        	<div class="morecommenttitle clear_b">点评对象</div>
                <div class="porductimg">
                    ...
                    <img src="<?php echo getimagethumb(120,90,2, $detail['dir'].'/'.$detail['showimg'], '', $detail['serverid']); ?>" style="width: 200px;height: 200px;">
                    </a>
                </div>
            ...
            <div class="taglist clear_b">
            	<a href="http://www.8264.com/diaoyu" target="_blank">钓鱼场地</a>
                
                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php if($detail['type']==195 || $detail['type']==196) { ?>194<?php } elseif($detail['type']==198 || $detail['type']==199 || $detail['type']==200 ) { ?>197<?php } elseif($detail['type']==201 ) { ?>201<?php } ?>&amp;isfree=0&amp;provinceid=0&amp;cityid=0&amp;order=lastpost&amp;page=1" target="_blank">
                    <?php echo $catetype[$detail['type']];?>
                </a>
                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=0&amp;isfree=0&amp;provinceid=<?php echo $detail['provinceid'];?>&amp;cityid=0&amp;order=lastpost&amp;page=1" target="_blank">
                    <?php echo $proList[$detail['provinceid']]['cityname'];?>
                </a>
