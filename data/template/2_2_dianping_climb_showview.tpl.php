<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('climb_showview', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/dianping/header.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/dianping/nav.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/common/zhidemai.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/dianping/showview_content.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/dianping/showview_credit.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/dianping/climb_mycomment.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/dianping/climb_comment.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/dianping/replyedit_pic_upload.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/dianping/reply_pic_upload.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/dianping/sidebar_map.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/common/hd_ad.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/dianping/footer.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/common/header_8264_new.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/common/ewm_r.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/common/weixin_share.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/common/footer_8264_new.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/common/header_common.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
|| checktplrefresh('./template/8264/dianping/climb_showview.htm', './template/8264/common/index_ad_top.htm', 1509518211, '2', './data/template/2_2_dianping_climb_showview.tpl.php', './template/8264', 'dianping/climb_showview')
;
block_get('7030,7012');?>
<!doctype html>
<html>
...
<?php } ?>
<!-- //值得买 -->
<div style="margin-top:20px;display: none;"><?php $bottom_ads = array('416', '409', '417'); $bottom_ad = rand(0, 2); $bottom_ad_id = $bottom_ads[$bottom_ad]; ?><?php echo adshow("custom_$bottom_ad_id"); ?></div>
                        ...
                        <div class="review-item-detail">
                            <span class="detail-item address">
                             ...
                             <span class="detail-item cate">
                                <i class="ui-icon"></i><?php echo $typename;?>,<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=0&amp;placetype=<?php echo $detail['placetype'];?>&amp;provinceid=0&amp;cityid=0&amp;page=1" target="_brank"><?php echo $cate_placetype[$detail['placetype']];?></a>
                            </span>
                            <span class="detail-item tel">
                                <i class="ui-icon"></i><?php if($detail['tel']) { ?><?php echo $detail['tel'];?><?php } else { ?>未填写<?php } ?>
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <div class="ui-block ui-block-content">
            <div class="comment-form-box">
                ...
                <div class="rows-content row-color-3">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="weakpoint" id="weakpoint" cols="30" rows="2" placeholder="请填写该攀爬场地的不足之处"></textarea>
                ...
                <div class="rows-content row-color-4">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="goodpoint" id="goodpoint" cols="30" rows="2" placeholder="请填写该攀爬场地的优点"></textarea>
                ...
                <div class="rows-content row-color-5">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="message" id="message" cols="30" rows="6" placeholder="请填写该攀爬场地的综合评价"></textarea>
    ...
    <div class="ui-grid-2 ui-grid-right">
        ...
        <div class="right-hot-warpten">
            <div class="ui-block ui-block-title">
                <div class="ui-title ui-title-line">
                    <h3>热门</h3>
                    <div class="ui-title-link"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;type=0&amp;placetype=0&amp;provinceid=0&amp;cityid=0&amp;page=1" target="_brank">more</a></div>
                </div>
            </div>
            <div class="ui-block ui-block-content">
                    ...
                    <ul class="hot-list">
                        <?php if(is_array($sidebar_list_hot)) foreach($sidebar_list_hot as $k => $item) { ?>                        <li>
                            ...
                            <div class="list-bd">
                                ...
                                <span class="comm-num"><i class="ui-icon icon-comm"></i><?php if($item['cnum']) { ?><?php echo $item['cnum'];?><?php } else { ?>0<?php } ?>人参与点评</span>
    ...
    <div class="ui-grid-2 ui-grid-right">
        <div class="right-same-area-warpten">
            <div class="ui-block ui-block-title">
                <div class="ui-title ui-title-line">
                    <h3>同地区</h3>
                    <div class="ui-title-link"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=0&amp;placetype=0&amp;provinceid=<?php echo $detail['provinceid'];?>&amp;cityid=0&amp;page=1" target="_brank">more</a></div>
                </div>
            </div>
            <div class="ui-block ui-block-content">
...
<div class="choiceness"><?php block_display('7030'); ?></div>
</div>
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        $('#message').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该攀爬场地的综合评价。</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该攀爬场地的综合评价，不能少于10个字符。</span></div>'
        });
        //缺点
        $('#weakpoint').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该攀爬场地的不足之处。</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该攀爬场地的不足之处，不能少于10个字符。</span></div>'
        });
        //优点
        $('#goodpoint').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该攀爬场地的优点</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该攀爬场地的优点，不能少于10个字符</span></div>'
        });
