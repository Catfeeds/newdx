<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('history', 'common/header_8264_new');
0
|| checktplrefresh('./template/default/weather/history.htm', './template/8264/common/header_8264_new.htm', 1509517868, '2', './data/template/2_2_weather_history.tpl.php', './template/8264', 'weather/history')
|| checktplrefresh('./template/default/weather/history.htm', './template/8264/common/zhidemai.htm', 1509517868, '2', './data/template/2_2_weather_history.tpl.php', './template/8264', 'weather/history')
|| checktplrefresh('./template/default/weather/history.htm', './template/8264/common/footer_8264_new.htm', 1509517868, '2', './data/template/2_2_weather_history.tpl.php', './template/8264', 'weather/history')
|| checktplrefresh('./template/default/weather/history.htm', './template/8264/common/header_common.htm', 1509517868, '2', './data/template/2_2_weather_history.tpl.php', './template/8264', 'weather/history')
|| checktplrefresh('./template/default/weather/history.htm', './template/8264/common/index_ad_top.htm', 1509517868, '2', './data/template/2_2_weather_history.tpl.php', './template/8264', 'weather/history')
;?>
<!doctype html>
<html>
<head>
    ...
    $('.countdown').each(function(i, v) {
        ...
        function formatNum(n) {
            ...
            <div class="navigation clear_b">
                <h3>
                    当前位置：<a href="http://www.8264.com/weather/">全国天气预报</a>><a href="http://www.8264.com/weather/<?php echo $parent_spell;?>/"><?php echo $parent_area;?></a>><a href="http://www.8264.com/weather/<?php echo $_GET['pspell'];?>/<?php echo $_GET['area'];?>/"><?php echo $cur_city;?>天气</a>
                </h3>
            ...
            <div class="btitle clear_b">
                <h1><?php echo $cur_city;?><?php echo $show_dateline;?>历史天气</h1>
            </div>
            <div class="historylist">
                <div class="historyzs">
                    <span>平均高温：<i><?php echo $weather_history_result['avg_max_tem'];?>℃</i></span>
                    <span>平均低温：<i><?php echo $weather_history_result['avg_min_tem'];?>℃</i></span>
                    <span>极端高温：<i><?php echo $weather_history_result['max_tem'];?>℃</i></span>
                    <span>极端低温：<i><?php echo $weather_history_result['min_temp'];?>℃</i></span>
                </div>
                <div class="historylistcon mt30">
                    ...
                    <?php if(is_array($weather_history_result['data'])) foreach($weather_history_result['data'] as $weather_history) { ?>                    <div class="historyone">
                        <span class="w300"><?php echo $weather_history['date'];?></span>
                        <span class="w174"><?php echo $weather_history['maxTem'];?>℃</span>
                        <span class="w174"><?php echo $weather_history['minTem'];?>℃</span>
                        <span class="w174"><?php echo $weather_history['weather'];?></span>
                        <span class="w174"><?php echo $weather_history['winddirection'];?></span>
                        <span class="w174"><?php echo $weather_history['windpower'];?></span>
                    </div>
                    <?php } ?>
                </div>
            </div>
            <div class="btitle clear_b">
                <h1><?php echo $cur_city;?>历史天气</h1>

            </div>
            <div class="citylist clear_b">
            <?php $year=date("Y"); ?>            <?php $now=strtotime(date('Y-m')); ?>            <?php $last=strtotime('2014-1'); ?>            <?php while($now>=$last){ ?>            <?php $nows=date('Ym',$now); ?>            	<a href="http://www.8264.com/weather/<?php echo $_GET['pspell'];?>/<?php echo $area;?>/tianqi-<?php echo $nows; ?>.html" target="_blank"><?php echo $cur_city;?><?php echo date('Y年m月',$now); ?>天气</a>
            <?php $now= strtotime('-1 month',$now); ?>            <?php } ?>            </div>
            ...
            <div class="citylist clear_b">
                <?php if(is_array($weather_parallel_area_list)) foreach($weather_parallel_area_list as $weather_parallel_area) { ?>                <a href="http://www.8264.com/weather/<?php echo $weather_parallel_area['pspell'];?>/<?php echo $weather_parallel_area['spell'];?>/tianqi-<?php echo $show_history_date;?>.html" target="_blank"><?php echo $weather_parallel_area['name'];?>历史天气</a>
                <?php } ?>
            </div>
        </div>
        <!--切换城市列表开始-->
