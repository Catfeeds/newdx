<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('spacecp_blog_edit_uc', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/home/spacecp_blog_edit_uc.htm', './template/8264/common/header_8264_new.htm', 1509521368, '2', './data/template/2_2_home_spacecp_blog_edit_uc.tpl.php', './template/8264', 'home/spacecp_blog_edit_uc')
|| checktplrefresh('./template/8264/home/spacecp_blog_edit_uc.htm', './template/8264/home/space_header_uc.htm', 1509521368, '2', './data/template/2_2_home_spacecp_blog_edit_uc.tpl.php', './template/8264', 'home/spacecp_blog_edit_uc')
|| checktplrefresh('./template/8264/home/spacecp_blog_edit_uc.htm', './template/8264/home/space_footer_uc.htm', 1509521368, '2', './data/template/2_2_home_spacecp_blog_edit_uc.tpl.php', './template/8264', 'home/spacecp_blog_edit_uc')
|| checktplrefresh('./template/8264/home/spacecp_blog_edit_uc.htm', './template/8264/common/footer_8264_new.htm', 1509521368, '2', './data/template/2_2_home_spacecp_blog_edit_uc.tpl.php', './template/8264', 'home/spacecp_blog_edit_uc')
|| checktplrefresh('./template/8264/home/spacecp_blog_edit_uc.htm', './template/8264/common/header_common.htm', 1509521368, '2', './data/template/2_2_home_spacecp_blog_edit_uc.tpl.php', './template/8264', 'home/spacecp_blog_edit_uc')
|| checktplrefresh('./template/8264/home/spacecp_blog_edit_uc.htm', './template/8264/common/index_ad_top.htm', 1509521368, '2', './data/template/2_2_home_spacecp_blog_edit_uc.tpl.php', './template/8264', 'home/spacecp_blog_edit_uc')
|| checktplrefresh('./template/8264/home/spacecp_blog_edit_uc.htm', './template/8264/common/ewm_r.htm', 1509521368, '2', './data/template/2_2_home_spacecp_blog_edit_uc.tpl.php', './template/8264', 'home/spacecp_blog_edit_uc')
;
block_get('6905');?>
<?php if(!$_G['member']['telstatus']) showmessage('bindtel_tips', 'http://u.8264.com/home-setting.html#account-security'); ?><!doctype html>
<html>
<head>
...
<?php } ?>
<!-- //手机绑定提示 -->
<link rel="stylesheet" type="text/css" href="http://static.8264.com/static/css/forum/fu_blog.css?<?php echo VERHASH;?>" />
<style type="text/css">
.customizefile{
...
<!--module end--><div class="main-content">
<div class="mod-wrap main-container">
<div class="post-blog-tit">
<a href="javascript:void(0);">写日志</a>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=blog&amp;view=me&amp;from=space" class="ret-list">返回日志列表 >></a>
</div>
<div class="fu_r">
<?php if(!$_G['inajax'] && (!$blog['uid'] || $blog['uid']==$_G['uid'])) { ?>
...
<option value="-1">存储相册</option><?php if(is_array($albums)) foreach($albums as $value) { ?><option value="<?php echo $value['albumid'];?>"><?php echo $value['albumname'];?></option>
<?php } ?>
<option value="addoption" style="color:red;">+创建新相册</option>
</select>
<a href="javascript:;" id="insertallimage" onclick="insert_all_imagetag()">全部插入</a>
</div>
<script src="<?php echo $_G['setting']['jspath'];?>home_uploadpic.js?<?php echo VERHASH;?>" type="text/javascript"></script>
...
<span>选择相册</span>
<div class="xzxcout showdowndiv" style="display:none"><?php if(is_array($albums)) foreach($albums as $album) { ?>            					<a href="javascript:;" onclick="$('selectalbum_span').style.display = 'none';" albumid="<?php echo $album['albumid'];?>"><?php echo $album['albumname'];?></a>
            					<?php } ?>
</div>
</div>
...
<form id="ttHtmlEditor" class="input-form" method="post" autocomplete="off" action="home.php?mod=spacecp&amp;ac=blog&amp;blogid=<?php echo $blog['blogid'];?><?php if($_G['gp_modblogkey']) { ?>&amp;modblogkey=<?php echo $_G['gp_modblogkey'];?><?php } ?>" enctype="multipart/form-data">
<?php if(!empty($_G['setting']['pluginhooks']['spacecp_top'])) echo $_G['setting']['pluginhooks']['spacecp_top']; ?>
<table cellspacing="0" cellpadding="0" class="tfm">
<tr>
<td style="padding:0;"><input type="text" id="subject" name="subject" value="<?php echo $blog['subject'];?>" size="60" onblur="relatekw();" class="px" style="width: 63%;" /></td>
</tr>
<tr>
...
<iframe src='home.php?mod=editor&charset=<?php echo CHARSET;?>&allowhtml=<?php echo $allowhtml;?>&doodle=<?php if($_G['setting']['magicstatus'] && !empty($_G['setting']['magics']['doodle'])) { ?>1<?php } ?>' name="uchome-ifrHtmlEditor" id="uchome-ifrHtmlEditor" scrolling="no" border="0" frameborder="0" style="width: 700px; height: 400px; border: 1px solid #d6d6d6;padding-bottom:36px;*padding-bottom:40px;"></iframe>
</td>
</tr>
</table>
...
<input type="hidden" class="px vm" size="40" id="tag" name="tag" value="<?php echo $blog['tag'];?>"  />
</div>
</li>
<?php if($blog['uid'] && $blog['uid']!=$_G['uid']) { ?><?php $selectgroupstyle='display:none'; ?></ul>
<ul class="opea-other-panel">
<?php } ?>
<li>
...
<li style="display:none;">
<span class="t">动态选项</span>
<div class="collon-content">
<input type="checkbox" name="makefeed" id="makefeed" value="1" class="pc"<?php if(ckprivacy('blog', 'feed')) { ?> checked="checked"<?php } ?>> <label for="makefeed">发送动态 (<a href="home.php?mod=spacecp&amp;ac=privacy&amp;op=feed" target="_blank">更改默认配置</a>)</label>
</div>
</li>
                    <?php if($_GET['op']!='edit') { ?>
                    <li class="notic-frid">
                        ...
                        <div class="collon-content">
                        	<input type="checkbox" name="ext_friend_feed" id="ext_friend_feed" class="pc"/> <label for="ext_friend_feed">通知<?php echo $ext_limit;?>位好友</label>
                        </div>
                    </li>
                    <?php } ?>
</ul>
...
<?php if(!empty($_G['setting']['pluginhooks']['spacecp_bottom'])) echo $_G['setting']['pluginhooks']['spacecp_bottom']; ?>
</div>
</div>
</div>
</div>
...
if (slen < 1 || slen > 80) {
showDialog_uc("标题长度(1~80字符)不符合要求");
subject.focus();
return false;
}
}
