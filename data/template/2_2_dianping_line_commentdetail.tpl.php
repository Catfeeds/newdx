<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('line_commentdetail', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/line_commentdetail.htm', './template/8264/dianping/header.htm', 1509518519, '2', './data/template/2_2_dianping_line_commentdetail.tpl.php', './template/8264', 'dianping/line_commentdetail')
|| checktplrefresh('./template/8264/dianping/line_commentdetail.htm', './template/8264/dianping/nav_comment.htm', 1509518519, '2', './data/template/2_2_dianping_line_commentdetail.tpl.php', './template/8264', 'dianping/line_commentdetail')
|| checktplrefresh('./template/8264/dianping/line_commentdetail.htm', './template/8264/dianping/footer.htm', 1509518519, '2', './data/template/2_2_dianping_line_commentdetail.tpl.php', './template/8264', 'dianping/line_commentdetail')
|| checktplrefresh('./template/8264/dianping/line_commentdetail.htm', './template/8264/common/header_8264_new.htm', 1509518519, '2', './data/template/2_2_dianping_line_commentdetail.tpl.php', './template/8264', 'dianping/line_commentdetail')
|| checktplrefresh('./template/8264/dianping/line_commentdetail.htm', './template/8264/common/ewm_r.htm', 1509518519, '2', './data/template/2_2_dianping_line_commentdetail.tpl.php', './template/8264', 'dianping/line_commentdetail')
|| checktplrefresh('./template/8264/dianping/line_commentdetail.htm', './template/8264/common/weixin_share.htm', 1509518519, '2', './data/template/2_2_dianping_line_commentdetail.tpl.php', './template/8264', 'dianping/line_commentdetail')
|| checktplrefresh('./template/8264/dianping/line_commentdetail.htm', './template/8264/common/footer_8264_new.htm', 1509518519, '2', './data/template/2_2_dianping_line_commentdetail.tpl.php', './template/8264', 'dianping/line_commentdetail')
|| checktplrefresh('./template/8264/dianping/line_commentdetail.htm', './template/8264/common/header_common.htm', 1509518519, '2', './data/template/2_2_dianping_line_commentdetail.tpl.php', './template/8264', 'dianping/line_commentdetail')
|| checktplrefresh('./template/8264/dianping/line_commentdetail.htm', './template/8264/common/index_ad_top.htm', 1509518519, '2', './data/template/2_2_dianping_line_commentdetail.tpl.php', './template/8264', 'dianping/line_commentdetail')
;?>
<!doctype html>
<html>
<head>
...
<!--                                    <div class="avatar-box">
                                    ...
                                    <div>
                                        ...
                                        <?php if($commentlist['starnum']) { ?>
                                            <div class="rows-content row-color-1">
                                                ...
                                                <div class="attrValues">
                                                <?php if(floor(($commentlist['ext2']-$commentlist['ext1'])/86400)==0) { ?>
                                                <p><?php echo dgmdate($commentlist['ext1'], 'Y-m-d '); ?><?php echo $commentlist['ext4'];?>时 - <?php echo $commentlist['ext5'];?>时  共计<?php echo $commentlist['ext5']-$commentlist['ext4'];?>小时</p>
                                                <?php } else { ?>
                                                <p><?php echo dgmdate($commentlist['ext1'], 'Y-m-d '); ?> 至 <?php echo dgmdate($commentlist['ext2'], 'Y-m-d'); ?> 共<?php echo floor(($commentlist['ext2']-$commentlist['ext1'])/86400); ?>天</p>
                                                <?php } ?>
                                                </div>
                                            </div>
                                        <?php } ?>
        ...
        <div class="col-sider">
            ...
            <div class="taglist clear_b">
            	<a href="http://www.8264.com/xianlu" target="_blank">线路</a>
                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=<?php echo $detail['type'];?>&amp;timetype=0&amp;provinceid=0&amp;cityid=0&amp;page=1" target="_blank">
                    <?php echo $cate_type[$detail['type']];?>
                </a>
                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=0&amp;timetype=0&amp;provinceid=<?php echo $prolist;?>&amp;cityid=0&amp;page=1" target="_blank">
                    <?php echo $regionList[$prolist]['cityname'];?>
                </a>
