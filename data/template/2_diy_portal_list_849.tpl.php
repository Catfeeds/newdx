<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_849', 'common/header_8264_new');
0
|| checktplrefresh('./template/default/portal/list_849.htm', './template/8264/common/header_8264_new.htm', 1509517981, 'diy', './data/template/2_diy_portal_list_849.tpl.php', 'data/diy', 'portal/list_849')
|| checktplrefresh('./template/default/portal/list_849.htm', './template/8264/common/zhidemai.htm', 1509517981, 'diy', './data/template/2_diy_portal_list_849.tpl.php', 'data/diy', 'portal/list_849')
|| checktplrefresh('./template/default/portal/list_849.htm', './template/8264/common/weixin_share_bottom.htm', 1509517981, 'diy', './data/template/2_diy_portal_list_849.tpl.php', 'data/diy', 'portal/list_849')
|| checktplrefresh('./template/default/portal/list_849.htm', './template/8264/common/footer_8264_new.htm', 1509517981, 'diy', './data/template/2_diy_portal_list_849.tpl.php', 'data/diy', 'portal/list_849')
|| checktplrefresh('./template/default/portal/list_849.htm', './template/8264/common/header_common.htm', 1509517981, 'diy', './data/template/2_diy_portal_list_849.tpl.php', 'data/diy', 'portal/list_849')
|| checktplrefresh('./template/default/portal/list_849.htm', './template/8264/common/index_ad_top.htm', 1509517981, 'diy', './data/template/2_diy_portal_list_849.tpl.php', 'data/diy', 'portal/list_849')
;?>
<!doctype html>
<html>
<head>
...
<?php } ?>
<!-- //手机绑定提示 --><?php $list = array(); ?><?php $list = topic_get_list($cat, $type, $page); ?><link rel="stylesheet" type="text/css" href="http://static.8264.com/static/css/common/reset.css" />
<link href="http://static.8264.com/static/css/portal/list8264_style.css" rel="stylesheet" type="text/css">
<div class="header">
<div class="layout">
<div class="icoHill">&nbsp;</div>
<div class="headerL">
<h1><span class="country">8264专题</span></h1>
<div class="site">
...
<a href="http://www.8264.com/topic_list/" <?php if(!isset($type)) { ?>class="nowmod"<?php } ?>>全部</a>
<a href="portal.php?mod=list&amp;catid=849&amp;type=0&amp;page=1" <?php if(isset($type) && $type==0) { ?>class="nowmod"<?php } ?>>专题</a>
<a href="portal.php?mod=list&amp;catid=849&amp;type=1&amp;page=1" <?php if($type==1) { ?>class="nowmod"<?php } ?>>活动</a>
</div>
</div>
</div>
</div>
<div class="warpper">
<!--//导航条//-->
<div class="warpten clearfix" style="width:980px; margin:10px auto;">
...
<div class="ztall clearfix" style="width:980px;">
<?php if($list['list']) { if(is_array($list['list'])) foreach($list['list'] as $value) { ?><div class="imgone">
<div class="ztimgone">
<a href="portal.php?mod=topic&amp;topicid=<?php echo $value['topicid'];?>" target="_blank">
<img src="<?php echo $value['pic'];?>?1"/>
</a>
</div>
<div class="ztnewname">
<a href="portal.php?mod=topic&amp;topicid=<?php echo $value['topicid'];?>" target="_blank" title="<?php echo $value['title'];?>"<?php if($type == 1) { ?> <?php if($value['endtime'] > $_G['timestamp']) { ?> class="zting"<?php } elseif($value['endtime'] < $_G['timestamp'] && $value['endtime'] != 0) { ?> class="ztend"<?php } } ?>><?php echo $value['title'];?></a>
</div>
</div>
<?php } ?>
</div>
<?php if($list['multi']) { ?>
<div class="listPageBox"><?php echo $list['multi'];?></div>
<?php } } ?>
</div>
