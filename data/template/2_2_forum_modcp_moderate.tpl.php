...
<tr>
<td>&nbsp;</td>
<td colspan="3"><button type="submit" name="submit" id="searchsubmit" class="pn" value="true"><strong>提交</strong></button></td>
</tr>
</table>
<?php } else { ?>
<p class="emp">你没有管理任何版块的权限，无法执行此操作</p>
<?php } ?>
</form>
</div>
...
<p class="pbn">
<span class="y">
<a href="forum.php?mod=modcp&amp;action=<?php echo $_G['gp_action'];?>&amp;op=<?php echo $op;?>&amp;moderate[]=<?php echo $post['id'];?>&amp;modact=validate&amp;filter=<?php echo $filter;?>&amp;dosubmit=1" onclick="showWindow('mods', this.href)" class="xi2">通过</a><span class="pipe">|</span>
<a href="forum.php?mod=modcp&amp;action=<?php echo $_G['gp_action'];?>&amp;op=<?php echo $op;?>&amp;moderate[]=<?php echo $post['id'];?>&amp;modact=delete&amp;filter=<?php echo $filter;?>&amp;dosubmit=1" onclick="showWindow('mods', this.href)" class="xi2">删除</a><span class="pipe">|</span>
<a href="forum.php?mod=modcp&amp;action=<?php echo $_G['gp_action'];?>&amp;op=<?php echo $op;?>&amp;moderate[]=<?php echo $post['id'];?>&amp;modact=ignore&amp;filter=<?php echo $filter;?>&amp;dosubmit=1" onclick="showWindow('mods', this.href)" class="xi2">忽略</a><span class="pipe">|</span>
...
<div class="um bw0 cl">
<input type="checkbox" class="pc" name="chkall" id="chkall" onclick="modcheckall()" /> <label for="chkall">全选</label>
...
<p class="mtn">
<a href="forum.php?mod=modcp&amp;action=<?php echo $_G['gp_action'];?>&amp;op=<?php echo $op;?>&amp;moderate[]=<?php echo $member['uid'];?>&amp;modact=validate&amp;filter=<?php echo $filter;?>&amp;dosubmit=1" onclick="showWindow('mods', this.href)">通过</a><span class="pipe">|</span>
<a href="forum.php?mod=modcp&amp;action=<?php echo $_G['gp_action'];?>&amp;op=<?php echo $op;?>&amp;moderate[]=<?php echo $member['uid'];?>&amp;modact=delete&amp;filter=<?php echo $filter;?>&amp;dosubmit=1" onclick="showWindow('mods', this.href)">删除</a><span class="pipe">|</span>
<a href="forum.php?mod=modcp&amp;action=<?php echo $_G['gp_action'];?>&amp;op=<?php echo $op;?>&amp;moderate[]=<?php echo $member['uid'];?>&amp;modact=ignore&amp;filter=<?php echo $filter;?>&amp;dosubmit=1" onclick="showWindow('mods', this.href)">否决</a>
</p>
</td>
