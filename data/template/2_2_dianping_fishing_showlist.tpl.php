<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('fishing_showlist', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/fishing_showlist.htm', './template/8264/dianping/header.htm', 1509518027, '2', './data/template/2_2_dianping_fishing_showlist.tpl.php', './template/8264', 'dianping/fishing_showlist')
|| checktplrefresh('./template/8264/dianping/fishing_showlist.htm', './template/8264/dianping/nav.htm', 1509518027, '2', './data/template/2_2_dianping_fishing_showlist.tpl.php', './template/8264', 'dianping/fishing_showlist')
|| checktplrefresh('./template/8264/dianping/fishing_showlist.htm', './template/8264/common/zhidemai.htm', 1509518027, '2', './data/template/2_2_dianping_fishing_showlist.tpl.php', './template/8264', 'dianping/fishing_showlist')
|| checktplrefresh('./template/8264/dianping/fishing_showlist.htm', './template/8264/dianping/sidebar_comment_rate.htm', 1509518027, '2', './data/template/2_2_dianping_fishing_showlist.tpl.php', './template/8264', 'dianping/fishing_showlist')
|| checktplrefresh('./template/8264/dianping/fishing_showlist.htm', './template/8264/dianping/sidebar_contactus.htm', 1509518027, '2', './data/template/2_2_dianping_fishing_showlist.tpl.php', './template/8264', 'dianping/fishing_showlist')
|| checktplrefresh('./template/8264/dianping/fishing_showlist.htm', './template/8264/dianping/footer.htm', 1509518027, '2', './data/template/2_2_dianping_fishing_showlist.tpl.php', './template/8264', 'dianping/fishing_showlist')
|| checktplrefresh('./template/8264/dianping/fishing_showlist.htm', './template/8264/common/header_8264_new.htm', 1509518027, '2', './data/template/2_2_dianping_fishing_showlist.tpl.php', './template/8264', 'dianping/fishing_showlist')
|| checktplrefresh('./template/8264/dianping/fishing_showlist.htm', './template/8264/common/ewm_r.htm', 1509518027, '2', './data/template/2_2_dianping_fishing_showlist.tpl.php', './template/8264', 'dianping/fishing_showlist')
|| checktplrefresh('./template/8264/dianping/fishing_showlist.htm', './template/8264/common/weixin_share.htm', 1509518027, '2', './data/template/2_2_dianping_fishing_showlist.tpl.php', './template/8264', 'dianping/fishing_showlist')
|| checktplrefresh('./template/8264/dianping/fishing_showlist.htm', './template/8264/common/footer_8264_new.htm', 1509518027, '2', './data/template/2_2_dianping_fishing_showlist.tpl.php', './template/8264', 'dianping/fishing_showlist')
|| checktplrefresh('./template/8264/dianping/fishing_showlist.htm', './template/8264/common/header_common.htm', 1509518027, '2', './data/template/2_2_dianping_fishing_showlist.tpl.php', './template/8264', 'dianping/fishing_showlist')
|| checktplrefresh('./template/8264/dianping/fishing_showlist.htm', './template/8264/common/index_ad_top.htm', 1509518027, '2', './data/template/2_2_dianping_fishing_showlist.tpl.php', './template/8264', 'dianping/fishing_showlist')
;
block_get('7031');?>
<!doctype html>
<html>
...
<div class="nav-name blue">钓鱼类型</div>
<div class="nav-list-wartpen">
<div class="nav-list-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=0&amp;isfree=<?php echo $isfree;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;order=lastpost&amp;page=1"
<?php if($type == 0) { ?> class="blue"<?php } ?>>全部</a><?php if(is_array($cate_type)) foreach($cate_type as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $k;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;order=lastpost&amp;page=1"<?php if($type == $k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
<?php } ?>
</div>
...
<div class="nav-sift-one">
<div class="nav-name orange">是否收费</div>
<div class="nav-list-wartpen">
<div class="nav-list-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=0&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;order=lastpost&amp;page=1"
<?php if($type == 0) { ?> class="blue"<?php } ?>>全部</a><?php if(is_array($cate_isfree)) foreach($cate_isfree as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $k;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;order=lastpost&amp;page=1"<?php if($isfree == $k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
<?php } ?>
</div>
<div class="nav-list-more"></div>
</div>
...
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=0&amp;cityid=0&amp;order=lastpost&amp;page=1"
<?php if($provinceid == 0) { ?> class = "blue"<?php } ?>>全部</a><?php if(is_array($proList)) foreach($proList as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=<?php echo $k;?>&amp;cityid=0&amp;order=lastpost&amp;page=1"
 value="<?php echo $k;?>"
 class="province <?php if($provinceid == $k) { ?> blue<?php } ?>"><?php echo $v['cityname'];?></a>
<?php } ?>
</div>
<span class="tc_dq clboth" style="z-index:10000;width:450px;"><?php if(is_array($cityList)) foreach($cityList as $key => $value) { ?><span id='province_<?php echo $key;?>' class='div_city'><?php if(is_array($value)) foreach($value as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=<?php echo $key;?>&amp;cityid=<?php echo $k;?>&amp;order=lastpost&amp;page=1"
...
<div class="nav-list-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=0&amp;cityid=0&amp;order=lastpost&amp;page=1"
<?php if($provinceid == 0) { ?> class = "blue"<?php } ?>>全部</a><?php if(is_array($proList)) foreach($proList as $k => $val) { ?><a id="cbtn_<?php echo $k;?>" href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=<?php echo $k;?>&amp;cityid=0&amp;order=lastpost&amp;page=1"
 value="<?php echo $k;?>"
...
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=<?php echo $key;?>&amp;cityid=<?php echo $kc;?>&amp;order=lastpost&amp;page=1"
 class="city <?php if($cityid == $kc) { ?> blue<?php } ?>"><?php echo $v['cityname'];?></a>
</li>
<?php } ?><?php continue; } } ?>
</ul>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=<?php echo $k;?>&amp;cityid=0&amp;order=lastpost&amp;page=1" class="link-add-more">全部<?php echo $val['cityname'];?>分类</a>
</div>
<?php } ?>
</div>
</div>
...
<?php if($type==0 && $isfree==0 && $provinceid==0) { ?> <h3><span>所有钓鱼</span></h3><?php } ?>
</div>
<div class="sift-left">
<div class="condition-box">
<h1>
<?php if($type) { ?><a
href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=0&amp;isfree=<?php echo $isfree;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;order=lastpost&amp;page=1"
class="condition"><?php echo $cate_type[$type];?><i></i></a><?php } if($isfree) { ?><a
href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=0&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;order=lastpost&amp;page=1"
class="condition"><?php echo $cate_isfree[$isfree];?><i></i></a><?php } if($provinceid) { ?><a
href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=0&amp;cityid=0&amp;order=lastpost&amp;page=1"
class="condition"><?php echo $proList[$provinceid]['cityname'];?><i></i></a><?php } if($provinceid && $cityid) { ?><a
href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=0&amp;order=lastpost&amp;page=1"
...
<div class="sift-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;order=lastpost&amp;page=1"<?php if($order=='lastpost') { ?> class="hover"<?php } ?>><i></i>默认</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;order=heats&amp;page=1"<?php if($order=='heats') { ?> class="hover"<?php } ?>><i></i>热度</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;order=score&amp;page=1"<?php if($order=='score') { ?> class="hover"<?php } ?>><i></i>评分</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php echo $type;?>&amp;isfree=<?php echo $isfree;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;order=dateline&amp;page=1"<?php if($order=='dateline') { ?> class="hover"<?php } ?>><i></i>最新</a>
</div>
</div>
<!-- //排序筛选 -->
</div>
...
<?php if($item['provinceid']) { ?> <?php echo $proList[$item['provinceid']]['cityname'];?>，<?php } if($item['provinceid'] &&
$item['cityid']) { ?><?php echo $cityList[$item['provinceid']][$item['cityid']]['cityname'];?>，<?php } if($item['type']) { ?><?php echo $alltypename[$item['type']];?>，<?php } if($item['isfree']) { ?><?php echo $cate_isfree[$item['isfree']];?><?php } ?>
...
<a href="http://www.8264.com/dianping.php?mod=fishing&amp;act=dopost&amp;do=new" target="_blank"
 class="line-button">
<i class="line-icon"></i>
<span>发布场地</span>
</a>
