<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_dianping', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/home/space_dianping.htm', './template/8264/common/header_8264_new.htm', 1509517873, '2', './data/template/2_2_home_space_dianping.tpl.php', './template/8264', 'home/space_dianping')
|| checktplrefresh('./template/8264/home/space_dianping.htm', './template/8264/home/space_header_uc.htm', 1509517873, '2', './data/template/2_2_home_space_dianping.tpl.php', './template/8264', 'home/space_dianping')
|| checktplrefresh('./template/8264/home/space_dianping.htm', './template/8264/home/space_dianping_inc.htm', 1509517873, '2', './data/template/2_2_home_space_dianping.tpl.php', './template/8264', 'home/space_dianping')
|| checktplrefresh('./template/8264/home/space_dianping.htm', './template/8264/home/space_footer_uc.htm', 1509517873, '2', './data/template/2_2_home_space_dianping.tpl.php', './template/8264', 'home/space_dianping')
|| checktplrefresh('./template/8264/home/space_dianping.htm', './template/8264/common/footer_8264_new.htm', 1509517873, '2', './data/template/2_2_home_space_dianping.tpl.php', './template/8264', 'home/space_dianping')
|| checktplrefresh('./template/8264/home/space_dianping.htm', './template/8264/common/header_common.htm', 1509517873, '2', './data/template/2_2_home_space_dianping.tpl.php', './template/8264', 'home/space_dianping')
|| checktplrefresh('./template/8264/home/space_dianping.htm', './template/8264/common/index_ad_top.htm', 1509517873, '2', './data/template/2_2_home_space_dianping.tpl.php', './template/8264', 'home/space_dianping')
|| checktplrefresh('./template/8264/home/space_dianping.htm', './template/8264/common/ewm_r.htm', 1509517873, '2', './data/template/2_2_home_space_dianping.tpl.php', './template/8264', 'home/space_dianping')
;
block_get('6905');?>
<!doctype html>
<html>
...
<!--module end--><?php $ua 	= strtolower($_SERVER['HTTP_USER_AGENT']);
$isIE6  = strpos($ua, 'msie 6.0') !== false ? true : false; ?><!--main-content-->		
<div class="main-content layout-page">
<div class="layout-app">
<div class="col-main">
<div class="main-wrap">
<div class="ui-block ui-block-content">
<div class="page-container-review">
<div class="list-area">
<?php if($list) { ?>
<ul><?php if(is_array($list)) foreach($list as $v) { ?><li class="list-row"><div class="review-cate">
<a href="<?php echo $_G['config']['web']['portal'];?><?php echo $dpModList[$v['fid']]['uname'];?><?php if(in_array($dpModList[$v['fid']]['mname'], array('climb', 'club', 'hostel', 'diving', 'fishing', 'chain'))) { ?>/<?php } ?>" class="review-name">
<i class="icon-r icon-<?php echo $dpModList[$v['fid']]['mname'];?>-r"></i><?php echo $dpModList[$v['fid']]['cname'];?>
</a>
</div>
<div class="review-content article-info">
<div class="hd">
<div class="list-tit">
<a href="<?php echo $_G['config']['web']['portal'];?><?php echo $dpModList[$v['fid']]['uname'];?><?php if(in_array($dpModList[$v['fid']]['mname'], array('climb', 'club', 'hostel', 'diving', 'fishing', 'chain'))) { ?>/<?php echo $v['tid'];?>.html<?php } elseif($dpModList[$v['fid']]['mname'] == 'equipment') { ?>-<?php echo $v['tid'];?>-1.html<?php } else { ?>-<?php echo $v['tid'];?><?php } ?>" class="c-tx2" title="<?php echo $threadList[$v['tid']]['subject'];?>" target="_blank">
点评<span class="rl-tit"><?php echo $threadList[$v['tid']]['subject'];?></span>
</a>
<?php if($v['rate']) { ?>
<span class="icon-m icon-coin-m" title="8264币"></span>
<?php } ?>
</div>
<div class="rating-level small-rating rlist-rating">
<span class="score-value score-value-<?php echo intval($v['starnum'])*2;; ?>">
<em></em>
</span>
<strong><?php echo $dpModList[$v['fid']]['star'][$v['starnum']];?></strong>
</div>
</div>
<div class="bd">
<div class="txt-details-info review-info showheight" style="height:90px;">
<?php if($dpModList[$v['fid']]['mname'] == 'mountain') { if($v['ext1']) { ?><p><b>攀登日期：</b><?php if($v['ext1']==$v['ext2']) { ?><?php echo $v['ext1'];?>&nbsp;&nbsp;<?php echo $v['starHour'];?>时至<?php echo $v['endHour'];?>时&nbsp;共用 <?php echo $v['time'];?><?php } else { ?><?php echo $v['ext1'];?>&nbsp;至&nbsp;<?php echo $v['ext2'];?>&nbsp;共用 <?php echo $v['time'];?><?php } ?></p><?php } if($v['ext3']) { ?><p><b>费用协作：</b><?php echo $v['ext3'];?></p><?php } if($v['ext4']) { ?><p><b>我的建议：</b><?php echo $v['ext4'];?></p><?php } if($v['message']) { ?><p><b>攀登综述：</b><?php echo $v['message'];?></p><?php } } elseif($dpModList[$v['fid']]['mname'] == 'line') { if($v['ext1']) { ?>
<p>
<b>时间：</b>
<?php if($v['isTian']) { ?>
...
<?php } if($v['ext3']) { ?><p><b>费用：</b><?php echo $v['ext3'];?></p><?php } if($v['weakpoint']) { ?><p><b>注意：</b><?php echo $v['weakpoint'];?></p><?php } if($v['message']) { ?><p><b>综合：</b><?php echo $v['message'];?></p><?php } } elseif($dpModList[$v['fid']]['mname'] == 'equipment') { if($v['extdata']['price']) { ?><p><b>价格来源：</b><?php echo $v['extdata']['price'];?></p><?php } if($v['weakpoint']) { ?><p><b>不足：</b><?php echo $v['weakpoint'];?></p><?php } if($v['goodpoint']) { ?><p><b>优点：</b><?php echo $v['goodpoint'];?></p><?php } if($v['message']) { ?><p><b>综合：</b><?php echo $v['message'];?></p><?php } } else { if($v['weakpoint']) { ?><p><b>不足：</b><?php echo $v['weakpoint'];?></p><?php } if($v['goodpoint']) { ?><p><b>优点：</b><?php echo $v['goodpoint'];?></p><?php } if($v['message']) { ?><p><b>综合：</b><?php echo $v['message'];?></p><?php } } ?>
<span style="display:none;" class="span_height"></span>
</div>
<a class="j-rw-toggle" href="javascript:void(0)"><span>展开</span><i class="icon-m icon-unfold-m" <?php if($isIE6) { ?>style="display:none;"<?php } ?>></i></a>
<!--计算高度所用-->
<div class="txt-details-info review-info realheight" style="display:none;">
<?php if($dpModList[$v['fid']]['mname'] == 'mountain') { if($v['ext1']) { ?><p><b>攀登日期：</b><?php if($v['ext1']==$v['ext2']) { ?><?php echo $v['ext1'];?>&nbsp;&nbsp;<?php echo $v['starHour'];?>时至<?php echo $v['endHour'];?>时&nbsp;共用 <?php echo $v['time'];?><?php } else { ?><?php echo $v['ext1'];?>&nbsp;至&nbsp;<?php echo $v['ext2'];?>&nbsp;共用 <?php echo $v['time'];?><?php } ?></p><?php } if($v['ext3']) { ?><p><b>费用协作：</b><?php echo $v['ext3'];?></p><?php } if($v['ext4']) { ?><p><b>我的建议：</b><?php echo $v['ext4'];?></p><?php } if($v['message']) { ?><p><b>攀登综述：</b><?php echo $v['message'];?></p><?php } } elseif($dpModList[$v['fid']]['mname'] == 'line') { if($v['ext1']) { ?>
<p>
<b>时间：</b>
<?php if($v['isTian']) { ?>
...
<a href="javascript:void(0);" class="list-op-item useful <?php if($supportlist[$v['pid']]) { ?>active<?php } ?>"
<?php if($_G['uid'] && !$supportlist[$v['pid']] && $_G['uid'] != $space['uid']) { ?> id="supportBtn_<?php echo $v['pid'];?>"<?php } if(!$_G['uid']) { ?> onclick="javascript:window.location.href = '<?php echo $_G['siteurl'];?>member.php?mod=logging&action=login';return false;"<?php } if($_G['uid']) { if($supportlist[$v['pid']]) { ?>
title="你已经评价过了"
<?php } else { ?>
title="有用"
<?php } } else { ?>
...
<?php } ?>
>
<i class="icon-m icon-useful-m"></i>
<em>有用(<?php echo $v['supports'];?>)</em>
</a>
...
<p><i class="icon-warn"></i><?php if($space['self']) { ?>您还没有发表点评<?php } else { ?>没有可浏览的点评<?php } ?></p>
</div>
</div>
<?php } ?>
</div>
...
<li class="menu-nav <?php if(!$fid) { ?>menu-nav-current<?php } ?>">
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=dianping">
<i class="menu-nav-icon icon-all-review"></i>
<em>全部点评</em>
<span class="number"><?php echo $allcount;?></span>
</a>
</li><?php if(is_array($dpModList)) foreach($dpModList as $v) { if($v['count']) { ?>
<li class="menu-nav <?php if($v['fid'] == $fid) { ?>menu-nav-current<?php } ?>">
<a href="home.php?mod=space&amp;do=dianping&amp;uid=<?php echo $space['uid'];?>&amp;fid=<?php echo $v['fid'];?>">
<i class="menu-nav-icon icon-<?php echo $v['mname'];?>"></i>
<em><?php echo $v['cname'];?></em>
<span class="number"><?php echo $v['count'];?></span>
</a>
</li>
<?php } } ?>
</ul>
