<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('shop_showview', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/dianping/header.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/dianping/nav.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/common/zhidemai.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/dianping/showview_content.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/dianping/shop_mycomment.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/dianping/replyedit_pic_upload.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/dianping/showview_credit.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/dianping/shop_comment.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/dianping/reply_pic_upload.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/dianping/sidebar_map.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/dianping/sidebar_contactus.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/dianping/footer.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/common/header_8264_new.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/common/ewm_r.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/common/weixin_share.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/common/footer_8264_new.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/common/header_common.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
|| checktplrefresh('./template/8264/dianping/shop_showview.htm', './template/8264/common/index_ad_top.htm', 1509517867, '2', './data/template/2_2_dianping_shop_showview.tpl.php', './template/8264', 'dianping/shop_showview')
;
block_get('6905,6983');?>
<!doctype html>
<html>
...
<span class="detail-item website">
<i class="ui-icon"></i>
<?php if($detail['marketid']!=0) { ?>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $detail['provinceid'];?>&amp;rid=0&amp;sid=2&amp;cid=0&amp;bid=0&amp;order=lastpost&amp;page=1" target="_brank">商场店</a>
<?php } else { ?>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $detail['provinceid'];?>&amp;rid=0&amp;sid=1&amp;cid=0&amp;bid=0&amp;order=lastpost&amp;page=1" target="_brank">街边店</a>
<?php } ?>
</span>
<?php if($detail['cbrandid']) { ?>
<span class="detail-item website">
<i class="ui-icon"></i><?php echo $cbrands['chainbrand'];?>
</span>
<?php } ?>
<span class="detail-item tel">
<i class="ui-icon"></i><?php if($detail['tel']) { ?><?php echo $regions['areacode'];?>-<?php echo $detail['tel'];?><?php } else { ?>暂无电话<?php } ?>
</span>
...
<i class="ui-icon"></i>
<?php if($detail['addr']) { if($detail['provinceid']) { ?>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $detail['provinceid'];?>&amp;rid=0&amp;sid=0&amp;cid=0&amp;bid=0&amp;order=lastpost&amp;page=1" target="_brank"><?php echo $arr_region[$detail['provinceid']]['name'];?> </a>
<?php } if($detail['regionid']) { ?>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $detail['provinceid'];?>&amp;rid=<?php echo $detail['regionid'];?>&amp;sid=0&amp;cid=0&amp;bid=0&amp;order=lastpost&amp;page=1" target="_brank"><?php echo $arr_region[$detail['provinceid']]['city'][$detail['regionid']]['cityname'];?> </a>
<?php } ?>
<?php echo $detail['addr'];?>
<?php } else { ?>暂无地址<?php } ?>
</span>
...
<!-- //detail -->
        ...
        <?php echo adshow("custom_413"); ?>        </div>
<div class="ui-grid-6 ui-grid-left">
...
<h3>我的点评</h3>
<span class="note">假如您的点评没有奖励8264币，请联系工作人员QQ1919501975询问原因</span>
</div>
</div>
<div class="ui-block ui-block-content">
...
<?php if($act=='showview' && ($_G['adminid'] == 1 || $_G['uid']==$mycomment['authorid'])) { include template('dianping/cplist_comment'); } ?>
</div>
</div>
...
</div><?php if(checkperm('seccode') && ($secqaacheck || $seccodecheck)) { ?>
<div class="rows-content row-color-6">
<div class="commAttr">
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="weakpoint" id="weakpoint" cols="30" rows="2" placeholder="请填写该店铺的不足之处"></textarea>
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="goodpoint" id="goodpoint" cols="30" rows="2" placeholder="请填写该店铺的优点"></textarea>
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="message" id="message" cols="30" rows="6" placeholder="请从店铺的货品数量、产品质量、产品价格、服务态度等方面进行点评。"></textarea>
    ...
    <div class="bd w750">
        <div class="popGoogleMap">
            ...
            <div id="bm_editbox" style="display: none;">
                <h3>地址：<?php echo $detail['newaddress'];?>（<span class="cBlue" id="bm_mark" style="cursor: pointer;">地图上标注</span>）</h3>
                <div class="searchMap">
...
<ul class="eq-list"><?php if(is_array($shop_near)) foreach($shop_near as $k => $value) { ?><li>
<div class="imgbox"><a href="http://www.8264.com/dianping.php?mod=shop&amp;act=showview&amp;tid=<?php echo $value['tid'];?>" title="<?php echo $value['subject'];?>" target="_blank" ><img src="<?php echo getimagethumb(60,60,2, $value['dir'].'/'.$value['showimg'], '', $value['serverid']); ?>" alt="<?php echo $value['subject'];?>"></a></div>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="http://www.8264.com/dianping.php?mod=shop&amp;act=showview&amp;tid=<?php echo $value['tid'];?>" title="<?php echo $value['subject'];?>" target="_blank" class="<?php if($k<1) { ?>orange<?php } elseif($k<3) { ?>blue<?php } ?>"><?php echo $value['subject'];?></a></h3>
<div class="star-comm">
...
<span class="comm-num"><i class="ui-icon icon-comm"></i><?php echo $value['cnum'];?></span>
</div>
</div>
</li>
<?php } ?>
...
<div class="ui-block ui-block-content">
<div class="common-list-box eq-list-box">
<ul class="eq-list"><?php if(is_array($shop_new)) foreach($shop_new as $k => $value) { ?><li>
<div class="imgbox"><a href="http://www.8264.com/dianping.php?mod=shop&amp;act=showview&amp;tid=<?php echo $value['tid'];?>" title="<?php echo $value['subject'];?>" target="_blank" ><img src="<?php echo getimagethumb(60,60,2, $value['dir'].'/'.$value['showimg'], '', $value['serverid']); ?>" alt="<?php echo $value['subject'];?>"></a></div>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="http://www.8264.com/dianping.php?mod=shop&amp;act=showview&amp;tid=<?php echo $value['tid'];?>" title="<?php echo $value['subject'];?>" target="_blank" class="<?php if($k<1) { ?>orange<?php } elseif($k<3) { ?>blue<?php } ?>"><?php echo $value['subject'];?></a></h3>
<div class="star-comm">
...
<div class="ui-block ui-block-content">
<div class="common-list-box eq-list-box">
<ul class="eq-list"><?php if(is_array($shop_hot)) foreach($shop_hot as $k => $value) { ?><li>
<div class="imgbox"><a href="http://www.8264.com/dianping.php?mod=shop&amp;act=showview&amp;tid=<?php echo $value['tid'];?>" title="<?php echo $value['subject'];?>" target="_blank" ><img src="<?php echo getimagethumb(60,60,2, $value['dir'].'/'.$value['showimg'], '', $value['serverid']); ?>" alt="<?php echo $value['subject'];?>"></a></div>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="http://www.8264.com/dianping.php?mod=shop&amp;act=showview&amp;tid=<?php echo $value['tid'];?>" title="<?php echo $value['subject'];?>" target="_blank" class="<?php if($k<1) { ?>orange<?php } elseif($k<3) { ?>blue<?php } ?>"><?php echo $value['subject'];?></a></h3>
<div class="star-comm">
...
<div class="ui-block ui-block-title">
<div class="ui-title ui-title-line">
<h3><?php echo $arr_region[$detail['provinceid']]['name'];?>其他<?php echo $cbrands['chainbrand'];?></h3>
</div>
</div>
<div class="ui-block ui-block-content">
<div class="common-list-box eq-list-box">
<ul class="eq-list"><?php if(is_array($shop_cbrand)) foreach($shop_cbrand as $k => $value) { ?><li>
<div class="imgbox"><a href="http://www.8264.com/dianping.php?mod=shop&amp;act=showview&amp;tid=<?php echo $value['tid'];?>" title="<?php echo $value['subject'];?>" target="_blank" ><img src="<?php echo getimagethumb(60,60,2, $value['dir'].'/'.$value['showimg'], '', $value['serverid']); ?>" alt="<?php echo $value['subject'];?>"></a></div>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="http://www.8264.com/dianping.php?mod=shop&amp;act=showview&amp;tid=<?php echo $value['tid'];?>" title="<?php echo $value['subject'];?>" target="_blank" class="<?php if($k<1) { ?>orange<?php } elseif($k<3) { ?>blue<?php } ?>"><?php echo $value['subject'];?></a></h3>
<div class="star-comm">
...
<?php } ?>
    ...
    <?php } ?>
<!--联系方式--><div class="ui-grid-2 ui-grid-right">
...
<div class="friendLink"><?php block_display('6983'); ?></div>
<script>
(function($){
$(function(){
//添加点评
...
onShow: '',
onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该店铺的综合评价。</span></div>',
onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
defaultValue: ""
}).inputValidator({
empty: false,
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该店铺的综合评价，不能少于10个字符。</span></div>'
});
//缺点
$('#weakpoint').formValidator({
onShow: '',
onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该店铺的不足之处。</span></div>',
onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
defaultValue: ""
}).inputValidator({
empty: false,
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该店铺的不足之处，不能少于10个字符。</span></div>'
});
//优点
$('#goodpoint').formValidator({
onShow: '',
onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该店铺的优点</span></div>',
onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
defaultValue: ""
}).inputValidator({
empty: false,
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该店铺的优点，不能少于10个字符</span></div>'
});
