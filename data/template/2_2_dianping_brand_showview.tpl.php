<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('brand_showview', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/dianping/header.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/dianping/nav.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/common/zhidemai.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/dianping/showview_content.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/dianping/showview_like_btn.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/dianping/showview_like_userlist.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/dianping/showview_relation_eq.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/dianping/showview_credit.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/dianping/brand_mycomment.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/dianping/brand_comment.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/dianping/replyedit_pic_upload.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/dianping/reply_pic_upload.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/dianping/footer.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/common/header_8264_new.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/common/ewm_r.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/common/weixin_share.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/common/footer_8264_new.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/common/header_common.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
|| checktplrefresh('./template/8264/dianping/brand_showview.htm', './template/8264/common/index_ad_top.htm', 1509517868, '2', './data/template/2_2_dianping_brand_showview.tpl.php', './template/8264', 'dianping/brand_showview')
;
block_get('6905,6981');?>
<!doctype html>
<html>
...
jQuery(function($){
    ...
    <?php } ?>
    <!-- //值得买 -->
    <div style="margin: 20px auto 0px auto;display: none;"><?php $bottom_ads = array('416', '409', '417'); $bottom_ad = rand(0, 2); $bottom_ad_id = $bottom_ads[$bottom_ad]; ?><?php echo adshow("custom_$bottom_ad_id"); ?></div>
...
<?php if($_G['adminid']==1) { include template('dianping/cplist_thread'); } ?>
</div>
</div>
...
<div class="brand-intro">
                                                                                            <?php if(!empty($detail['tel'])) { ?>
<h3 class="b-tit">联系电话 <?php echo $detail['tel'];?></h3>
                                                                                            <?php } ?>
<div class="logo-box">
<img class="logo-img" src="<?php if($detail['serverid']==1) { ?>http://image.8264.com/<?php } else { ?>http://image1.8264.com/<?php } ?><?php echo $detail['dir'];?>/<?php echo $detail['showimg'];?>">
<p class="brand-addr">中国总部：<?php echo $detail['city'];?></p>
</div>
<div class="brand-info"><?php $zsp = stripos($detail[subject],"（"); ?><?php $esp = stripos($detail[subject],"("); if($zsp) { ?><?php $detail[ename] =  mb_substr($detail[subject],0,$zsp); } elseif($esp) { ?><?php $detail[ename] =  mb_substr($detail[subject],0,$esp); } ?>
<p>品牌名称：<?php if($detail['ename']) { ?><?php echo $detail['ename'];?><?php } else { ?>无<?php } ?></p>
<p>中文名称：<?php if($detail['cname']) { ?><?php echo $detail['cname'];?><?php } else { ?>无<?php } ?></p>
<p>品牌国籍：<?php if($detail['nation']) { ?><?php echo $cate_region[$detail['nation']];?><?php } else { ?>无<?php } ?></p>
</div>
</div>
<div class="focus-count">
<span class="view"><b><?php echo $detail['views'] += get_redis_views($detail['tid'],'viewthread'); ?></b>人浏览</span>
<span class="pipe">|</span>
<span class="discuss"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $tid;?>#comment"><b><?php echo $detail['replies'];?></b></a>人参与讨论</span>
</div>
</div>
<div class="brand-review-attribute">
<div class="attribute-top-content">
<div class="brand-website">
<h3>品牌官网：
<?php if($detail['url']) { ?><?php $str = $detail['url']; ?><?php $find = "|"; if(stripos($str,$find)) { ?><?php $brand_url = substr($str,0,strpos($str,$find)); if($brand_url) { ?><?php $gw = substr($str,strpos($str,$find)+1); ?><a href="<?php echo $gw;?>" target="_blank" <?php if($detail['tid'] != '880044') { ?>rel="nofollow"<?php } ?>><?php echo $gw;?></a>
<?php } } else { if(stripos($detail['url'],'tmall.com') && $detail['tid']=='1216338') { ?>
<a href="<?php echo $detail['url'];?>" target="_blank" rel="nofollow"><?php echo $detail['url'];?></a>
<?php } else { ?>
<a href="<?php echo $detail['url'];?>" target="_blank" rel="nofollow"><?php echo $detail['url'];?></a>
<?php } } } else { ?>
无
...
(<span class="num"><?php echo $detail['cnum'];?></span>人评分)
</div>
<div class="rw-rechart-con">
<div title="力荐" class="rm-rechart-line">
...
<div class="rm-rechart-val"><?php echo $detail['percent5'];?>% (力荐)</div>
</div>
<div title="推荐" class="rm-rechart-line">
<div class="rating-level small-rating rm-rating">
...
<div class="rm-rechart-val"><?php echo $detail['percent4'];?>% (推荐)</div>
</div>
<div title="还行" class="rm-rechart-line">
<div class="rating-level small-rating rm-rating">
...
<div class="rm-rechart-val"><?php echo $detail['percent3'];?>% (还行)</div>
</div>
<div title="较差" class="rm-rechart-line">
<div class="rating-level small-rating rm-rating">
...
<div class="rm-rechart-val"><?php echo $detail['percent2'];?>% (较差)</div>
</div>
<div title="很差" class="rm-rechart-line">
<div class="rating-level small-rating rm-rating">
...
<div class="rm-rechart-val"><?php echo $detail['percent1'];?>% (很差)</div>
</div>
</div>
<div class="review-item-detail">
                                                                                                        <?php if(!empty($detail['company'])) { ?>
<span class="detail-item belong">
<i class="ui-icon"></i><?php echo $detail['company'];?>
</span>
                                                                                                        <?php } ?>
                                                                                                        <?php if(!empty($detail['addr'])) { ?>
<span class="detail-item address">
<i class="ui-icon"></i><?php echo $detail['addr'];?>
</span>
                                                                                                        <?php } ?>
</div>
<?php if($brand_rank) { ?>
<div class="ranking ranking-grid-<?php echo count($brand_rank) ?>">
<ul class="ranking-list"><?php if(is_array($brand_rank)) foreach($brand_rank as $key => $value) { ?><li>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=0&amp;nat=0&amp;cp=<?php echo $value['cp'];?>&amp;order=score&amp;page=1" target="_blank">
<div class="ranking-num"><b><?php echo $value['ranking'];?></b>名</div>
<p class="ranking-word"><?php echo $value['name'];?></p>
</a>
</li>
<?php } ?>
</ul>
...
<!-- //detail -->
                        ...
                        <div style=" margin:35px 0px;"><?php echo adshow("custom_339"); ?></div>
<div class="ui-grid-6 ui-grid-left">
<!-- content --><div class="review-intro">
<div class="ui-block ui-block-title">
...
<!-- like_btn --><div class="brand-vote">
<a href="javascript:void(0);" class="vote-item-link like">
<div class="pillar">
<div style="height: 60px;" class="pillar-bar"  id="likenum"><em><?php echo $likenum;?></em></div>
</div>
<span class="vote-btn" id="addlike">我喜欢</span>
</a>
<a href="javascript:void(0);" class="vote-item-link want">
<div class="pillar">
<div style="height: 15.8582px;" class="pillar-bar" id="wantnum"> <em><?php echo $wantnum;?></em>
</div>
</div>
<span class="vote-btn" id="wantuse">我想用</span>
</a>
</div>
<script>
(function($){
...
var url = 'http://www.8264.com/dianping.php?mod=misc&act=comment&do=addlike&tid=<?php echo $detail['tid'];?>';
$.post(url,{uid:'<?php echo $_G['uid'];?>',type:'likeit'},
function(data){
if(data=='-2'){
alert('你已经表态过了！');
return false;
...
$('#likenum').html('<em>'+data+'</em>');
$('#like_users').show();
}
});
});
$('#wantuse').click(function(){
if(<?php echo $_G['uid'];?>==''){
alert('你需要登陆后才能表态');
window.location.href = 'http://www.8264.com/member.php?mod=logging&action=login';
return false;
...
var url = 'http://www.8264.com/dianping.php?mod=misc&act=comment&do=addlike&tid=<?php echo $detail['tid'];?>';
$.post(url,{uid:'<?php echo $_G['uid'];?>',type:'wantuse'},
function(data){
if(data=='-2'){
alert('你已经表态过了！');
return false;
...
<?php if($like_users) { ?><div class="brand-userList-wrapper">
<div class="ui-block ui-block-title">
<div class="ui-title">
<h4>喜欢<?php echo $detail['subject'];?>品牌的用户<span class="num"><?php echo $likenum;?></span>人</h4>
</div>
</div>
<div class="ui-block ui-block-content">
<ul class="u-item-list" >
<li id="like_users" style="display:none;">
<a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" rel="nofollow" target="_brank"><?php echo avatar($_G['uid'], small); echo cutstr($_G['username'],7,''); ?></a>
</li><?php if(is_array($like_users)) foreach($like_users as $value) { ?><li>
<a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>" rel="nofollow" target="_brank"><?php echo avatar($value['uid'], small); echo cutstr($value['username'],7,''); ?></a>
</li>
<?php } ?>
</ul>
</div>
</div>
<?php } if($brand_eq) { ?><div class="brand-product-wrapper">
<div class="ui-block ui-block-title">
<div class="ui-title ui-title-line">
<h3><?php echo $detail['subject'];?></h3>
 <span style="margin-left:10px;vertical-align:-1px"> 装备库 （<?php echo $brand_eq_count;?>件）</span>
<a href="http://www.8264.com/zhuangbei-0-0-<?php echo $detail['id'];?>-5-1.html" target="_blank" class="item-more">+<?php echo $detail['subject'];?>更多</a>
</div>
</div>
<div class="ui-block ui-block-content">

<ul class="product-slide-nav">

</ul>
<div class="product-slide-content"><?php for ($i = 0; $i < $block_num; ++$i): ?><div class="product-container" <?php if($i==0) { ?>style="display:black;"<?php } else { ?>style="display:none;"<?php } ?>><?php $targe_index = $i * 3; ?><?php for ($j = $targe_index; $j < $targe_index + 3; ++$j): ?><?php if ($j == $brand_eq_count)break; ?><?php $value = $brand_eq[$j]; ?><div class="product-slide-pannel">
<a href="http://www.8264.com/zhuangbei-<?php echo $value['tid'];?>-1.html" title="<?php echo $value['subject'];?>" target="_blank" >
<p class="img-product">
<img src="<?php echo getimagethumb(185,185,1, $value['dir'].'/'.$value['showimg'], $value['kaid'], $value['serverid']); ?>" alt="">
</p>
<div class="text-product"><p><?php echo $value['subject'];?></p></div>
</a>
...
<!--去掉8264币-->
<div class="ui-grid-6 ui-grid-left">
<!-- 点评赚8264币 --><div class="review-adv-box" style="display: none;">
<div class="ui-block ui-block-content">
...
<div class="ui-grid-6 ui-grid-left" >
<!-- 我的点评 -->
<div id="mycomment" <?php if(!$mycomment || !$_G['uid']) { ?> style="display:none;" <?php } ?> >	<div class="review-comment-box">
<div class="ui-block ui-block-title">
<div class="ui-title ui-title-line">
...
<a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" class="user-avatar" target="_blank" rel="nofollow"><?php echo avatar($mycomment['authorid'], small); ?><span class="user-name"><?php echo $mycomment['author'];?></span>
</a>
</div>
<div class="comment-word">

<div class="rows-content row-color-1" <?php if($mycomment['starnum']==0) { ?> style="display:none;" <?php } ?>>
<div class="commAttr">
<i class="attrs-icon comm"></i>推荐
</div>
<div class="attrValues">
<div class="rating-level big-rating clist-rating">
<span id="score-value" class="score-value score-value-<?php echo $mycomment['starnum']*2; ?>">
<em></em>
</span>
<span id="scorename">(<?php if($mycomment['starnum']==1) { ?>很差<?php } elseif($mycomment['starnum']==2) { ?>较差<?php } elseif($mycomment['starnum']==3) { ?>还行<?php } elseif($mycomment['starnum']==4) { ?>推荐<?php } elseif($mycomment['starnum']==5) { ?>力荐<?php } ?>)</span>
</div>
</div>
</div>

<div class="rows-content row-color-2" <?php if(!$mycomment['weakpoint']) { ?>style="display:none;"<?php } ?>>
<div class="commAttr">
...
<div class="rows-content row-color-3" <?php if(!$mycomment['weakpoint']) { ?>style="display:none;"<?php } ?>>
<div class="commAttr">
...
<div class="ui-block ui-block-content">
<div class="comment-main" id="commentlist"><div class="comment-main"><?php if(is_array($commentlist)) foreach($commentlist as $comment) { ?><div id="post_<?php echo $comment['pid'];?>" class="comment-list-box">
<div class="avatar-box">
...
<?php if($_G['adminid'] == 1) { if($_G['group']['allowdelpost']) { ?><a href="javascript:;" onclick="modaction('delpost', '', '', 'forum.php?ctl=<?php echo $mod;?>&act=moderator')">删除</a><span class="pipe">|</span><?php } if($_G['group']['allowstickreply']) { ?><a href="javascript:;" onclick="modaction('stickreply', '', '', 'forum.php?ctl=<?php echo $mod;?>&act=moderator')">置顶</a><?php } } ?>
</div>
</div>
</td>
<td class="m_r"></td>
...
<li><a class="one-star" id="star_1_e" value='1' href="javascript:void(0);" title="很差">100</a></li>
<li><a class="two-stars" id="star_2_e" value='2' href="javascript:void(0);" title="较差">200</a></li>
<li><a class="three-stars" id="star_3_e" value='3'  href="javascript:void(0);" title="还行">300</a></li>
<li><a class="four-stars" id="star_4_e" value='4' href="javascript:void(0);" title="推荐">400</a></li>
<li><a class="five-stars" id="star_5_e" value='5' href="javascript:void(0);" title="力荐">500</a></li>
</ul>
...
</div><div class="rows-content row-color-6">
    <div class="commAttr">
        <i class="attrs-icon picture"></i>图片
    </div>
    <dl class="pubDt50">
...
<input type="submit" name="submit" value="修改" class="btn-issue" />
</div>
</div>
</div>
</div>
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="weakpoint" id="weakpoint" cols="30" rows="2" placeholder="请填写该品牌的不足之处"></textarea>
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="goodpoint" id="goodpoint" cols="30" rows="2" placeholder="请填写该品牌的优点"></textarea>
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="message" id="message" cols="30" rows="6" placeholder="请从品牌的产品质量、性能、品牌形象、产品价格、售后服务、购买便利度等方面对品牌进行综合评价。优秀点评奖励1个8264币（可用于礼品兑换），抄袭者倒扣5个8264币。"></textarea>
<div id="messageTip" class="valid-tips-container"></div>
</div>
</div>
</div>
<!--start----发布页图片上传--><?php if($_G['uid']) { ?>
<div class="rows-content row-color-6">
    <div class="commAttr">
        <i class="attrs-icon picture"></i>图片
    </div>
...
<!-- side bar -->
<div class="col-sider">
<?php if($brand_articles) { ?>
<div class="ui-grid-2 ui-grid-right">
<div class="right-customer-news-wapten">
<div class="ui-block ui-block-title">
<div class="ui-title ui-title-line">
<h3><?php echo $detail['cname'];?>新闻</h3>
</div>
</div>
<div class="ui-block ui-block-content">
<div class="common-list-box customer-news">
<ul><?php if(is_array($brand_articles)) foreach($brand_articles as $value) { ?><li>
<div class="imgbox">
<a href="http://www.8264.com/viewnews-<?php echo $value['aid'];?>-page-1.html" target="_blank" title="<?php echo $value['title'];?>">
<?php if($value['pic']) { ?>
<img src="<?php echo $value['pic'];?>" style="width:68px;height:50px;" alt="<?php echo $value['title'];?>" />
<?php } else { ?>
<img src="http://www.8264.com/static/image/common/nopic.gif" style="width:68px;height:50px;" alt="<?php echo $value['title'];?>" />
<?php } ?>
</a>
</div>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="http://www.8264.com/viewnews-<?php echo $value['aid'];?>-page-1.html" target="_blank" title="<?php echo $value['title'];?>" ><?php echo $value['title'];?></a></h3>
<div class="date"><?php echo gmdate('Y.m.d',$value['dateline']) ?></div>
</div>
</li>
<?php } ?>
</ul>
...
<?php } if($rank_brand) { ?>
<div class="ui-grid-2 ui-grid-right">
<div class="right-hot-eq-warpten">
<div class="ui-block ui-block-title">
<div class="ui-title ui-title-line">
<h3>同排行品牌</h3>
</div>
...
<div class="ui-block ui-block-content">
<div class="common-list-box right-brand-box">
<ul><?php if(is_array($rank_brand)) foreach($rank_brand as $k => $value) { ?><li>
<div class="imgbox"><a href="http://www.8264.com/dianping.php?mod=brand&amp;act=showview&amp;tid=<?php echo $value['tid'];?>" title="<?php echo $value['subject'];?>" target="_blank" ><img src="http://image1.8264.com/<?php echo $value['dir'];?>/<?php echo $value['showimg'];?>" alt="<?php echo $value['subject'];?>"></a></div>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="http://www.8264.com/dianping.php?mod=brand&amp;act=showview&amp;tid=<?php echo $value['tid'];?>" title="<?php echo $value['subject'];?>" target="_blank" class="<?php if($k<1) { ?>orange<?php } elseif($k<3) { ?>blue<?php } ?>"><?php echo $value['subject'];?></a></h3>
<div class="star-comm">
<div class="rating-level small-rating req-inner-rating">
<span class="score-value score-value-<?php echo floor($value['score']); ?>">
<em></em>
</span>
<strong><?php echo $value['score'];?></strong>
</div>
...
<?php } if($brand_bbs) { ?>
<div class="ui-grid-2 ui-grid-right">
<div class="right-customer-common-wapten">
<div class="ui-block ui-block-title">
<div class="ui-title ui-title-line">
<h3><?php echo $detail['cname'];?>讨论</h3>
</div>
</div>
<div class="ui-block ui-block-content">
<div class="common-list-box customer-common">
<ul><?php if(is_array($brand_bbs)) foreach($brand_bbs as $value) { ?><li>
<div class="imgbox"><a href="home.php?mod=space&amp;uid=<?php echo $value['authorid'];?>" rel="nofollow"  target="_blank"><?php echo $value['avatar'];?></a></div>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="http://bbs.8264.com/thread-<?php echo $value['tid'];?>-1-1.html" target="_blank" title="<?php echo $value['subject'];?>"class=""><?php echo $value['subject'];?></a></h3>
</div>
</li>
<?php } ?>
</ul>
...
<ul><?php if(is_array($brand_topics)) foreach($brand_topics as $value) { ?><li>
<a href="http://www.8264.com/topic/<?php echo $value['topicid'];?>.html" target="_blank" title="<?php echo $value['title'];?>"><img src="<?php echo $value['cover'];?>" alt="<?php echo $value['title'];?>"></a>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="http://www.8264.com/topic/<?php echo $value['topicid'];?>.html" target="_blank"  title="<?php echo $value['title'];?>"><?php echo $value['title'];?></a></h3>
</div>
</li>
<?php } ?>
</ul>
...
<ul class="right-same-area"><?php if(is_array($brand_blogs)) foreach($brand_blogs as $value) { ?><li>
<h3 class="wlist-bd-title"><a href="http://u.8264.com/home-space-uid-<?php echo $value['uid'];?>-do-blog-id-<?php echo $value['blogid'];?>.html" target="_blank" title="<?php echo $value['subject'];?>"><?php echo $value['subject'];?></a></h3>
</li>
<?php } ?>
</ul>
</div>
...
<div class="friendLink"><?php block_display('6981'); ?></div>
...
var goodpoint = $("#postform #goodpoint").val();
var weakpoint = $("#postform #weakpoint").val();
var message = $("#postform #message").val();
 //form表单初始化验证后进行二次验证
if(starnum == 0){
$("#postform #starnumTip").show();
}
...
var goodpoint = $("#editform #goodpoint_e").val();
var weakpoint = $("#editform #weakpoint_e").val();
var message = $("#editform #message_e").val();
//form表单初始化验证后进行二次验证
if(starnum == 0){
$("#editform #starnumTip").show();
}
if(weakpoint.length<10 || goodpoint.length <10 || message.length <10 || starnum == 0){
return false;
}
...
var title =	$('#editform #star_'+data['starnum']+'_e').attr('title');
$('#editform .stars1-tips').html(title);
//图片处理
var str = '';
$.each(data['attachlist'],function(i,v){
str += "<span class=\"attachpic\"  id=\"image_"+ v.aid+"\" title=\""+ v.filename+"\">";
...
e.preventDefault();
$.get(this.href, {ajaxreply:1}, function(data){
...
onShow: '',
onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该品牌的综合评价。</span></div>',
onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
defaultValue: ""
}).inputValidator({
empty: false,
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该品牌的综合评价，不能少于10个字符。</span></div>'
});
//缺点
$('#weakpoint').formValidator({
onShow: '',
onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该品牌的不足之处。</span></div>',
onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
defaultValue: ""
}).inputValidator({
empty: false,
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该品牌的不足之处，不能少于10个字符。</span></div>'
});
//优点
$('#goodpoint').formValidator({
onShow: '',
onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该品牌的优点</span></div>',
onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
defaultValue: ""
}).inputValidator({
empty: false,
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该品牌的优点，不能少于10个字符</span></div>'
});
