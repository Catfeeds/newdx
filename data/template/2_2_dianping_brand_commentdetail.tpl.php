<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('brand_commentdetail', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/brand_commentdetail.htm', './template/8264/dianping/header.htm', 1509517898, '2', './data/template/2_2_dianping_brand_commentdetail.tpl.php', './template/8264', 'dianping/brand_commentdetail')
|| checktplrefresh('./template/8264/dianping/brand_commentdetail.htm', './template/8264/dianping/nav_comment.htm', 1509517898, '2', './data/template/2_2_dianping_brand_commentdetail.tpl.php', './template/8264', 'dianping/brand_commentdetail')
|| checktplrefresh('./template/8264/dianping/brand_commentdetail.htm', './template/8264/dianping/footer.htm', 1509517898, '2', './data/template/2_2_dianping_brand_commentdetail.tpl.php', './template/8264', 'dianping/brand_commentdetail')
|| checktplrefresh('./template/8264/dianping/brand_commentdetail.htm', './template/8264/common/header_8264_new.htm', 1509517898, '2', './data/template/2_2_dianping_brand_commentdetail.tpl.php', './template/8264', 'dianping/brand_commentdetail')
|| checktplrefresh('./template/8264/dianping/brand_commentdetail.htm', './template/8264/common/ewm_r.htm', 1509517898, '2', './data/template/2_2_dianping_brand_commentdetail.tpl.php', './template/8264', 'dianping/brand_commentdetail')
|| checktplrefresh('./template/8264/dianping/brand_commentdetail.htm', './template/8264/common/weixin_share.htm', 1509517898, '2', './data/template/2_2_dianping_brand_commentdetail.tpl.php', './template/8264', 'dianping/brand_commentdetail')
|| checktplrefresh('./template/8264/dianping/brand_commentdetail.htm', './template/8264/common/footer_8264_new.htm', 1509517898, '2', './data/template/2_2_dianping_brand_commentdetail.tpl.php', './template/8264', 'dianping/brand_commentdetail')
|| checktplrefresh('./template/8264/dianping/brand_commentdetail.htm', './template/8264/common/header_common.htm', 1509517898, '2', './data/template/2_2_dianping_brand_commentdetail.tpl.php', './template/8264', 'dianping/brand_commentdetail')
|| checktplrefresh('./template/8264/dianping/brand_commentdetail.htm', './template/8264/common/index_ad_top.htm', 1509517898, '2', './data/template/2_2_dianping_brand_commentdetail.tpl.php', './template/8264', 'dianping/brand_commentdetail')
;?>
<!doctype html>
<html>
<head>
...
<!--                                    <div class="avatar-box">
                                ...
                                <div class="comment-list-box">
                                    ...
                                    <div class="comment-word">
                                        ...
                                        <div class="attrValues pt15">
                                            <p><?php echo $pre['message'];?>
                                                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=commentdetail&amp;tid=<?php echo $pre['tid'];?>&amp;pid=<?php echo $pre['pid'];?>&amp;uid=<?php echo $pre['uid'];?>" target="_blank" class="morelink">显示全文</a>
                                            </p>
                                        </div>
                            ...
                            <div class="comment-main">
                                <div class="comment-list-box">
                                    ...
                                    <div class="comment-word">
                                        ...
                                        <div class="attrValues pt15">
                                            <p><?php echo $next['message'];?>
                                                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=commentdetail&amp;tid=<?php echo $next['tid'];?>&amp;pid=<?php echo $next['pid'];?>&amp;uid=<?php echo $next['uid'];?>" target="_blank" class="morelink">显示全文</a>
                                            </p>
                                        </div>
        ...
        <div class="col-sider">
            ...
            <div class="taglist clear_b">
            	<a href="http://www.8264.com/pinpai" target="_blank">户外品牌</a>
                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=<?php echo $detail['letter'];?>&amp;nat=<?php echo $detail['nation'];?>&amp;cp=0&amp;order=lastpost&amp;page=1" target="_blank"><?php if($detail['nation']) { ?><?php echo $cate_region[$detail['nation']];?><?php } else { ?>无<?php } ?></a>
            </div>
