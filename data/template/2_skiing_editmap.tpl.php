<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('editmap', 'common/header');
0
|| checktplrefresh('./source/plugin/skiing/template/editmap.htm', './template/8264/common/header.htm', 1507282586, 'skiing', './data/template/2_skiing_editmap.tpl.php', './source/plugin/skiing/template', 'editmap')
|| checktplrefresh('./source/plugin/skiing/template/editmap.htm', './template/8264/common/footer.htm', 1507282586, 'skiing', './data/template/2_skiing_editmap.tpl.php', './source/plugin/skiing/template', 'editmap')
|| checktplrefresh('./source/plugin/skiing/template/editmap.htm', './template/8264/common/header_common.htm', 1507282586, 'skiing', './data/template/2_skiing_editmap.tpl.php', './source/plugin/skiing/template', 'editmap')
;?>
<!doctype html>
<html>
<head>
...
<div class="tm_c" fwin="mods" style="width:700px;padding: 0 10px;background-color: #fff;">
    <h3 class="flb"><em fwin="mods"><?php echo $ski['sName'];?></em>
        <span><a title="关闭" onclick="hideWindow('editmap')" class="flbc" href="javascript:;">关闭</a></span></h3>        
        <div class="c">
            <div class="tplw">	              
                <p class="add">地址：(<?php echo $ski['pro'];?>)<?php echo $ski['kAddress'];?>&nbsp;&nbsp;&nbsp;&nbsp;</p><b class="bz">地图上标注</b>				
            </div>
...
<input type="hidden" value="<?php echo $ski['kAddress'];?>" id="sAddress" name="sAddress">				
<input type="hidden" value="<?php echo $ski['pro'];?>" id="pro" name="pro">
<input type="hidden" value="<?php echo $ski['tid'];?>" id="tid" name="tid">
                <div id="edmap"></div>				
            </div>
            <div class="mark">
...
<script type="text/javascript">
;(function($){
var tid = <?php echo $ski['tid'];?>;
var long = <?php echo $ski['longitude'];?>;
var lat = <?php echo $ski['latitude'];?>;
