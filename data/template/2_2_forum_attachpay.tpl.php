...
<div class="f_c">
<h3 class="flb">
<em id="return_<?php echo $_G['gp_handlekey'];?>">购买附件</em>
<span>
...
<tr>
<td>&nbsp;</td>
<td>你的 <?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['title'];?> 不足，无法下载</td>
</tr>
<?php } elseif($status == 2) { ?>
<tr>
<td>&nbsp;</td>
<td>你所在的用户组可以免费下载, <a href="forum.php?mod=attachment&amp;aid=<?php echo $aidencode;?>" target="_blank">下载附件</a></td>
</tr>
<?php } ?>
</table>
</div>
...
<?php } ?>
<button class="pn pnc" type="button" onclick="hideWindow('<?php echo $_G['gp_handlekey'];?>');"><span>关闭</span></button>
</div>
</div>
</form>
