<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('equipment_showview', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/dianping/header.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/dianping/nav.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/common/zhidemai.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/dianping/showview_content.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/dianping/showview_credit.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/dianping/equipment_mycomment.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/dianping/equipment_comment.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/dianping/replyedit_pic_upload.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/dianping/reply_pic_upload.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/common/hd_ad.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/dianping/footer.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/common/header_8264_new.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/common/ewm_r.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/common/weixin_share.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/common/footer_8264_new.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/common/header_common.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
|| checktplrefresh('./template/8264/dianping/equipment_showview.htm', './template/8264/common/index_ad_top.htm', 1509517872, '2', './data/template/2_2_dianping_equipment_showview.tpl.php', './template/8264', 'dianping/equipment_showview')
;
block_get('6905,6982');?>
<!doctype html>
<html>
...
jQuery(function($){
    ...
    <?php } ?>
    <!-- //值得买 -->
    <div style="margin: 20px auto 0px auto;display: none;">
        ...
        <div style=" width:980px; margin: 10px auto 0px auto;"><?php echo adshow("custom_432"); ?></div>
...
<ul class="review-pic-box" id="lunbobig"><?php if(is_array($piclist)) foreach($piclist as $k => $pic) { ?><li>
<a href="<?php if($pic['serverid']==99) { ?>http://image1.8264.com/<?php } else { ?>http://image.8264.com/<?php } ?><?php echo $pic['dir'];?>/<?php echo $pic['attachment'];?>" title="点击查看原图" target="_blank">
<img src="<?php echo getimagethumb(322,322,11, $pic['dir'].'/'.$pic['attachment'], $pic['aid'], $pic['serverid']); ?>" />
</a>
</li>
<?php } ?>
</ul>
</div>
<ul class="review-booth-tbumb" id="lunbosmall"><?php if(is_array($piclist)) foreach($piclist as $k => $pic) { ?><li class="<?php if($k==0) { ?>pic-selected<?php } else { ?>pic-item<?php } ?>">
<div class="pic-item">
<a href="<?php if($pic['serverid']==99) { ?>http://image1.8264.com/<?php } else { ?>http://image.8264.com/<?php } ?><?php echo $pic['dir'];?>/<?php echo $pic['attachment'];?>" target="_blank">
<img src="<?php echo getimagethumb(48,48,2, $pic['dir'].'/'.$pic['attachment'], $pic['aid'], $pic['serverid']); ?>" />
</a>
</div>
</li>
<?php } ?>
...
(<span class="num"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $tid;?>#comment"><?php echo $detail['cnum'];?></a></span>人评分)
</div>
...
<div class="rm-rechart-full" style="width:<?php if($detail['percent5']) { ?><?php echo $detail['percent5'];?><?php } else { ?>0<?php } ?>%;"></div>
</div>
<div class="rm-rechart-val"><?php if($detail['percent5']) { ?><?php echo $detail['percent5'];?><?php } else { ?>0<?php } ?>% (力荐)</div>
</div>
...
<span class="detail-item cate">
<i class="ui-icon"></i><a href="http://www.8264.com/dianping.php?mod=equipment&amp;act=showlist&amp;order=lastpost&amp;pcid=<?php echo $detail['pcid'];?>&amp;cid=<?php echo $detail['cid'];?>&amp;bid=0&amp;page=1" target="_blank" title="<?php echo $detail['cname'];?>"><?php echo $detail['cname'];?></a>
</span>
<span class="detail-item price">
<i class="ui-icon"></i><?php if($detail['price'] != '0.00') { ?>￥<?php echo $detail['price'];?><?php } else { ?>暂无报价<?php } ?>
</span>
<span class="detail-item brand">
<i class="ui-icon"></i><?php if($detail['brandid']) { ?><a href="http://www.8264.com/dianping.php?mod=equipment&amp;act=showlist&amp;order=lastpost&amp;pcid=0&amp;cid=0&amp;bid=<?php echo $detail['brandid'];?>&amp;page=1" title="<?php echo $detail['brandname'];?>更多产品" target="_brank"><?php echo $detail['brandname'];?>更多产品</a><?php } else { ?><?php echo $detail['brandname'];?><?php } ?>
</span>
<span class="detail-item brand">
<i class="ui-icon"></i>
<?php if($detail['brandtid']) { ?><a href="http://www.8264.com/pinpai-<?php echo $detail['brandtid'];?>" title="<?php echo $detail['brandname'];?>品牌介绍" target="_brank"><?php echo $detail['brandname'];?>品牌介绍</a><?php } else { ?><?php echo $detail['brandname'];?><?php } ?>
</span>
</div>
<?php if($detail['dgurl']) { ?>
<a href="<?php echo $detail['dgurl'];?>" rel="nofollow" title="点这去购买<?php echo $detail['subject'];?>" target="_brank" class="buyit">去购买</a>
<?php } ?>
</div>
</div>
...
<!-- //detail -->
                        ...
                        <div style=" margin:35px 0px;"><?php echo adshow("custom_341"); ?></div>
<div class="ui-grid-6 ui-grid-left">
...
<!-- 我的点评 -->
<div id="mycomment">
<?php if($mycomment) { ?><div class="review-comment-box">
<div class="ui-block ui-block-title">
...
<?php } if($mycomment['extdata']) { ?>
<div class="rows-content row-color-2">
<div class="commAttr" style="padding:3px 4px">价格来源</div>
<div class="attrValues">
<p><?php $extdata = unserialize($mycomment['extdata']); echo $extdata['price'] ?></p>
</div>
</div>
...
<span class="rows-title"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $mycomment['tid'];?>" title="<?php echo $mycomment['subject'];?>" target="_blank"><?php echo cutstr($mycomment['subject'], 40); ?></a></span>
...
<div class="ui-block ui-block-content">
<div class="comment-main"  id="commentlist"><div class="comment-main"><?php $k = 0; if(is_array($commentlist)) foreach($commentlist as $comment) { ?><div id="post_<?php echo $comment['pid'];?>" class="comment-list-box">
<div class="avatar-box">
...
<textarea name="extdata" id="extdata_e" cols="30" rows="2"></textarea>
<div id="extdata_eTip" class="valid-tips-container"></div>
</div>
</div>
</div>
<div class="rows-content row-color-3">
...
<!-- 编辑页添加图片上传表单 --><div class="rows-content row-color-6">
    <div class="commAttr">
        <i class="attrs-icon picture"></i>图片
    </div>
    <dl class="pubDt50">
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="extdata" id="extdata" cols="30" rows="2" placeholder="请写明自己从哪里得到的，入手时间，购买价格，不写者一律不奖励8264币"></textarea>
<div id="extdataTip" class="valid-tips-container"></div>
</div>
</div>
</div>
<div class="rows-content row-color-3">
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="weakpoint" id="weakpoint" cols="30" rows="2" placeholder="请结合自己使用一段时间后的感受详细说明该装备本身的缺点，价格知名度不是装备本身的缺点，没有写明自己实际使用体会的一律不奖励8264币"></textarea>
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="goodpoint" id="goodpoint" cols="30" rows="2" placeholder="请结合自己的使用感受说明该装备的优点，把说明书里的文字重新编辑不奖励8264币"></textarea>
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="message" id="message" cols="30" rows="6" placeholder="请结合自己的使用感受综合对该装备进行客观评价，描述缺点多的优先加币，胡编乱造捧臭脚的一律不加币"></textarea>
<div id="messageTip" class="valid-tips-container"></div>
</div>
</div>
</div>
<!-- 发布页图片上传 --><?php if($_G['uid']) { ?>
<div class="rows-content row-color-6">
    <div class="commAttr">
        <i class="attrs-icon picture"></i>图片
    </div>
...
<ul><?php if(is_array($relatedthread)) foreach($relatedthread as $thread) { ?><li>
<div class="imgbox"><a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" target="_blank" rel="nofollow"><?php echo avatar($thread['authorid'], small); ?></a></div>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>" target="_blank" title="<?php echo $thread['subject'];?>"><?php echo $thread['subject'];?></a></h3>
<div class="comm-review">
<span class="comm-num" title="<?php echo $thread['replies'];?>条回复"><i class="ui-icon icon-comm"></i><?php echo $thread['replies'];?></span>
<span class="review-num" title="<?php echo $thread['views'];?>次浏览"><i class="ui-icon icon-comm"></i><?php echo $thread['views'];?></span>
</div>
</div>
</li>
<?php } ?>
...
<div class="ui-block ui-block-title">
<div class="ui-title ui-title-line">
<h3><?php echo $detail['subject'];?>同类装备</h3>
</div>
</div>
<div class="ui-block ui-block-content">
<div class="common-list-box eq-list-box">
<ul class="eq-list"><?php if(is_array($sidebar_cate)) foreach($sidebar_cate as $k => $item) { ?><li>
<div class="imgbox"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" target="_blank"><img src="<?php echo getimagethumb(60,60,2, $item['dir'].'/'.$item['showimg'], 0, $item['serverid']); ?>" alt=""></a></div>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="<?php echo $item['subject'];?>" target="_blank"<?php if($k==0) { ?> class="orange"<?php } elseif($k==1 || $k==2) { ?> class="blue"<?php } ?>><?php echo $item['subject'];?></a></h3>
<div class="star-comm">
...
<span class="comm-num" title="<?php echo $item['cnum'];?>人参与点评"><i class="ui-icon icon-comm"></i><?php echo $item['cnum'];?></span>
</div>
</div>
</li>
<?php } ?>
...
<?php if($sidebar_brand) { ?>
<div class="ui-grid-2 ui-grid-right">
<!-- 同品牌装备 -->
<div class="right-hot-eq-warpten">
<div class="ui-block ui-block-title">
<div class="ui-title ui-title-line">
<h3><?php echo $detail['subject'];?>同品牌装备</h3>
</div>
</div>
<div class="ui-block ui-block-content">
<div class="common-list-box eq-list-box">
<ul class="eq-list"><?php if(is_array($sidebar_brand)) foreach($sidebar_brand as $k => $item) { ?><li>
<div class="imgbox"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" target="_blank"><img src="<?php echo getimagethumb(60,60,2, $item['dir'].'/'.$item['showimg'], 0, $item['serverid']); ?>" alt=""></a></div>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="<?php echo $item['subject'];?>" target="_blank"<?php if($k==0) { ?> class="orange"<?php } elseif($k==1 || $k==2) { ?> class="blue"<?php } ?>><?php echo $item['subject'];?></a></h3>
<div class="star-comm">
...
<div class="ui-block ui-block-content">
<div class="common-list-box eq-list-box">
<ul class="eq-list"><?php if(is_array($sidebar_hot)) foreach($sidebar_hot as $k => $item) { ?><li>
<div class="imgbox"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" target="_blank"><img src="<?php echo getimagethumb(60,60,2, $item['dir'].'/'.$item['showimg'], 0, $item['serverid']); ?>" alt=""></a></div>
<div class="list-bd">
<h3 class="ilist-bd-title"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="<?php echo $item['subject'];?>" target="_blank"<?php if($k==0) { ?> class="orange"<?php } elseif($k==1 || $k==2) { ?> class="blue"<?php } ?>><?php echo $item['subject'];?></a></h3>
<div class="star-comm">
...
<span class="comm-num" title="<?php echo $item['cnum'];?>人参与点评" style="zoom:1"><i class="ui-icon icon-comm"></i><?php echo $item['cnum'];?></span>
</div>
</div>
</li>
<?php } ?>
...
<!--<div class="friendLink"><?php block_display('6982'); ?></div>-->
<div class="friendLink">
    <div id="portal_block_6982" class="block move-span">
        <div id="portal_block_6982_content" class="content">
            <div class="portal_block_summary">
                <div class="friendLinkcon">
                    <span>热门相机品牌</span>
                    <?php if(is_array($show_all_brand)) foreach($show_all_brand as $brand) { ?>                        <?php if($brand['brandid'] != -1 && $brand['brandid'] != 821 && $brand['brandid'] != 671 && $brand['brandid'] != 16 && $brand['brandid'] != 229 && $brand['brandid'] != 275 && $brand['brandid'] != 248 && $brand['brandid'] != 808 ) { ?>
                            <a title="<?php echo $brand['brandname'];?>" target="_blank" href="http://www.8264.com/zhuangbei-21-113-<?php echo $brand['brandid'];?>-5-1.html"> <?php echo $brand['brandname'];?>相机</a>
                        <?php } ?>
                    <?php } ?>

                </div>
                <div class="friendLinkcon">
                    <?php if(is_array($hot_xiangji)) foreach($hot_xiangji as $rand) { ?>                        <a title="<?php echo $rand['subject'];?>" target="_blank" href="http://www.8264.com/zhuangbei-<?php echo $rand['tid'];?>-1.html"> <?php echo $rand['subject'];?></a>
                    <?php } ?>
                </div>
            </div>
        </div>
...
var extdata = $.trim($("#postform #extdata").val());
...
if(extdata.length<10 || weakpoint.length<10 || goodpoint.length <10 || message.length <10 || starnum == 0){
return false;
}
<?php if(checkperm('seccode') && ($secqaacheck || $seccodecheck)) { ?>
...
var postUrll='http://www.8264.com/dianping.php?mod=misc&act=dopost&model=equipment&do=newsave&tid=<?php echo $detail['tid'];?>';
var stararray=['很差','较差','还行','推荐','力荐'];
$.post(postUrll,{starnum:starnum,goodpoint:goodpoint,weakpoint:weakpoint,message:message,extdata:extdata,formhash:'<?php echo FORMHASH;?>',replypostsubmit:'yes',imgselect:imgselect},
function(data){
if(data == '-1'){
alert('你需要登陆后才能评价');
...
var extdata = $.trim($("#editform #extdata_e").val());
...
if(extdata.length<10 || weakpoint.length<10 || goodpoint.length <10 || message.length <10 || starnum == 0){
alert("评分|价格来源|不足|优点|综合 必填项不能为空");
return false;
}
 //图片aid获取
var imgselect = new Array();
...
var postUrll='http://www.8264.com/dianping.php?mod=misc&act=dopost&model=equipment&do=editsave&tid=<?php echo $detail['tid'];?>';
var stararray=['很差','较差','还行','推荐','力荐'];
$.post(postUrll,{starnum:starnum,goodpoint:goodpoint,pid:pid,weakpoint:weakpoint,extdata:extdata,message:message,formhash:'<?php echo FORMHASH;?>',replypostsubmit:'yes',imgselect:imgselect},
function(data){
if(data == '-2'){
alert('修改失败');
$('#overlay').remove();
...
$('#editform #extdata_e').val((data['extdata']));
...
empty: false,
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该产品的综合评价，不能少于10个字符。</span></div>'
});
//缺点
...
empty: false,
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该产品的不足之处，不能少于10个字符。</span></div>'
});
//优点
...
empty: false,
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该产品的优点，不能少于10个字符</span></div>'
});
//价格来源
$('#extdata').formValidator({
onShow: '',
...
empty: false,
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请认真填写产品的价格来源，不能少于10个字符</span></div>'
});
