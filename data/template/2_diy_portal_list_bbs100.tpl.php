<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_bbs100', 'common/header');
0
|| checktplrefresh('./template/8264/portal/list_bbs100.htm', './template/8264/common/header.htm', 1509518029, 'diy', './data/template/2_diy_portal_list_bbs100.tpl.php', './template/8264', 'portal/list_bbs100')
|| checktplrefresh('./template/8264/portal/list_bbs100.htm', './template/8264/common/footer.htm', 1509518029, 'diy', './data/template/2_diy_portal_list_bbs100.tpl.php', './template/8264', 'portal/list_bbs100')
|| checktplrefresh('./template/8264/portal/list_bbs100.htm', './template/8264/common/header_common.htm', 1509518029, 'diy', './data/template/2_diy_portal_list_bbs100.tpl.php', './template/8264', 'portal/list_bbs100')
;
block_get('4594');?>
<!doctype html>
<html>
...
<div id="wp" class="wp">
<link href="template/8264/css/channel/channel_bbs100.css" rel="stylesheet" type="text/css" />
<script src="http://www.8264.com/static/js/jquery-1.6.1.min.js" type="text/javascript"></script>
<div class="warpten">
<div class="navcon">
<?php echo $subject;?> <b>(<?php echo $tm;?>)</b>
</div>
<div class="l">
<!--单条循环开始-->
<?php if($bbs) { if(is_array($bbs)) foreach($bbs as $thread) { ?><div class="bbsoneall">
<h2>
<?php if($thread['name']) { ?> <em>[
<a href="http://bbs.8264.com/forum-forumdisplay-fid-<?php echo $thread['fid'];?>-filter-typeid-typeid-<?php echo $thread['typeid'];?>.html"><?php echo $thread['name'];?></a>
]</em> 
&nbsp;
<?php } ?>
<a href="http://bbs.8264.com/thread-<?php echo $thread['tid'];?>-1-1.html" target="_blank"><?php echo $thread['subject'];?></a>
</h2>
<div class="bbsoneh1down">
<span>发帖时间：<?php echo $thread['dateline'];?></span>
<span>最后回复时间：<?php echo $thread['lastpost'];?></span>
<span>回复数：<?php echo $thread['replies'];?></span>
<span>总浏览数：<?php echo $thread['views'];?></span>
<span>热度值：<?php echo $thread['heats'];?></span>
</div>
<div class="bbsone">
<div class="touimgall">
<a href="home.php?mod=space&amp;uid=<?php echo $thread['authorid'];?>" target="_blank"><?php echo $thread['avatar'];?></a>
<div class="touname">
...
<!--单条开始-->
<div class="menu">
<div class="rtitle">论坛热度排行</div>
<ul>
<li>
<a href="http://www.8264.com/portal.php?mod=list&amp;catid=874&amp;filter=heats&amp;dateline=7">7天内排行</a>
</li>
<li>
<a href="http://www.8264.com/portal.php?mod=list&amp;catid=874&amp;filter=heats&amp;dateline=30">30天内排行</a>
</li>
<li>
<a href="http://www.8264.com/portal.php?mod=list&amp;catid=874&amp;filter=heats&amp;dateline=all">总排行</a>
</li>
</ul>
</div>
<!--单条结束-->
<div class="menu">
<div class="rtitle">论坛点击排行</div>
<ul>
<li>
<a href="http://www.8264.com/portal.php?mod=list&amp;catid=874&amp;filter=views&amp;dateline=7">7天内排行</a>
</li>
<li>
<a href="http://www.8264.com/portal.php?mod=list&amp;catid=874&amp;filter=views&amp;dateline=30">30天内排行</a>
</li>
<li>
<a href="http://www.8264.com/portal.php?mod=list&amp;catid=874&amp;filter=views&amp;dateline=all">总排行</a>
</li>
</ul>
</div>
<div class="menu">
<div class="rtitle">论坛回帖排行</div>
<ul>
<li>
<a href="http://www.8264.com/portal.php?mod=list&amp;catid=874&amp;filter=replies&amp;dateline=7">7天内排行</a>
</li>
<li>
<a href="http://www.8264.com/portal.php?mod=list&amp;catid=874&amp;filter=replies&amp;dateline=30">30天内排行</a>
</li>
<li>
<a href="http://www.8264.com/portal.php?mod=list&amp;catid=874&amp;filter=replies&amp;dateline=all">总排行</a>
</li>
</ul>
</div>
</div>
...
jQuery.noConflict();	
;(function($) {
var btns_top = $('#rl').offset().top;			
$(window).scroll(function() {				
if ($(document).scrollTop()>= btns_top) {
...
</script><?php block_display('4594'); ?></div>
