<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('fishing_showview', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/dianping/header.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/dianping/nav.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/common/zhidemai.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/dianping/showview_content.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/dianping/showview_credit.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/dianping/fishing_mycomment.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/dianping/fishing_comment.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/dianping/replyedit_pic_upload.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/dianping/reply_pic_upload.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/dianping/sidebar_map.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/common/hd_ad.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/dianping/footer.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/common/header_8264_new.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/common/ewm_r.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/common/weixin_share.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/common/footer_8264_new.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/common/header_common.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
|| checktplrefresh('./template/8264/dianping/fishing_showview.htm', './template/8264/common/index_ad_top.htm', 1509518035, '2', './data/template/2_2_dianping_fishing_showview.tpl.php', './template/8264', 'dianping/fishing_showview')
;
block_get('7031,7010');?>
<!doctype html>
<html>
...
<i class="ui-icon"></i>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=<?php if($detail['type']==195 || $detail['type']==196) { ?>194<?php } elseif($detail['type']==198 || $detail['type']==199 || $detail['type']==200 ) { ?>197<?php } elseif($detail['type']==201 ) { ?>201<?php } ?>&amp;isfree=0&amp;provinceid=0&amp;cityid=0&amp;order=lastpost&amp;page=1" target="_brank"><?php echo $catetype[$detail['type']];?></a>,
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=0&amp;isfree=<?php echo $detail['isfree'];?>&amp;provinceid=0&amp;cityid=0&amp;order=lastpost&amp;page=1" target="_brank"><?php echo $cate_isfree[$detail['isfree']];?></a>
</span>
                        </div>
                    </div>
                </div>
...
<?php if($_GET['inajax'] == 1) { ?><?php dp_output(); } ?>
    ...
    <!-- //我的点评 -->
    <?php if(!$commentlist) { ?>
    <div style="margin:16px 0px 30px 0px; display:none;"><img src="http://static.8264.com/dianping/images/demo/dyyb.jpg"></div>
    <?php } ?>
    <?php if($commentlist) { ?>
        ...
        <div class="ui-block ui-block-content">
            <div class="comment-form-box">
                ...
                <div class="rows-content row-color-3">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="weakpoint" id="weakpoint" cols="30" rows="2" placeholder="请填写该钓鱼场地的不足之处"></textarea>
                ...
                <div class="rows-content row-color-4">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="goodpoint" id="goodpoint" cols="30" rows="2" placeholder="请填写该钓鱼场地的优点"></textarea>
                ...
                <div class="rows-content row-color-5">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="message" id="message" cols="30" rows="6" placeholder="请填写该钓鱼场地的综合评价"></textarea>
    ...
    <div class="ui-grid-2 ui-grid-right">
        ...
        <div class="right-hot-warpten">
            <div class="ui-block ui-block-title">
                <div class="ui-title ui-title-line">
                    <h3>热门</h3>
                    <div class="ui-title-link"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=0&amp;isfree=0&amp;provinceid=0&amp;cityid=0&amp;order=heats&amp;page=1" target="_brank">more</a></div>
                </div>
            </div>
            <div class="ui-block ui-block-content">
    ...
    <div class="ui-grid-2 ui-grid-right">
        <div class="right-same-area-warpten">
            <div class="ui-block ui-block-title">
                <div class="ui-title ui-title-line">
                    <h3>同地区</h3>
                    <div class="ui-title-link"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;type=0&amp;isfree=0&amp;provinceid=<?php echo $detail['provinceid'];?>&amp;cityid=0&amp;order=lastpost&amp;page=1" target="_brank">more</a></div>
                </div>
            </div>
            <div class="ui-block ui-block-content">
...
<div class="choiceness">
        <?php block_display('7031'); ?></div>
</div>
<div class="friendLink"><?php block_display('7010'); ?></div>
<script>
    (function($){
        $(function(){
            //添加点评
...
$(":submit",this).attr("disabled","disabled");
    ...
    jQuery(document).ready(function($) {
        ...
        $('#message').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该钓鱼场地的综合评价。</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该钓鱼场地的综合评价，不能少于10个字符。</span></div>'
        });
        //缺点
        $('#weakpoint').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该钓鱼场地的不足之处。</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该钓鱼场地的不足之处，不能少于10个字符。</span></div>'
        });
        //优点
        $('#goodpoint').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该钓鱼场地的优点</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该钓鱼场地的优点，不能少于10个字符</span></div>'
        });
