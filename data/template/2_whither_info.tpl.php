<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('info', 'common/header_8264_new');
0
|| checktplrefresh('./source/plugin/whither/template/info.htm', './template/8264/common/header_8264_new.htm', 1508282244, 'whither', './data/template/2_whither_info.tpl.php', './source/plugin/whither/template', 'info')
|| checktplrefresh('./source/plugin/whither/template/info.htm', './template/8264/common/footer_8264_new.htm', 1508282244, 'whither', './data/template/2_whither_info.tpl.php', './source/plugin/whither/template', 'info')
|| checktplrefresh('./source/plugin/whither/template/info.htm', './template/8264/common/header_common.htm', 1508282244, 'whither', './data/template/2_whither_info.tpl.php', './source/plugin/whither/template', 'info')
|| checktplrefresh('./source/plugin/whither/template/info.htm', './template/8264/common/index_ad_top.htm', 1508282244, 'whither', './data/template/2_whither_info.tpl.php', './source/plugin/whither/template', 'info')
;?>
<!doctype html>
<html>
<head>
...
<div class="z" style="line-height:30px;"><?php echo $forumoption_mudidi->getBreadcrumbNavByTid($mudidi_info['tid']); ?> <em>&rsaquo;</em> <?php echo $mudidi_info['name'];?>
</div>
</div>
...
<h4>
<span style="float:right; font-size:12px; font-weight:normal; line-height:40px;">
<?php if($_G['uid'] && $_G['group']['radminid'] > 0) { ?>
<a href="/plugin.php?id=whither:pubinfo&amp;tid=<?php echo $mudidi_info['tid'];?>">发布新信息</a> <span class="pipe">|</span>
<a href="/plugin.php?id=whither:pubinfo&amp;tid=<?php echo $mudidi_info['tid'];?>&amp;infoid=<?php echo $infoid;?>">编辑</a> <span class="pipe">|</span>
<?php if($mudidi_info['default'] == 0) { ?>
<a href="/plugin.php?id=whither:delinfo&amp;infoid=<?php echo $infoid;?>">删除<?php echo $mudidi_info['name'];?>信息</a> <span class="pipe">|</span>
<?php } } ?>
<a href="/forum.php?mod=viewthread&amp;tid=<?php echo $mudidi_data['tid'];?>" class="link_blue">返回<?php echo $mudidi_data['subject'];?></a>
</span>
<?php echo $mudidi_info['name'];?>
</h4>
<div class="info">
<?php if($mudidi_info['message']) { ?>
<?php echo $mudidi_info['message'];?>
<?php } else { ?>
<p>
<?php if($_G['uid'] && $_G['group']['radminid'] > 0) { ?>
<?php echo $mudidi_info['name'];?>目前尚无内容, <a href="/plugin.php?id=whither:pubinfo&amp;tid=<?php echo $mudidi_info['tid'];?>&amp;infoid=<?php echo $infoid;?>">点击添加</a>
<?php } else { ?>
信息正在完善中...
<?php } ?>
</p>
...
<?php if($scapeareaTid) { ?><?php $guideData = $forumoption_mudidi->getGuideByTid($scapeareaTid, 5); } if($guideData) { ?>
<div class="bm vw pl guide_list">
<div class="bm_h cl">
<h2>
<a href="/plugin.php?id=whither:guidelist&amp;tid=<?php echo $mudidi_info['tid'];?>" class="more">更多攻略</a>
<?php echo $mudidi_data['subject'];?>攻略大全
<span class="pub_guide">
<a href="http://bbs.8264.com/forum-post-action-newthread-fid-52.html?mtid=<?php echo $tid;?>">发布攻略</a>
</span>
</h2>
</div>
...
<?php } ?>
</div><?php include DISCUZ_ROOT.'./source/plugin/whither/template/_sidebar.php'; ?></div>
