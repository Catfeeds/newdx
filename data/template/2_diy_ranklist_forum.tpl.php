<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('forum', 'common/header');
0
|| checktplrefresh('./template/default/ranklist/forum.htm', './template/8264/common/header.htm', 1501882228, 'diy', './data/template/2_diy_ranklist_forum.tpl.php', './template/8264', 'ranklist/forum')
|| checktplrefresh('./template/default/ranklist/forum.htm', './template/default/common/simplesearchform.htm', 1501882228, 'diy', './data/template/2_diy_ranklist_forum.tpl.php', './template/8264', 'ranklist/forum')
|| checktplrefresh('./template/default/ranklist/forum.htm', './template/default/ranklist/side_left.htm', 1501882228, 'diy', './data/template/2_diy_ranklist_forum.tpl.php', './template/8264', 'ranklist/forum')
|| checktplrefresh('./template/default/ranklist/forum.htm', './template/8264/common/footer.htm', 1501882228, 'diy', './data/template/2_diy_ranklist_forum.tpl.php', './template/8264', 'ranklist/forum')
|| checktplrefresh('./template/default/ranklist/forum.htm', './template/8264/common/header_common.htm', 1501882228, 'diy', './data/template/2_diy_ranklist_forum.tpl.php', './template/8264', 'ranklist/forum')
;?>
<!doctype html>
<html>
<head>
...
<h1 class="mt">版块排行</h1>
<ul class="tb cl">
<li<?php if($_G['gp_orderby'] == 'threads') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=forum&amp;orderby=threads">发帖排行</a></li>
<li<?php if($_G['gp_orderby'] == 'posts') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=forum&amp;orderby=posts">回复排行</a></li>
<li<?php if($_G['gp_orderby'] == 'thismonth') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=forum&amp;orderby=thismonth">最近 30 天发帖排行</a></li>
<li<?php if($_G['gp_orderby'] == 'today') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=forum&amp;orderby=today">最近 24 小时发帖排行</a></li>
</ul>
<?php if($forumsrank) { ?>
<div class="tl">
<table cellspacing="0" cellpadding="0">
