<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_8264list', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/portal/list_8264list.htm', './template/8264/common/header_8264_new.htm', 1509520052, 'diy', './data/template/2_diy_portal_list_8264list.tpl.php', './template/8264', 'portal/list_8264list')
|| checktplrefresh('./template/8264/portal/list_8264list.htm', './template/8264/common/zhidemai.htm', 1509520052, 'diy', './data/template/2_diy_portal_list_8264list.tpl.php', './template/8264', 'portal/list_8264list')
|| checktplrefresh('./template/8264/portal/list_8264list.htm', './template/8264/common/weixin_share_bottom.htm', 1509520052, 'diy', './data/template/2_diy_portal_list_8264list.tpl.php', './template/8264', 'portal/list_8264list')
|| checktplrefresh('./template/8264/portal/list_8264list.htm', './template/8264/common/footer_8264_new.htm', 1509520052, 'diy', './data/template/2_diy_portal_list_8264list.tpl.php', './template/8264', 'portal/list_8264list')
|| checktplrefresh('./template/8264/portal/list_8264list.htm', './template/8264/common/header_common.htm', 1509520052, 'diy', './data/template/2_diy_portal_list_8264list.tpl.php', './template/8264', 'portal/list_8264list')
|| checktplrefresh('./template/8264/portal/list_8264list.htm', './template/8264/common/index_ad_top.htm', 1509520052, 'diy', './data/template/2_diy_portal_list_8264list.tpl.php', './template/8264', 'portal/list_8264list')
;
...
<?php } ?>
<!-- //手机绑定提示 -->
<!--[name]8264新闻列表模板[/name]--><?php $list = array(); ?><?php $wheresql = category_get_wheresql($cat); ?><?php $list = category_get_list($cat, $wheresql, $page); ?><link href="http://static.8264.com/static/css/portal/list8264_style.css" rel="stylesheet" type="text/css">
