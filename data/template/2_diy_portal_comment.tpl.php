...
0
|| checktplrefresh('./template/default/portal/comment.htm', './template/8264/common/header.htm', 1509432143, 'diy', './data/template/2_diy_portal_comment.tpl.php', './template/8264', 'portal/comment')
|| checktplrefresh('./template/default/portal/comment.htm', './template/default/common/simplesearchform.htm', 1509432143, 'diy', './data/template/2_diy_portal_comment.tpl.php', './template/8264', 'portal/comment')
|| checktplrefresh('./template/default/portal/comment.htm', './template/8264/common/footer.htm', 1509432143, 'diy', './data/template/2_diy_portal_comment.tpl.php', './template/8264', 'portal/comment')
|| checktplrefresh('./template/default/portal/comment.htm', './template/8264/common/header_common.htm', 1509432143, 'diy', './data/template/2_diy_portal_comment.tpl.php', './template/8264', 'portal/comment')
;?>
<!doctype html>
<html>
<head>
...
<div class="bm vw">
<div class="h hm">
<h1 class="ph"><a href="portal.php?mod=view&amp;aid=<?php echo $aid;?>"><?php echo $article['title'];?></a></h1>
<p>评论 (<?php echo $article['commentnum'];?>)<span class="pipe">|</span><a href="portal.php?mod=comment&amp;aid=<?php echo $aid;?>#message" class="xi2 xw1">发表评论</a></p>
</div>
<div class="bm_c"><?php if(is_array($commentlist)) foreach($commentlist as $comment) { include template('portal/comment_li'); } if($pricount) { ?>
<p class="mbw">提示：本页有 <?php echo $pricount;?> 个评论因未通过审核而被隐藏</p>
<?php } ?>
