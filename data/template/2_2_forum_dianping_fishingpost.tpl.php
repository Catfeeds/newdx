<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('fishingpost', 'forum/dianping/header');
0
|| checktplrefresh('./template/8264/forum/dianping/fishingpost.htm', './template/8264/forum/dianping/header.htm', 1504438612, '2', './data/template/2_2_forum_dianping_fishingpost.tpl.php', './template/8264', 'forum/dianping/fishingpost')
|| checktplrefresh('./template/8264/forum/dianping/fishingpost.htm', './template/8264/forum/dianping/editor_2014_second.htm', 1504438612, '2', './data/template/2_2_forum_dianping_fishingpost.tpl.php', './template/8264', 'forum/dianping/fishingpost')
|| checktplrefresh('./template/8264/forum/dianping/fishingpost.htm', './template/8264/forum/dianping/editor_2014_first.htm', 1504438612, '2', './data/template/2_2_forum_dianping_fishingpost.tpl.php', './template/8264', 'forum/dianping/fishingpost')
|| checktplrefresh('./template/8264/forum/dianping/fishingpost.htm', './template/8264/forum/dianping/footer.htm', 1504438612, '2', './data/template/2_2_forum_dianping_fishingpost.tpl.php', './template/8264', 'forum/dianping/fishingpost')
|| checktplrefresh('./template/8264/forum/dianping/fishingpost.htm', './template/8264/common/header_8264_new.htm', 1504438612, '2', './data/template/2_2_forum_dianping_fishingpost.tpl.php', './template/8264', 'forum/dianping/fishingpost')
|| checktplrefresh('./template/8264/forum/dianping/fishingpost.htm', './template/8264/common/editor_2014.htm', 1504438612, '2', './data/template/2_2_forum_dianping_fishingpost.tpl.php', './template/8264', 'forum/dianping/fishingpost')
|| checktplrefresh('./template/8264/forum/dianping/fishingpost.htm', './template/8264/forum/editor_menu_forum_newimage_2014.htm', 1504438612, '2', './data/template/2_2_forum_dianping_fishingpost.tpl.php', './template/8264', 'forum/dianping/fishingpost')
|| checktplrefresh('./template/8264/forum/dianping/fishingpost.htm', './template/8264/common/ewm_r.htm', 1504438612, '2', './data/template/2_2_forum_dianping_fishingpost.tpl.php', './template/8264', 'forum/dianping/fishingpost')
|| checktplrefresh('./template/8264/forum/dianping/fishingpost.htm', './template/8264/common/footer_8264_new.htm', 1504438612, '2', './data/template/2_2_forum_dianping_fishingpost.tpl.php', './template/8264', 'forum/dianping/fishingpost')
|| checktplrefresh('./template/8264/forum/dianping/fishingpost.htm', './template/8264/common/header_common.htm', 1504438612, '2', './data/template/2_2_forum_dianping_fishingpost.tpl.php', './template/8264', 'forum/dianping/fishingpost')
|| checktplrefresh('./template/8264/forum/dianping/fishingpost.htm', './template/8264/common/index_ad_top.htm', 1504438612, '2', './data/template/2_2_forum_dianping_fishingpost.tpl.php', './template/8264', 'forum/dianping/fishingpost')
|| checktplrefresh('./template/8264/forum/dianping/fishingpost.htm', './template/8264/common/taobao_ad_alert.htm', 1504438612, '2', './data/template/2_2_forum_dianping_fishingpost.tpl.php', './template/8264', 'forum/dianping/fishingpost')
;?>
<!doctype html>
<html>
<head>
...
<div class="pubWeb">
<h1 class="tit20 mb45"><?php if(($action=='new')) { ?>发布<?php echo $modname;?><?php } else { ?>编辑<?php echo $modname;?><?php } ?>点</h1>
<div class="bd">
...
<?php } ?>" onsubmit="return fishing_validate(this);">
...
<?php if($action=='new') { ?><input type="hidden" name="dateline" id="dateline" value="<?php echo TIMESTAMP;?>" /><?php } if($action == 'edit') { ?><input type="hidden" name="pid" value="<?php echo $editdata['pid'];?>" /><?php } ?>
<dl class="pubDt50">
<dt><span class="icoName48x43"></span></dt>
<dd>
<span class="inputTipsText">
<?php if($action=='new') { ?><label class="fs16"><?php echo $modname;?>点<?php echo $modsetting['mc'];?></label><?php } ?>
...
<input type="hidden" name="pro" id="province" value="<?php echo $editdata['provinceid'];?>" />
<input type="text" value="<?php if($editdata['provinceid']) { ?>已选择省份: <?php echo $provinces[$editdata['provinceid']]['cityname'];?><?php } else { ?>请选择省份<?php } ?>" class="diqu js" readonly="readonly"/>
<div class="qy_down"><?php if(is_array($provinces)) foreach($provinces as $province) { ?><a rel="<?php echo $province['codeid'];?>" href="javascript:void(0);" class="province" execute="ajaxGetCity"><?php echo $province['cityname'];?></a>
<?php } ?>
</div>
</div>
</span>
<span class="inputTipsText2">
<div class="qy selectdown " style="z-index:500;" >
<input type="hidden" name="city" id="city" value="<?php echo $editdata['cityid'];?>" />
<input type="text" value="<?php if($editdata['cityid']) { ?>已选择城市: <?php echo $cities[$editdata['cityid']]['cityname'];?><?php } else { ?>请选择城市<?php } ?>" class="diqu js" readonly="readonly"/>
<div class="qy_down">
...
<span id="xq"></span>
<span class="inputTipsText">
<label class="fs16"<?php if($editdata['addr']) { ?> style="display:none;"<?php } ?>><?php echo $modsetting['address'];?>：不要重复填写省、市地区</label>
...
<span class="rdlx">请选择鱼场类型</span><?php if(is_array($fishingTypes)) foreach($fishingTypes as $tk => $tv) { ?><input type="radio" name="type" value="<?php echo $tk;?>" <?php if($tk == $editdata['type']) { ?>checked="checked"<?php } ?> id="type_<?php echo $tk;?>">
<label for="type_<?php echo $tk;?>" class="ml10 fs214"><?php echo $tv;?></label>
<?php } ?>
</dd>
</dl>
...
<input type="radio" name="isfree" value="1" <?php if($editdata['isfree'] == 1) { ?>checked="checked"<?php } ?> id="notfree" />
<label for="notfree" class="ml10 fs214">收费</label>
<input type="radio" name="isfree" value="2" <?php if($editdata['isfree'] == '2') { ?>checked="checked"<?php } if($action == 'new') { ?> checked="checked" <?php } ?> id="isfree" />
...
<span class="inputTipsText">
<label class="fs16" <?php if($editdata['tel']) { ?>style="display: none;"<?php } ?>>如：58585678</label>
<input type="text" class="inputText w270" name="tel" id="telephone" value="<?php echo $editdata['tel'];?>" />
</span>
</dd>
</dl>
...
var require = {'subject': {'empty':"请填写<?php echo $modname;?>名称", 'len>80': "您的<?php echo $modname;?>名称超过 80 个字符的限制"},
'uploadfile': {'pnumber': "请上传<?php echo $modname;?>图片，并至少选择一张"},
'pro': {'number': "请选择<?php echo $modname;?>所在省份"},
'city': {'number': "请选择<?php echo $modname;?>所在城市"},
'address': {'empty': "请填写<?php echo $modname;?>详细地址"},
'type': {'number': "请选择<?php echo $modname;?>鱼场类型"},
'isfree': {'number': "请选择<?php echo $modname;?>是否免费"},
//'tel': {'telephone': "请填写正确的联系电话"},
'message': {'empty': "请填写<?php echo $modname;?>简介", 'len<50': "<?php echo $modname;?>字数不少于50字"},
<?php if($action != 'edit' && checkperm('seccode') && ($secqaacheck || $seccodecheck)) { ?>
