<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('actplat', 'dianping/header');
0
|| checktplrefresh('./template/8264/portal/actplat.htm', './template/8264/dianping/header.htm', 1509078932, 'diy', './data/template/2_diy_portal_actplat.tpl.php', './template/8264', 'portal/actplat')
|| checktplrefresh('./template/8264/portal/actplat.htm', './template/8264/common/footer_8264_new.htm', 1509078932, 'diy', './data/template/2_diy_portal_actplat.tpl.php', './template/8264', 'portal/actplat')
|| checktplrefresh('./template/8264/portal/actplat.htm', './template/8264/common/header_8264_new.htm', 1509078932, 'diy', './data/template/2_diy_portal_actplat.tpl.php', './template/8264', 'portal/actplat')
|| checktplrefresh('./template/8264/portal/actplat.htm', './template/8264/common/header_common.htm', 1509078932, 'diy', './data/template/2_diy_portal_actplat.tpl.php', './template/8264', 'portal/actplat')
|| checktplrefresh('./template/8264/portal/actplat.htm', './template/8264/common/index_ad_top.htm', 1509078932, 'diy', './data/template/2_diy_portal_actplat.tpl.php', './template/8264', 'portal/actplat')
;?>
<!doctype html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="http://static.8264.com/static/css/portal/style_pcact.css">
<style>
.pg a.prev {
background-image: none;
    ...
    <div class="header">
        <div class="layout">
            ...
            <div class="headerL">
                <h1>
                    <span class="country">活动平台</span>
                </h1>
                <div class="site">
                    <a href="http://www.8264.com/">首页</a>
                    > 
                    <a href="http://www.8264.com/portal.php?mod=actplat">活动平台</a>
                </div>
            </div>
            <div class="headerR"><a href="http://app.zaiwai.com/" target="_blank"><img src="http://static.8264.com/static/images/portal/actplat/zaiwailogo.png"/></a></div>
        </div>
    </div>
<div class="warpper">
    	<div class="warpten mt15 clear_b">
        	<!--左边开始-->
        	<div class="bignewsbox">
            	<div class="bignews">
<!--单条循环开始--><?php if(is_array($lunboList)) foreach($lunboList as $v) { ?>                    <div class="bignewsimg"><a href="<?php echo $v['bannerurl'];?>" target="_blank"><img src="<?php echo $v['pic'];?>"/></a></div>
<?php } ?>
<!--单条循环结束-->
</div>
</div>
...
// 轮播结束
            ...
            <!--右边开始-->
            <div class="hotact">
            	<div class="hotacttitle">热门活动</div>
                <div class="hotactlist">
                	<ul>
                    	<!--单条循环开始--><?php if(is_array($hotactList)) foreach($hotactList as $v) { ?><li><a href="<?php echo $v['url'];?>" target="_blank" title="<?php echo $v['title'];?>"><?php echo cutstr($v['title'],32,'...'); ?></a></li>
<?php } ?>
<!--单条循环结束-->
                    </ul>
                </div>
                <a href="http://bbs.8264.com/forum-forumdisplay-fid-12-typeid-1593-filter-typeid.html" target="_blank" class="fbact">发布活动</a>
                <div class="adbp">2016广告洽谈   QQ：3278817818</div>
            </div>
            <!--右边结束-->
        </div>
        <div class="actlisttw">
            <!--单条开始--><?php if(is_array($list)) foreach($list as $v) { ?>            <div class="actlistone clear_b mt15">
                <div class="actlist_l">
                    <a href="http://bbs.8264.com/thread-<?php echo $v['aid'];?>-1-1.html" target="_blank" class="actlist_link"><?php echo $v['subject'];?></a>
                    <p><?php echo cutstr($v['textmessage'],170,'...'); ?></p>
                    <div class="simglist">
<?php if(($v['pic1'])||($v['pic2'])||($v['pic3'])||($v['pic4'])) { ?>
  <?php if($v['pic1']) { ?><img class="lazy" src="<?php echo $v['pic1'];?>" ><?php } ?>
  <?php if($v['pic2']) { ?><img class="lazy" src="<?php echo $v['pic2'];?>" ><?php } ?>
  <?php if($v['pic3']) { ?><img class="lazy" src="<?php echo $v['pic3'];?>" ><?php } ?>
  <?php if($v['pic4']) { ?><img class="lazy" src="<?php echo $v['pic4'];?>" ><?php } } else { if(is_array($v['imgList'])) foreach($v['imgList'] as $vv) { ?><?php echo $vv;?>
<?php } ?>  
<?php } ?>
                    </div>
                </div>
                <div class="actlist_r">
                	<div class="timelist"><i class="ksicon"></i>开始时间：<?php echo $v['starttime'];?></div>
                    <div class="timelist"><i class="endicon"></i>结束时间：<?php echo $v['endtime'];?></div>
                    <div class="timelist"><i class="gongicon"></i>公布时间：<?php echo $v['publictime'];?></div>
<?php if($v['is_closed']) { ?>
<a   class="addcj" style="background:none;text-indent:70px;">活动结束</a>
<?php } else { ?>
                    <a href="http://bbs.8264.com/thread-<?php echo $v['aid'];?>-1-1.html" target="_blank" class="addcj">我要参加</a>
<?php } ?>
                </div>
            </div>
<?php } ?>
