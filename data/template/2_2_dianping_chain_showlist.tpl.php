<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('chain_showlist', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/chain_showlist.htm', './template/8264/dianping/header.htm', 1508223320, '2', './data/template/2_2_dianping_chain_showlist.tpl.php', './template/8264', 'dianping/chain_showlist')
|| checktplrefresh('./template/8264/dianping/chain_showlist.htm', './template/8264/dianping/nav.htm', 1508223320, '2', './data/template/2_2_dianping_chain_showlist.tpl.php', './template/8264', 'dianping/chain_showlist')
|| checktplrefresh('./template/8264/dianping/chain_showlist.htm', './template/8264/common/zhidemai.htm', 1508223320, '2', './data/template/2_2_dianping_chain_showlist.tpl.php', './template/8264', 'dianping/chain_showlist')
|| checktplrefresh('./template/8264/dianping/chain_showlist.htm', './template/8264/dianping/sidebar_comment_rate.htm', 1508223320, '2', './data/template/2_2_dianping_chain_showlist.tpl.php', './template/8264', 'dianping/chain_showlist')
|| checktplrefresh('./template/8264/dianping/chain_showlist.htm', './template/8264/dianping/sidebar_contactus.htm', 1508223320, '2', './data/template/2_2_dianping_chain_showlist.tpl.php', './template/8264', 'dianping/chain_showlist')
|| checktplrefresh('./template/8264/dianping/chain_showlist.htm', './template/8264/dianping/footer.htm', 1508223320, '2', './data/template/2_2_dianping_chain_showlist.tpl.php', './template/8264', 'dianping/chain_showlist')
|| checktplrefresh('./template/8264/dianping/chain_showlist.htm', './template/8264/common/header_8264_new.htm', 1508223320, '2', './data/template/2_2_dianping_chain_showlist.tpl.php', './template/8264', 'dianping/chain_showlist')
|| checktplrefresh('./template/8264/dianping/chain_showlist.htm', './template/8264/common/ewm_r.htm', 1508223320, '2', './data/template/2_2_dianping_chain_showlist.tpl.php', './template/8264', 'dianping/chain_showlist')
|| checktplrefresh('./template/8264/dianping/chain_showlist.htm', './template/8264/common/weixin_share.htm', 1508223320, '2', './data/template/2_2_dianping_chain_showlist.tpl.php', './template/8264', 'dianping/chain_showlist')
|| checktplrefresh('./template/8264/dianping/chain_showlist.htm', './template/8264/common/footer_8264_new.htm', 1508223320, '2', './data/template/2_2_dianping_chain_showlist.tpl.php', './template/8264', 'dianping/chain_showlist')
|| checktplrefresh('./template/8264/dianping/chain_showlist.htm', './template/8264/common/header_common.htm', 1508223320, '2', './data/template/2_2_dianping_chain_showlist.tpl.php', './template/8264', 'dianping/chain_showlist')
|| checktplrefresh('./template/8264/dianping/chain_showlist.htm', './template/8264/common/index_ad_top.htm', 1508223320, '2', './data/template/2_2_dianping_chain_showlist.tpl.php', './template/8264', 'dianping/chain_showlist')
;
block_get('6905');?>
<!doctype html>
<html>
...
<div class="nav-name blue">分类</div>
 <div class="line_con_gray clboth p_r div_region">
<span class="arrow_d"></span>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=0&amp;cid=0&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1" <?php if(!$pcid && !$cid) { ?>  class="blue" <?php } ?>>全部</a><?php if(is_array($category)) foreach($category as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $k;?>&amp;cid=0&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1" value="<?php echo $k;?>" class="category <?php if($pcid == $k && !$cid) { ?> blue<?php } ?>"><?php echo $v['name'];?></a>
<?php } ?>
</div>
<span class="tc_cate clboth" style="z-index:10000;width:450px;"><?php if(is_array($category)) foreach($category as $key => $value) { ?><span id='category_<?php echo $key;?>' class='div_subcate'><?php if(is_array($value['child'])) foreach($value['child'] as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $key;?>&amp;cid=<?php echo $k;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1"<?php if($cid==$k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
<?php } ?>
</span>
<?php } ?>
</span>
...
<div class="line_con_gray clboth p_r div_region">
<span class="arrow_d"></span>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;provinceid=0&amp;cityid=0&amp;page=1"
<?php if($provinceid == 0) { ?> class = "blue"<?php } ?>>全部</a><?php if(is_array($proList)) foreach($proList as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;provinceid=<?php echo $k;?>&amp;cityid=0&amp;page=1"
 value="<?php echo $k;?>"
 class="province <?php if($provinceid == $k) { ?> blue<?php } ?>"><?php echo $v['cityname'];?></a>
<?php } ?>
</div>
<span class="tc_dq clboth" style="z-index:10000;width:450px;"><?php if(is_array($cityList)) foreach($cityList as $key => $value) { ?><span id='province_<?php echo $key;?>' class='div_city'><?php if(is_array($value)) foreach($value as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;provinceid=<?php echo $key;?>&amp;cityid=<?php echo $k;?>&amp;page=1"
...
<h3><span style="color:#585858;">所有<?php echo $dp_modules[$mod]['cname'];?></span></h3>
</div>
<div class="sift-left">
<div class="condition-box">
<h1>
<?php if($provinceid) { ?><a
href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;provinceid=0&amp;cityid=0&amp;page=1"
class="condition"><?php echo $proList[$provinceid]['cityname'];?><i></i></a><?php } if($provinceid && $cityid) { ?><a
href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=0&amp;page=1"
...
<div class="sift-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1" <?php if($order=='lastpost') { ?> class="hover"<?php } ?>><i></i>默认</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1" <?php if($order=='heats') { ?> class="hover"<?php } ?>><i></i>热度</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=score&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1" <?php if($order=='score') { ?> class="hover"<?php } ?>><i></i>评分</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=dateline&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;provinceid=<?php echo $provinceid;?>&amp;cityid=<?php echo $cityid;?>&amp;page=1" <?php if($order=='dateline') { ?> class="hover"<?php } ?>><i></i>最新</a>
</div>
</div>
<!-- //排序筛选 -->
</div>
...
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="<?php echo $item['subject'];?>" target="_blank"><img src="<?php echo getimagethumb(400,300,2, $item['dir'].'/'.$item['showimg'], '', $item['serverid']); ?>" alt=""></a>
<div class="list-info">
<h2>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="<?php echo $item['subject'];?>" class="title-big" target="_blank"><?php echo $item['subject'];?></a>
</h2>
<?php if($item['addr']) { ?>
<span>
<?php if($item['provinceid']) { ?> <?php echo $proList[$item['provinceid']]['cityname'];?>，<?php } if($item['provinceid'] && $item['cityid']) { ?><?php echo $cityList[$item['provinceid']][$item['cityid']]['cityname'];?><?php } ?>
</span>
<p>
地址：<?php echo str_replace(array($proList[$item['provinceid']]['cityname'],$cityList[$item['provinceid']][$item['cityid']]['cityname'],'市','省'),'',$item['addr']); ?></p>
<?php } else { ?>
...
<?php if($item['cnum']) { ?>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>#comment" target="_blank"><?php echo $item['cnum'];?>人点评</a>
<?php } else { ?>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>#write" class="gift" target="_blank"><i></i>我要点评</a>
<?php } ?>
</div>
</li>
<?php } } else { ?>
...
<a href="http://www.8264.com/dianping.php?mod=chain&amp;act=dopost&amp;do=new" target="_blank" class="line-button">
<i class="line-icon"></i>
<span>发布<?php echo $dp_modules[$mod]['cname'];?></span>
</a>
</div>
</div>
...
//分类菜单
jQuery(document).ready(function($) {
var tc_cate_maxW = $(".tc_cate").width();
var maxW = $(".tc_cate").parent().width();
$('.category').hover(function() {
$(".tc_cate").hide();
$(".div_subcate").hide();
clearTimeout(window.subbox_show);
var catid = $(this).attr("value");
if ($("#category_" + catid).length > 0) {
$("#category_" + catid).show();
$(".tc_cate").show();
}
$(".tc_cate").css({
"width": "auto"
});
var tc_cateW = $(".tc_cate").width() + 1;
tc_cateW = tc_cateW > tc_cate_maxW ? tc_cate_maxW : tc_cateW;
$(".tc_cate").css({
"width": tc_cateW
});
var left = $(this).position().left + Math.floor($(this).width() / 2) - Math.floor(tc_cate_maxW / 4) + (tc_cate_maxW - tc_cateW) / 2;
left = left < 0 ? 0 : left;
left = left + Math.floor(tc_cateW / 4) * 5 > maxW ? maxW - tc_cateW - 22 : left;
$(".tc_cate").css({
