<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('post_diving', 'forum/dianping/header');
0
|| checktplrefresh('./template/8264/forum/dianping/post_diving.htm', './template/8264/forum/dianping/header.htm', 1505892179, '2', './data/template/2_2_forum_dianping_post_diving.tpl.php', './template/8264', 'forum/dianping/post_diving')
|| checktplrefresh('./template/8264/forum/dianping/post_diving.htm', './template/8264/forum/dianping/editor_2014_second.htm', 1505892179, '2', './data/template/2_2_forum_dianping_post_diving.tpl.php', './template/8264', 'forum/dianping/post_diving')
|| checktplrefresh('./template/8264/forum/dianping/post_diving.htm', './template/8264/forum/dianping/editor_2014_first.htm', 1505892179, '2', './data/template/2_2_forum_dianping_post_diving.tpl.php', './template/8264', 'forum/dianping/post_diving')
|| checktplrefresh('./template/8264/forum/dianping/post_diving.htm', './template/8264/forum/dianping/footer.htm', 1505892179, '2', './data/template/2_2_forum_dianping_post_diving.tpl.php', './template/8264', 'forum/dianping/post_diving')
|| checktplrefresh('./template/8264/forum/dianping/post_diving.htm', './template/8264/common/header_8264_new.htm', 1505892179, '2', './data/template/2_2_forum_dianping_post_diving.tpl.php', './template/8264', 'forum/dianping/post_diving')
|| checktplrefresh('./template/8264/forum/dianping/post_diving.htm', './template/8264/common/editor_2014.htm', 1505892179, '2', './data/template/2_2_forum_dianping_post_diving.tpl.php', './template/8264', 'forum/dianping/post_diving')
|| checktplrefresh('./template/8264/forum/dianping/post_diving.htm', './template/8264/forum/editor_menu_forum_newimage_2014.htm', 1505892179, '2', './data/template/2_2_forum_dianping_post_diving.tpl.php', './template/8264', 'forum/dianping/post_diving')
|| checktplrefresh('./template/8264/forum/dianping/post_diving.htm', './template/8264/common/ewm_r.htm', 1505892179, '2', './data/template/2_2_forum_dianping_post_diving.tpl.php', './template/8264', 'forum/dianping/post_diving')
|| checktplrefresh('./template/8264/forum/dianping/post_diving.htm', './template/8264/common/footer_8264_new.htm', 1505892179, '2', './data/template/2_2_forum_dianping_post_diving.tpl.php', './template/8264', 'forum/dianping/post_diving')
|| checktplrefresh('./template/8264/forum/dianping/post_diving.htm', './template/8264/common/header_common.htm', 1505892179, '2', './data/template/2_2_forum_dianping_post_diving.tpl.php', './template/8264', 'forum/dianping/post_diving')
|| checktplrefresh('./template/8264/forum/dianping/post_diving.htm', './template/8264/common/index_ad_top.htm', 1505892179, '2', './data/template/2_2_forum_dianping_post_diving.tpl.php', './template/8264', 'forum/dianping/post_diving')
|| checktplrefresh('./template/8264/forum/dianping/post_diving.htm', './template/8264/common/taobao_ad_alert.htm', 1505892179, '2', './data/template/2_2_forum_dianping_post_diving.tpl.php', './template/8264', 'forum/dianping/post_diving')
;?>
<!doctype html>
<html>
<head>
...
<input type="hidden" name="type" id="type" value="<?php echo $editdata['type'];?>" />
<input type="text" value="<?php if($editdata['type']) { ?>已选择类型：<?php echo $typelist[$editdata['type']]['name'];?> <?php } else { ?>请选择<?php echo $modname;?>类型<?php } ?>" class="diqu js"
id="climb_type_value" readonly="readonly"/>
<div class="tp_down"><?php if(is_array($typelist)) foreach($typelist as $k => $v) { ?><a href="javascript:void(0);" rel="<?php echo $k;?>" ><?php echo $v['name'];?></a>
<?php } ?>
</div>
</div>
</span>
<span class="icoRedStar">*</span>
        ...
        <dl class="pubDt50">
            <dt><span class="icoGps48x43"></span></dt>
            <dd>
<span class="inputTipsText2"><?php if(is_array($typelist)) foreach($typelist as $k => $v) { ?>                        <span style="padding-right: 20px;"><input type="checkbox" name="type[]" value="<?php echo $k;?>" rel="<?php echo $v['name'];?>" class="check" <?php if($typelists[$k]) { ?>checked<?php } ?>><span style="padding-left: 8px;"><?php echo $v['name'];?></span></span>
                    <?php } ?>
</span>
                <span class="icoRedStar">*</span>
            </dd>
        </dl>
        <input type="hidden" name="sel_address" value="<?php echo $regionsList[$editdata['pro']]['cityname'];?><?php echo $cities[$editdata['city']]['cityname'];?>" id="addr" />
<dl class="pubDt50">
...
<div class="qy selectdown" style="z-index:501;">
                        <input type="text" id="country_text" value="<?php if($editdata['pro']>=820000) { ?>位于国外<?php } else { ?>位于国内<?php } ?>" class="diqu js" readonly="readonly"/>
...
<input type="hidden" name="province" value="<?php echo $editdata['pro'];?>" id="province" />
<input type="text" id="province_text" value="<?php if($editdata['pro']) { ?>已选择省份：<?php echo $regionsList[$editdata['pro']]['cityname'];?> <?php } else { ?>请选择所在省份<?php } ?>" class="diqu js" readonly="readonly"/>
<div class="qy_down"><?php if(is_array($regionsList)) foreach($regionsList as $k => $v) { ?><a rel="<?php echo $k;?>" href="javascript:void(0);" execute="ajaxGetCity" myid="pro"><?php echo $v['cityname'];?></a>
<?php } ?>
</div>
</div>
</span>
...
<input type="text" name="cityname" value="<?php if($editdata['cityid']) { ?>已选择城市：<?php echo $cities[$editdata['cityid']]['cityname'];?><?php } else { ?>请选择城市<?php } ?>" id="select_city" class="diqu js" readonly="readonly"/>
<div class="qy_down">
<?php if($cities) { if(is_array($cities)) foreach($cities as $city) { ?><a href="javascript:void(0);" rel="<?php echo $city['codeid'];?>" name="cityid"><?php echo $city['cityname'];?></a>
<?php } } ?>
</div>
</div>
</span>
...
<input type="text" class="inputText w360" name="addr" id="address" value="<?php echo $editdata['addr'];?>" />
        ...
        <dl class="pubDt50 foreign" style="display: none;">
            ...
            <dd>
                <span id="xq"></span>
<span class="inputTipsText">
<label class="fs16"><?php if(! $editdata['addr']) { ?> 请填写所在国家<?php } ?></label>
<input type="text" class="inputText w360" name="con_province" id="countryprovince" value="<?php echo $foreign_countrys[$editdata['pro']]['cityname'];?>" style="width: 200px;"/>
                    <label class="fs16" style="left: 239px;"><?php if(! $editdata['addr']) { ?> 请填写具体地址<?php } ?></label>
<input type="text" class="inputText w360" name="con_address" id="countryaddress" value="<?php echo $editdata['addr'];?>" />
</span>
                <span class="icoRedStar">*</span>
            </dd>
        </dl>
...
objcity.siblings('input[type=hidden]').val("<?php echo $editdata['city'];?>").siblings('input.js')
.val("<?php if($editdata['cityName']) { } else { ?>请选择城市<?php } ?>").end();
var postData = "provinceid="+provinceid;
jQuery.ajax({
type: 'post',
dataType: 'html',
url: '/forum.php?ctl=<?php echo $modstr;?>&act=ajaxGetRegion',
data: postData,
...
<script type="text/javascript">
function modform_validate(theform) {<?php //使用编辑器后, 编写的内容在body中, 需要通过该代码将内容放在textarea中, (editor.js) ?>var message = wysiwyg ? html2bbcode(getEditorContents()) : (!theform.parseurloff.checked ? parseurl(theform.message.value) : theform.message.value);
...
//		_showmsg('请填写<?php echo $modname;?>地址');
//		return false;
//	}


if(trim(theform.province.value) == '') {
_showmsg('请选择<?php echo $modname;?>经过省份');
return false;
}

if(trim(theform.cityname.value) == '') {
_showmsg('请选择或填写<?php echo $modname;?>所在城市');
return false;
}

if(trim(theform.message.value) == '') {
_showmsg('请填写<?php echo $modname;?>简介');
return false;
}
