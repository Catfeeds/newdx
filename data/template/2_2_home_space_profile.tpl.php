<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_profile', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/home/space_profile.htm', './template/8264/common/header_8264_new.htm', 1509517878, '2', './data/template/2_2_home_space_profile.tpl.php', './template/8264', 'home/space_profile')
|| checktplrefresh('./template/8264/home/space_profile.htm', './template/8264/home/space_header_uc.htm', 1509517878, '2', './data/template/2_2_home_space_profile.tpl.php', './template/8264', 'home/space_profile')
|| checktplrefresh('./template/8264/home/space_profile.htm', './template/8264/home/space_footer_uc.htm', 1509517878, '2', './data/template/2_2_home_space_profile.tpl.php', './template/8264', 'home/space_profile')
|| checktplrefresh('./template/8264/home/space_profile.htm', './template/8264/common/footer_8264_new.htm', 1509517878, '2', './data/template/2_2_home_space_profile.tpl.php', './template/8264', 'home/space_profile')
|| checktplrefresh('./template/8264/home/space_profile.htm', './template/8264/common/header_common.htm', 1509517878, '2', './data/template/2_2_home_space_profile.tpl.php', './template/8264', 'home/space_profile')
|| checktplrefresh('./template/8264/home/space_profile.htm', './template/8264/common/index_ad_top.htm', 1509517878, '2', './data/template/2_2_home_space_profile.tpl.php', './template/8264', 'home/space_profile')
|| checktplrefresh('./template/8264/home/space_profile.htm', './template/8264/common/ewm_r.htm', 1509517878, '2', './data/template/2_2_home_space_profile.tpl.php', './template/8264', 'home/space_profile')
;
block_get('6905');?>
<!doctype html>
<html>
...
<!--module end--><div class="main-content layout-page">
...
<ul class="panel-list">
<li>
<label class="lbl-txt">用户名</label>
<div class="collon-t">
<span><?php echo $space['username'];?></span>
</div>
</li>
<li>
<label class="lbl-txt">ID</label>
<div class="collon-t">
<span><?php echo $space['uid'];?></span>
</div>
</li>
<li>
<label class="lbl-txt">性别</label>
<div class="collon-t">
<span><?php if($profiles['gender']['value']) { ?><?php echo $profiles['gender']['value'];?><?php } else { ?>未填写<?php } ?></span>
</div>
</li>
<li>
<label class="lbl-txt">访问量</label>
<div class="collon-t">
<span class="c-tx6"><?php echo $space['views'];?></span>
</div>
</li>
<li>
<label class="lbl-txt">等级</label>
<div class="collon-t">
<span><?php echo $space['group']['grouptitle'];?></span>
</div>
</li>
<li>
<label class="lbl-txt">勋章</label>
<div class="collon-t">
<span>
<?php if($space['medals']) { if(is_array($space['medals'])) foreach($space['medals'] as $medal) { ?><img src="http://static.8264.com/static/image/common/<?php echo $medal['image'];?>" border="0" alt="<?php echo $medal['name'];?>" title="<?php echo $medal['name'];?>" /> &nbsp;
<?php } } else { ?>
目前没有
<?php } ?>
</span>
...
<li>
<label class="lbl-txt">现居地</label>
<div class="collon-t">
<span><?php if($profiles['residecity']['value']) { ?><?php echo $profiles['residecity']['value'];?><?php } else { ?>未填写<?php } ?></span>
</div>
</li>
</ul>
<ul class="panel-list">
...
<li>
<label class="lbl-txt">E-mail</label>
<div class="collon-t">
<span><?php echo $space['email'];?></span>
</div>
</li>
<li>
<label class="lbl-txt">常用邮箱</label>
<div class="collon-t">
<span><?php if($profiles['field1']['value']) { ?><?php echo $profiles['field1']['value'];?><?php } else { ?>未填写<?php } ?></span>
</div>
</li>
<?php } ?>
<li>
<label class="lbl-txt">统计信息</label>
<div class="collon-t collon-span">
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=friend" target="_blank">关注数 <em class="c-tx"><?php if($space['friends']) { ?><?php echo $space['friends'];?><?php } else { ?>0<?php } ?></em></a>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=friend&amp;view=fans" target="_blank">粉丝数 <em class="c-tx"><?php if($space['fans']) { ?><?php echo $space['fans'];?><?php } else { ?>0<?php } ?></em></a>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=blog&amp;view=me&amp;from=space" target="_blank">日志数 <em class="c-tx"><?php if($space['blogs']) { ?><?php echo $space['blogs'];?><?php } else { ?>0<?php } ?></em></a>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=album&amp;view=me" target="_blank">相册数 <em class="c-tx"><?php if($space['albums']) { ?><?php echo $space['albums'];?><?php } else { ?>0<?php } ?></em></a>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=thread&amp;view=me&amp;type=reply&amp;from=space" target="_blank">回帖数 <em class="c-tx"><?php if($space['posts']) { ?><?php echo $space['posts'];?><?php } else { ?>0<?php } ?></em></a>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=thread&amp;view=me&amp;type=thread&amp;from=space" target="_blank">帖子数 <em class="c-tx"><?php if($space['threads']) { ?><?php echo $space['threads'];?><?php } else { ?>0<?php } ?></em></a>
<a href="home.php?mod=spacecp&amp;ac=credit&amp;uid=<?php echo $space['uid'];?>&amp;op=base">积分 <em class="c-tx"><?php echo $space['credits'];?></em></a>
<span>驴币 <em class="c-tx"><?php echo $space['extcredits2'];?></em></span>
<span>8264币 <em class="c-tx"><?php echo $space['extcredits5'];?></em></span>
<span>先锋币 <em class="c-tx"><?php echo $space['extcredits6'];?></em></span>
</div>
</li>						
</ul>
</div>
...
<!--基本信息 end-->
<!--活跃概况-->
<div class="basic-panel" id="active_profile">
<div class="basic-info-tit">
<h3 class="tit">活跃概况</h3>
</div>
<div class="basic-msg-panel">
<ul class="panel-list">
<li>
<label class="lbl-txt">用户组</label>
<div class="collon-t">
<span class="c-tx5"><?php echo $space['group']['grouptitle'];?></span>
</div>
</li>
<?php if($count) { ?>
<li>
<label class="lbl-txt">管理的板块</label>
<div class="collon-t"><?php if(is_array($manage_forum)) foreach($manage_forum as $key => $value) { ?><a href="forum.php?mod=forumdisplay&amp;fid=<?php echo $key;?>" target="_blank" class="c-tx5"><?php echo $value;?></a> &nbsp;
<?php } ?>
</div>
</li>
<?php } if($space['adminid'] && $space['admingroup']['grouptitle']) { ?>
<li>
<label class="lbl-txt">管理组</label>
<div class="collon-t">
<span class="c-tx5"><?php echo $space['admingroup']['grouptitle'];?></span>
</div>
</li>
<?php } ?>
<li>
<label class="lbl-txt">在线时间</label>
<div class="collon-t">
<span><?php echo $space['oltime'];?>小时</span>
</div>
</li>
<li>
<label class="lbl-txt">注册时间</label>
<div class="collon-t">
<span><?php echo $space['regdate'];?></span>
</div>
</li>
<li>
<label class="lbl-txt">最后访问</label>
<div class="collon-t">
<span><?php echo $space['lastvisit'];?></span>
</div>
</li>
</ul>
<ul class="panel-list">							
<li>
<label class="lbl-txt">上次活动时间</label>
<div class="collon-t">
<span><?php echo $space['lastactivity'];?></span>
</div>
</li>
<li>
<label class="lbl-txt">上次发表时间</label>
<div class="collon-t">
<span><?php echo $space['lastpost'];?></span>
</div>
</li>
<?php if($_G['uid'] == $space['uid'] || $_G['group']['allowviewip']) { ?>
<li>
<label class="lbl-txt">注册IP</label>
<div class="collon-t">
<span><?php echo $space['regip'];?> - <?php echo $space['regip_loc'];?></span>
</div>
</li>
<li>
<label class="lbl-txt">上次访问IP</label>
<div class="collon-t">
<span><?php echo $space['lastip'];?> - <?php echo $space['lastip_loc'];?></span>
</div>
</li>
<?php } ?>
</ul>
...
<li class="menu-nav menu-nav-current">
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=profile#basic_info">
<i class="menu-nav-icon icon-basic"></i>
<em>基本信息</em>
</a>
</li>
<li class="menu-nav">
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=profile#active_profile">
