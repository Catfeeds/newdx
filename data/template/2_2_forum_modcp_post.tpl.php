...
<?php if($error == 1) { ?>
<p class="xi1">搜索条件不足！你至少应当在 关键字，帖子作者或者发帖 IP 当中设置一个搜索的条件</p>
<?php } elseif($error == 2) { ?>
<p class="xi1">时间范围错误！版主只能删除近 1 周的帖子，超级版主可以删除 2 周内的帖子，请重新选择开始时间</p>
<?php } elseif($error == 3) { ?>
<p class="xi1">你输入的关键字不合法！每个关键字至少由 2 个汉字或者 4 个英文字符组成</p>
<?php } elseif($error == 4) { ?>
<p class="xi1">你无权使用批量删帖功能</p>
...
<th>
主题: &nbsp;<a target="_blank" href="forum.php?mod=redirect&amp;goto=findpost&amp;pid=<?php echo $post['pid'];?>&amp;ptid=<?php echo $post['tid'];?>&amp;modthreadkey=<?php echo $post['modthreadkey'];?>"><?php echo $post['tsubject'];?></a><br />
...
<input type="checkbox" name="chkall" id="chkall" class="pc" onclick="checkall(this.form, 'delete')" /> <label for="chkall">删?</label> 
<button type="submit" name="deletesubmit" id="deletesubmit" class="pn" value="true"><strong>删除</strong></button> 
<input type="checkbox" name="nocredit" id="nocredit" class="pc" value="1" checked="checked"> <label for="nocredit">不更新用户积分</label>
<?php } ?>
</td>
</tr>
</table>
