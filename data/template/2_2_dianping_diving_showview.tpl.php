<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('diving_showview', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/dianping/header.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/dianping/nav.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/common/zhidemai.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/dianping/showview_content.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/dianping/showview_credit.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/dianping/diving_mycomment.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/dianping/diving_comment.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/dianping/replyedit_pic_upload.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/dianping/reply_pic_upload.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/dianping/sidebar_map.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/common/hd_ad.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/dianping/footer.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/common/header_8264_new.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/common/ewm_r.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/common/weixin_share.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/common/footer_8264_new.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/common/header_common.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
|| checktplrefresh('./template/8264/dianping/diving_showview.htm', './template/8264/common/index_ad_top.htm', 1509519821, '2', './data/template/2_2_dianping_diving_showview.tpl.php', './template/8264', 'dianping/diving_showview')
;
block_get('6905,7011');?>
<!doctype html>
<html>
                    ...
                    <div class="review-booth">
                        <ul class="review-pic-box">
                            <?php if(is_array($piclist)) foreach($piclist as $pic) { ?>                            <li>
                                <a  title="点击查看原图" target="_blank" href="<?php echo $pic['url'];?><?php echo $pic['attachment'];?>">
                                    <img src="<?php echo getimagethumb(322,322,11, 'plugin/'.$pic['attachment'], $pic['aid'], $pic['serverid']); ?>" style="width: 322px;height: 244px;">
                                </a>
                            </li>
                            <?php } ?>
                        </ul>
...
<em></em>
                        ...
                        <div class="reviews-count">
                            (<span class="num"><?php if($detail['cnum']) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $tid;?>#comment"><?php echo $detail['cnum'];?></a><?php } else { ?>0<?php } ?></span>人评分)
                        </div>
...
<i class="ui-icon"></i><?php echo $countries[$detail['provinceid']]['cityname'];?><?php echo $countries[$detail['cityid']]['cityname'];?><?php echo $detail['addr'];?>
</span>
<span class="detail-item cate">
<i class="ui-icon"></i><?php echo $typename;?>
</span>
                        </div>
                    </div>
                </div>
...
<?php if($_GET['inajax'] == 1) { ?><?php dp_output(); } ?>
    ...
    <!-- //我的点评 -->
    <?php if(!$commentlist) { ?>
    <div style="margin:16px 0px 30px 0px; display:none"><img src="http://static.8264.com/dianping/images/demo/qsyb.jpg"></div>
    <?php } ?>
    <?php if($commentlist) { ?>
            ...
            <div class="comment-form-box">
                <div class="rows-content row-color-1">
                    ...
                    <div class="attrForms">
                        <div class="star-rating-box">
                            <ul class="star-rating-level stars1">
                                <li><a class="one-star" value="1"  href="javascript:void(0);" title="很差">100</a></li>
                                <li><a class="two-stars" value="2" href="javascript:void(0);" title="较差">200</a></li>
                                <li><a class="three-stars" value="3" href="javascript:void(0);" title="还行">300</a></li>
                                <li><a class="four-stars" value="4" href="javascript:void(0);" title="推荐">400</a></li>
                                <li><a class="five-stars" value="5" href="javascript:void(0);" title="力荐">500</a></li>
                            </ul>
                            <span class="result stars1-tips"  style=""></span>
                            <div class="clearfix"></div>
                ...
                <div class="rows-content row-color-3">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="weakpoint" id="weakpoint" cols="30" rows="2" placeholder="请填写该潜水场地的不足之处"></textarea>
                            <div id="weakpointTip" class="valid-tips-container">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="rows-content row-color-4">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="goodpoint" id="goodpoint" cols="30" rows="2" placeholder="请填写该潜水场地的优"></textarea>
                            <div id="goodpointTip" class="valid-tips-container">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="rows-content row-color-5">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="message" id="message" cols="30" rows="6" placeholder="请填写该潜水场地的综合评价"></textarea>
                            <div id="messageTip" class="valid-tips-container">
                            </div>
                        </div>
    ...
    <div class="ui-grid-2 ui-grid-right">
        ...
        <div class="right-hot-warpten">
            <div class="ui-block ui-block-title">
                <div class="ui-title ui-title-line">
                    <h3>热门</h3>
                    <div class="ui-title-link"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;type=0&amp;provinceid=<?php echo $detail['provinceid'];?>&amp;cityid=0&amp;page=1" target="_brank">more</a></div>
                </div>
            </div>
            <div class="ui-block ui-block-content">
                    ...
                    <ul class="hot-list">
                        <?php if(is_array($sidebar_list_hot)) foreach($sidebar_list_hot as $k => $item) { ?>                        <li>
                            ...
                            <div class="list-bd">
                                ...
                                </div>                                <span class="comm-num"><i class="ui-icon icon-comm"></i><?php if($item['cnum']) { ?><?php echo $item['cnum'];?><?php } else { ?>0<?php } ?>人参与点评</span>
    ...
    <div class="ui-grid-2 ui-grid-right">
        <div class="right-same-area-warpten">
            <div class="ui-block ui-block-title">
                <div class="ui-title ui-title-line">
                    <h3>同地区</h3>
                    <div class="ui-title-link"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;type=0&amp;provinceid=<?php echo $detail['provinceid'];?>&amp;cityid=0&amp;page=1" target="_brank">more</a></div>
                </div>
            </div>
            <div class="ui-block ui-block-content">
...
<span class="score-value score-value-<?php echo floor($item['score']); ?>" title="<?php echo floor($item['score']); ?>分">
<em></em>
</span>
                            </div>
                        </li>
...
<div class="friendLink"><?php block_display('7011'); ?></div>
<script>
    (function($){
        $(function(){
            //添加点评
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function($) {
        ...
        $('#message').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该潜水场地的综合评价。</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该潜水场地的综合评价，不能少于10个字符。</span></div>'
        });
        //缺点
        $('#weakpoint').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该潜水场地的不足之处。</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该潜水场地的不足之处，不能少于10个字符。</span></div>'
        });
        //优点
        $('#goodpoint').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该潜水场地的优点</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该潜水场地的优点，不能少于10个字符</span></div>'
        });
        /*修改页面交互*/
        //综合
