<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('spacecp_upload_uc', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/home/spacecp_upload_uc.htm', './template/8264/common/header_8264_new.htm', 1509518831, '2', './data/template/2_2_home_spacecp_upload_uc.tpl.php', './template/8264', 'home/spacecp_upload_uc')
|| checktplrefresh('./template/8264/home/spacecp_upload_uc.htm', './template/8264/common/footer_8264_new.htm', 1509518831, '2', './data/template/2_2_home_spacecp_upload_uc.tpl.php', './template/8264', 'home/spacecp_upload_uc')
|| checktplrefresh('./template/8264/home/spacecp_upload_uc.htm', './template/8264/common/header_common.htm', 1509518831, '2', './data/template/2_2_home_spacecp_upload_uc.tpl.php', './template/8264', 'home/spacecp_upload_uc')
|| checktplrefresh('./template/8264/home/spacecp_upload_uc.htm', './template/8264/common/index_ad_top.htm', 1509518831, '2', './data/template/2_2_home_spacecp_upload_uc.tpl.php', './template/8264', 'home/spacecp_upload_uc')
;?>
<!doctype html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="http://static.8264.com/static/css/home/album-new.css?<?php echo VERHASH;?>">
...
<input type="hidden" id="album_now" value="<?php echo $albumid;?>">
<div class="upimgfont">上传到</div>
<div class="xlprbox">
<div class="albumcon" id="albumcon">
<?php if($album_list_type == 1) { ?>
<img src="<?php echo $the_album['mpic'];?>"/>
<span><?php echo $the_album['albumname'];?></span>
<?php } else { ?>
<img src=""/>
<span>请选择相册</span>
<?php } ?>
...
<!--循环开始--><?php if(is_array($user_albums)) foreach($user_albums as $album_list_id => $album_list_one) { ?><div class="albumcon" onclick="changelist(this, <?php echo $album_list_id;?>);" id="album_<?php echo $album_list_id;?>" <?php if($album_list_id == $albumid) { ?> style="display:none;" <?php } ?> >
<img src="<?php echo $album_list_one['mpic'];?>"/>
<span><?php echo $album_list_one['albumname'];?></span>
</div>
<?php } ?>
<!--循环结束-->
</div>
...
<!--点击上传开始-->
<script src="http://static.8264.com/static/js/webuploader.js?<?php echo VERHASH;?>" type="text/javascript" type="text/javascript"></script>
<script src="http://static.8264.com/static/js/webuploader_album.js?<?php echo VERHASH;?>" type="text/javascript" type="text/javascript"></script>
...
async:false,
data: {uid:<?php echo $_G['uid'];?>, hash:"<?php echo $hash;?>", albumid:"new_"+new_name, catid:0},
dataType: 'json',
