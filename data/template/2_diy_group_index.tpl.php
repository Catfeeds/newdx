<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('index', 'common/header');
0
|| checktplrefresh('./template/default/group/index.htm', './template/8264/common/header.htm', 1504230060, 'diy', './data/template/2_diy_group_index.tpl.php', 'data/diy', 'group/index')
|| checktplrefresh('./template/default/group/index.htm', './template/default/common/pubsearchform.htm', 1504230060, 'diy', './data/template/2_diy_group_index.tpl.php', 'data/diy', 'group/index')
|| checktplrefresh('./template/default/group/index.htm', './template/8264/common/footer.htm', 1504230060, 'diy', './data/template/2_diy_group_index.tpl.php', 'data/diy', 'group/index')
|| checktplrefresh('./template/default/group/index.htm', './template/8264/common/header_common.htm', 1504230060, 'diy', './data/template/2_diy_group_index.tpl.php', 'data/diy', 'group/index')
;
block_get('1,2');?>
<!doctype html>
<html>
...
<div id="wp" class="wp">
<link href="http://static.8264.com/static/css/group/group_index.css?<?php echo VERHASH;?>" rel="stylesheet" type="text/css"><?php if($_G['setting']['search']) { ?><?php $slist = array(); if($_G['setting']['search']['portal']['status'] && ($_G['group']['allowsearch'] & 1 || $_G['adminid'] == 1)) { ?><?php
$slist[portal] = <<<EOF
...
$slist[portal] .= <<<EOF
 onclick="modifyAdvancedUrl(this.value);" /> 文章</label>
EOF;
...
$slist[forum] .= <<<EOF
 onclick="modifyAdvancedUrl(this.value);" /> {$_G['setting']['navs']['2']['navname']}</label>
EOF;
...
$slist[blog] .= <<<EOF
 onclick="modifyAdvancedUrl(this.value);" /> 日志</label>
EOF;
...
$slist[album] .= <<<EOF
 onclick="modifyAdvancedUrl(this.value);" /> 相册</label>
EOF;
...
$slist[group] .= <<<EOF
 onclick="modifyAdvancedUrl(this.value);" /> {$_G['setting']['navs']['3']['navname']}</label>
EOF;
?><?php } ?><?php
$slist[user] = <<<EOF

<label for="mod_user" title="搜索好友"><input type="radio" id="mod_user" name="mod" value="user" class="pr" onclick="modifyAdvancedUrl(this.value);" /> 用户</label>
...
<tr>
<td>
<input type="text" name="srchtxt" id="srchtxt" value="请输入搜索内容" autocomplete="off" onfocus="searchFocus(this);" onblur="searchBlur(this);" />
</td>
<td>&nbsp;<?php echo implode('', $slist);; ?>&nbsp;<input type="radio" id="mod_bd" name="mod" value="baidu" class="pr" onclick="modifybaiduUrl(this.value);" /> 百度搜索&nbsp;</td>

<td><button type="submit" id="search_submit" onclick="changeurl();" name="searchsubmit" class="xw1" value="true">搜索</button></td>
<td><a href="search.php?mod=forum&amp;adv=yes" id="advancedsearch" target="_blank" class="xi2">高级搜索</a></td>
<td>
<div class="hot">
<?php if($_G['setting']['srchhotkeywords']) { ?>
<strong class="xw1 xi1">热搜: </strong><?php if(is_array($_G['setting']['srchhotkeywords'])) foreach($_G['setting']['srchhotkeywords'] as $val) { if($val=trim($val)) { ?><?php $valenc=rawurlencode($val); ?><?php
$__FORMHASH = FORMHASH;$srchhotkeywords[] = <<<EOF
<a href="search.php?mod=search&amp;srchtxt={$valenc}&amp;formhash={$__FORMHASH}&amp;searchsubmit=true&amp;mod=forum" target="_blank" class="xi2">{$val}</a>
EOF;
?>
<?php } } echo implode('<span class="pipe">|</span>', $srchhotkeywords);; } ?>
</div>
</td>
</tr>
</table>
...
$('scform').action = 'search.php?searchsubmit=yes';
$('advancedsearch').href = 'search.php?adv=yes&mod=' + mod;
}
function modifybaiduUrl(mod) {
if(mod=='baidu'){	
$('scform').action = 'http://so.8264.com/cse/search?s=9963133823733045431&ie=gbk';					
}	
}
function changeurl(){
var mod = $('mod_bd').value;
if(mod=='baidu'){			
var search = '&q='+$('srchtxt').value;
$('scform').action +=search;	
return true;
}			
}
</script>
</div>
<?php } ?><?php echo adshow("text/wp a_t"); ?><style id="diy_style" type="text/css">#portal_block_1 .content {  margin-left:0px !important;}#portal_block_2 .content {  font-size:14px !important;margin-left:10px !important;}</style>
<div class="wp">
...
<div class="bm bmw">
<div class="bm_h cl">
<span class="y xw1"><a href="group.php?mod=my" style="color:#336699;">我的<?php echo $_G['setting']['navs']['3']['navname'];?> &rsaquo;</a></span>
<h2><?php echo $_G['setting']['navs']['3']['navname'];?>焦点</h2>
</div>
<!--[diy=diy5]--><div id="diy5" class="area"><div id="frameMAhAgp" class="frame move-span cl frame-1-1"><div id="frameMAhAgp_left" class="column frame-1-1-l"><div id="frameMAhAgp_left_temp" class="move-span temp"></div><?php block_display('1'); ?></div><div id="frameMAhAgp_center" class="column frame-1-1-r"><div id="frameMAhAgp_center_temp" class="move-span temp"></div><?php block_display('2'); ?></div></div></div><!--[/diy]-->
</div>
...
<a href="forum.php?mod=group&amp;action=create" id="create_group_btn"><img src="http://static.8264.com/static/image/common/create_group.png" alt="创建<?php echo $_G['setting']['navs']['3']['navname'];?>" /></a>
</div>
</div>
<?php } else { ?>
<div class="bm bw0">
<div class="bm_c">
<a href="forum.php?mod=group&amp;action=create&amp;fupid=<?php echo $fup;?>&amp;groupid=<?php echo $sgid;?>" id="create_group_btn"><img src="http://static.8264.com/static/image/common/create_group.png" alt="创建<?php echo $_G['setting']['navs']['3']['navname'];?>" /></a>
</div>
</div>
<?php } ?>
<div class="drag">
