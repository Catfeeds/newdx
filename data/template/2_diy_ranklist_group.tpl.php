...
0
|| checktplrefresh('./template/default/ranklist/group.htm', './template/8264/common/header.htm', 1506051280, 'diy', './data/template/2_diy_ranklist_group.tpl.php', './template/8264', 'ranklist/group')
|| checktplrefresh('./template/default/ranklist/group.htm', './template/default/common/simplesearchform.htm', 1506051280, 'diy', './data/template/2_diy_ranklist_group.tpl.php', './template/8264', 'ranklist/group')
|| checktplrefresh('./template/default/ranklist/group.htm', './template/default/ranklist/side_left.htm', 1506051280, 'diy', './data/template/2_diy_ranklist_group.tpl.php', './template/8264', 'ranklist/group')
|| checktplrefresh('./template/default/ranklist/group.htm', './template/8264/common/footer.htm', 1506051280, 'diy', './data/template/2_diy_ranklist_group.tpl.php', './template/8264', 'ranklist/group')
|| checktplrefresh('./template/default/ranklist/group.htm', './template/8264/common/header_common.htm', 1506051280, 'diy', './data/template/2_diy_ranklist_group.tpl.php', './template/8264', 'ranklist/group')
;?>
<!doctype html>
<html>
<head>
...
<h1 class="mt">群组排行</h1>
<ul class="tb cl">
<li<?php if($_G['gp_orderby'] == 'credit') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=group&amp;orderby=credit">积分排行</a></li>
<li<?php if($_G['gp_orderby'] == 'member') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=group&amp;orderby=member">成员数排行</a></li>
<li<?php if($_G['gp_orderby'] == 'threads') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=group&amp;orderby=threads">发帖排行</a></li>
<li<?php if($_G['gp_orderby'] == 'posts') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=group&amp;orderby=posts">回复排行</a></li>
<li<?php if($_G['gp_orderby'] == 'thismonth') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=group&amp;orderby=thismonth">最近 30 天发帖排行</a></li>
<li<?php if($_G['gp_orderby'] == 'today') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=group&amp;orderby=today">最近 24 小时发帖排行</a></li>
</ul>
<?php if($groupsrank) { ?>
<div class="tl">
<table cellspacing="0" cellpadding="0">
...
<th>群组<?php if($_G['gp_orderby'] == 'credit') { ?>(群组积分数排行)<?php } ?></th>
<td width="100">
<?php if($_G['gp_orderby'] == 'today') { ?>最近 24 小时发帖
<?php } elseif($_G['gp_orderby'] == 'posts') { ?>回复
<?php } elseif($_G['gp_orderby'] == 'thismonth') { ?>最近 30 天发帖
<?php } elseif($_G['gp_orderby'] == 'credit') { ?>积分数
<?php } elseif($_G['gp_orderby'] == 'member') { ?>成员数
<?php } else { ?>发帖<?php } ?>
</td>
...
<td>
<?php if($_G['gp_orderby'] == 'credit') { ?><?php echo $forum['commoncredits'];?>
<?php } elseif($_G['gp_orderby'] == 'member') { ?><?php echo $forum['membernum'];?>
