<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('shop_commentdetail', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/shop_commentdetail.htm', './template/8264/dianping/header.htm', 1509518266, '2', './data/template/2_2_dianping_shop_commentdetail.tpl.php', './template/8264', 'dianping/shop_commentdetail')
|| checktplrefresh('./template/8264/dianping/shop_commentdetail.htm', './template/8264/dianping/nav_comment.htm', 1509518266, '2', './data/template/2_2_dianping_shop_commentdetail.tpl.php', './template/8264', 'dianping/shop_commentdetail')
|| checktplrefresh('./template/8264/dianping/shop_commentdetail.htm', './template/8264/dianping/footer.htm', 1509518266, '2', './data/template/2_2_dianping_shop_commentdetail.tpl.php', './template/8264', 'dianping/shop_commentdetail')
|| checktplrefresh('./template/8264/dianping/shop_commentdetail.htm', './template/8264/common/header_8264_new.htm', 1509518266, '2', './data/template/2_2_dianping_shop_commentdetail.tpl.php', './template/8264', 'dianping/shop_commentdetail')
|| checktplrefresh('./template/8264/dianping/shop_commentdetail.htm', './template/8264/common/ewm_r.htm', 1509518266, '2', './data/template/2_2_dianping_shop_commentdetail.tpl.php', './template/8264', 'dianping/shop_commentdetail')
|| checktplrefresh('./template/8264/dianping/shop_commentdetail.htm', './template/8264/common/weixin_share.htm', 1509518266, '2', './data/template/2_2_dianping_shop_commentdetail.tpl.php', './template/8264', 'dianping/shop_commentdetail')
|| checktplrefresh('./template/8264/dianping/shop_commentdetail.htm', './template/8264/common/footer_8264_new.htm', 1509518266, '2', './data/template/2_2_dianping_shop_commentdetail.tpl.php', './template/8264', 'dianping/shop_commentdetail')
|| checktplrefresh('./template/8264/dianping/shop_commentdetail.htm', './template/8264/common/header_common.htm', 1509518266, '2', './data/template/2_2_dianping_shop_commentdetail.tpl.php', './template/8264', 'dianping/shop_commentdetail')
|| checktplrefresh('./template/8264/dianping/shop_commentdetail.htm', './template/8264/common/index_ad_top.htm', 1509518266, '2', './data/template/2_2_dianping_shop_commentdetail.tpl.php', './template/8264', 'dianping/shop_commentdetail')
;?>
<!doctype html>
<html>
<head>
...
<!--                                    <div class="avatar-box">
        ...
        <div class="col-sider">
            ...
            <div class="taglist clear_b">
            	<a href="http://www.8264.com/dianpu" target="_blank">户外店</a>
                <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;pid=<?php echo $detail['provinceid'];?>&amp;rid=0&amp;sid=0&amp;cid=0&amp;bid=0&amp;order=lastpost&amp;page=1" target="_blank">
                   <?php echo $arr_region[$detail['provinceid']]['name'];?>
                </a>
