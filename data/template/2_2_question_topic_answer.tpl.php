<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('answer', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/question/topic/answer.htm', './template/8264/common/zhidemai.htm', 1509520137, '2', './data/template/2_2_question_topic_answer.tpl.php', './template/8264', 'question/topic/answer')
|| checktplrefresh('./template/8264/question/topic/answer.htm', './template/8264/question/seditor_new_2016.htm', 1509520137, '2', './data/template/2_2_question_topic_answer.tpl.php', './template/8264', 'question/topic/answer')
|| checktplrefresh('./template/8264/question/topic/answer.htm', './template/8264/common/footer_8264_new.htm', 1509520137, '2', './data/template/2_2_question_topic_answer.tpl.php', './template/8264', 'question/topic/answer')
...
<?php if($_G['uid']&&$_G['uid']==$reply['authorid']) { ?>
<a href="question.php?ctl=topic&amp;act=editreply&amp;topicid=<?php echo $reply['ref_topicid'];?>&amp;replyid=<?php echo $reply['replyid'];?>" class="editoricon">编辑</a>
<?php } ?>
...
<img style="width:200px!important;height:200px!important; border-radius:0;margin:0;" src="http://www.8264.com/qrcode.php?output=1&amp;url=<?php echo $_G['siteurl'];?>wenda/share-<?php echo $topic['topicid'];?>-iswei-1-shareuid-<?php echo $_G['uid'];?>.html&amp;size=9">
                ...
                <div class="wyfbbox">
                    ...
                    <a href="javascript:void(0);" class="wyhd">我来回答</a>
                </div>
                <!--新添加模块结束-->
...
</script><?php echo adshow("custom_484"); ?></div>
<!-- 友情链接 -->
<style>
