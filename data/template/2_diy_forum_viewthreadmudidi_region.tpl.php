<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('viewthreadmudidi_region', 'common/header_8264_new');
0
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/8264/common/header_8264_new.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/default/common/simplesearchform.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/8264/forum/viewthread_node_2014.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/default/forum/mudidi_guide.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/default/forum/viewthread_nodebrand.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/default/forum/viewthread_fastpostbrand.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/default/forum/tagLeft.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/default/forum/mudidi_footer.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/8264/common/footer_8264_new.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/8264/common/header_common.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/8264/common/index_ad_top.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/8264/forum/viewthread_node_body_2014.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/8264/forum/viewthread_node_body_2014.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
|| checktplrefresh('./template/default/forum/viewthreadmudidi_region.htm', './template/8264/common/seditor_2014.htm', 1508734518, 'diy', './data/template/2_diy_forum_viewthreadmudidi_region.tpl.php', './template/8264', 'forum/viewthreadmudidi_region')
;?>
<!doctype html>
<html>
<head>
...
<div class="container"><?php $postcount = 0; ?><?php $regionData = $forumoption_mudidi->getRegionByTid($_G['tid']); if(is_array($postlist)) foreach($postlist as $i => $post) { if($post['first']) { ?><?php $mudidiData = $post; ?><div class="mudidi_view_top"></div>
<div class="mudidi_view">
<div class="mudidi_box last">
<h4>
...
</h4><?php $post['message'] = preg_replace('/^暂无相关内容$/', '', $post['message']); ?><div class="info" style="border-bottom:1px solid #ccc;">
...
<?php } ?><?php $mudidi_level = $forumoption_mudidi->getLevelByTid($_G['tid']); if($mudidi_level == 1) { ?><?php $subData = $forumoption_mudidi->getSubRegionByTid($_G['tid']); ?><?php $zoom = 2; } else { ?><?php $subData = $forumoption_mudidi->getSubScapeareaByTid($_G['tid']); ?><?php $zoom = 5; } ?>
<div style="margin-top:10px; overflow:hidden; width:100%;">
<div class="mudidi_info"><?php $mudidiInfoList = $subData; ?><?php $detailScapeNum = 0; ?><div class="mudidi_info_detail_show"><?php if(is_array($mudidiInfoList)) foreach($mudidiInfoList as $i => $scape) { if($detailScapeNum == 7) { ?><?php break; } ?>
<p class="row">
<strong><a href="/thread-<?php echo $scape['tid'];?>-1-1.html"><?php echo $scape['name'];?></a> </strong>
<span class="quotes_begin">
<span class="quotes_end"><?php $str = messagecutstr($scape['message'], 50); ?><?php $str = preg_replace('/^[　]+|\s+/', '', $str); ?><?php $str = preg_replace('/^暂无相关内容$/', '', $str); ?><?php $str = str_replace('　', '', $str); ?><?php echo $str; ?></span>
</span>
</p><?php unset($mudidiInfoList[$i]); ?><?php ++$detailScapeNum; } ?>
</div>
</div>
<div class="mudidi_map">
<?php if($regionData['lat'] && $regionData['long']) { ?><?php $centerLat = $regionData['lat']; ?><?php $centerLong = $regionData['long']; } elseif(count($subData) > 0) { ?><?php $minLat = 181; ?><?php $minLong = 181; ?><?php $maxLat = 0; ?><?php $maxLong = 0; if(is_array($subData)) foreach($subData as $i => $scapearea) { if($scapearea['lat'] && $scapearea['long']) { if($scapearea['lat'] < $minLat) { ?><?php $minLat = $scapearea['lat']; } if($scapearea['lat'] > $maxLat) { ?><?php $maxLat = $scapearea['lat']; } if($scapearea['long'] < $minLong) { ?><?php $minLong = $scapearea['long']; } if($scapearea['long'] > $maxLong) { ?><?php $maxLong = $scapearea['long']; } } } ?><?php $centerLat = ($minLat + $maxLat) / 2; ?><?php $centerLong = ($minLong + $maxLong) / 2; } ?>
<div id="mapContainer" style="width:220px;height:200px;"></div>
                                <script src="http://api.map.baidu.com/api?v=1.2&services=true" type="text/javascript"></script>
                                <script type="text/javascript">
                                    var map = new BMap.Map("mapContainer");
                                    var point = new BMap.Point(<?php echo $centerLong;?>, <?php echo $centerLat;?>);
...
<div class="mudidi_info_dropdown info">
<div class="ralateContent scapeList" style="line-height:22px;"><?php if(is_array($mudidiInfoList)) foreach($mudidiInfoList as $i => $scape) { ?><a href="/thread-<?php echo $scape['tid'];?>-1-1.html"><?php echo $scape['name'];?></a>
<?php } ?>
</div>
...
<script type="text/javascript">
;(function($){
if ($('.mudidi_info_dropdown .scapeList').height() > 22) {
$('.mudidi_info_dropdown .scapeList').height(22);
$('.mudidi_info_dropdown .more').show();
};
$('.mudidi_info_dropdown .more a').toggle(function(){
$('.mudidi_info_dropdown .scapeList').css('height', 'auto');
$('.mudidi_info_dropdown .more').addClass('moreB');
$(this).attr('title', '折叠全部');
return false;
}, function(){
$('.mudidi_info_dropdown .scapeList').css('height', '22px');
$('.mudidi_info_dropdown .more').removeClass('moreB');
$(this).attr('title', '展开全部');
return false;
});
})(jQuery);
</script>
...
</div><?php $postcount++; } ?><?php $guideData = $forumoption_mudidi->getGuideByRegionTid($_G['tid'], 8); ?><?php $guide_title = $regionData['name'].'攻略大全'; ?><?php $pub_guide_link = 'http://bbs.8264.com/forum-post-action-newthread-fid-52.html?mtid='.$_G['tid']; ?><div class="bm vw pl guide_list">
<div class="bm_h cl">
<h2>
...
<div class="mudidi_info_nav"><?php $regionSn = $forumoption_mudidi->getSnByTid($_G['tid']); ?><?php $mudidi_info_list = $forumoption_mudidi->getInfoNav($regionSn); ?><h2 class="mudidi_info_title"><?php echo $regionData['name'];?>旅游信息</h2>
...
<h2 class="mudidi_info_title mudidi_info_margin_top"><?php echo $regionData['name'];?>旅游导航</h2>
<dl class="mudidi_info_list mudidi_info_list2">
<dt><a href="/whither-scapearealist-<?php echo $_G['tid'];?>-1.html" title="<?php echo $regionData['name'];?>旅游景区">景区</a></dt>
<dt class="even"><a href="/whither-guidelist-<?php echo $_G['tid'];?>-1.html" title="<?php echo $regionData['name'];?>旅游攻略">攻略</a></dt>
<dt><a href="/whither-photolist-<?php echo $_G['tid'];?>-1.html" title="<?php echo $regionData['name'];?>照片图片">相册</a></dt>
<dt class="even"><a href="http://u.8264.com/home-space-do-activity-view-all-date-week-class--area-0.html" title="<?php echo $regionData['name'];?>户外活动">活动</a></dt>
<dt>
<?php if($regionData['hotelUrl']) { ?>
<a href="<?php echo $regionData['hotelUrl'];?>" target="_blank" title="<?php echo $regionData['name'];?>酒店住宿">旅舍</a>
<?php } else { ?>
<a href="javascript:void(0);" title="此景区暂无旅舍推荐">旅舍</a>
<?php } ?>
</dt>
<dt class="even"><a href="http://bx.8264.com/" target="_blank" title="<?php echo $regionData['name'];?>户外保险">保险</a></dt>
<dt><a href="/whither-weather-<?php echo $_G['tid'];?>.html" title="<?php echo $regionData['name'];?>天气预报">天气</a></dt>
<dt class="even"><a href="/whither-map-<?php echo $_G['tid'];?>.html" title="<?php echo $regionData['name'];?>地图">地图</a></dt>
</dl>
</div>
        <script type="text/javascript">
...
</script><?php $activityData = $forumoption_mudidi->getRalateActivityByKeyword($regionData['name'], 6); if($activityData) { ?>
<div class="sidebar_box">
<div class="sidebar_box_title">
<a href="http://bbs.8264.com/forum-5-1.html" class="more">更多</a>
<h5><?php echo $regionData['name'];?>活动</h5>
</div>
...
<?php } ?><?php $subScapeareaData = $forumoption_mudidi->getSubScapeareaBySn($regionSn, 3); ?>        <?php if(subScapeareaData) { ?>
<div class="sidebar_box">
<div class="sidebar_box_title">
<a href="/whither-weather-<?php echo $_G['tid'];?>.html" class="more">查看详细</a>
<h5><?php echo $regionData['name'];?>相关景区天气</h5>
</div>
<div class="sidebar_box_content">
<div class="weather"><?php if(is_array($subScapeareaData)) foreach($subScapeareaData as $subScapeareaId => $subScapearea) { ?><?php $weathers = $forumoption_mudidi->getWeatherInfo($subScapearea['long'], $subScapearea['lat']); if($weathers['0']) { ?>
<div class="item">
<span><a href="http://bbs.8264.com/whither-weather-<?php echo $subScapearea['tid'];?>.html"><?php echo $subScapearea['name'];?></a></span>
<span><img src="http://www.google.com<?php echo $weathers['0']['icon'];?>" alt="" /></span>
<span><?php echo $weathers['0']['condition'];?></span>
<span><?php echo $weathers['0']['high'];?>℃/<?php echo $weather['low'];?>℃</span>
</div>
<?php } } ?>
</div>
<div class="clear"></div>
...
<h5><?php echo $regionData['name'];?>照片</h5>
</div>
<div class="sidebar_box_content">
...
<div class="clear"></div>
<?php if($regionData['hotelName']) { ?>
<div class="bm vw pl">
<div class="bm_h cl">
<?php if($regionData['hotelUrl']) { ?>
<a href="<?php echo $regionData['hotelUrl'];?>" class="more">更多旅舍</a>
<?php } ?>
<h2><?php echo $regionData['hotelName'];?>旅舍</h2>
</div>
<div style="padding:10px 0;">
<script src="http://hoteldistr.yododo.com/sale/distr_backoffice/adCodeJump_gbk.jsp?distrid=1&width=960&height=120&styletype=wide&areaname=<?php echo $regionData['hotelName'];?>" type="text/javascript"></script>
</div>
</div>
