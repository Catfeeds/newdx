...
<input type="hidden" name="formhash" value="<?php echo FORMHASH;?>" />
<input type="hidden" name="frommodcp" value="<?php if(empty($do)) { ?>1<?php } else { ?>2<?php } ?>" />
<table cellspacing="0" cellpadding="0">
<tbody class="th">
<tr>
<td class="icn">&nbsp;</td>
...
<?php if($thread['readperm']) { ?> - [阅读权限 <span class="bold"><?php echo $thread['readperm'];?></span>]<?php } if($thread['price'] > 0) { if($thread['special'] == '3') { ?>
