<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_album_view', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/home/space_album_view.htm', './template/8264/common/header_8264_new.htm', 1509517867, '2', './data/template/2_2_home_space_album_view.tpl.php', './template/8264', 'home/space_album_view')
|| checktplrefresh('./template/8264/home/space_album_view.htm', './template/8264/home/space_header_uc.htm', 1509517867, '2', './data/template/2_2_home_space_album_view.tpl.php', './template/8264', 'home/space_album_view')
|| checktplrefresh('./template/8264/home/space_album_view.htm', './template/8264/home/space_footer_uc.htm', 1509517867, '2', './data/template/2_2_home_space_album_view.tpl.php', './template/8264', 'home/space_album_view')
|| checktplrefresh('./template/8264/home/space_album_view.htm', './template/8264/common/footer_8264_new.htm', 1509517867, '2', './data/template/2_2_home_space_album_view.tpl.php', './template/8264', 'home/space_album_view')
|| checktplrefresh('./template/8264/home/space_album_view.htm', './template/8264/common/header_common.htm', 1509517867, '2', './data/template/2_2_home_space_album_view.tpl.php', './template/8264', 'home/space_album_view')
|| checktplrefresh('./template/8264/home/space_album_view.htm', './template/8264/common/index_ad_top.htm', 1509517867, '2', './data/template/2_2_home_space_album_view.tpl.php', './template/8264', 'home/space_album_view')
|| checktplrefresh('./template/8264/home/space_album_view.htm', './template/8264/common/ewm_r.htm', 1509517867, '2', './data/template/2_2_home_space_album_view.tpl.php', './template/8264', 'home/space_album_view')
;
block_get('6905');?>
<?php $_G['home_tpl_titles'] = array($album['albumname'], '相册'); ?><?php $friendsname = array(0 => '全站用户可见',1 => '仅自己可见',2 => '仅自己可见',3 => '仅自己可见',4 => '仅自己可见'); ?><!doctype html>
<html>
<head>
...
<form method="post" autocomplete="off" id="theform" name="theform" action="home.php?mod=spacecp&amp;ac=album&amp;op=editpic&amp;albumid=<?php echo $album['albumid'];?>&amp;is_uc=1">
...
<img src="<?php echo $album['pic'];?>" alt="<?php echo $album['albumname'];?>">
</a>
<!--	<div class="info">
<span class="data"><i class="icon-m icon-data-m"></i><?php echo date('Y-m-d', $album[dateline]) ?></span>
<span class="count"><?php echo $album['picnum'];?></span>
</div>-->
</div>
<div class="albuminfo-others">
<div class="album-tit-view">
<h3><?php echo $album['albumname'];?></h3>
<?php if($space['self']) { ?><a href="home.php?mod=spacecp&amp;ac=album&amp;op=edit&amp;albumid=<?php echo $album['albumid'];?>" class="modify-album-info" id="albumedit" onclick="showWindow(this.id, this.href, 'get', 0);">编辑</a><?php } ?>
<a class="ret-list" href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=album&amp;view=me">返回相册列表 >></a>
</div>				
<div class="album-profile-more">
<div class="album-describe">
<span> 创建于 <?php echo date('Y-m-d', $album['dateline']); ?> </span>
<span style="margin-left:8px;"><?php echo $album['picnum'];?>张</span>
</div>
<?php if($space['self']) { ?><div class="album-limit" style="margin-left:0"><i style="font-style:normal;margin:0 8px 0 6px;">/</i><?php echo $friendsname[$album['friend']];?></div><?php } ?>
</div>
</div>
<div class="interact-info">
<?php if($_G['uid']) { ?>
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=album&amp;id=<?php echo $album['albumid'];?>&amp;spaceuid=<?php echo $space['uid'];?>&amp;handlekey=sharealbumhk_<?php echo $album['albumid'];?>&amp;is_uc=1" id="a_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" class="item am-praise-btn" style="float:left;">
<?php } else { ?>
<a href="member.php?mod=logging&amp;action=login" class="item am-praise-btn" style="float:left;">
<?php } ?>				
<i class="icon-m icon-praise-m"></i><span id="favoritenum"><?php echo $album['favtimes'];?></span>
</a>
...
<?php if($_G['uid']) { ?>
<!--<a href="#" class="oshr" onclick="showWindow('pubalbum','http://www.8264.com/plugin.php?id=whither:pubalbum&albumid=<?php echo $_G['gp_id'];?>','get',0);return false;" style="background:#fff url(http://bbs.8264.com/static/image/common/recom_mdd.gif) 5px 2px no-repeat;">推荐到目的地</a>	-->		
<?php } ?>
</div>
</div>		
<!--相册信息 end-->
<!--相册管理-->
<?php if($space['self']) { ?>
<div class="mod-photo-tool" <?php if($isEdit) { ?>style="display:none;"<?php } ?>>
<div class="photo-op-item">
<a href="home.php?mod=spacecp&amp;ac=upload&amp;op=flash&amp;albumid=<?php echo $album['albumid'];?>" class="pl-upload" target="_blank"><i class="icon-m icon-upload-m"></i>上传照片</a>
</div>
<div class="photo-op-item">
<a href="javascript:void(0);" class="pl-manage" id="pl-manage"><i class="icon-m icon-manage-m"></i>批量管理</a>
</div>
</div>
<div class="photo-list-op" <?php if(!$isEdit) { ?>style="display:none;"<?php } ?>>
<div class="op-bar">
<div class="op-select">
...
<a data-hottag="manage.movephotos" class="op-item pl-manage-toolbar-move" href="javascript:void(0);" onclick="piMovePic(this.rel)" rel="home.php?mod=spacecp&amp;ac=album&amp;op=editpic&amp;albumid=<?php echo $album['albumid'];?>&amp;subop=move&amp;page=1">移动到相册</a>
...
<div class="mod-photo-list manageContainer <?php if($isEdit) { ?>mod-op-current<?php } ?>">
<?php if($list) { ?>	
<ul class="pl-photolist"><?php if(is_array($list)) foreach($list as $value) { ?><li class="pl-photoitem">
<div class="mod-photo-item" id="picdiv_<?php echo $value['picid'];?>">
<div class="item-bd">								
<a href="javascript:void(0);" class="item-cover pl-photoitem-img isIE6">
<?php if($value['pic']) { ?><img src="<?php echo $value['pic'];?>" alt="" class="picture" /><?php } if($value['status'] == 1) { ?><b>(待审核)</b><?php } ?>
</a>
<a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>&amp;do=<?php echo $do;?>&amp;picid=<?php echo $value['picid'];?>&amp;listpage=<?php echo $_G['gp_page'];?>" style="display:none;"></a>
<a href="<?php echo $value['filepath'];?>" style="display:none;"></a>
<?php if($space['self']) { ?>
<!--管理框-->
...
<ul>
<li>
<a onclick="showWindow('setpichk', this.href, 'get', 0)" href="home.php?mod=spacecp&amp;ac=album&amp;op=setpic&amp;albumid=<?php echo $value['albumid'];?>&amp;picid=<?php echo $value['picid'];?>&amp;handlekey=setpichk&amp;is_uc=1" class="pl-photoitem-op-cover setpic" id="setpic_<?php echo $value['picid'];?>">
<i class="icon-m icon-cover-m"></i><span><?php if($value['filepath'] == $album['mpic']) { ?>封面图片<?php } else { ?>设为封面<?php } ?></span>
</a>
</li>
<li>
<a href="home.php?mod=spacecp&amp;ac=album&amp;op=editpic&amp;albumid=<?php echo $album['albumid'];?>&amp;subop=move&amp;picids=<?php echo $value['picid'];?>&amp;page=<?php echo $page;?>" class="pl-photoitem-op-move" onclick="showWindow('albummove', this.href, 'get', 0)"><i class="icon-m icon-move-m"></i>移动到相册</a>
</li>
<li>
<a href="javascript:void(0);" class="pl-photoitem-op-delete" onclick="deletePic('<?php echo $value['picid'];?>')"><i class="icon-m icon-delete-m"></i>删除</a>
</li>
</ul>
</div>
</div>
<!--管理框 end-->
<!--选择框-->
<div class="item-select j-pl-photoitem-selctn item_check" <?php if(!$isEdit) { ?>style="display:none;"<?php } ?>>
<div class="bor">
<span>点击选择</span>
</div>
...
<!--图片描述-->
<div class="item-ft"><?php $value[title] = $value[title] ? $value[title] : $value[filename]; ?><div class="item-tit pl-photoitem-title">
<span class=""><?php echo $value['title'];?></span>
</div>
<?php if($space['self']) { ?>
<div class="mod-input mod-input-focus pl-photoitem-quickedit" style="display:none;">
<div class="input-wrap">
<input type="text" value="<?php echo $value['title'];?>" maxlength="30" data-saving="0" name="title[<?php echo $value['picid'];?>]" onfocus="this.select();">
</div>
</div>
<?php } ?>
...
<input type="checkbox" name="ids[<?php echo $value['picid'];?>]" value="<?php echo $value['picid'];?>" id="picid_<?php echo $value['picid'];?>" class="picid" style="display:none;">
</li>
<?php } ?>
</ul>
<?php } else { if(!$pricount) { ?><p class="emp">该相册下还没有图片</p><?php } if($pricount) { ?><p>本页有 <?php echo $pricount;?> 张图片因作者的隐私设置或未通过而隐藏</p><?php } } ?>
</div>							
</div>
<!--相片列表 end-->				
</div>
...
ajaxpost('theform', 'return_<?php echo $_G['gp_handlekey'];?>');
return false;
});
