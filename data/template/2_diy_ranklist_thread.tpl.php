...
<h1 class="mt">帖子排行</h1>
<ul class="tb cl">
<li<?php if($_G['gp_orderby'] == 'replies') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=thread&amp;orderby=replies&amp;before=<?php echo $_G['gp_before'];?>">回复排行</a></li>
<li<?php if($_G['gp_orderby'] == 'views') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=thread&amp;orderby=views&amp;before=<?php echo $_G['gp_before'];?>">查看排行</a></li>
<li<?php if($_G['gp_orderby'] == 'sharetimes') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=thread&amp;orderby=sharetimes&amp;before=<?php echo $_G['gp_before'];?>">分享排行</a></li>
<li<?php if($_G['gp_orderby'] == 'favtimes') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=thread&amp;orderby=favtimes&amp;before=<?php echo $_G['gp_before'];?>">收藏排行</a></li>
</ul>
<p id="before" class="tbmu<?php if($threadlist) { ?> bw0<?php } ?>">
<a href="misc.php?mod=ranklist&amp;type=thread&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=thisweek" id="604800" <?php if($_G['gp_before'] == 'thisweek') { ?>class="a"<?php } ?> />本周</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=thread&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=thismonth" id="2592000" <?php if($_G['gp_before'] == 'thismonth') { ?>class="a"<?php } ?> />本月</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=thread&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=today" id="86400" <?php if($_G['gp_before'] == 'today') { ?>class="a"<?php } ?> />今日</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=thread&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=all" id="all" <?php if($_G['gp_before'] == 'all') { ?>class="a"<?php } ?> />全部</a>
</p>
<?php if($threadlist) { ?>
<div class="tl">
<table cellspacing="0" cellpadding="0">
...
<td class="by">作者</td>
<td width="60">
<?php if($_G['gp_orderby'] == 'views') { ?>查看
<?php } elseif($_G['gp_orderby'] == 'sharetimes') { ?>分享
<?php } elseif($_G['gp_orderby'] == 'favtimes') { ?>收藏
<?php } else { ?>回复<?php } ?>
</td>
</tr>
