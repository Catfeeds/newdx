        ...
        <div class="ui-block ui-block-content">
            <div class="comment-form-box">
                ...
                <div class="rows-content row-color-3">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="weakpoint" id="weakpoint" cols="30" rows="2" placeholder="请填写该客栈的不足之处"></textarea>
                ...
                <div class="rows-content row-color-4">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="goodpoint" id="goodpoint" cols="30" rows="2" placeholder="请填写该客栈的优点"></textarea>
                ...
                <div class="rows-content row-color-5">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="message" id="message" cols="30" rows="6" placeholder="请填写该客栈的综合评价"></textarea>
    ...
    <div class="ui-grid-2 ui-grid-right">
        ...
        <div class="right-hot-warpten">
            <div class="ui-block ui-block-title">
                <div class="ui-title ui-title-line">
                    <h3>热门</h3>
                    <div class="ui-title-link"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;provinceid=0&amp;cityid=0&amp;page=1" target="_brank">更多</a></div>
                </div>
            </div>
            <div class="ui-block ui-block-content">
                <div class="common-list-box hot-list-box">
    ...
    <div class="ui-grid-2 ui-grid-right">
        <div class="right-same-area-warpten">
            <div class="ui-block ui-block-title">
                <div class="ui-title ui-title-line">
                    <h3>同地区</h3>
                    <div class="ui-title-link"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;provinceid=<?php echo $detail['provinceid'];?>&amp;cityid=0&amp;page=1" target="_brank">更多</a></div>
                </div>
            </div>
            <div class="ui-block ui-block-content">
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        $('#message').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该客栈的综合评价。</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该客栈的综合评价，不能少于10个字符。</span></div>'
        });
        //缺点
        $('#weakpoint').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该客栈的不足之处。</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该客栈的不足之处，不能少于10个字符。</span></div>'
        });
        //优点
        $('#goodpoint').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该客栈的优点</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该客栈的优点，不能少于10个字符</span></div>'
        });
