...
<div>
<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=group&amp;id=<?php echo $_G['forum']['fid'];?>&amp;handlekey=sharealbumhk_<?php echo $_G['forum']['fid'];?>" id="a_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" title="收藏" class="fa_fav">收藏</a><span class="pipe">|</span><?php if($_G['setting']['rssstatus'] && !$_G['gp_archiveid']) { ?><a href="forum.php?mod=rss&amp;fid=<?php echo $_G['fid'];?>&amp;auth=<?php echo $rssauth;?>" target="_blank" title="RSS" class="fa_rss">RSS</a><?php } if($status == 'isgroupuser') { ?><span class="pipe">|</span><a href="javascript:;" onclick="showWindow('invite','misc.php?mod=invite&action=group&id=<?php echo $_G['fid'];?>')" class="fa_ivt"><strong class="xi2">邀请好友</strong></a><?php } ?>
<span class="pipe">|</span><?php if($_G['current_grouplevel']['icon']) { ?><img src="<?php echo $_G['current_grouplevel']['icon'];?>" title="<?php echo $_G['setting']['navs']['3']['navname'];?>等级: <?php echo $_G['current_grouplevel']['leveltitle'];?>" class="vm"> <?php } ?>积分: <?php echo $_G['forum']['commoncredits'];?><span class="pipe">|</span>群主: <?php $i = 1; if(is_array($groupmanagers)) foreach($groupmanagers as $manage) { if($i <= 0) { ?>, <?php } ?><?php $i--; ?><a href="home.php?mod=space&amp;uid=<?php echo $manage['uid'];?>" target="_blank" class="xi2"><?php echo $manage['username'];?></a><?php } ?>
</div>
...
<dd class="cl">
<span class="y"><a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=group&amp;id=<?php echo $_G['forum']['fid'];?>&amp;handlekey=sharealbumhk_<?php echo $_G['forum']['fid'];?>" id="a_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" title="收藏" class="fa_fav">收藏</a><span class="pipe">|</span><?php if($_G['setting']['rssstatus'] && !$_G['gp_archiveid']) { ?><a href="forum.php?mod=rss&amp;fid=<?php echo $_G['fid'];?>&amp;auth=<?php echo $rssauth;?>" target="_blank" title="RSS" class="fa_rss">RSS</a><?php } if($status == 'isgroupuser') { ?><span class="pipe">|</span><a href="javascript:;" onclick="showWindow('invite','misc.php?mod=invite&action=group&id=<?php echo $_G['fid'];?>')" class="fa_ivt"><strong class="xi2">邀请好友</strong></a><?php } ?></span>
...
<?php if($_G['forum']['ismoderator']) { ?><li <?php if($action == 'manage') { ?>class="a"<?php } ?>><a href="forum.php?mod=group&amp;action=manage&amp;fid=<?php echo $_G['fid'];?>#groupnav">管理<?php echo $_G['setting']['navs']['3']['navname'];?></a></li><?php } if(CURMODULE == 'group') { ?><?php if(!empty($_G['setting']['pluginhooks']['group_nav_extra'])) echo $_G['setting']['pluginhooks']['group_nav_extra']; } else { ?><?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_nav_extra'])) echo $_G['setting']['pluginhooks']['forumdisplay_nav_extra']; } ?>
</ul>
</div>
...
<a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})" onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')" title="发帖"><img src="http://static.8264.com/static/image/common/pn_post.png" alt="发帖" /></a>
</div>
<div class="tl bm bml">
<div class="th">
...
<td class="icn">
<a href="forum.php?mod=viewthread&amp;tid=<?php echo $tid;?>&amp;extra=<?php echo $extra;?>" title="新窗口打开" target="_blank">
...
<ul class="ttp bm cl">
<li<?php if(!$_G['gp_typeid']) { ?> class="xw1 a"<?php } ?>><a href="forum.php?mod=forumdisplay&amp;action=list&amp;fid=<?php echo $_G['fid'];?>">全部</a></li>
...
<img src="http://static.8264.com/static/image/common/recommend_<?php echo $thread['recommendicon'];?>.gif" align="absmiddle" alt="recommend" title="评价指数 <?php echo $thread['recommends'];?>" />
<?php } if($thread['heatlevel']) { ?>
<img src="http://static.8264.com/static/image/common/hot_<?php echo $thread['heatlevel'];?>.gif" align="absmiddle" alt="heatlevel" title="<?php echo $thread['heatlevel'];?> 级热门" />
<?php } if($thread['digest'] > 0) { ?>
<img src="http://static.8264.com/static/image/common/digest_<?php echo $thread['digest'];?>.gif" align="absmiddle" alt="digest" title="精华 <?php echo $thread['digest'];?>" />
<?php } if($thread['rate'] > 0) { ?>
<img src="http://static.8264.com/static/image/common/agree.gif" align="absmiddle" alt="agree" title="帖子被加分" />
...
<?php echo $multipage;?>
<span <?php if($_G['setting']['visitedforums']) { ?>id="visitedforums" onmouseover="$('visitedforums').id = 'visitedforumstmp';this.id = 'visitedforums';showMenu({'ctrlid':this.id})"<?php } ?> class="pgb y"><a href="forum.php?mod=group&amp;fid=<?php echo $_G['fid'];?>">返回首页</a></span>
<a href="javascript:;" id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})" onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')" title="发帖"><img src="http://static.8264.com/static/image/common/pn_post.png" alt="发帖" /></a>
...
<div class="bm_h cl">		
<h1 class="xs2">创建新<?php echo $_G['setting']['navs']['3']['navname'];?></h1>
</div>
<div class="bm_c">
...
<em id="secondgroup"><select name="fup" id="fup" class="ps" ><option value="">必选项</option></select></em>
</td>
</tr>
<tr>
...
<td><label><input type="radio" name="gviewperm" class="pr" tabindex="4" value="1" checked="checked"> 所有人</label> <label><input type="radio" class="pr" name="gviewperm" value="0"> 仅成员</label></td>
</tr>
<tr>
<th><strong class="rq y">*</strong>加入方式:</th>
<td><label><input type="radio" name="jointype" class="pr" tabindex="5" value="0" checked="checked"> 自由加入</label> <label><input type="radio" class="pr" name="jointype" value="2"> 审核加入</label> <label><input type="radio" class="pr" name="jointype" value="1"> 邀请加入</label></td>
</tr>
<tr>
<th>&nbsp;</th>
<td>注：除<?php echo $_G['setting']['navs']['3']['navname'];?>名称和分类暂时不能修改外，其它项目在创建完成后仍可修改。</td>
</tr>
<tr>
<th>&nbsp;</th>
<td>
<input type="hidden" name="createsubmit" value="true"><button type="submit" class="pn pnp" tabindex="6"><strong>创建</strong></button>
...
<a href="forum.php?mod=group&amp;action=manage&amp;op=group&amp;fid=<?php echo $_G['fid'];?>"<?php if($_G['gp_op'] == 'group') { ?> class="a"<?php } ?>><?php echo $_G['setting']['navs']['3']['navname'];?>设置</a>
<?php if(!empty($groupmanagers[$_G['uid']]) || $_G['adminid'] == 1) { ?>
<span class="pipe">|</span><a href="forum.php?mod=group&amp;action=manage&amp;op=checkuser&amp;fid=<?php echo $_G['fid'];?>"<?php if($_G['gp_op'] == 'checkuser') { ?> class="a"<?php } ?>>成员审核</a>
<span class="pipe">|</span><a href="forum.php?mod=group&amp;action=manage&amp;op=manageuser&amp;fid=<?php echo $_G['fid'];?>"<?php if($_G['gp_op'] == 'manageuser') { ?> class="a"<?php } ?>>成员管理</a>
<?php } if($_G['forum']['founderuid'] == $_G['uid'] || $_G['adminid'] == 1) { ?>
<span class="pipe">|</span><a href="forum.php?mod=group&amp;action=manage&amp;op=threadtype&amp;fid=<?php echo $_G['fid'];?>"<?php if($_G['gp_op'] == 'threadtype') { ?> class="a"<?php } ?>>主题分类</a>
<span class="pipe">|</span><a href="forum.php?mod=group&amp;action=manage&amp;op=demise&amp;fid=<?php echo $_G['fid'];?>"<?php if($_G['gp_op'] == 'demise') { ?> class="a"<?php } ?>><?php echo $_G['setting']['navs']['3']['navname'];?>转让</a>
<?php } ?>
</p>
...
<tr>
<th><strong class="rq">*</strong><?php echo $_G['setting']['navs']['3']['navname'];?>名称:</th>
...
<tr>
<th><strong class="rq">*</strong>所属分类:</th>
<td>
...
<tr>
<th>浏览权限</th>
<td><label><input type="radio" name="gviewpermnew" class="pr" value="1" <?php echo $gviewpermselect['1'];?>> 所有人</label> <label><input type="radio" name="gviewpermnew" class="pr" value="0" <?php echo $gviewpermselect['0'];?>> 仅成员</label></td>
</tr>
<tr>
<th>加入方式</th>
<td>
<label><input type="radio" name="jointypenew" class="pr" value="0" <?php echo $jointypeselect['0'];?> /> 自由加入 </label>
<label><input type="radio" name="jointypenew" class="pr" value="2" <?php echo $jointypeselect['2'];?> /> 审核加入 </label>
<label><input type="radio" name="jointypenew" class="pr" value="1" <?php echo $jointypeselect['1'];?> /> 邀请加入 </label>
<?php if(!empty($specialswitch['allowclosegroup'])) { ?>
<label><input type="radio" name="jointypenew" class="pr" value="-1" <?php echo $jointypeselect['-1'];?> /> 关闭</label>
...
<?php if($_G['forum']['domain'] && $consume) { ?>修改域名将需要支付积分<strong><?php echo $consume;?></strong>，你现在有拥有<strong><?php echo $credits;?></strong><?php } ?>
</p>
</td>
</tr>
...
<tr>
<th>&nbsp;</th>
<td><button type="submit" name="groupmanage" class="pn pnp" value="1"><strong>提交</strong></button></td>
</tr>
</tbody>
</table>
</form>
...
<dd class="pns"><button type="submit" name="checkusertrue" class="pn pnp" value="true" onclick="location.href='forum.php?mod=group&action=manage&op=checkuser&fid=<?php echo $_G['fid'];?>&uid=<?php echo $user['uid'];?>&checktype=1'"><em>通过</em></button> &nbsp; <button type="submit" name="checkuserfalse" class="pn" value="true" onclick="location.href='forum.php?mod=group&action=manage&op=checkuser&fid=<?php echo $_G['fid'];?>&uid=<?php echo $user['uid'];?>&checktype=2'"><em>忽略</em></button></dd>
</dl>
<?php } ?>
</div>
...
<input type="text" onclick="$('groupsearch').value=''" value="请输入成员名称" size="15" class="px p_fre vm" id="groupsearch" name="srchuser">&nbsp;
...
目前你的<?php echo $_G['setting']['navs']['3']['navname'];?>等级不能使用此功能。
<?php } else { ?>
<script type="text/JavaScript">
var rowtypedata = [
[
...
<th>启用主题分类:</th>
<td>
<label><input type="radio" name="threadtypesnew[status]" class="pr" value="1" onclick="$('threadtypes_config').style.display = '';$('threadtypes_manage').style.display = '';" <?php echo $checkeds['status']['1'];?>> 是</label>
<label><input type="radio" name="threadtypesnew[status]" class="pr" value="0" onclick="$('threadtypes_config').style.display = 'none';$('threadtypes_manage').style.display = 'none';"  <?php echo $checkeds['status']['0'];?>> 否</label>
<p class="d">设置是否启用主题分类功能，你需要同时设定相应的分类选项，才能启用本功能</p>
</td>
</tr>
...
<th>发帖必须归类:</th>
<td>
<label><input type="radio" name="threadtypesnew[required]" class="pr" value="1" <?php echo $checkeds['required']['1'];?>> 是</label>
<label><input type="radio" name="threadtypesnew[required]" class="pr" value="0" <?php echo $checkeds['required']['0'];?>> 否</label>
...
<th>类别前缀:</th>
<td>
<label><input type="radio" name="threadtypesnew[prefix]" class="pr" value="0" <?php echo $checkeds['prefix']['0'];?>> 不显示</label>
<label><input type="radio" name="threadtypesnew[prefix]" class="pr" value="1" <?php echo $checkeds['prefix']['1'];?>> 显示</label>
...
<?php } } ?>
<tr>
<td colspan="4"><img class="vm" src="http://static.8264.com/static/image/common/addicn.gif" /> <a href="javascript:;" onclick="addrow(this, 0)">添加分类</a></td>
</tr>
</table>
</div>
<button type="submit" class="pn pnp mtm" name="groupthreadtype" value="1"><strong>提交</strong></button>
</form>
</div>
<?php } ?>
</div>
...
<div class="mtm"><h2>温馨提示：</h2><p><?php echo $_G['setting']['navs']['3']['navname'];?>转让成功后，你依然是该群的群主，但不再是<?php echo $_G['setting']['navs']['3']['navname'];?>创始人，所以可自由退出该<?php echo $_G['setting']['navs']['3']['navname'];?>。</p><p>转让后无法直接恢复群，需被接收者主动操作才可以再次转回，请谨慎操作。</p></div>
</div>
...
<th>&nbsp;</th>
<td>
<button type="submit" name="groupdemise" class="pn pnp" value="1"><strong>提交</strong></button>
</td>
</tr>
</table>
</form>
...
<div class="bm bmn">
<div class="bm_c xw1 xi1">你已有 <?php echo $groupnum;?> 个<?php echo $_G['setting']['navs']['3']['navname'];?>，还能创建 <?php echo $allowbuildgroup;?> 个。</div>
</div>
...
<?php } ?>
[<a href="javascript:;" onclick="setCopy($('group_link').href, '<?php echo $_G['setting']['navs']['3']['navname'];?>地址已经复制到剪贴板')" class="xi2">复制</a>]
</p>
...
<?php if($status == 'isgroupuser') { ?><p class="ptn"><a onclick="showDialog('你确定要退出该<?php echo $_G['setting']['navs']['3']['navname'];?>吗？', 'confirm', '', function(){location.href='forum.php?mod=group&action=out&fid=<?php echo $_G['fid'];?>'})" href="javascript:;" class="xi2">退出<?php echo $_G['setting']['navs']['3']['navname'];?></a><p><?php } ?>
</div>
</div>
