...
0
|| checktplrefresh('./template/default/weather/index.htm', './template/8264/common/header_8264_new.htm', 1509517940, '2', './data/template/2_2_weather_index.tpl.php', './template/8264', 'weather/index')
|| checktplrefresh('./template/default/weather/index.htm', './template/8264/common/zhidemai.htm', 1509517940, '2', './data/template/2_2_weather_index.tpl.php', './template/8264', 'weather/index')
|| checktplrefresh('./template/default/weather/index.htm', './template/8264/common/footer_8264_new.htm', 1509517940, '2', './data/template/2_2_weather_index.tpl.php', './template/8264', 'weather/index')
|| checktplrefresh('./template/default/weather/index.htm', './template/8264/common/header_common.htm', 1509517940, '2', './data/template/2_2_weather_index.tpl.php', './template/8264', 'weather/index')
|| checktplrefresh('./template/default/weather/index.htm', './template/8264/common/index_ad_top.htm', 1509517940, '2', './data/template/2_2_weather_index.tpl.php', './template/8264', 'weather/index')
;?>
<!doctype html>
<html>
<head>
...
<?php } ?>
<!-- //手机绑定提示 -->
<link rel="stylesheet" type="text/css" href="http://static.8264.com/static/css/weather/style/style.css">
...
<style>
    body{ background:url(http://static.8264.com/static/css/weather/images/forecast_bg.png) fixed top center;}
</style>
        <div class="w1170">
        	<!-- 值得买 -->
            ...
            <style>
                .zhidemaiwidth{ width:1170px;}
                .zhidemaibox .zhidemailist_new{ width:1170px; margin:0 auto; overflow:hidden;}
                .zhidemaibox .zhidemailist_new ul{ width:1370px;}
                .zhidemaibox .zhidemailist_new li{width:176px; overflow:hidden;}
                .zhidemaibox .zhidemailist_new li img{ width:176px;}
            </style>
            <style>
/*
...
jQuery(function($){
    $('.countdown').each(function(i, v) {
        ...
        function formatNum(n) {
            ...
            <?php } ?>
            <!-- //值得买 -->
            <div class="navigation clear_b">
                <h3>
                    当前位置：<a href="http://www.8264.com/weather/">全国天气预报</a>><a href="http://www.8264.com/weather/<?php echo $parent_spell;?>/"><?php echo $parent_area;?></a>><a href="http://www.8264.com/weather/<?php echo $weather_area_name['pspell'];?>/<?php echo $weather_area_name['spell'];?>/"><?php echo $cur_city;?>天气</a>
                </h3>
                <div class="changecity">
                    <span>切换城市</span>
                </div>
            </div>
            <div class="btitle clear_b">
                <h1><?php echo $cur_city;?>天气预报</h1>
                <div>
                    <!-- 活动二维码 -->
                    <style>
                    .gzhboxheardbox{float:right; cursor:pointer;position:relative; line-height:1.4; margin-right:15px;}
                    ...
                    .gzhboxheardbox:hover .gzhpopcon{display:block}
                    .gzhpopcon{width:250px;height:120px;position:absolute;top:34px;right:0px;background:rgba(242,242,242,.8);display:none;box-shadow:0 12px 10px rgba(12,4,7,.4)}
                    ...
                    <div class="gzhboxheardbox">
                        <span class="gzhspan" style="color: #ffc52a;"><?php echo $cur_city;?>精彩活动推荐</span>
                        <div class="gzhpopcon">
                    ...
                    <!-- //活动二维码 -->
                    <a href="http://www.8264.com/weather/<?php echo $weather_area_name['pspell'];?>/<?php echo $area;?>/tianqi-<?php echo $history_show;?>.html" target="_blank"><?php echo $cur_city;?>历史天气</a>
                </div>
            </div>
            <div class="forecast clear_b">
                <div style=" width:1200px;">
                    <div class="today_detail">
                        <div class="dateweek">
                            <div class="todaycon clear_b">
                                <div class="left">
                                    <b>今天</b>
                                    <span><?php echo $weather_forecast_result['update_date'];?>实时天气</span>
                                </div>
                                <div class="right">
                                    <span><?php echo $weather_forecast_result['current_date'];?></span>
                                    <span><?php echo $weather_forecast_result['current_week'];?></span>
                                </div>
                            </div>
                            <div class="todaycon clear_b pt30">
                                <div class="left">
                                    <img alt="weather_icon" src="http://static.8264.com/static/css/weather/images/icon/<?php echo $weather_forecast_result['code'];?>.png"/>
                                     <em style=" display:block"><?php echo $weather_forecast_result['weather'];?></em>
                                </div>
                                <div class="right">
                                    <i style="font-size:36px; color:#ffc52a; font-weight:bold;"><?php echo $weather_forecast_result['temperature'];?>℃</i>
                                    <em><?php echo $weather_forecast_result['minTemp'];?>/<?php echo $weather_forecast_result['maxTemp'];?>℃</em>
                                </div>
                            </div>
                            <div class="wdescdatail clear_b">
                                <a href="#">雾霾指数：<?php if($weather_forecast_result['aqi']=='') { ?>良好<?php } else { ?><?php echo $weather_forecast_result['aqi'];?><?php } ?></a>
                                <span>空气质量：良好</span>
                                <span>风力预报：<?php echo $weather_forecast_result['wind_dir'];?><?php echo $weather_forecast_result['wind_power'];?>级</span>
                                <a href="#">穿衣指数：<?php echo $weather_forecast_result['drsg'];?></a>
                            </div>
                        </div>
                    </div>
                    <div class="detail_day_list clear_b w242">
                        <ul>
                            <?php if(is_array($weather_forecast_result['hourly_forecast'])) foreach($weather_forecast_result['hourly_forecast'] as $weather_forecast) { ?>                            <li>
                                <span class="date"><?php echo $weather_forecast['date'];?></span>
                                <span class="week"><?php echo $weather_forecast['time'];?></span>
                                <span class="wicon"><img src="http://static.8264.com/static/css/weather/images/icon/<?php echo $weather_forecast_result['code'];?>.png"></span>
                                <span class="wdesc"> <?php echo $weather_forecast['weather'];?> </span>
                                <span class="temp"> <?php echo $weather_forecast['temperature'];?>℃ </span>
                                <span class="direct"> <?php echo $weather_forecast['wind_dir'];?> </span>
                                <span class="wind"> <?php echo $weather_forecast['wind_power'];?>级 </span>
                            </li>
                            <?php } ?>
                        </ul>
                    </div>
            ...
            <div class="btitle clear_b">
                <h1><?php echo $cur_city;?>未来7天天气预报</h1>
                <div>
                    <a href="http://www.8264.com/weather/<?php echo $weather_area_name['pspell'];?>/<?php echo $weather_area_name['spell'];?>/yubao-10.html" target="_blank"><?php echo $cur_city;?>10天天气预报</a>
                    <a href="http://www.8264.com/weather/<?php echo $weather_area_name['pspell'];?>/<?php echo $weather_area_name['spell'];?>/yubao-15.html" target="_blank"><?php echo $cur_city;?>15天天气预报</a>
                    <a href="http://www.8264.com/weather/<?php echo $weather_area_name['pspell'];?>/<?php echo $weather_area_name['spell'];?>/yubao-30.html" target="_blank"><?php echo $cur_city;?>30天天气预报</a>
                </div>
            </div>
            <div class="forecast clear_b">
                <div style=" width:1200px;">
                    <div class="detail_day_list clear_b w129">
                        <ul>
                            <?php if(is_array($weather_forecast_result['daily_forecast'])) foreach($weather_forecast_result['daily_forecast'] as $weather_forecast_daily) { ?>                            <li>
                                <span class="date"><?php echo $weather_forecast_daily['date'];?></span>
                                <span class="week"> <?php echo $weather_forecast_daily['week'];?> </span>
                                <span class="wicon"><img src="http://static.8264.com/static/css/weather/images/icon/<?php echo $weather_forecast_daily['code'];?>.png"></span>
                                <span class="wdesc"> <?php echo $weather_forecast_daily['weather'];?> </span>
                                <span class="temp"> <?php echo $weather_forecast_daily['minTemp'];?>/<?php echo $weather_forecast_daily['maxTemp'];?>℃ </span>
                                <span class="direct"> <?php echo $weather_forecast_daily['wind_dir'];?> </span>
                                <span class="wind"> <?php echo $weather_forecast_daily['wind_power'];?>级</span>
                            </li>
                            <?php } ?>
                        </ul>
                    </div>
            ...
            <div class="btitle clear_b">
                <h1>其他城市天气预报</h1>
                <div><a href="http://www.8264.com/weather/" target="_blank">更多城市查询</a></div>
            </div>
            <div class="citylist clear_b">
                <?php if(is_array($weather_parallel_area_list)) foreach($weather_parallel_area_list as $weather_parallel_area) { ?>                <a href="http://www.8264.com/weather/<?php echo $weather_parallel_area['pspell'];?>/<?php echo $weather_parallel_area['spell'];?>/" target="_blank"><?php echo $weather_parallel_area['name'];?>天气预报</a>
                <?php } ?>
            </div>
        </div>
        <!--切换城市列表开始-->
        ...
        <script>
            $(function () {
                ...
                $(".changecity span").click(function () {
                    $(".minicity_content").load('http://www.8264.com/weather.php?ctl=get_citylist_by_ajax&is_ajax=1&area=<?php echo $_GET['area'];?>&pspell=<?php echo $_GET['pspell'];?>');
                    $(".citylistbox").css({
                        "opacity": "100", "z-index": "1091"
                    });
                    $(".citylistbox").height(ww);
                    $(".minicity_content").height(ww - 70);
                });
                $(document).on("click",".citytitle i",function(){
                    $(".citylistbox").css({
                        "opacity": "0", "z-index": "-1"
                    });
                });
