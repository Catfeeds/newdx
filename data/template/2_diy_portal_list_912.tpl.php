...
0
|| checktplrefresh('./template/8264/portal/list_912.htm', './template/8264/common/float_guide.htm', 1509517936, 'diy', './data/template/2_diy_portal_list_912.tpl.php', './template/8264', 'portal/list_912')
|| checktplrefresh('./template/8264/portal/list_912.htm', './template/8264/common/ewm_l.htm', 1509517936, 'diy', './data/template/2_diy_portal_list_912.tpl.php', './template/8264', 'portal/list_912')
|| checktplrefresh('./template/8264/portal/list_912.htm', './template/8264/common/footer_8264_new.htm', 1509517936, 'diy', './data/template/2_diy_portal_list_912.tpl.php', './template/8264', 'portal/list_912')
;?><?php include template('common/header2014'); ?><!--[name]户外摄影师[/name]-->
<meta http-equiv=Content-Type content="text/html; charset=GB2312">
<meta name="keywords" content="户外摄影师">
<meta name="description" content="户外摄影师">

<link rel="stylesheet" type="text/css" href="http://static.8264.com/static/css/portal/style911.css">
<style id="diy_style" type="text/css"></style>
<div class="warpten clearfix" style="display:none;">
...
<div class="top2box clear_b">
            <?php if($count_array ==1) { ?>
    	<div class="top2one">
        	<div class="topbigimg"><a href="<?php echo $array_2['0']['url'];?>" target="_blank"><img src="<?php echo $array_2['0']['pic'];?>"></a></div>
            <div class="gunum">
            	<i></i>
                <em><?php echo $array_2['0']['commentnum'];?></em>
            </div>
            <div class="topztbox">
            	<div class="qinum"><?php echo $array_2['0']['pubmf'];?> <?php echo $array_2['0']['pubd'];?>th</div>
                <div class="title20333"><a href="<?php echo $array_2['0']['url'];?>" target="_blank" style="text-decoration: none;"><?php echo $array_2['0']['title'];?></a></div>
                <div class="infoboxyh">
                	<blockquote><?php echo $array_2['0']['summary'];?></blockquote>
                </div>
            </div>
            <div class="gzboxgray clear_b">
            	<div class="reveiwbox">
                	<img src="http://static.8264.com/static/images/reveiwicon.png"/>
                    <?php if(is_array($array_2['0']['arr'])) foreach($array_2['0']['arr'] as $img) { ?>                    <a href="<?php echo $img['uid'];?>" target="_blank"><?php echo $img['tx'];?></a>
                    <?php } ?>
                    <i class="slhicon"></i>
                </div>
                <div class="gznumbox">
                	<b><?php echo $array_2['0']['viewnum'];?></b>
                	人已关注
                </div>
            </div>
        </div>
            <?php } elseif($count_array >1) { ?>
            <div class="top2one">
        	<div class="topbigimg"><a href="<?php echo $array_2['0']['url'];?>" target="_blank"><img src="<?php echo $array_2['0']['pic'];?>"></a></div>
            <div class="gunum">
            	<i></i>
        ...
        <div class="top2one right">
        	<div class="topbigimg"><a href="<?php echo $array_3['0']['url'];?>" target="_blank"><img src="<?php echo $array_3['0']['pic'];?>"></a></div>
            <div class="gunum">
            	<i></i>
                <em><?php echo $array_3['0']['commentnum'];?></em>
            </div>
            <div class="topztbox">
            	<div class="qinum"><?php echo $array_3['0']['pubmf'];?> <?php echo $array_3['0']['pubd'];?>th</div>
                <div class="title20333"><a href="<?php echo $array_3['0']['url'];?>" target="_blank" style="text-decoration: none;"><?php echo $array_3['0']['title'];?></a></div>
                <div class="infoboxyh">
                	<blockquote><?php echo $array_3['0']['summary'];?></blockquote>
                </div>
            </div>
            <div class="gzboxgray clear_b">
            	<div class="reveiwbox">
                	<img src="http://static.8264.com/static/images/reveiwicon.png"/>
                        <?php if(is_array($array_3['0']['arr'])) foreach($array_3['0']['arr'] as $img) { ?>                        <a href="<?php echo $img['uid'];?>" target="_blank"><?php echo $img['tx'];?></a>
                        <?php } ?>
                    <i class="slhicon"></i>
                </div>
                <div class="gznumbox">
                	<b><?php echo $array_3['0']['viewnum'];?></b>
                	人已关注
                </div>
            </div>
        </div>
    ...
    <?php } ?>
    <div class="syslistbox clear_b">
    	<div class="w1000">
    	<!--单条开始-->
        <?php if(is_array($array)) foreach($array as $item) { ?>    	<div class="sysbox">
        	<div class="bigimg">
            	<a href="<?php echo $item['url'];?>" target="_blank"><img src="<?php echo $item['pic'];?>"></a>
            </div>
            <div class="name_ll_dp_box">
            	<a href="<?php echo $item['url'];?>" target="_blank"><?php echo $item['title'];?></a>
                <div class="lldpbox">
                	<span class="llicon"><?php echo $item['viewnum'];?></span>
                    <span class="dpicon"><?php echo $item['commentnum'];?></span>
                </div>
            </div>
            <!--日期显示-->
<!--            <div class="qsbox60">
            	<b><?php echo $item['pubd'];?></b>
                <span><?php echo $item['pubm'];?></span>
            </div>-->
        </div>
        <?php } ?>
        <!--单条结束-->
    ...
    <?php $count = DB::result_first("SELECT COUNT(*) FROM ".DB::table('portal_article_title')." WHERE catid IN (912) AND pic<>''"); ?><?php $ppp = 102; ?><?php $multi = multi($count, $ppp, $page, 'portal.php?mod=list&catid=912'); ?>    <?php if($multi) { ?>
