...
<?php if($_G['uid']) { ?>
<a href="javascript:;" onclick="docomment_form(<?php echo $value['doid'];?>, <?php echo $value['id'];?>, '<?php echo $_G['gp_key'];?>');">»Ø¸´</a>
<?php } if($value['uid']==$_G['uid'] || $dv['uid']==$_G['uid'] || checkperm('managedoing')) { ?>
 <a href="home.php?mod=spacecp&amp;ac=doing&amp;op=delete&amp;doid=<?php echo $value['doid'];?>&amp;id=<?php echo $value['id'];?>&amp;handlekey=doinghk_<?php echo $value['doid'];?>_<?php echo $value['id'];?>" id="<?php echo $_G['gp_key'];?>_doing_delete_<?php echo $value['doid'];?>_<?php echo $value['id'];?>" onclick="showWindow(this.id, this.href, 'get', 0);">É¾³ý</a>
<?php } if(checkperm('managedoing')) { ?>
<span class="xg1 xw0">IP: <?php echo $value['ip'];?></span>
<?php } ?>
<div id="<?php echo $_G['gp_key'];?>_form_<?php echo $value['doid'];?>_<?php echo $value['id'];?>"></div>
</li>
<?php } } ?>
</ul>
<?php } ?>
