<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('clubpost', 'forum/dianping/header');
0
|| checktplrefresh('./template/8264/forum/dianping/clubpost.htm', './template/8264/forum/dianping/header.htm', 1508223970, '2', './data/template/2_2_forum_dianping_clubpost.tpl.php', './template/8264', 'forum/dianping/clubpost')
|| checktplrefresh('./template/8264/forum/dianping/clubpost.htm', './template/8264/forum/dianping/editor_2014_second.htm', 1508223970, '2', './data/template/2_2_forum_dianping_clubpost.tpl.php', './template/8264', 'forum/dianping/clubpost')
|| checktplrefresh('./template/8264/forum/dianping/clubpost.htm', './template/8264/forum/dianping/editor_2014_first.htm', 1508223970, '2', './data/template/2_2_forum_dianping_clubpost.tpl.php', './template/8264', 'forum/dianping/clubpost')
|| checktplrefresh('./template/8264/forum/dianping/clubpost.htm', './template/8264/forum/dianping/footer.htm', 1508223970, '2', './data/template/2_2_forum_dianping_clubpost.tpl.php', './template/8264', 'forum/dianping/clubpost')
|| checktplrefresh('./template/8264/forum/dianping/clubpost.htm', './template/8264/common/header_8264_new.htm', 1508223970, '2', './data/template/2_2_forum_dianping_clubpost.tpl.php', './template/8264', 'forum/dianping/clubpost')
|| checktplrefresh('./template/8264/forum/dianping/clubpost.htm', './template/8264/common/editor_2014.htm', 1508223970, '2', './data/template/2_2_forum_dianping_clubpost.tpl.php', './template/8264', 'forum/dianping/clubpost')
|| checktplrefresh('./template/8264/forum/dianping/clubpost.htm', './template/8264/forum/editor_menu_forum_newimage_2014.htm', 1508223970, '2', './data/template/2_2_forum_dianping_clubpost.tpl.php', './template/8264', 'forum/dianping/clubpost')
|| checktplrefresh('./template/8264/forum/dianping/clubpost.htm', './template/8264/common/ewm_r.htm', 1508223970, '2', './data/template/2_2_forum_dianping_clubpost.tpl.php', './template/8264', 'forum/dianping/clubpost')
|| checktplrefresh('./template/8264/forum/dianping/clubpost.htm', './template/8264/common/footer_8264_new.htm', 1508223970, '2', './data/template/2_2_forum_dianping_clubpost.tpl.php', './template/8264', 'forum/dianping/clubpost')
|| checktplrefresh('./template/8264/forum/dianping/clubpost.htm', './template/8264/common/header_common.htm', 1508223970, '2', './data/template/2_2_forum_dianping_clubpost.tpl.php', './template/8264', 'forum/dianping/clubpost')
|| checktplrefresh('./template/8264/forum/dianping/clubpost.htm', './template/8264/common/index_ad_top.htm', 1508223970, '2', './data/template/2_2_forum_dianping_clubpost.tpl.php', './template/8264', 'forum/dianping/clubpost')
;?>
<!doctype html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="http://static.8264.com/static/css/dianping/xl_detail.css?<?php echo VERHASH;?>" />
<style type="text/css">
...
.icoName48x43{
    ...
    width: 48px;
    height: 43px;
    background: url(http://static.8264.com/static/images/dianping/shopicon.jpg) no-repeat;
}
.icoName48x43_zizhi{
    display: block;
    width: 48px;
    height: 43px;
    background: url(http://static.8264.com/static/images/dianping/zizhi.png) no-repeat;
}
.icoName48x43_ren{
    display: block;
    width: 48px;
    height: 43px;
    background: url(http://static.8264.com/static/images/dianping/lingdui.png) no-repeat;
}
.icoName48x43_shijian{
    display: block;
    width: 48px;
    height: 43px;
    background: url(http://static.8264.com/static/images/dianping/shijian.png) no-repeat;
}
.icoName48x43_jid{
    display: block;
    width: 48px;
    height: 43px;
    background: url(http://static.8264.com/static/images/dianping/icon.png) no-repeat -73px -56px;
}
.icoName48x43_contact{
    display: block;
    width: 48px;
    height: 43px;
    background: url(http://static.8264.com/static/images/dianping/contact.png) no-repeat;
}
.icoName48x43_weixin{
    display: block;
    width: 48px;
    height: 43px;
    background: url(http://static.8264.com/static/images/dianping/weixin.png) no-repeat;
}
.icoName48x43_qq{
    display: block;
    width: 48px;
    height: 43px;
    background: url(http://static.8264.com/static/images/dianping/qq.png) no-repeat;
}
...
</style><div id="alltemplateobj" class="templist" style="display: none;visibility: hidden;">
...
<span class="icoRedStar">*</span>
                ...
                <dl class="pubDt50" style="margin-left:50px;">

<dd>
<span class="inputTipsText">
<?php if($action=='new') { ?><label class="fs16">请填写户外俱乐部简称</label><?php } ?>
<input type="text" class="inputText w270" name="subject_jiancheng" id="subject_jiancheng" value="<?php echo $editdata['subject_jiancheng'];?>" />
</span>
<span class="icoRedStar">*</span>&nbsp;&nbsp;&nbsp;&nbsp;请填写不多于六个中文汉字
</dd>
</dl>

        
<!-- 俱乐部公司资质、领队人数、成立时间-->
<!--		<dl class="pubDt50" id="climb_place_list">
<dt><span class="icoName48x43_zizhi"></span></dt>
<dd>
<span class="inputTipsText2">
<div class="sc selectdown">
<input type="hidden" name="gongsitype" id="place_type" value="<?php echo $editdata['gongsitype'];?>" />
<input type="text" value="<?php if($editdata['gongsitype']) { ?>已选择场地：<?php echo $clubTypeList[$editdata['gongsitype']]['name'];?> <?php } else { ?>请选择公司资质<?php } ?>" class="diqu js"
 readonly="readonly"/>
<div class="sc_down"><?php if(is_array($clubTypeList)) foreach($clubTypeList as $k => $v) { ?><a href="javascript:void(0);" rel="<?php echo $k;?>" ><?php echo $v['name'];?></a>
<?php } ?>
</div>
</div>
</span>
<span class="icoRedStar">*</span>
                ...
                <dl class="pubDt50">
<dt><span class="icoName48x43_ren"></span></dt>
<dd>
<span class="inputTipsText">
<?php if($action=='new') { ?><label class="fs16">持有领队证人数</label><?php } ?>
<input type="text" class="inputText w270" name="lingduinum" id="lingduinum" value="<?php echo $editdata['lingduinum'];?>" />
</span>&nbsp;&nbsp;
...
<span class="icoRedStar">*</span>
                ...
                <dl class="pubDt50">
<dt><span class="icoName48x43_shijian"></span></dt>
<dd>
<span class="inputTipsText2">
<div class="qy selectdown" style="z-index:1000;">
<input type="hidden" name="chenglishijian" value="<?php echo $editdata['chenglishijian'];?>" />
<input type="text" value="<?php if($editdata['chenglishijian']) { ?>已选择成立时间：<?php echo $editdata['chenglishijian'];?> <?php } else { ?>请选择成立年份<?php } ?>" class="diqu js" readonly="readonly"/>
<div class="qy_down"><?php if(is_array($year_arr)) foreach($year_arr as $k => $v) { ?><a rel="<?php echo $k;?>" href="javascript:void(0);" execute="ajaxGetCity"><?php echo $v;?></a>
<?php } ?>
</div>
</div>
</span>
...
<span class="icoRedStar">*</span>&nbsp;&nbsp;&nbsp;请上传俱乐部封面展示图，尺寸比例为4:3
...
<input type="hidden" name="provinceid" value="<?php echo $editdata['pro'];?>" id="provinceid" />
<input type="text" id="province_text" value="<?php if($editdata['pro']) { ?>已选择省份：<?php echo $provinces[$editdata['pro']]['cityname'];?> <?php } else { ?>请选择省份<?php } ?>" class="diqu js" readonly="readonly"/>
...
<input type="text" name="cityname" id="city_text" value="<?php if($editdata['cityid']) { ?>已选择城市：<?php echo $cities[$editdata['cityid']]['cityname'];?><?php } else { ?>请选择城市<?php } ?>" id="cityname" class="diqu js"/>
<div class="qy_down">
...
<input type="text" class="inputText w360" name="address" id="address" value="<?php echo $editdata['addr'];?>" />
</span>
...
<input type="hidden" value="<?php echo $editdata['latitude'];?>" id="latitude" name="latitude">
                ...
                <dl class="pubDt50">
                        <dt><span class="icoName48x43_jid"></span></dt>
                        <dd>
                            <span class="inputTipsText">
                                <label class="fs16"<?php if($editdata['uids']) { ?> style="display:none;"<?php } ?>>请填写俱乐部活动发布的用户名,用英文逗号分隔</label>
                                <input type="text" class="inputText w270" name="uids" id="uids" value="<?php echo $editdata['uids'];?>" />
                            </span>&nbsp;&nbsp;&nbsp;&nbsp;请填写发布活动时的用户名，如：喜力户外
                        </dd>
                    </dl>
                <!-- 俱乐部输入自动完成
                    <dl class="pubDt50">
                        ...
                        <dd>
                            <span class="inputTipsText">
                                    <label class="fs16" id="tids_notice"<?php if($editdata['clubname']) { ?> style="display: none;"<?php } ?>>俱乐部简称</label>
                                    <input type="text" name="clubname" id="clubname" class="inputText w270 js" value="<?php echo $editdata['clubname'];?>">
                                    <input type="hidden" name="clubid" id="clubid" class="clubid" value="<?php echo $editdata['clubid'];?>" />	
                                    <div class="auto_down" style="width:318px;">
                                            <span style="width:318px;">限8个字。</span>
                                            <?php if(is_array($activityClubList)) foreach($activityClubList as $k => $v) { ?>                                            <a href="javascript:void(0);" att="<?php echo $v['clubid'];?>"><?php echo $v['clubname'];?></a>
                                            <?php } ?>
                                    </div>
                            </span>
                            
                            <?php if($action=='edit' && !$editdata['clubid']) { ?>
                            &nbsp;&nbsp;&nbsp;&nbsp;没有该俱乐部
                            <?php } else { ?>
                            &nbsp;&nbsp;&nbsp;&nbsp;添加俱乐部在论坛中的名称，如“高山牦牛探险”，可关联它发布的活动
                            <?php } ?>
                        </dd>
                    </dl>
                -->         
...
$(".pubWeb").delegate('div[class$=_down]>a', 'click', function(){	
var hid     = $(this).attr('hid');
var tempVal = $(this).text();
                var tempid = $(this).attr('att');
$(this).parent().hide();
if(hid) {
...
//俱乐部
if (tempobj.attr("id") == 'clubname' && tempid >0) {
var tempObj = $('.single-tag-clubname');
if (tempVal == '') {
tempObj.hide();
} else {
tempObj.find('span').html('').html(tempVal);
                                $("#clubid").val(tempid);
...
objcity.siblings('input[type=hidden]').val("<?php echo $editdata['cityid'];?>").siblings('input.js')
.val("<?php if($editdata['cityName']) { } else { ?>请选择城市<?php } ?>").end();
...
focus_blur('#captcha', 'prev', '');
        focus_blur('#lingduinum','prev','');
        focus_blur('#clubname','prev','');
        focus_blur('#uids','prev','');
        focus_blur('#contact','prev','');
        focus_blur('#weixin','prev','');
        focus_blur('#qq','prev','');
        focus_blur('#tel','prev','');
        focus_blur('#subject_jiancheng','prev','');
//加载地图
...
return keyword;
       ...
       //俱乐部自动完成
$(".inputTipsText").delegate('input.js', 'keyup', function(){
...
var require = {'subject': {'empty':"请填写<?php echo $modname;?><?php echo $modsetting['mc'];?>", 'len>80': "您的<?php echo $modname;?>名称超过 80 个字符的限制"},
                       'subject_jiancheng': {'empty':"请填写俱乐部的简称", 'len>12': "您的俱乐部简称名称超过 6 个字符的限制"}, 
                        'uploadfile': {'pnumber': "请上传<?php echo $modname;?>图片，并至少选择一张"},
                        'provinceid' : {'pnumber': "请选择<?php echo $modname;?>所在省份"},
                        'city' : {'pnumber': "请选择或填写<?php echo $modname;?>所在城市"},
                        'message': {'empty': "请填写<?php echo $modname;?>简介"},
                        'message': {'empty': "请填写<?php echo $modname;?>简介", 'len<100': "<?php echo $modname;?>字数不少于50字"},
                        };
...
<script src="static/js/newswfobject.js" type="text/javascript"></script>
<script type="text/javascript"><?php /*it will make a request to misc.php, as far as the callback is concerned, 'uploadsuccess' is the default. because the 'editor' also set 'uploadsuccess' as the default callback,
