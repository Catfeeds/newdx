<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_favorite', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/home/space_favorite.htm', './template/8264/common/header_8264_new.htm', 1509517586, '2', './data/template/2_2_home_space_favorite.tpl.php', './template/8264', 'home/space_favorite')
|| checktplrefresh('./template/8264/home/space_favorite.htm', './template/8264/home/space_header_uc.htm', 1509517586, '2', './data/template/2_2_home_space_favorite.tpl.php', './template/8264', 'home/space_favorite')
|| checktplrefresh('./template/8264/home/space_favorite.htm', './template/8264/home/space_footer_uc.htm', 1509517586, '2', './data/template/2_2_home_space_favorite.tpl.php', './template/8264', 'home/space_favorite')
|| checktplrefresh('./template/8264/home/space_favorite.htm', './template/8264/common/footer_8264_new.htm', 1509517586, '2', './data/template/2_2_home_space_favorite.tpl.php', './template/8264', 'home/space_favorite')
|| checktplrefresh('./template/8264/home/space_favorite.htm', './template/8264/common/header_common.htm', 1509517586, '2', './data/template/2_2_home_space_favorite.tpl.php', './template/8264', 'home/space_favorite')
|| checktplrefresh('./template/8264/home/space_favorite.htm', './template/8264/common/index_ad_top.htm', 1509517586, '2', './data/template/2_2_home_space_favorite.tpl.php', './template/8264', 'home/space_favorite')
|| checktplrefresh('./template/8264/home/space_favorite.htm', './template/8264/common/ewm_r.htm', 1509517586, '2', './data/template/2_2_home_space_favorite.tpl.php', './template/8264', 'home/space_favorite')
;
block_get('6905');?>
<!doctype html>
<html>
...
<!--module end--><!--main-content--><?php $arrIdtype = array('tid'=>'帖子','blogid'=>'日志','albumid'=>'相册'); ?><div class="main-content layout-page">
<div class="layout-app">
<div class="col-main">
<div class="main-wrap">
<?php if($list) { ?>
<div class="ui-block ui-block-content">
<div class="page-container-coll">						
<ul class="coll-list-box collectList"><?php if(is_array($list)) foreach($list as $v) { ?><li>
<a href="<?php echo $v['url'];?>" target="_blank"><b class="c-type">[ <?php echo $arrIdtype[$v['idtype']];?> ]</b><?php echo $v['title'];?></a>
<span class="p-time"><?php echo date('Y-m-d H:i', $v['dateline']); ?></span>
<a class="coll-delete" title="取消收藏" id="a_delete_<?php echo $v['favid'];?>" href="home.php?mod=spacecp&amp;ac=favorite&amp;op=delete&amp;favid=<?php echo $v['favid'];?>" onclick="showWindow(this.id, this.href, 'get', 0);">取消</a>
</li>
<?php } ?>
</ul>
<!--分页-->
...
<p><i class="icon-warn"></i>你还没有添加任何收藏</p>
</div>
</div>		
<?php } ?>
</div>			
...
<li class="menu-nav <?php if($_G['gp_type'] == 'all') { ?>menu-nav-current<?php } ?>">
<a href="home.php?mod=space&amp;do=favorite">
<i class="menu-nav-icon icon-all-coll"></i>
<em>全部收藏</em>
<span class="number"><?php echo $arrCount['all'];?></span>
</a>
</li><?php if(is_array($idtypes)) foreach($idtypes as $k => $v) { if($arrCount[$k] > 0) { ?>
<li class="menu-nav <?php if($_G['gp_type'] == $k) { ?>menu-nav-current<?php } ?>">
<a href="home.php?mod=space&amp;do=favorite&amp;type=<?php echo $k;?>">
<i class="menu-nav-icon icon-post"></i>
<em><?php echo $arrIdtype[$v];?></em>
<span class="number"><?php echo $arrCount[$k];?></span>
</a>
</li>
<?php } } ?>						
</ul>
...
jQuery(function(){
//取消收藏按钮
jQuery('.collectList li').hover(function(){
jQuery(this).find('.coll-delete').show();
},function(){
jQuery(this).find('.coll-delete').hide();
});
});
</script>
<!--main-content end-->	
