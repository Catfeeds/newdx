<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('header2014', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/common/header2014.htm', './template/8264/common/header_8264_new.htm', 1509517921, '2', './data/template/2_2_common_header2014.tpl.php', './template/8264', 'common/header2014')
|| checktplrefresh('./template/8264/common/header2014.htm', './template/8264/common/header_common.htm', 1509517921, '2', './data/template/2_2_common_header2014.tpl.php', './template/8264', 'common/header2014')
|| checktplrefresh('./template/8264/common/header2014.htm', './template/8264/common/index_ad_top.htm', 1509517921, '2', './data/template/2_2_common_header2014.tpl.php', './template/8264', 'common/header2014')
;?>
<!doctype html>
<html>
<head>
...
<div class="headerL">
<h1><span class="country"><?php if($_G['basescript']=='portal' && $_G['gp_mod']=='list' && $_G['catid']) { if($_G['catid']==842) { ?>每日一图<?php } elseif($_G['catid']==880) { ?>勇者先行<?php } elseif($_G['catid']==878) { ?>铿锵玫瑰<?php } elseif($_G['catid']==912) { ?>户外摄影师<?php } elseif($_G['catid']==881) { ?>线路推荐<?php } else { ?>论坛精选<?php } } ?></span></h1>
<div class="site">
<a href="<?php echo $_G['config']['web']['portal'];?>">首页</a>
<?php if($_G['basescript']=='portal' && $_G['gp_mod']=='list' && $_G['catid']) { ?>
> <a href="<?php echo $_G['config']['web']['portal'];?>list/<?php echo $_G['catid'];?>"><?php if($_G['catid']==842) { ?>每日一图<?php } elseif($_G['catid']==880) { ?>勇者先行<?php } elseif($_G['catid']==878) { ?>铿锵玫瑰<?php } elseif($_G['catid']==912) { ?>户外摄影师<?php } elseif($_G['catid']==881) { ?>线路推荐<?php } else { ?>论坛精选<?php } ?></a>
<?php } else { ?>
<a href="http://bbs.8264.com/forum-480-1.html" target="_blank" >装备推荐</a>
<?php } ?>
</div>
</div>
<div class="headerR">
...
<a href="http://www.8264.com/list/871" <?php if($_G['catid']==871) { ?>class="nowmod"<?php } ?>>论坛精选</a>
<a href="http://www.8264.com/list/842" <?php if($_G['catid']==842) { ?>class="nowmod"<?php } ?>>每日一图</a>

<a href="http://www.8264.com/pp" <?php if($_G['catid']==878) { ?>class="nowmod"<?php } ?>>铿锵玫瑰</a>

<a href="http://www.8264.com/list/912" <?php if($_G['catid']==912) { ?>class="nowmod"<?php } ?>>户外摄影师</a>

<a href="http://www.8264.com/list/880" <?php if($_G['catid']==880) { ?>class="nowmod"<?php } ?>>勇者先行</a>
