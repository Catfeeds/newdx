<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('list_902', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/portal/list_902.htm', './template/8264/common/header_8264_new.htm', 1509518849, 'diy', './data/template/2_diy_portal_list_902.tpl.php', 'data/diy', 'portal/list_902')
|| checktplrefresh('./template/8264/portal/list_902.htm', './template/8264/common/zhidemai.htm', 1509518849, 'diy', './data/template/2_diy_portal_list_902.tpl.php', 'data/diy', 'portal/list_902')
|| checktplrefresh('./template/8264/portal/list_902.htm', './template/8264/common/footer_8264_new.htm', 1509518849, 'diy', './data/template/2_diy_portal_list_902.tpl.php', 'data/diy', 'portal/list_902')
|| checktplrefresh('./template/8264/portal/list_902.htm', './template/8264/common/header_common.htm', 1509518849, 'diy', './data/template/2_diy_portal_list_902.tpl.php', 'data/diy', 'portal/list_902')
|| checktplrefresh('./template/8264/portal/list_902.htm', './template/8264/common/index_ad_top.htm', 1509518849, 'diy', './data/template/2_diy_portal_list_902.tpl.php', 'data/diy', 'portal/list_902')
;?>
<!doctype html>
<html>
<head>
...
<?php } ?>
<!-- //手机绑定提示 -->
<link href="template/8264/css/channel/style_902.css?20141023" rel="stylesheet" type="text/css">
<style id="diy_style" type="text/css">#portal_block_6902 {  margin:0px !important;border:#000000 0px !important;}#portal_block_6902 .content {  margin:0px !important;}#frameKFQtNx {  margin:0px !important;border:0px !important;}</style>
<div class="topHead">
<div class="w980 clearfix">
<div class="titLeft">
<h2>数据图说</h2>
<h3>信息爆炸的时代，我们希望用简明的图表，让您轻松阅读。</h3>
</div>
...
<div class="w980"><?php $arrs = $arr['list']; ?><?php $pic_array = array(array(), array()); $i = 0; if(count($arrs) >= 2) { ?><?php $pic_array[0][] = $arrs[0]; unset($arrs[0]); ?><?php $pic_array[1][] = $arrs[1]; unset($arrs[1]); ?><?php $pics = array_merge($arrs,array()); } ?><?php foreach ($pics as $pic): ?><?php $pic_array[$i%2][] = $pic; ?><?php $i++; ?><?php endforeach; ?><div class="layoutLeft"><?php if(is_array($pic_array['0'])) foreach($pic_array['0'] as $key => $value) { ?><!-- 循环 开始 -->
<dl class="dateList">
<dd class="pic">
<a href="portal.php?mod=view&amp;aid=<?php echo $value['aid'];?>" target="_blank">
<img src="<?php echo $value['pic'];?>" />
</a>
</dd>
<dt>
<a href="portal.php?mod=view&amp;aid=<?php echo $value['aid'];?>" target="_blank"><?php echo $value['title'];?></a>
<span class="line">黑线</span>
</dt>
<dd class="text">
<p>
...
<!-- 循环 开始 --><?php if(is_array($pic_array['1'])) foreach($pic_array['1'] as $value) { ?><dl class="dateList">
<dd class="pic">
<a href="portal.php?mod=view&amp;aid=<?php echo $value['aid'];?>" target="_blank">
<img src="<?php echo $value['pic'];?>" />
</a>
