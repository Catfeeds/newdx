<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('register_2014', 'common/header_8264_new');?><?php include template('common/header_8264_new'); ?><link href="http://static.8264.com/static/css/common/style.css?<?php echo VERHASH;?>" rel="stylesheet" type="text/css">
...
<input name="<?php echo $this->setting['reginput']['username'];?>" id="r_username" type="text" class="input_text w307 logoicon" tabindex="1" size="25" autocomplete="off" required="required" />
<span class="noteinfo" id="m_username">用户名由 3 到 15 个字符组成</span>
</div>
<div class="inputlist_zc">
<label class="labelicon" id="n_password">密码</label>
<input name="<?php echo $this->setting['reginput']['password'];?>" id="r_password" type="password" class="input_text w307 passwordicon" tabindex="1" size="25" required="required" />
<span class="noteinfo" id="m_password">请填写密码</span>
</div>
<div class="inputlist_zc">
<label class="labelicon" id="n_password2">确认密码</label>
<input name="<?php echo $this->setting['reginput']['password2'];?>" id="r_password2" type="password" class="input_text w307 passwordicon" tabindex="1" size="25" required="required" />
...
<?php if(!empty($_G['setting']['pluginhooks']['register_input'])) echo $_G['setting']['pluginhooks']['register_input']; ?>
                ...
                <div class="yzm" style="margin-bottom:20px;display: <?php if($secqaacheck) { ?>block<?php } else { ?>none<?php } ?>">
