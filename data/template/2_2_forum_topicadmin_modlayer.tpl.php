...
<?php if($_G['adminid'] == 1) { ?><label><input type="checkbox" name="chkall" class="pc" onclick="if(!($('mdct').innerHTML = modclickcount = checkall(this.form, 'moderate'))) {$('mdly').style.display = 'none';}" /> 全选</label><?php } ?>
...
<?php if(!empty($_G['setting']['pluginhooks']['forumdisplay_modlayer'])) echo $_G['setting']['pluginhooks']['forumdisplay_modlayer']; } elseif(CURMODULE == 'modcp') { ?>
