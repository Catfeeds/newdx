<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_blog_list_uc', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/home/space_blog_list_uc.htm', './template/8264/common/header_8264_new.htm', 1509517869, '2', './data/template/2_2_home_space_blog_list_uc.tpl.php', './template/8264', 'home/space_blog_list_uc')
|| checktplrefresh('./template/8264/home/space_blog_list_uc.htm', './template/8264/home/space_header_uc.htm', 1509517869, '2', './data/template/2_2_home_space_blog_list_uc.tpl.php', './template/8264', 'home/space_blog_list_uc')
|| checktplrefresh('./template/8264/home/space_blog_list_uc.htm', './template/8264/home/space_footer_uc.htm', 1509517869, '2', './data/template/2_2_home_space_blog_list_uc.tpl.php', './template/8264', 'home/space_blog_list_uc')
|| checktplrefresh('./template/8264/home/space_blog_list_uc.htm', './template/8264/common/footer_8264_new.htm', 1509517869, '2', './data/template/2_2_home_space_blog_list_uc.tpl.php', './template/8264', 'home/space_blog_list_uc')
|| checktplrefresh('./template/8264/home/space_blog_list_uc.htm', './template/8264/common/header_common.htm', 1509517869, '2', './data/template/2_2_home_space_blog_list_uc.tpl.php', './template/8264', 'home/space_blog_list_uc')
|| checktplrefresh('./template/8264/home/space_blog_list_uc.htm', './template/8264/common/index_ad_top.htm', 1509517869, '2', './data/template/2_2_home_space_blog_list_uc.tpl.php', './template/8264', 'home/space_blog_list_uc')
|| checktplrefresh('./template/8264/home/space_blog_list_uc.htm', './template/8264/common/ewm_r.htm', 1509517869, '2', './data/template/2_2_home_space_blog_list_uc.tpl.php', './template/8264', 'home/space_blog_list_uc')
;
block_get('6905');?>
<?php $_G[home_tpl_spacemenus][] = "<a href=\"home.php?mod=space&amp;uid=$space[uid]&amp;do=blog&amp;view=me\">TA的所有日志</a>";
$friendsname = array(1 => '仅好友可见',2 => '指定好友可见',3 => '仅自己可见',4 => '凭密码可见'); ?><!doctype html>
<html>
<head>
...
<div class="ui-title">
<h3><?php if($space['self']) { ?>我<?php } else { ?><?php echo $space['username'];?><?php } ?>的日志<span class="number"><?php echo $allcount;?></span></h3>
<?php if($space['self']) { ?>
<a href="home.php?mod=spacecp&amp;ac=blog" class="ui-add-link"><i class="ui-icon ui-add-icon"></i>发表日志</a>
<?php } ?>
</div>
</div>
<?php } ?>
...
<div class="list-area">
<?php if($list) { ?>
<ul><?php if(is_array($list)) foreach($list as $k => $v) { ?><li class="list-row"><?php $tempYear = date('Y', $v['dateU']); if(!isset($arrYear[$tempYear])) { ?>
<div class="blog-post-has-year">
<span class="post-year"><?php echo $tempYear;?></span>
</div><?php $arrYear[$tempYear] = $tempYear; } ?>
<div class="blog-post-data">
<span class="date-month"><?php echo date('m月', $v['dateU']); ?></span>
<span class="date-day"><?php echo date('d', $v['dateU']); ?></span>
</div>
<div class="blog-content article-info">
<div class="hd">
<div class="list-tit">
<a href="home.php?mod=space&amp;uid=<?php echo $v['uid'];?>&amp;do=blog&amp;id=<?php echo $v['blogid'];?>" class="c-tx" title="<?php echo $v['subject'];?>">
<span><?php echo $v['subject'];?></span>
</a>	
<?php if($v['pic']) { ?>
<span class="icon-m icon-img-m" title="日志中包含图片"></span>
<?php } ?>
</div>
<div class="list-op-bar">
<span class="list-op-item">
<i class="icon-m icon-view-m"></i>
<em><?php echo $v['viewnum'];?></em>
</span>
<span class="list-op-item">
<i class="icon-m icon-comment-m"></i>
<em><?php echo $v['replynum'];?></em>
</span>
<span class="list-op-item">
<i class="icon-m icon-praise-m"></i>
<em><?php echo $v['click3']+$v['click4'];; ?></em>
</span>
</div>
</div>
<div class="bd">
<div class="txt-details-info">
<p><?php if($v['message']) { echo cutstr($v['message'], 190, '...'); } else { ?>&nbsp;<?php } ?></p>
</div>
</div>
</div>
</li>
...
<p><i class="icon-warn"></i><?php if($space['self']) { ?>您还没有发表日志<?php } else { ?>没有可浏览的日志<?php } ?></p>									
<?php if($space['self']) { ?><p><a class="post-btn" href="home.php?mod=spacecp&amp;ac=blog"><i>+</i>发表日志</a></p><?php } ?>
</div>
</div>
<?php } ?>						
</div>
...
<li class="menu-nav <?php if(!is_numeric($_GET['classid'])) { ?>menu-nav-current<?php } ?>">
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=blog&amp;view=me&amp;from=space">
<i class="menu-nav-icon icon-all-blog"></i>
<em>全部日志</em>
<span class="number"><?php echo $allcount;?></span>
</a>
</li>
<?php if($classnumList['0']) { ?>
<li class="menu-nav <?php if(0 == $classid && is_numeric($_GET['classid'])) { ?>menu-nav-current<?php } ?>">
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=blog&amp;classid=0&amp;view=me&amp;from=space">
<i class="menu-nav-icon icon-personal-blog"></i>
<em>个人日志</em>
<span class="number"><?php echo $classnumList['0'];?></span>
</a>
</li>
<?php } if($classarr) { if(is_array($classarr)) foreach($classarr as $k => $v) { if($classnumList[$k]) { ?>
<li class="menu-nav <?php if($k == $classid) { ?>menu-nav-current<?php } ?>">
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=blog&amp;classid=<?php echo $k;?>&amp;view=me&amp;from=space">
<i class="menu-nav-icon icon-create-category"></i>
<em><?php echo $v;?></em>
<span class="number"><?php echo $classnumList[$k];?></span>
</a>
</li>
<?php } ?>	
<?php } } ?>
