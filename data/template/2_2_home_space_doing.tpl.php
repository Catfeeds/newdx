<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_doing', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/home/space_doing.htm', './template/8264/common/header_8264_new.htm', 1509518050, '2', './data/template/2_2_home_space_doing.tpl.php', './template/8264', 'home/space_doing')
|| checktplrefresh('./template/8264/home/space_doing.htm', './template/8264/home/space_header_uc.htm', 1509518050, '2', './data/template/2_2_home_space_doing.tpl.php', './template/8264', 'home/space_doing')
|| checktplrefresh('./template/8264/home/space_doing.htm', './template/8264/home/space_footer_uc.htm', 1509518050, '2', './data/template/2_2_home_space_doing.tpl.php', './template/8264', 'home/space_doing')
|| checktplrefresh('./template/8264/home/space_doing.htm', './template/8264/common/footer_8264_new.htm', 1509518050, '2', './data/template/2_2_home_space_doing.tpl.php', './template/8264', 'home/space_doing')
|| checktplrefresh('./template/8264/home/space_doing.htm', './template/8264/common/header_common.htm', 1509518050, '2', './data/template/2_2_home_space_doing.tpl.php', './template/8264', 'home/space_doing')
|| checktplrefresh('./template/8264/home/space_doing.htm', './template/8264/common/index_ad_top.htm', 1509518050, '2', './data/template/2_2_home_space_doing.tpl.php', './template/8264', 'home/space_doing')
|| checktplrefresh('./template/8264/home/space_doing.htm', './template/8264/common/ewm_r.htm', 1509518050, '2', './data/template/2_2_home_space_doing.tpl.php', './template/8264', 'home/space_doing')
;
block_get('6905');?>
<!doctype html>
<html>
...
<div class="bm_c">
<?php if($space['self']) { include template('home/space_doing_form'); } if($dolist) { ?>
<div class="xld <?php if(empty($diymode)) { ?>xlda<?php } ?>"><?php if(is_array($dolist)) foreach($dolist as $dv) { ?><?php $doid = $dv[doid]; ?><?php $_G[gp_key] = $key = random(8); ?><dl id="<?php echo $key;?>dl<?php echo $doid;?>" class="pbn bbda cl">
...
<a href="javascript:;" onclick="docomment_form(<?php echo $doid;?>, 0, '<?php echo $key;?>');">回复</a><?php if($dv['uid']==$_G['uid']) { ?><span class="pipe">|</span><a href="home.php?mod=spacecp&amp;ac=doing&amp;op=delete&amp;doid=<?php echo $doid;?>&amp;id=<?php echo $dv['id'];?>&amp;handlekey=doinghk_<?php echo $doid;?>_<?php echo $dv['id'];?>" id="<?php echo $key;?>_doing_delete_<?php echo $doid;?>_<?php echo $dv['id'];?>" onclick="showWindow(this.id, this.href, 'get', 0);">删除</a><?php } if(checkperm('managedoing')) { ?>
<span class="pipe">IP: <?php echo $dv['ip'];?></span>
<?php } ?>
</dd>
</dl>
<?php } if($pricount) { ?>
<p class="mtm">本页有 <?php echo $pricount;?> 条说说因未通过审核而隐藏</p>
<?php } ?>
</div>
<?php if($multi) { ?><div class="pgs cl mtm"><?php echo $multi;?></div><?php } } else { ?>
<p class="emp">现在还没有说说。<?php if($space['self']) { ?>你可以用一句话记录下这一刻在做什么。<?php } ?></p>
<?php } ?>		
