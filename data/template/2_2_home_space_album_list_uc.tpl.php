<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('space_album_list_uc', 'common/header_8264_new');
0
|| checktplrefresh('./template/8264/home/space_album_list_uc.htm', './template/8264/common/header_8264_new.htm', 1509517875, '2', './data/template/2_2_home_space_album_list_uc.tpl.php', './template/8264', 'home/space_album_list_uc')
|| checktplrefresh('./template/8264/home/space_album_list_uc.htm', './template/8264/home/space_header_uc.htm', 1509517875, '2', './data/template/2_2_home_space_album_list_uc.tpl.php', './template/8264', 'home/space_album_list_uc')
|| checktplrefresh('./template/8264/home/space_album_list_uc.htm', './template/8264/home/space_footer_uc.htm', 1509517875, '2', './data/template/2_2_home_space_album_list_uc.tpl.php', './template/8264', 'home/space_album_list_uc')
|| checktplrefresh('./template/8264/home/space_album_list_uc.htm', './template/8264/common/footer_8264_new.htm', 1509517875, '2', './data/template/2_2_home_space_album_list_uc.tpl.php', './template/8264', 'home/space_album_list_uc')
|| checktplrefresh('./template/8264/home/space_album_list_uc.htm', './template/8264/common/header_common.htm', 1509517875, '2', './data/template/2_2_home_space_album_list_uc.tpl.php', './template/8264', 'home/space_album_list_uc')
|| checktplrefresh('./template/8264/home/space_album_list_uc.htm', './template/8264/common/index_ad_top.htm', 1509517875, '2', './data/template/2_2_home_space_album_list_uc.tpl.php', './template/8264', 'home/space_album_list_uc')
|| checktplrefresh('./template/8264/home/space_album_list_uc.htm', './template/8264/common/ewm_r.htm', 1509517875, '2', './data/template/2_2_home_space_album_list_uc.tpl.php', './template/8264', 'home/space_album_list_uc')
;
block_get('6905');?>
<?php $friendsname = array(1 => '仅好友可见',2 => '指定好友可见',3 => '仅自己可见',4 => '凭密码可见'); ?><!doctype html>
<html>
<head>
...
<?php if($count) { ?>
<div class="album-tit">
<h3 class="tit" style="font-size:14px;margin-top:2px;">
<a href="javascript:void(0);"><?php if($space['self']) { ?>我<?php } else { ?><?php echo $space['username'];?><?php } ?>的相册<b><?php echo $count;?></b></a>
</h3>
<?php if($space['self']) { ?><a href="home.php?mod=spacecp&amp;ac=upload&amp;op=flash" class="upload-photo" target="_blank"><i class="ui-icon ui-add-icon"></i>上传照片</a><?php } ?>
</div>
<?php } if($count) { ?>
<div class="user-album-list">
<ul class="album-list manageContainer mod-op-current"><?php if(is_array($list)) foreach($list as $key => $value) { ?><li class="album-item">
<div class="fav-album">
<div class="album-cover">
<a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>&amp;do=album&amp;id=<?php echo $value['albumid'];?>" class="album-cover-a">
<?php if($value['pic']) { ?><img src="<?php echo $value['pic'];?>" alt="<?php echo $value['albumname'];?>" /><?php } ?>	
</a>
</div>
<div class="album-detail">
<div class="album-detail-inner">
<a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>&amp;do=album&amp;id=<?php echo $value['albumid'];?>" class="tit"><?php if($value['albumname']) { ?><?php echo $value['albumname'];?><?php } else { ?>默认相册<?php } ?></a>
<a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>&amp;do=album&amp;id=<?php echo $value['albumid'];?>" class="count"><?php echo cutstr($value['picnum'], 28, '...'); ?></a>
</div>
</div>
<!--操作-->
<?php if($space['self']) { ?>
...
<ul>
<li><a href="home.php?mod=spacecp&amp;ac=album&amp;op=edit&amp;albumid=<?php echo $value['albumid'];?>" class="pl-photoitem-op-edit" id="albumedit" onclick="showWindow(this.id, this.href, 'get', 0);"><i class="icon-m icon-edit-m"></i>编辑</a></li>
<li><a href="home.php?mod=spacecp&amp;ac=upload&amp;op=flash&amp;albumid=<?php echo $value['albumid'];?>" class="pl-photoitem-op-upload"><i class="icon-m icon-upload-m"></i>上传</a></li>
</ul>
</div>
</div>
<?php } ?>
...
<p><i class="icon-warn"></i><?php if($space['self']) { ?>您还没有创建相册<?php } else { ?>没有可浏览的相册<?php } ?></p>
<?php if($space['self']) { ?><p><a class="post-btn" href="home.php?mod=spacecp&amp;ac=upload&amp;op=flash"><i>+</i>上传照片</a></p><?php } ?>
</div>
</div>
<?php } ?>	
</div>
...
<!--ie7防止底部样式问题-->
<div style="visibility:hidden;height:0;">8264</div>
<!--ie7防止底部样式问题 end-->
<!--main-content end-->	
</div>	
<!--content end-->
