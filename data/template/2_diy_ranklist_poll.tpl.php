<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('poll', 'common/header');
0
|| checktplrefresh('./template/default/ranklist/poll.htm', './template/8264/common/header.htm', 1501675320, 'diy', './data/template/2_diy_ranklist_poll.tpl.php', './template/8264', 'ranklist/poll')
|| checktplrefresh('./template/default/ranklist/poll.htm', './template/default/common/simplesearchform.htm', 1501675320, 'diy', './data/template/2_diy_ranklist_poll.tpl.php', './template/8264', 'ranklist/poll')
|| checktplrefresh('./template/default/ranklist/poll.htm', './template/default/ranklist/side_left.htm', 1501675320, 'diy', './data/template/2_diy_ranklist_poll.tpl.php', './template/8264', 'ranklist/poll')
|| checktplrefresh('./template/default/ranklist/poll.htm', './template/8264/common/footer.htm', 1501675320, 'diy', './data/template/2_diy_ranklist_poll.tpl.php', './template/8264', 'ranklist/poll')
|| checktplrefresh('./template/default/ranklist/poll.htm', './template/8264/common/header_common.htm', 1501675320, 'diy', './data/template/2_diy_ranklist_poll.tpl.php', './template/8264', 'ranklist/poll')
;?>
<!doctype html>
<html>
<head>
...
<h1 class="mt">投票排行</h1>
<ul class="tb cl">
<li<?php if($_G['gp_orderby'] == 'heats') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=poll&amp;orderby=heats&amp;before=<?php echo $_G['gp_before'];?>">热度排行</a></li>
<li<?php if($_G['gp_orderby'] == 'favtimes') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=poll&amp;orderby=favtimes&amp;before=<?php echo $_G['gp_before'];?>">收藏排行</a></li>
<li<?php if($_G['gp_orderby'] == 'sharetimes') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=poll&amp;orderby=sharetimes&amp;before=<?php echo $_G['gp_before'];?>">分享排行</a></li>
</ul>
<p id="before" class="tbmu">
<a href="misc.php?mod=ranklist&amp;type=poll&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=thisweek" id="604800" <?php if($_G['gp_before'] == 'thisweek') { ?>class="a"<?php } ?> />本周</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=poll&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=thismonth" id="2592000" <?php if($_G['gp_before'] == 'thismonth') { ?>class="a"<?php } ?> />本月</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=poll&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=today" id="86400" <?php if($_G['gp_before'] == 'today') { ?>class="a"<?php } ?> />今日</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=poll&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=all" id="all" <?php if($_G['gp_before'] == 'all') { ?>class="a"<?php } ?> />全部</a>
</p>
<?php if($polllist) { ?>
<ul class="el pll"><?php if(is_array($polllist)) foreach($polllist as $poll) { ?><li class="cl">
...
<div class="mtn xg1">
<?php if($_G['gp_orderby'] == 'favtimes') { ?>收藏 <?php echo $poll['favtimes'];?>
<?php } elseif($_G['gp_orderby'] == 'sharetimes') { ?>分享 <?php echo $poll['sharetimes'];?>
