<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('equipment_showlist', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/equipment_showlist.htm', './template/8264/dianping/header.htm', 1509517867, '2', './data/template/2_2_dianping_equipment_showlist.tpl.php', './template/8264', 'dianping/equipment_showlist')
|| checktplrefresh('./template/8264/dianping/equipment_showlist.htm', './template/8264/dianping/nav.htm', 1509517867, '2', './data/template/2_2_dianping_equipment_showlist.tpl.php', './template/8264', 'dianping/equipment_showlist')
|| checktplrefresh('./template/8264/dianping/equipment_showlist.htm', './template/8264/common/zhidemai.htm', 1509517867, '2', './data/template/2_2_dianping_equipment_showlist.tpl.php', './template/8264', 'dianping/equipment_showlist')
|| checktplrefresh('./template/8264/dianping/equipment_showlist.htm', './template/8264/dianping/footer.htm', 1509517867, '2', './data/template/2_2_dianping_equipment_showlist.tpl.php', './template/8264', 'dianping/equipment_showlist')
|| checktplrefresh('./template/8264/dianping/equipment_showlist.htm', './template/8264/common/header_8264_new.htm', 1509517867, '2', './data/template/2_2_dianping_equipment_showlist.tpl.php', './template/8264', 'dianping/equipment_showlist')
|| checktplrefresh('./template/8264/dianping/equipment_showlist.htm', './template/8264/common/ewm_r.htm', 1509517867, '2', './data/template/2_2_dianping_equipment_showlist.tpl.php', './template/8264', 'dianping/equipment_showlist')
|| checktplrefresh('./template/8264/dianping/equipment_showlist.htm', './template/8264/common/weixin_share.htm', 1509517867, '2', './data/template/2_2_dianping_equipment_showlist.tpl.php', './template/8264', 'dianping/equipment_showlist')
|| checktplrefresh('./template/8264/dianping/equipment_showlist.htm', './template/8264/common/footer_8264_new.htm', 1509517867, '2', './data/template/2_2_dianping_equipment_showlist.tpl.php', './template/8264', 'dianping/equipment_showlist')
|| checktplrefresh('./template/8264/dianping/equipment_showlist.htm', './template/8264/common/header_common.htm', 1509517867, '2', './data/template/2_2_dianping_equipment_showlist.tpl.php', './template/8264', 'dianping/equipment_showlist')
|| checktplrefresh('./template/8264/dianping/equipment_showlist.htm', './template/8264/common/index_ad_top.htm', 1509517867, '2', './data/template/2_2_dianping_equipment_showlist.tpl.php', './template/8264', 'dianping/equipment_showlist')
;?>
<!doctype html>
<html>
<head>
...
jQuery(function($){
    $('.countdown').each(function(i, v) {
        ...
        <!-- //值得买 -->
                ...
                <div class="ui-grid-12 ui-grid-full" style="display: none;">
...
<div class="nav-name blue">装备类型</div>
 <div class="line_con_gray clboth p_r div_region">
<span class="arrow_d"></span>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=0&amp;cid=0&amp;bid=<?php echo $bid;?><?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1" <?php if(!$pcid && !$cid) { ?>  class="blue" <?php } ?>>全部</a><?php if(is_array($category)) foreach($category as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $k;?>&amp;cid=0&amp;bid=<?php echo $bid;?><?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1" value="<?php echo $k;?>" class="province <?php if($pcid == $k && !$cid) { ?> blue<?php } ?>"><?php echo $v['name'];?></a>
<?php } ?>
</div>
<span class="tc_dq clboth" style="z-index:10000;width:450px;"><?php if(is_array($category)) foreach($category as $key => $value) { ?><span id='province_<?php echo $key;?>' class='div_city'><?php if(is_array($value['child'])) foreach($value['child'] as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $key;?>&amp;cid=<?php echo $k;?>&amp;bid=<?php echo $bid;?><?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1"<?php if($cid==$k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
<?php } ?>
</span>
<?php } ?>
</span>
...
<div class="nav-name orange">装备价格</div>
<div class="nav-list-wartpen">
<div class="nav-list-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;page=1"<?php if(!$min && !$max) { ?> class="blue"<?php } ?> rel="nofollow" >全部</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;min=0&amp;max=100&amp;page=1"<?php if(!$min && $max==100) { ?> class="blue"<?php } ?> rel="nofollow">100元以下</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;min=100&amp;max=500&amp;page=1"<?php if($min==100 && $max==500) { ?> class="blue"<?php } ?> rel="nofollow">100~500元</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;min=500&amp;max=1000&amp;page=1"<?php if($min==500 && $max==1000) { ?> class="blue"<?php } ?> rel="nofollow">500~1000元</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;min=1000&amp;max=2000&amp;page=1"<?php if($min==1000 && $max==2000) { ?> class="blue"<?php } ?> rel="nofollow">1000~2000元</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;min=2000&amp;max=3000&amp;page=1"<?php if($min==2000 && $max==3000) { ?> class="blue"<?php } ?> rel="nofollow">2000~3000元</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;min=3000&amp;max=4000&amp;page=1"<?php if($min==3000 && $max==4000) { ?> class="blue"<?php } ?> rel="nofollow">3000~4000元</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;min=4000&amp;max=5000&amp;page=1"<?php if($min==4000 && $max==5000) { ?> class="blue"<?php } ?> rel="nofollow">4000~5000元</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;min=5000&amp;max=0&amp;page=1"<?php if($min==5000 && !$max) { ?> class="blue"<?php } ?> rel="nofollow">5000元以上</a>
</div>
</div>
</div>
<div class="nav-sift-one">
<div class="nav-name darkblue">装备品牌</div>
<div class="nav-list-wartpen">
<div class="nav-list-box nav-list-box-hide">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=0<?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1"<?php if(!$bid) { ?> class="blue"<?php } ?>>全部</a>
<?php if($show_brand) { if(is_array($show_brand)) foreach($show_brand as $s_brand) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $s_brand['id'];?><?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1"<?php if($bid == $s_brand['id']) { ?> class="blue"<?php } ?>><?php echo $s_brand['subject'];?></a>
<?php } } elseif($show_all_brand) { if(is_array($show_all_brand)) foreach($show_all_brand as $s_brand) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $s_brand['id'];?><?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1"<?php if($bid == $s_brand['id']) { ?> class="blue"<?php } ?>><?php echo $s_brand['subject'];?></a>
<?php } } if($show_brand) { ?>
<a href="javascript:;" id="bshow">更多品牌</a>
<?php } else { if($has_other) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=other<?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1"<?php if($bid == 'other') { ?> class="blue"<?php } ?>>其他品牌</a><?php } ?>
<span class="buttondown"></span>
<?php } ?>
</div>
</div>

<?php if($show_all_brand) { ?>
<div class="brand_tan_warpten at_list" id="bbox">
<div class="brand_tan_title" id="bnav"><?php if(is_array($letterlist)) foreach($letterlist as $key => $letter) { ?><a href="javascript:;"<?php if($key == 1) { ?>  class="select_z"<?php } ?>><?php echo $letter;?></a>
<?php } ?>
<!-- <a href="javascript:;" style="width: 36px; font-size: 14px;">其他</a> -->
</div>
<div class="brand-list-box" id="bdiv"><?php if(is_array($letterlist)) foreach($letterlist as $key => $letter) { ?><div class="brand-list" <?php if($key != 1) { ?>style="display:none;"<?php } ?>><?php if(is_array($show_all_brand)) foreach($show_all_brand as $s_brand) { if($s_brand['letter'] == $key) { ?>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $s_brand['id'];?><?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1"<?php if($bid == $s_brand['id']) { ?> class="select_z"<?php } ?>><?php echo $s_brand['subject'];?></a>
<?php } } ?>
</div>
<?php } ?>
<div style="display:none;">
<?php if($has_other) { ?>
<a href="<?php echo $url;?>&act=showlist&order=<?php echo $order;?>&pcid=<?php echo $pcid;?>&cid=<?php echo $cid;?>&bid=other<?php if($min || $max) { ?>&min=<?php echo $min;?>&max=<?php echo $max;?><?php } ?>&page=1"<?php if($bid == 'other') { ?> class="cBlue"<?php } ?>>其他品牌</a>
<?php } ?>
</div>
</div>
</div>
...
<div class="sift-left" style="padding:5px 0px 0px 0px;">
<div class="sift-box">
<!-- <?php $searchtext=urlencode(diconv($searchtexts, "GBK","UTF-8")); ?> -->
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?><?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1<?php if($searchtext!='') { ?>?searchtext=<?php echo $searchtext;?><?php } ?>" <?php if($order=='lastpost') { ?> class="hover"<?php } ?>><i></i>默认</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?><?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1<?php if($searchtext!='') { ?>?searchtext=<?php echo $searchtext;?><?php } ?>" <?php if($order=='heats') { ?> class="hover"<?php } ?>><i></i>热度</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=score&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?><?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1<?php if($searchtext!='') { ?>?searchtext=<?php echo $searchtext;?><?php } ?>" <?php if($order=='score') { ?> class="hover"<?php } ?>><i></i>评分</a>
<a href="http://www.8264.com/list/867/" target="_blank" style="background:#f98361;">装备值得买</a>
</div>
</div>

<div class="publish-right" style="overflow:hidden;">
                        	<style>
.searchequipment{ width:285px; height:30px; border:#8394a2 solid 1px; overflow:hidden; background:#fbfcfd; /*display:none;*/ float:left; margin-right:10px; border-radius:3px;}
.searchequipment .searchbutton{ width:34px; height:30px; background:url(http://static.8264.com/dianping/images/icon/data/searchbutton.png) center center no-repeat #576e81; float:right; border:none;}
.searchequipment .searchtext{ width:245px; height:30px; border:0 none; float:left; line-height:30px; text-indent:10px; color:#585858;}
                            </style>
                        	<div class="searchequipment">
                            	<input type="text" class="searchtext" placeholder="多个关键字用空格隔开，如“凯乐石 背包”" value="<?php echo $searchtexts;?>">
...
window.location.href="http://www.8264.com/zhuangbei.html?searchtext="+searchtext;
});
...
<div class="publish-box" style="float:right;">
<a href="http://www.8264.com/dianping.php?mod=equipment&amp;act=dopost&amp;do=new" target="_blank" class="publish-orange" style="height:32px; line-height:32px; background-position:9px 12px;">发布新装备</a>
</div>

</div>
</div>
<!-- 取消分类筛选 -->
<div class="sift-left" style="margin-top:5px;">
<div class="condition-box">
<h1><?php if($pcid) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=0&amp;cid=0&amp;bid=<?php echo $bid;?><?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1" class="condition"><?php echo $category[$pcid]['name'];?><i></i></a><?php } if($cid) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=0&amp;bid=<?php echo $bid;?><?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1" class="condition"><?php echo $category[$pcid]['child'][$cid];?><i></i></a><?php } if($min && $max) { ?>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;min=0&amp;max=0&amp;page=1" class="condition"><?php echo $min;?>~<?php echo $max;?>元<i></i></a>
<?php } elseif(!$min && $max) { ?>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;min=0&amp;max=0&amp;page=1" class="condition"><?php echo $max;?>元以下<i></i></a>
<?php } elseif($min && !$max) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=<?php echo $bid;?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?>&amp;page=1" class="condition"><?php echo $min;?>元以上<i></i></a>
<?php } if($bid) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=<?php echo $order;?>&amp;pcid=<?php echo $pcid;?>&amp;cid=<?php echo $cid;?>&amp;bid=0<?php if($min || $max) { ?>&amp;min=<?php echo $min;?>&amp;max=<?php echo $max;?><?php } ?>&amp;page=1" class="condition"><?php echo $brandlist[$bid]['subject'];?><i></i></a><?php } if($bid) { ?><a href="http://www.8264.com/pinpai-<?php echo $brandlist[$bid]['tid'];?>" target="_blank"><?php echo $brandlist[$bid]['subject'];?>品牌介绍</a><?php } ?>
</h1>
</div>
</div>
<!-- //取消分类筛选 -->
...
<div class="global-v3-content">
<div class="module">
<!-- list -->
<div class="ui-grid-12 ui-grid-full">
<div class="equip-box-warpten">
<?php if($modlist) { ?>
<ul class="equip-box"><?php if(is_array($modlist)) foreach($modlist as $k => $item) { ?><li>
<div class="pic">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="<?php echo $item['subject'];?>" target="_blank">
<img src="<?php echo getimagethumb(231,231,1, $item['dir'].'/'.$item['showimg'], $item['kaid'], $item['serverid']); ?>" alt="<?php echo $item['subject'];?>">
</a>
</div>
<div class="item-info-box">
<h3 class="bname">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="[<?php echo $item['brandname'];?>]<?php echo $item['subject'];?>" target="_blank"><?php echo $item['brandname'];?></a>
</h3>
<h2 class="iname">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="<?php echo $item['subject'];?>" target="_blank"><?php echo $item['subject'];?></a>
</h2>
<div class="rating-level-v3">
<span class="score-value score-value-<?php echo floor($item['score']); ?>"><em></em></span><?php if($item['score']!='0.0') { ?><strong class="eq-star"><?php echo $item['score'];?></strong><?php } else { ?><span class="eq-star">暂无评分</span><?php } ?>
</div>
<div class="equip-info-wrapper">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>#comment" target="_blank" class="equip-button">点评</a>
<div class="comment-review">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?><?php if($item['cnum']) { ?>#comment<?php } else { ?>#write<?php } ?>" target="_blank" class="comment"><i></i><?php echo $item['cnum'];?></a>
</div>
</div>
</div>
</li>
...
<script type="text/javascript">
jQuery(document).ready(function($) {
$(".equip-box li").hover(function() {
$(this).find(".item-info-box").animate({
height: 160
}, 300, function() {
});
$(this).find(".iname").animate({
height: 0,
marginTop: 0
}, 200, function() {
});
