<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('post', 'forum/dianping/header');
0
|| checktplrefresh('./template/8264/forum/dianping/post.htm', './template/8264/forum/dianping/header.htm', 1503803882, '2', './data/template/2_2_forum_dianping_post.tpl.php', './template/8264', 'forum/dianping/post')
|| checktplrefresh('./template/8264/forum/dianping/post.htm', './template/8264/forum/dianping/footer.htm', 1503803882, '2', './data/template/2_2_forum_dianping_post.tpl.php', './template/8264', 'forum/dianping/post')
|| checktplrefresh('./template/8264/forum/dianping/post.htm', './template/8264/common/header_8264_new.htm', 1503803882, '2', './data/template/2_2_forum_dianping_post.tpl.php', './template/8264', 'forum/dianping/post')
|| checktplrefresh('./template/8264/forum/dianping/post.htm', './template/8264/common/ewm_r.htm', 1503803882, '2', './data/template/2_2_forum_dianping_post.tpl.php', './template/8264', 'forum/dianping/post')
|| checktplrefresh('./template/8264/forum/dianping/post.htm', './template/8264/common/footer_8264_new.htm', 1503803882, '2', './data/template/2_2_forum_dianping_post.tpl.php', './template/8264', 'forum/dianping/post')
|| checktplrefresh('./template/8264/forum/dianping/post.htm', './template/8264/common/header_common.htm', 1503803882, '2', './data/template/2_2_forum_dianping_post.tpl.php', './template/8264', 'forum/dianping/post')
|| checktplrefresh('./template/8264/forum/dianping/post.htm', './template/8264/common/index_ad_top.htm', 1503803882, '2', './data/template/2_2_forum_dianping_post.tpl.php', './template/8264', 'forum/dianping/post')
|| checktplrefresh('./template/8264/forum/dianping/post.htm', './template/8264/common/taobao_ad_alert.htm', 1503803882, '2', './data/template/2_2_forum_dianping_post.tpl.php', './template/8264', 'forum/dianping/post')
;?>
<!doctype html>
<html>
<head>
...
_showmsg('请填写<?php echo $modname;?>的<?php echo $modsetting['address'];?>');
return false;
}
...
<?php if($action=='new') { ?>
猜在<span class="cBlue" id="dqtxt"><?php echo $nowregion['name'];?></span>，猜错了？
<?php } else { ?>
<?php echo $modname;?>在<span class="cBlue" id="dqtxt"><?php echo $nowregion['name'];?></span>，填错了？
<?php } ?>
<input type="hidden" name="pro" id="province" value="<?php echo $nowregion['id'];?>" />
<span class="cityChange"><span id="cityBtn">（切换城市 <em></em>）</span>
<div class="cityList" id="cityList">
<div class="list" id="cityItem"><?php if(is_array($regions)) foreach($regions as $type) { ?><a href="javascript:;" id="<?php echo $type['pro'];?>"><?php echo $type['name'];?></a>
<?php } ?>
</div>
<span class="topJJ">◆</span><span class="topJJWrite">◆</span>
</div>
...
<dd>
<span class="topTips" id="xqs"><?php echo $nowregion['name'];?> -</span>
<span class="inputTipsText">
...
<input type="hidden" value="<?php echo $editdata['longitude'];?>" id="longitude" name="mapx">
<input type="hidden" value="<?php echo $editdata['latitude'];?>" id="latitude" name="mapy">
</dd>
</dl>
<dl class="pubDt50">
<dt><span class="icoWeb48x43"></span></dt>
<dd><input type="text" name="url" id="url" value="<?php if($editdata['url']) { ?><?php echo $editdata['url'];?><?php } else { ?>http://<?php } ?>" class="inputText w270" /></dd>
</dl>
<?php if($_G['groupid'] == 1) { ?>
<!-- 公司内部人员才能添加导购链接 -->
<dl class="pubDt50">
...
<dd>
<span class="inputTipsText">
<label class="fs16"<?php if($editdata['phone']) { ?> style="display:none;"<?php } ?>>如：022-27308264</label>
<input type="text" class="inputText w270" name="phone" id="link" value="<?php echo $editdata['phone'];?>" />
</span>
...
<script type="text/javascript">
var params = {site:"<?php echo $_G['siteroot'];?>misc.php%3fmod=swfupload%26type=image%26fid=<?php echo $fid;?>%26mtype=plugin%26twidth=60%26theight=60%26random=<?php echo random(4); ?>",buttonimg:"<?php echo $_G['siteroot'];?>static/image/common/uploadnew.png"};
