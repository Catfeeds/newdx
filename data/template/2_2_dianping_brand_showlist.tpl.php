<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('brand_showlist', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/brand_showlist.htm', './template/8264/dianping/header.htm', 1509517888, '2', './data/template/2_2_dianping_brand_showlist.tpl.php', './template/8264', 'dianping/brand_showlist')
|| checktplrefresh('./template/8264/dianping/brand_showlist.htm', './template/8264/dianping/nav.htm', 1509517888, '2', './data/template/2_2_dianping_brand_showlist.tpl.php', './template/8264', 'dianping/brand_showlist')
|| checktplrefresh('./template/8264/dianping/brand_showlist.htm', './template/8264/common/zhidemai.htm', 1509517888, '2', './data/template/2_2_dianping_brand_showlist.tpl.php', './template/8264', 'dianping/brand_showlist')
|| checktplrefresh('./template/8264/dianping/brand_showlist.htm', './template/8264/dianping/footer.htm', 1509517888, '2', './data/template/2_2_dianping_brand_showlist.tpl.php', './template/8264', 'dianping/brand_showlist')
|| checktplrefresh('./template/8264/dianping/brand_showlist.htm', './template/8264/common/header_8264_new.htm', 1509517888, '2', './data/template/2_2_dianping_brand_showlist.tpl.php', './template/8264', 'dianping/brand_showlist')
|| checktplrefresh('./template/8264/dianping/brand_showlist.htm', './template/8264/common/ewm_r.htm', 1509517888, '2', './data/template/2_2_dianping_brand_showlist.tpl.php', './template/8264', 'dianping/brand_showlist')
|| checktplrefresh('./template/8264/dianping/brand_showlist.htm', './template/8264/common/weixin_share.htm', 1509517888, '2', './data/template/2_2_dianping_brand_showlist.tpl.php', './template/8264', 'dianping/brand_showlist')
|| checktplrefresh('./template/8264/dianping/brand_showlist.htm', './template/8264/common/footer_8264_new.htm', 1509517888, '2', './data/template/2_2_dianping_brand_showlist.tpl.php', './template/8264', 'dianping/brand_showlist')
|| checktplrefresh('./template/8264/dianping/brand_showlist.htm', './template/8264/common/header_common.htm', 1509517888, '2', './data/template/2_2_dianping_brand_showlist.tpl.php', './template/8264', 'dianping/brand_showlist')
|| checktplrefresh('./template/8264/dianping/brand_showlist.htm', './template/8264/common/index_ad_top.htm', 1509517888, '2', './data/template/2_2_dianping_brand_showlist.tpl.php', './template/8264', 'dianping/brand_showlist')
;
block_get('6905');?>
<!doctype html>
<html>
...
<div class="brand-list-warpten">
<ul class="brand-without-star"><?php if(is_array($zhaolist)) foreach($zhaolist as $item) { ?><?php $zhaozsp = stripos($item[subject],"（"); ?><?php $zhaoesp = stripos($item[subject],"("); if($zhaozsp) { ?><?php $item[ename] =  mb_substr($item[subject],0,$zhaozsp); ?><?php $item[cname] =  mb_substr($item[subject],$zhaozsp,strlen($item[subject])); } elseif($zhaoesp) { ?><?php $item[ename] =  mb_substr($item[subject],0,$zhaoesp); ?><?php $item[cname] =  mb_substr($item[subject],$zhaoesp,strlen($item[subject])); } ?>
<li>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" class="brand-img" target="_blank">
<img src="http://image1.8264.com/<?php echo $item['dir'];?>/<?php echo $item['showimg'];?>" alt="<?php echo $item['subject'];?>"></a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>#comment" target="_blank" class="brand-commn"><?php echo $item['cnum'];?></a>
<h2 class="brand-name">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" target="_blank"><?php echo cutstr($item['ename'],15,''); ?><br>
<?php if($item['cname']) { echo cutstr($item['cname'],20,''); } ?></a>
</h2>
</li>
<?php } ?>
<li>
<a href="http://www.8264.com/about-adservice.html" class="brand-img" target="_blank"><img src="http://image1.8264.com/forum/201109/23/165255v8vsi8nvr4iqadv5.jpg" alt=""></a>
<h2 class="brand-name">
<a  href="http://www.8264.com/about-adservice.html" target="_blank">其他您的加入</a>
</h2>
</li>
<li>
<a href="http://www.8264.com/about-adservice.html" class="brand-img" target="_blank"><img src="http://image1.8264.com/forum/201109/23/165255v8vsi8nvr4iqadv5.jpg" alt=""></a>
...
<div class="nav-name blue">品牌首字母</div>
<div class="nav-list-wartpen">
<div class="nav-list-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=0&amp;nat=<?php echo $nat;?>&amp;cp=<?php echo $cp;?>&amp;order=<?php echo $order;?>&amp;page=1" <?php if($_GET['let']==0) { ?>class="blue"<?php } ?>>全部</a><?php if(is_array($cate_letter)) foreach($cate_letter as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=<?php echo $k;?>&amp;nat=<?php echo $nat;?>&amp;cp=<?php echo $cp;?>&amp;order=lastpost&amp;page=1"<?php if($_GET['let']==$k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
<?php } ?>
</div>
</div>
</div>
<!--单个导航结束-->
<div class="nav-sift-one">
<div class="nav-name orange">品牌国籍</div>
<div class="nav-list-wartpen">
<div class="nav-list-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=<?php echo $let;?>&amp;nat=0&amp;cp=<?php echo $cp;?>&amp;order=<?php echo $order;?>&amp;page=1" <?php if($_GET['nat']==0) { ?>class="blue"<?php } ?>>全部</a><?php if(is_array($cate_region)) foreach($cate_region as $k => $v) { ?><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=<?php echo $let;?>&amp;nat=<?php echo $k;?>&amp;cp=<?php echo $cp;?>&amp;order=<?php echo $order;?>&amp;page=1"<?php if($_GET['nat']==$k) { ?> class="blue"<?php } ?>><?php echo $v;?></a>
<?php } ?>
</div>
</div>
</div>
<div class="line_l_t_d line_l_t_brand">
<div class="nav-name darkblue">排行榜</div>
<div class="line_con_gray clboth p_r div_region">
<span class="arrow_d"></span>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=<?php echo $let;?>&amp;nat=<?php echo $nat;?>&amp;cp=0&amp;order=<?php echo $order;?>&amp;page=1" <?php if($_GET['cp']==0) { ?>class="blue"<?php } ?>>全部</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=<?php echo $let;?>&amp;nat=<?php echo $nat;?>&amp;cp=39&amp;order=score&amp;page=1" <?php if($_GET['cp']==39) { ?>class="blue"<?php } ?>><?php echo $cate_ranklist['39'];?></a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=<?php echo $let;?>&amp;nat=<?php echo $nat;?>&amp;cp=41&amp;order=score&amp;page=1" <?php if($_GET['cp']==41) { ?>class="blue"<?php } ?>><?php echo $cate_ranklist['41'];?></a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=<?php echo $let;?>&amp;nat=<?php echo $nat;?>&amp;cp=43&amp;order=score&amp;page=1" <?php if($_GET['cp']==43) { ?>class="blue"<?php } ?>><?php echo $cate_ranklist['43'];?></a>
<!-- <a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=<?php echo $let;?>&amp;nat=<?php echo $nat;?>&amp;cp=45&amp;order=score&amp;page=1" <?php if($_GET['cp']==45) { ?>class="blue"<?php } ?>><?php echo $cate_ranklist['45'];?></a> -->
<a href="https://h5.youzan.com/v2/showcase/homepage?common%2Furl%2Fcreate=&amp;kdt_id=18585513&amp;scan=3&amp;from=kdt" style="position:relative; display:none;" target="_blank">十大2017最受欢迎装备排行榜<span style="position: absolute; top:-10px; right:-24px;"><img src="http://static.8264.com/dianping/images/icon/data/hot.png"></span></a>
<ul class="nav-brand-item"><?php if(is_array($cate_ranklist)) foreach($cate_ranklist as $k => $v) { if($k!=39 &&  $k!=41 &&  $k!=43) { ?>
<li><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=<?php echo $let;?>&amp;nat=<?php echo $nat;?>&amp;cp=<?php echo $k;?>&amp;order=score&amp;page=1"<?php if($_GET['cp']==$k) { ?> class="blue"<?php } ?>><?php echo $v;?></a></li>
<?php } } ?>
</ul>
</div>
</div>
...
<div class="sift-left">
<div class="sift-box">
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist" <?php if($_GET['order']=='lastpost' || $_GET['order']=='') { ?> class="hover" <?php } ?> ><i></i>默认</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=<?php echo $let;?>&amp;nat=<?php echo $nat;?>&amp;cp=<?php echo $cp;?>&amp;order=heats&amp;page=1" <?php if($_GET['order']=='heats') { ?> class="hover" <?php } ?> ><i></i>热度</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=<?php echo $let;?>&amp;nat=<?php echo $nat;?>&amp;cp=<?php echo $cp;?>&amp;order=score&amp;page=1" <?php if($_GET['order']=='score') { ?> class="hover" <?php } ?>><i></i>评分</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;let=<?php echo $let;?>&amp;nat=<?php echo $nat;?>&amp;cp=<?php echo $cp;?>&amp;order=dateline&amp;page=1" <?php if($_GET['order']=='dateline') { ?> class="hover" <?php } ?>><i></i>最新</a>
                                <a href="http://www.8264.com/list/867/" target="_blank" style="background:#f98361;">装备值得买</a>
</div>
</div>
<div class="publish-right">
<div class="publish-box">
<a href="http://www.8264.com/dianping.php?mod=brand&amp;act=dopost&amp;do=new&amp;action=newthread" target="_blank" class="publish-orange">发布新品牌</a>
</div>
</div>
</div>
</div>
...
<!-- list -->
<div class="brand-list-warpten">
<ul><?php if(is_array($modlist)) foreach($modlist as $item) { ?><?php $zsp = stripos($item[subject],"（"); ?><?php $esp = stripos($item[subject],"("); if($zsp) { ?><?php $item[ename] =  mb_substr($item[subject],0,$zsp); } elseif($esp) { ?><?php $item[ename] =  mb_substr($item[subject],0,$esp); } ?>
<li>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" target="_blank" class="brand-img">
<img src="http://image1.8264.com/<?php echo $item['dir'];?>/<?php echo $item['showimg'];?>" alt="<?php echo $item['subject'];?>">
</a>
<a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>#comment" target="_blank" class="brand-commn"><?php echo $item['cnum'];?></a>
<div class="rating-level small-rating brand-rating">
...
<h2 class="brand-name">
<a target="_blank" href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>"><?php echo cutstr($item['ename'],20,''); ?><br><?php if($item['cname']) { ?>(<?php echo cutstr($item['cname'],20,''); ?>)<?php } ?></a>
</h2>
</li>
<?php } ?>
</ul>
