<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('photolist', 'common/header_8264_new');
0
|| checktplrefresh('./source/plugin/whither/template/photolist.htm', './template/8264/common/header_8264_new.htm', 1508222372, 'whither', './data/template/2_whither_photolist.tpl.php', './source/plugin/whither/template', 'photolist')
|| checktplrefresh('./source/plugin/whither/template/photolist.htm', './template/8264/common/footer_8264_new.htm', 1508222372, 'whither', './data/template/2_whither_photolist.tpl.php', './source/plugin/whither/template', 'photolist')
|| checktplrefresh('./source/plugin/whither/template/photolist.htm', './template/8264/common/header_common.htm', 1508222372, 'whither', './data/template/2_whither_photolist.tpl.php', './source/plugin/whither/template', 'photolist')
|| checktplrefresh('./source/plugin/whither/template/photolist.htm', './template/8264/common/index_ad_top.htm', 1508222372, 'whither', './data/template/2_whither_photolist.tpl.php', './source/plugin/whither/template', 'photolist')
;?>
<!doctype html>
<html>
<head>
...
<div class="z" style="line-height:30px;"><?php echo $forumoption_mudidi->getBreadcrumbNavByTid($tid); ?> <em>&rsaquo;</em> 相关照片
</div>
</div>
...
<?php if($albumData) { ?>
<style type="text/css">
.mla li{ padding:0 13px; height:195px;}
</style>
<div class="mudidi_view_top"></div>
<div class="bm vw pl guide_list">
<div class="bm_h cl">
<h2><?php echo $mudidi_data['subject'];?>相册列表 <span style="font-weight:normal;">(共<?php echo $count;?>篇)</span></h2>
</div>
<div class="bm_c" style="overflow:hidden;">
<ul class="ml mla cl"><?php if(is_array($albumData)) foreach($albumData as $albumid => $album) { ?><li>
<div class="c"><a href="/home.php?mod=space&amp;uid=<?php echo $album['uid'];?>&amp;do=album&amp;id=<?php echo $album['albumid'];?>"><img src="http://image.8264.com/album/<?php echo $album['pic'];?>" alt="<?php echo $album['albumname'];?>" /></a></div>
<p class="ptm"><a href="/home.php?mod=space&amp;uid=<?php echo $album['uid'];?>&amp;do=album&amp;id=<?php echo $album['albumid'];?>"><?php echo $album['albumname'];?></a></p>
</li>
<?php } ?>
</ul>
<div class="pagebar"><?php $pageMulti = multi($count, $ppp, $page, "/whither-photolist-".$tid."-1.html"); ?><?php $pageMulti = preg_replace('/1\.html\?page=(\d+)/', '$1.html', $pageMulti); ?><?php echo $pageMulti;?>
</div>
</div>
</div>
<?php } ?>
