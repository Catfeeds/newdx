<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('activity', 'common/header');
0
|| checktplrefresh('./template/default/ranklist/activity.htm', './template/8264/common/header.htm', 1509520414, 'diy', './data/template/2_diy_ranklist_activity.tpl.php', './template/8264', 'ranklist/activity')
|| checktplrefresh('./template/default/ranklist/activity.htm', './template/default/common/simplesearchform.htm', 1509520414, 'diy', './data/template/2_diy_ranklist_activity.tpl.php', './template/8264', 'ranklist/activity')
|| checktplrefresh('./template/default/ranklist/activity.htm', './template/default/ranklist/side_left.htm', 1509520414, 'diy', './data/template/2_diy_ranklist_activity.tpl.php', './template/8264', 'ranklist/activity')
|| checktplrefresh('./template/default/ranklist/activity.htm', './template/8264/common/footer.htm', 1509520414, 'diy', './data/template/2_diy_ranklist_activity.tpl.php', './template/8264', 'ranklist/activity')
|| checktplrefresh('./template/default/ranklist/activity.htm', './template/8264/common/header_common.htm', 1509520414, 'diy', './data/template/2_diy_ranklist_activity.tpl.php', './template/8264', 'ranklist/activity')
;?>
<!doctype html>
<html>
<head>
...
<h1 class="mt">活动排行</h1>
<ul class="tb cl">
<li<?php if($_G['gp_orderby'] == 'heats') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=activity&amp;orderby=heats&amp;before=<?php echo $_G['gp_before'];?>">热度排行</a></li>
<li<?php if($_G['gp_orderby'] == 'favtimes') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=activity&amp;orderby=favtimes&amp;before=<?php echo $_G['gp_before'];?>">收藏排行</a></li>
<li<?php if($_G['gp_orderby'] == 'sharetimes') { ?> class="a"<?php } ?>><a href="misc.php?mod=ranklist&amp;type=activity&amp;orderby=sharetimes&amp;before=<?php echo $_G['gp_before'];?>">分享排行</a></li>
</ul>
<p id="before" class="tbmu">
<a href="misc.php?mod=ranklist&amp;type=activity&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=thismonth" id="2592000" <?php if($_G['gp_before'] == 'thismonth') { ?>class="a"<?php } ?> />本月</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=activity&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=thisweek" id="604800" <?php if($_G['gp_before'] == 'thisweek') { ?>class="a"<?php } ?> />本周</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=activity&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=today" id="86400" <?php if($_G['gp_before'] == 'today') { ?>class="a"<?php } ?> />今日</a><span class="pipe">|</span>
<a href="misc.php?mod=ranklist&amp;type=activity&amp;orderby=<?php echo $_G['gp_orderby'];?>&amp;before=all" id="all" <?php if($_G['gp_before'] == 'all') { ?>class="a"<?php } ?> />全部</a>
</p>
<?php if($activitylist) { ?>
<table cellpadding="0" cellspacing="0" class="acl"><?php if(is_array($activitylist)) foreach($activitylist as $activity) { ?><tr>
<td width="35" style="padding-left: 10px;"><?php if($activity['rank'] <= 3) { ?><img src="http://static.8264.com/static/image/common/rank_<?php echo $activity['rank'];?>.gif" alt="<?php echo $activity['rank'];?>" /><?php } else { ?><?php echo $activity['rank'];?><?php } ?></td>
<td class="type"><?php if($activity['aid']) { ?><img src="<?php echo $activity['attachurl'];?>" width="80" alt="" /><?php } else { ?><img src="http://static.8264.com/static/image/common/nophotosmall.gif" alt="nophoto" width="80" height="80" /><?php } ?></td>
<td>
...
<p class="xg1">
<?php if($_G['gp_orderby'] == 'favtimes') { ?>收藏 <?php echo $activity['favtimes'];?>
<?php } elseif($_G['gp_orderby'] == 'sharetimes') { ?>分享 <?php echo $activity['sharetimes'];?>
