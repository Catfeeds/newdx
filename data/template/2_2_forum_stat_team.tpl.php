<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('stat_team', 'common/header');
0
|| checktplrefresh('./template/default/forum/stat_team.htm', './template/8264/common/header.htm', 1501660107, '2', './data/template/2_2_forum_stat_team.tpl.php', './template/8264', 'forum/stat_team')
|| checktplrefresh('./template/default/forum/stat_team.htm', './template/default/common/simplesearchform.htm', 1501660107, '2', './data/template/2_2_forum_stat_team.tpl.php', './template/8264', 'forum/stat_team')
|| checktplrefresh('./template/default/forum/stat_team.htm', './template/default/common/stat.htm', 1501660107, '2', './data/template/2_2_forum_stat_team.tpl.php', './template/8264', 'forum/stat_team')
|| checktplrefresh('./template/default/forum/stat_team.htm', './template/8264/common/footer.htm', 1501660107, '2', './data/template/2_2_forum_stat_team.tpl.php', './template/8264', 'forum/stat_team')
|| checktplrefresh('./template/default/forum/stat_team.htm', './template/8264/common/header_common.htm', 1501660107, '2', './data/template/2_2_forum_stat_team.tpl.php', './template/8264', 'forum/stat_team')
;?>
<!doctype html>
<html>
<head>
...
<div id="wp" class="wp">
<link href="http://static.8264.com/static/css/home/misc_stat.css?<?php echo VERHASH;?>" rel="stylesheet" type="text/css">
...
<td><?php echo $team['members'][$uid]['lastvisit'];?></td>
...
<th width="50">本月在线(小时)</th>
<?php } ?>
</tr><?php unset($swapc); if(is_array($team['forums'][$category['fid']])) foreach($team['forums'][$category['fid']] as $fid => $forum) { if(is_array($team['moderators'][$fid])) foreach($team['moderators'][$fid] as $key => $uid) { ?><tr class="<?php echo swapclass('alt'); ?>">
