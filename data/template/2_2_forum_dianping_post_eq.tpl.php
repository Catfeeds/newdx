<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('post_eq', 'forum/dianping/header');
0
|| checktplrefresh('./template/8264/forum/dianping/post_eq.htm', './template/8264/forum/dianping/header.htm', 1508811934, '2', './data/template/2_2_forum_dianping_post_eq.tpl.php', './template/8264', 'forum/dianping/post_eq')
|| checktplrefresh('./template/8264/forum/dianping/post_eq.htm', './template/8264/forum/dianping/editor_2014_second.htm', 1508811934, '2', './data/template/2_2_forum_dianping_post_eq.tpl.php', './template/8264', 'forum/dianping/post_eq')
|| checktplrefresh('./template/8264/forum/dianping/post_eq.htm', './template/8264/forum/dianping/editor_2014_first.htm', 1508811934, '2', './data/template/2_2_forum_dianping_post_eq.tpl.php', './template/8264', 'forum/dianping/post_eq')
|| checktplrefresh('./template/8264/forum/dianping/post_eq.htm', './template/8264/forum/dianping/footer.htm', 1508811934, '2', './data/template/2_2_forum_dianping_post_eq.tpl.php', './template/8264', 'forum/dianping/post_eq')
|| checktplrefresh('./template/8264/forum/dianping/post_eq.htm', './template/8264/common/header_8264_new.htm', 1508811934, '2', './data/template/2_2_forum_dianping_post_eq.tpl.php', './template/8264', 'forum/dianping/post_eq')
|| checktplrefresh('./template/8264/forum/dianping/post_eq.htm', './template/8264/common/editor_2014.htm', 1508811934, '2', './data/template/2_2_forum_dianping_post_eq.tpl.php', './template/8264', 'forum/dianping/post_eq')
|| checktplrefresh('./template/8264/forum/dianping/post_eq.htm', './template/8264/forum/editor_menu_forum_newimage_2014.htm', 1508811934, '2', './data/template/2_2_forum_dianping_post_eq.tpl.php', './template/8264', 'forum/dianping/post_eq')
|| checktplrefresh('./template/8264/forum/dianping/post_eq.htm', './template/8264/common/ewm_r.htm', 1508811934, '2', './data/template/2_2_forum_dianping_post_eq.tpl.php', './template/8264', 'forum/dianping/post_eq')
|| checktplrefresh('./template/8264/forum/dianping/post_eq.htm', './template/8264/common/footer_8264_new.htm', 1508811934, '2', './data/template/2_2_forum_dianping_post_eq.tpl.php', './template/8264', 'forum/dianping/post_eq')
|| checktplrefresh('./template/8264/forum/dianping/post_eq.htm', './template/8264/common/header_common.htm', 1508811934, '2', './data/template/2_2_forum_dianping_post_eq.tpl.php', './template/8264', 'forum/dianping/post_eq')
|| checktplrefresh('./template/8264/forum/dianping/post_eq.htm', './template/8264/common/index_ad_top.htm', 1508811934, '2', './data/template/2_2_forum_dianping_post_eq.tpl.php', './template/8264', 'forum/dianping/post_eq')
;?>
<!doctype html>
<html>
<head>
...
_showmsg('请填写<?php echo $modname;?><?php echo $modsetting['mc'];?>');
return false;
} else if(mb_strlen(theform.subject.value) > 80) {
_showmsg('您的<?php echo $modname;?><?php echo $modsetting['mc'];?>超过 80 个字符的限制');
return false;
...
_showmsg('请上传<?php echo $modname;?><?php echo $modsetting['pic'];?>，并至少选择一张');
return false;
}
<?php } else { ?>
var subject=jQuery('#subject').val();
...
if(!jQuery('#bid').val()){
_showmsg('请选择<?php echo $modname;?><?php echo $modsetting['brand'];?>');
return false;
}

//if(!trim(jQuery('#sn').val())){
//	_showmsg('请填写<?php echo $modname;?><?php echo $modsetting['sn'];?>');
//	return false;
//}
if(!jQuery('#cid').val()||!jQuery('#pcid').val()){
_showmsg('请选择<?php echo $modname;?><?php echo $modsetting['typeclass'];?>');
return false;
}
        //参考价格填写的判断
        /*
if(!jQuery('#price').val()){
_showmsg('请选择<?php echo $modname;?>价格');
return false;
} else {
...
showDialog('请填写<?php echo $modname;?>简介');
return false;
}
...
</script><div id="alltemplateobj" class="templist" style="display: none;visibility: hidden;">
...
EOF;
?><?php $adveditor = $isfirstpost && $special || $special == 2 && ($_G['gp_action'] == 'newthread' || $_G['gp_action'] == 'reply' && !empty($_G['gp_addtrade']) || $_G['gp_action'] == 'edit' && $thread['special'] == 2); ?><?php $advmore = !$showthreadsorts && !$special || $_G['gp_action'] == 'reply' && empty($_G['gp_addtrade']) || $_G['gp_action'] == 'edit' && !$isfirstpost && ($thread['special'] == 2 && !$special || $thread['special'] != 2); ?><div class="layout mt50">
<div class="pubWeb">
...
<?php } ?>" onsubmit="return modform_validate(this);return false;">
...
<?php if($editdata['showimg'] && $editdata['dir']) { ?>
<a href="<?php echo $editdata['fmurl'];?><?php echo $editdata['dir'];?>/<?php echo $editdata['showimg'];?>" target="_blank"><img src="<?php echo getimagethumb(60,60,2,$editdata[dir].'/'.$editdata['showimg'], $editdata['kaid'], $editdata['serverid']); ?>" class="nowpic" /></a>
<?php if($editdata['kaid'] > 0) { ?>
<input type="hidden" name="headimgselect" value="<?php echo $editdata['kaid'];?>"/>
<?php } } ?>
</div>
</dd>
</dl>
...
<dd>
<span class="selectdiv<?php if($editdata['bid']) { ?> selectdiv_zhong<?php } ?>" id="bshow"><?php if(!$editdata['bid']) { ?>请选择<?php echo $modname;?>品牌<?php } else { ?>已选择品牌：<?php echo $editdata['bname'];?><?php } ?></span>
...
<a href="javascript:;" bid="<?php echo $brand['id'];?>" btid="<?php echo $brand['tid'];?>"><?php echo $brand['subject'];?></a>
<?php } } ?>
</div>
<?php } ?>
...
<input type="hidden" name="bid" id="bid" value="<?php echo $editdata['brandid'];?>" />
<input type="hidden" name="bname" id="bname" value="<?php echo $editdata['brandname'];?>" />
<input type="hidden" name="btid" id="btid" value="<?php echo $editdata['brandtid'];?>" />
</dd>
</dl>
...
<dd>
<span class="inputTipsText">
<label class="fs16" id="sn_notice"<?php if($editdata['sn']) { ?> style="display: none;"<?php } ?>>型号</label>
<input class="inputText w270" type="text" name="sn" id="sn" value="<?php echo $editdata['sn'];?>" />
</span>
<span class="icoRedStar">*</span>
</dd>
</dl>
...
<span class="icoRedStar">*</span>
<div class="categorylist" id="pclist"><?php if(is_array($typelist)) foreach($typelist as $typel) { if(is_array($typel)) foreach($typel as $type) { ?><a href="javascript:;" pcid="<?php echo $type['cid'];?>"<?php if($editdata['pcid'] == $type['cid']) { ?> selected="select_z"<?php } ?>><?php echo $type['name'];?></a>
<?php } } ?>
</div>
...
<span class="icoRedStar" id="cicon"<?php if(!$editdata['cid']) { ?> style="display:none;"<?php } ?>>*</span><?php if(is_array($typelist)) foreach($typelist as $typel) { if(is_array($typel)) foreach($typel as $type) { if($type['children']) { ?>
<div class="categorylist child" id="clist_<?php echo $type['cid'];?>"><?php if(is_array($type['children'])) foreach($type['children'] as $t_child) { ?><a href="javascript:;" cid="<?php echo $t_child['cid'];?>"<?php if($editdata['cid'] == $t_child['cid']) { ?> selected="select_z"<?php } ?>><?php echo $t_child['name'];?></a>
<?php } ?>
</div>
<?php } } } ?>
...
<dd>
<span class="inputTipsText">
<label class="fs16" id="price_notice"<?php if($editdata['price']) { ?> style="display: none;"<?php } ?>>参考价格</label>
<input type="text" class="inputText w150" name="price" id="price" value="<?php echo $editdata['price'];?>" maxlength="10" />
</span>
...
<dd>
<span class="inputTipsText">
<label class="fs16" id="tids_notice"<?php if($editdata['tids']) { ?> style="display: none;"<?php } ?>>网友测评帖子ID,用半角逗号分隔</label>
<input type="text" class="inputText w270" name="tids" id="tids" value="<?php echo $editdata['tids'];?>" />
</span>
</dd>
</dl>
<?php if($_G['groupid'] == 1) { ?>
...
<dd>
<span class="inputTipsText">
<label class="fs16" id="dgurl_notice"<?php if($editdata['dgurl']) { ?> style="display: none;"<?php } ?>>导购链接</label>
<input type="text" class="inputText w270" name="dgurl" id="dgurl" value="<?php echo $editdata['dgurl'];?>" />
</span>
</dd>
</dl>
<?php } ?>
<dl class="pubDt50">
<dd class="edtor"><?php $editor['value'] = $editdata['message']; ?><script src="<?php echo $_G['setting']['jspath'];?>forum_post.js?<?php echo VERHASH;?>" type="text/javascript"></script>
...
<input type="submit" class="publish182x43_1" name="<?php echo $action;?>post" id="postsubmit" value="" />
</dd>
</dl>
</form>
</div>
...
<script type="text/javascript">
var params = {site:"<?php echo $_G['siteroot'];?>misc.php%3fmod=swfupload%26type=image%26fid=<?php echo $fid;?>%26mtype=forum%26twidth=60%26theight=60%26head=1%26back=uploadsuccess_back_head%26water=no%26random=<?php echo random(4); ?>",buttonimg:"<?php echo $_G['siteroot'];?>static/image/common/uploadnew.png"};
