<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('getpasswd', 'common/header');
0
|| checktplrefresh('./template/default/member/getpasswd.htm', './template/8264/common/header.htm', 1504493140, '2', './data/template/2_2_member_getpasswd.tpl.php', './template/8264', 'member/getpasswd')
|| checktplrefresh('./template/default/member/getpasswd.htm', './template/8264/common/footer.htm', 1504493140, '2', './data/template/2_2_member_getpasswd.tpl.php', './template/8264', 'member/getpasswd')
|| checktplrefresh('./template/default/member/getpasswd.htm', './template/8264/common/header_common.htm', 1504493140, '2', './data/template/2_2_member_getpasswd.tpl.php', './template/8264', 'member/getpasswd')
;?>
<!doctype html>
<html>
<head>
...
<label><em>新密码:</em><input type="password" name="newpasswd1" size="25" class="txt" /></label>
<label><em>确认密码:</em><input type="password" name="newpasswd2" size="25" class="txt" /></label>
</div>
<div class="lgf minf">
<h4>没有账号？<?php echo $_G['setting']['reglinkname'];?></h4>
</div>
</div>
<p class="fsb pns cl">
<em>&nbsp;</em>
