<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('skiing_showview', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/dianping/header.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/dianping/nav.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/common/zhidemai.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/dianping/showview_content.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/dianping/showview_credit.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/dianping/skiing_mycomment.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/dianping/skiing_comment.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/dianping/replyedit_pic_upload.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/dianping/reply_pic_upload.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/dianping/sidebar_map.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/common/hd_ad.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/dianping/footer.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/common/header_8264_new.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/common/ewm_r.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/common/weixin_share.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/common/footer_8264_new.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/common/header_common.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
|| checktplrefresh('./template/8264/dianping/skiing_showview.htm', './template/8264/common/index_ad_top.htm', 1509517959, '2', './data/template/2_2_dianping_skiing_showview.tpl.php', './template/8264', 'dianping/skiing_showview')
;
block_get('7032,6990');?>
<!doctype html>
<html>
...
<i class="ui-icon"></i><?php if($detail['url']) { ?><a href="<?php echo $detail['url'];?>" target="_blank" rel="nofollow">官方网址</a><?php } else { ?>暂无官网<?php } ?>
</span>
<span class="detail-item tel">
<i class="ui-icon"></i><?php if($detail['tel']) { ?><?php echo $detail['tel'];?><?php } else { ?>暂无电话<?php } ?>
</span>
<span class="detail-item address">
<i class="ui-icon"></i><?php if($detail['addr']) { ?><?php echo $detail['addr'];?><?php } else { ?>暂无地址<?php } ?>
</span>
</div>
                        <?php if($detail['dgurl']) { ?>
                        <a href="<?php echo $detail['dgurl'];?>" rel="nofollow" title="点这去购买<?php echo $detail['subject'];?>的滑雪票" target="_brank" class="buyit">购买滑雪票</a>
                        <?php } ?>
</div>
</div>
</div>
...
<div class="ui-grid-6 ui-grid-left">
<!-- comment list -->
<?php if(!$commentlist) { } if($commentlist) { ?>
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="weakpoint" id="weakpoint" cols="30" rows="2" placeholder="请填写该滑雪场的不足之处"></textarea>
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="goodpoint" id="goodpoint" cols="30" rows="2" placeholder="请填写该滑雪场的优点"></textarea>
...
<div class="attrForms">
<div class="issue-forms-group">
<textarea name="message" id="message" cols="30" rows="6" placeholder="你可以填写从雪场价格、 交通、 服务、 雪具、 雪道、 雪质、缆车、餐饮等综合感受。优秀点评奖励1个8264币（可用于礼品兑换），抄袭者一经发现，扣除5个8264币。"></textarea>
...
<?php } ?>
                    ...
                    <?php echo adshow("custom_442"); ?>                    </div>
...
<div class="ui-title ui-title-line">
<h3>热门</h3>
<div class="ui-title-link"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;pro=0&amp;page=1">more</a></div>
</div>
</div>
<div class="ui-block ui-block-content">
...
<?php if($sidebar_region) { ?>
<div class="ui-grid-2 ui-grid-right">
<!-- 同地区滑雪场 -->
<div class="right-same-area-warpten">
<div class="ui-block ui-block-title">
<div class="ui-title ui-title-line">
<h3><?php echo $detail['subject'];?>同地区滑雪场</h3>
</div>
</div>
<div class="ui-block ui-block-content">
<div class="right-same-area-box">
<ul class="right-same-area"><?php if(is_array($sidebar_region)) foreach($sidebar_region as $k => $item) { ?><li>
<h3 class="wlist-bd-title"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showview&amp;tid=<?php echo $item['tid'];?>" title="<?php echo $item['subject'];?>" target="_blank"<?php if($k==0) { ?> class="orange"<?php } elseif($k==1 || $k==2) { ?> class="blue"<?php } ?>><?php echo $item['subject'];?></a></h3>
<div class="rating-level small-rating same-rating" title="<?php echo $item['cnum'];?>人参与点评">
<span class="score-value score-value-<?php echo floor($item['score']); ?>">
<em></em>
</span>
</div>
...
<div class="choiceness">
        <?php block_display('7032'); ?></div>
</div>
<div class="friendLink"><?php block_display('6990'); ?></div>
<script>
(function($){
$(function(){
//添加点评
...
onShow: '',
onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该滑雪场的综合评价。</span></div>',
onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
defaultValue: ""
}).inputValidator({
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该滑雪场的综合评价，不能少于10个字符。</span></div>'
});
//缺点
$('#weakpoint').formValidator({
onShow: '',
onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该滑雪场的不足之处。</span></div>',
onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
defaultValue: ""
}).inputValidator({
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该滑雪场的不足之处，不能少于10个字符。</span></div>'
});
//优点
$('#goodpoint').formValidator({
onShow: '',
onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该滑雪场的优点</span></div>',
onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
defaultValue: ""
}).inputValidator({
min: 20,
onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该滑雪场的优点，不能少于10个字符</span></div>'
});
