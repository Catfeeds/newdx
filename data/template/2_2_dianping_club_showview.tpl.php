<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('club_showview', 'dianping/header');
0
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/dianping/header.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/dianping/nav.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/common/zhidemai.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/dianping/showview_content.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/dianping/showview_credit.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/dianping/club_mycomment.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/dianping/climb_comment.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/dianping/replyedit_pic_upload.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/dianping/reply_pic_upload.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/dianping/sidebar_map.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/dianping/footer.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/common/header_8264_new.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/common/ewm_r.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/common/weixin_share.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/common/footer_8264_new.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/common/header_common.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
|| checktplrefresh('./template/8264/dianping/club_showview.htm', './template/8264/common/index_ad_top.htm', 1509517869, '2', './data/template/2_2_dianping_club_showview.tpl.php', './template/8264', 'dianping/club_showview')
;
block_get('6905,7012');?>
<!doctype html>
<html>
        ...
        <div class="ui-block ui-block-title">
            <div class="ui-title">
                ...
                <a href="http://www.8264.com/forum.php?ctl=<?php echo $mod;?>&amp;act=dopost&amp;do=edit&amp;tid=<?php echo $detail['tid'];?>&amp;pid=<?php echo $detail['pid'];?>" class="op-edit">
                    <span class="ui-title-manage">编辑</span>
                </a>
                <?php } ?>
            </div>
        </div>
                    ...
                    <div class="attribute-top-content">
                        ...
                        <div class="review-item-detail">
                            ...
                            <span class="detail-item ">
                                <i class="ui-icon chenglishijian"></i>成立时间：<?php echo $detail['chenglishijian'];?>年
                            </span>
                            <?php } ?>
<!--                            <span class="detail-item tel">
                                <i class="ui-icon"></i>联系方式：<?php if($detail['tel']) { ?><?php echo $detail['tel'];?><?php } else { ?>未填写<?php } ?>
                            </span>-->
                            <span class="detail-item address">
                                <i class="ui-icon"></i>所在地：<?php echo $countries[$detail['provinceid']]['cityname'];?><?php echo $countries[$detail['cityid']]['cityname'];?>
                            </span>
                            <?php if($detail['lingduinum'] > 0) { ?>
                            <span class="detail-item ">
                                <i class="ui-icon lingdui"></i>持证领队：<?php echo $detail['lingduinum'];?>人
                            </span>
                            <?php } ?>
                            <?php if($detail['gongsitype']) { ?>
                            <span class="detail-item ">
                                <i class="ui-icon type"></i>公司资质：<?php echo $cate_type[$detail['gongsitype']];?>
                            </span>
                            <?php } ?>
                        </div>
                    </div>
        ...
        <div class="ui-block ui-block-content">
            <div class="comment-form-box">
                ...
                <div class="rows-content row-color-3">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="weakpoint" id="weakpoint" cols="30" rows="2" placeholder="请填写该俱乐部的不足之处"></textarea>
                ...
                <div class="rows-content row-color-4">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="goodpoint" id="goodpoint" cols="30" rows="2" placeholder="请填写该俱乐部的优点"></textarea>
                ...
                <div class="rows-content row-color-5">
                    ...
                    <div class="attrForms">
                        <div class="issue-forms-group">
                            <textarea name="message" id="message" cols="30" rows="6" placeholder="请填写该俱乐部的综合评价"></textarea>
    ...
    <div class="ui-grid-2 ui-grid-right">
        ...
        <div class="right-hot-warpten">
            <div class="ui-block ui-block-title">
                <div class="ui-title ui-title-line">
                    <h3>TA的活动</h3>
<!--                    <div class="ui-title-link"><a href="http://u.8264.com/home-space-uid-<?php echo $detail['jids'];?>-do-ownactivity-type-orig.html" target="_brank">更多</a></div>-->
                </div>
            </div>
            <div class="ui-block ui-block-content">
                            ...
                            <div class="list-bd">
                                ...
                                <div class="rating-level small-rating hot-rating">
                                    <span style="margin-top:5px;">
                                        <?php $starttimefrom = date('Y-m-d', $item[starttimefrom]); ?>                                        <?php if($item['starttimeto']) { ?><?php echo $starttimefrom;?> 至 <?php echo date('Y-m-d', $item[starttimeto]) ?> <?php } else { ?><?php echo $starttimefrom;?><?php } ?>
                                    </span>
                                </div>
                            </div>
                        </li>
    ...
    <div class="ui-grid-2 ui-grid-right">
        ...
        <div class="right-hot-warpten">
            <div class="ui-block ui-block-title">
                <div class="ui-title ui-title-line">
                    <h3>热门</h3>
                    <div class="ui-title-link"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=heats&amp;gongsitype=0&amp;&amp;provinceid=0&amp;cityid=0&amp;page=1" target="_brank">更多</a></div>
                </div>
            </div>
            <div class="ui-block ui-block-content">
                <div class="common-list-box hot-list-box">
    ...
    <div class="ui-grid-2 ui-grid-right">
        <div class="right-same-area-warpten">
            <div class="ui-block ui-block-title">
                <div class="ui-title ui-title-line">
                    <h3>同地区</h3>
                    <div class="ui-title-link"><a href="http://www.8264.com/dianping.php?mod=<?php echo $mod;?>&amp;act=showlist&amp;order=lastpost&amp;gongsitype=0&amp;provinceid=<?php echo $detail['provinceid'];?>&amp;cityid=0&amp;page=1" target="_brank">更多</a></div>
                </div>
            </div>
            <div class="ui-block ui-block-content">
...
<script type="text/javascript">
    jQuery(document).ready(function($) {
        ...
        $('#message').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该俱乐部的综合评价。</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该俱乐部的综合评价，不能少于10个字符。</span></div>'
        });
        //缺点
        $('#weakpoint').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该俱乐部的不足之处。</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该俱乐部的不足之处，不能少于10个字符。</span></div>'
        });
        //优点
        $('#goodpoint').formValidator({
            onShow: '',
            onFocus: '<div class="valid-tips-container"><span class="tips-txt prompt"><i class="icon-v icon-prompt-v"></i>请填写该俱乐部的优点</span></div>',
            onCorrect: '<div class="valid-tips-container"><span class="tips-txt success"><i class="icon-v icon-success-v"></i></span></div>',
            defaultValue: ""
        }).inputValidator({
            min: 10,
            empty:false,
            onError: '<div class="valid-tips-container"><span class="tips-txt error"><i class="icon-v icon-error-v"></i>请填写该俱乐部的优点，不能少于10个字符</span></div>'
        });
