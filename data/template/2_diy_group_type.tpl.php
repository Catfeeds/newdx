<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('type', 'common/header');
0
|| checktplrefresh('./template/default/group/type.htm', './template/8264/common/header.htm', 1501654679, 'diy', './data/template/2_diy_group_type.tpl.php', './template/8264', 'group/type')
|| checktplrefresh('./template/default/group/type.htm', './template/default/common/simplesearchform.htm', 1501654679, 'diy', './data/template/2_diy_group_type.tpl.php', './template/8264', 'group/type')
|| checktplrefresh('./template/default/group/type.htm', './template/8264/common/footer.htm', 1501654679, 'diy', './data/template/2_diy_group_type.tpl.php', './template/8264', 'group/type')
|| checktplrefresh('./template/default/group/type.htm', './template/8264/common/header_common.htm', 1501654679, 'diy', './data/template/2_diy_group_type.tpl.php', './template/8264', 'group/type')
;?>
<!doctype html>
<html>
<head>
...
<div id="wp" class="wp">
<link href="http://static.8264.com/static/css/group/group_index.css?<?php echo VERHASH;?>" rel="stylesheet" type="text/css">
...
<?php } } ?><div class="z"><a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a><em>&rsaquo;</em><a href="group.php"><?php echo $_G['setting']['navs']['3']['navname'];?></a><?php echo $groupnav;?></div>
