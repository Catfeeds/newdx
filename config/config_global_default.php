...
// ----------------------------  CONFIG DB  ----------------------------- //
$_config['db']['1']['dbhost'] = '192.168.1.25';
$_config['db']['1']['dbuser'] = '';
$_config['db']['1']['dbpw'] = '';
...
$_config['db']['slave']['1']['dbhost'] = '192.168.1.18';
...
$_config['memory']['memcache']['server'] = '192.168.1.23';
$_config['memory']['memcache']['port'] = 11911;
$_config['memory']['memcache']['pconnect'] = 1;
$_config['memory']['memcache']['timeout'] = 1;
$_config['memory']['memcache_clusters'][1] = '192.168.1.23:11711';
$_config['memory']['memcache_clusters'][2] = '192.168.1.19:11811';
$_config['memory']['memcache_clusters'][3] = '192.168.1.17:11911';
// ----------------------------CONFIG VIEWS------------------------------ //
$_config['ignor_redisviews'] = true;
// --------------------------  CONFIG REDIS   --------------------------- //
$_config['memory']['redis']['server'] = '192.168.1.23';
$_config['memory']['redis']['port'] = 6381;
$_config['memory']['redis']['server23'] = '192.168.1.23';
...
// redis 6381
$_config['memory']['redis'][6381]['server'] = '192.168.1.23';
...
// redis 6379
$_config['memory']['redis'][6379]['server'] = '192.168.1.23';
...
// redis 6378
$_config['memory']['redis'][6378]['server'] = '192.168.1.23';
...
// redis 6382
$_config['memory']['redis'][6382]['server'] = '192.168.1.23';
...
// redis 6376
$_config['memory']['redis'][6376]['server'] = '192.168.1.23';
