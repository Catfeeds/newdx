...
document.write('<div onclick="javascript:submitFormWithChannel(\'logo\')" style="cursor:pointer;float: left;width:70px;height:23px;background: url(http://static.8264.com/static/image/common/Google_small.png) !important;background: none;filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\'http://static.8264.com/static/image/common/Google_small.png\', sizingMethod=\'scale\')"><img src="http://static.8264.com/static/image/common/none.gif" border="0" alt="Google" /></div>');
