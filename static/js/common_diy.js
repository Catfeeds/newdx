...
(function(){
	...
	Drag.prototype = {
		...
		toggleContent : function (e) {
			...
			if(display != '') {
				e.aim.src='http://static.8264.com/static/image/common/fl_collapsed_no.gif';
			} else {
				e.aim.src='http://static.8264.com/static/image/common/fl_collapsed_yes.gif';
			}
		},
	...
	DIY.prototype = {
		...
		changeStyle : function (t) {
			if (t == '') return false;
			$('style_css').href="http://static.8264.com/static/"+t+"/style.css";
