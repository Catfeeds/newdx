...
function fastpostappendreply() {
	...
	if($('secanswer3')) {
		$('checksecanswer3').innerHTML = '<img src="http://static.8264.com/static/image/common/none.gif" width="17" height="17">';
		$('secanswer3').value = '';
		secclick3['secanswer3'] = 0;
	}
	if($('seccodeverify3')) {
		$('checkseccodeverify3').innerHTML = '<img src="http://static.8264.com/static/image/common/none.gif" width="17" height="17">';
...
function succeedhandle_picreply(locationhref, message, param) {
	ajaxget('forum.php?mod=misc&action=picturemore&tid=' + param['tid'] + '&pid=' + param['pid'], 'commentsList');
	hideWindow('reply');
	showCreditPrompt();
}
